...
<Item issue="2989" category="enhancement">
Added support for the SAML v2.0 ForceAuthn attribute. When using FusionAuth as an IdP, this attribute will force re-authentication of the user, regardless of their SSO session state. This also resolves [GitHub Item #1736](https://github.com/FusionAuth/fusionauth-issues/issues/1736)
</Item>
