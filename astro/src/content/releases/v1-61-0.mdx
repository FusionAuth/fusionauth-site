...
<Item category="known-issue" resolvedIn="1.64.0" viaIssue="3381">
Long-running Admin UI requests can sometimes duplicate actions.
</Item>

<Item category="known-issue" viaIssue="3462" resolvedIn="1.69.0">
The `PATCH /api/application/{id}` API returns an error for applications whose name is duplicated across Tenants.
</Item>

<Item category="fix" issue="3273" since="1.61.0">
SCIM Group reconciliation may delete manually-assigned Group roles during the Microsoft Entra ID provisioning cycle.
</Item>
