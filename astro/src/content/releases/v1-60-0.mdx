...
<Item category="known-issue" resolvedIn="1.61.0" viaIssue="3186">Performing a user reindex occasionally results in an email, username, or phoneNumber, for a small fraction of users, to not be searchable via Elasticsearch/OpenSearch.</Item>
...
<Item category="known-issue" resolvedIn="1.61.1" viaIssue="3251">Providing an expired Id Token to the `/oauth2/logout` endpoint using the `id_token_hint` parameter results in an OAuth error.</Item>
