...
<Item category="known-issue" issue="3366">
Version upgrades may cause a FusionAuth instance to deactivate a configured license. To work around this issue, check for your license after a version upgrade; if it is missing, re-activate the license using your license Id from [account.fusionauth.io/](https://account.fusionauth.io/).
</Item>
