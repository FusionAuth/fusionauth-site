...
<Item category="known-issue" viaIssue="3089" resolvedIn="1.69.0">
User MFA method validation does not check for duplicates when providing an `id` for the method. This allows a user to add the same email account or phone number multiple times.
</Item>
