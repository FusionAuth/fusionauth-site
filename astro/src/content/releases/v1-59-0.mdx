...
<Item category="known-issue" viaIssue="3401" resolveIn="1.67.0">
...
As a workaround, you can set a random secure password on the user account, _then_ set `user.passwordChangeRequired` to `true`. As long as the user has a recovery option available (e.g. email or phone), they can use the **Forgot Password** flow to set up a new password.
</Item>
