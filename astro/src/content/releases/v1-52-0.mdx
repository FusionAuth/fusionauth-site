...
It sometimes required two <InlineUIElement>Submit</InlineUIElement> button clicks to exit interactive maintenance mode to upgrade your database schema. We are sorry if you had to click the <InlineUIElement>Submit</InlineUIElement> button twice.
</Item>
