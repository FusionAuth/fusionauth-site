...
<Item category="known-issue" viaIssue="3268" resolvedIn="1.69.0">
The Admin UI displays keys that cannot be used for the current task in the key dropdown (e.g. the JWT signing key dropdown displays a public key). Selecting an invalid key result in a validation error.
</Item>
