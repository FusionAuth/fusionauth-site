...
Updated `com.fasterxml.jackson.*` dependencies to version `2.14.0`. This update is proactive, there are no known exploits. See [CVE-2022-42003](https://www.cve.org/CVERecord?id=CVE-2022-42003) and [CVE-2022-42004](https://www.cve.org/CVERecord?id=CVE-2022-42004).
</Item>
