...
<Item category="known-issue" resolvedIn="1.69.0" viaIssue="3222">
A Generic Connector configured with a Login Validation Lambda will _always_ fail on first login for each user with `Unexpected FusionAuth error`.
</Item>
