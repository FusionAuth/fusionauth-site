...
date: 2026-04-30
description: "FusionAuth 1.65.0 adds self-service tenant SSO configuration, custom favicons for simple themes, voice MFA, a new way to test IdP configurations, and a variety of performance improvements. For more information, check out our <a href='https://fusionauth.io/blog/announcing-fusionauth-1-65'>release post</a>."
---
...
<Item category="security">
Fixed a potential directory traversal issue that could expose files stored outside the web root folder by upgrading `java-http` and `prime-mvc`.
</Item>
