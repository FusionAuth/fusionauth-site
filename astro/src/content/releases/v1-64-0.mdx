...
`GET /api/user/two-factor/recovery-code/{userId}` is deprecated. To follow security best practices, we recommend [regenerating recovery codes](/docs/apis/two-factor#generate-recovery-codes) whenever they need to be retrieved, rather than retrieving existing ones.
</Item>
