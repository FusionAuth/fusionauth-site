...
Added the `tenantID` parameter to several APIs used for fetching IdPs.
</Item>
...
Added an Admin UI page for [Fine-Grained Authorization (FGA)](/docs/extend/fine-grained-authorization/fusionauth-fga).
</Item>
