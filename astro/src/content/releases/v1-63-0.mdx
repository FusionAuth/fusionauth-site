...
Added AuthenticationType to the MFA Lambda. This enables the MFA lambda to prompt for MFA based on the method the user used to login.
</Item>

<Item category="enhancement" issue="3346">
Added more relevant information to the summary tab in the setup wizard.
</Item>

<Item category="enhancement" issue="3347">
...
Added validation to fix a bug where nonfunctional API keys could be successfully created by mismatching the `type` label with the PEM.
</Item>
