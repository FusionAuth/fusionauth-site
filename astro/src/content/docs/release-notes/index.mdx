...
<ReleaseNoteHeading version='1.58.0' releaseDate='July 21, 2025' />
### Known Issues
* A bug exists that prevents the Groups page from loading properly. If you use groups, it is recommended that you not upgrade to version `1.58.0` and wait instead for the `1.58.1` patch release.
