...
* <Issue issue="2916">
  Add additional validation of an authorizing JWT when issuing a new JWT.
  </Issue>
...
* <Issue issue="2928">
  The `POST /api/user/registration` call is documented as returning a refreshTokenId, but the id is not being returned on the response.
  </Issue>
* <Issue issue="2929">
...
* <Issue issue="1619">
  A new revocation policy option `Revoke on reuse of a one-time use token` allows you to revoke an active, one-time use refresh token if an attempt is made to use an already-used token from the same token chain. A token chain consists of all the refresh tokens that have been generated from refreshes of an original refresh token.
  </Issue>
* <Issue issue="2378">
...
* <Issue issue="2864">
  In the new Webhook Event Log there were numerous small UX and copy improvements added.
  </Issue>
* <Issue issue="2878">
...
* <Issue issue="2880">
  Cleaned up our default theme templates by removing some internal `TODO` comments that weren't benefiting users..
  </Issue>
* <Issue issue="2873">
  Update dependencies.
