...
* <Issue issue="3105">
    In rare cases, when FusionAuth is using an air-gapped license and running in a clusted setup, restoration of outbound network connectivity can cause a standard (not air-gapped) license to be incorrectly installed.
  </Issue>
