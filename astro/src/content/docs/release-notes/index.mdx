...
* <KnownIssue issue="3186">Performing a user reindex intermittently results in email, username, or phoneNumber to be omitted from Elastic/OpenSearch and not be searchable.</KnownIssue>
