...
* <KnownIssue issue="3183">When using FusionAuth as a SAML IDP with a SAML Populate lambda, lambdas that update the SAML assertion fail. See issue for workaround.</KnownIssue>
