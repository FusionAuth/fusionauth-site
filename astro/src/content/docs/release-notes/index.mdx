...
### Fixed
* <Issue issue="3153">
    An upgrade to FusionAuth version `1.58.2` or `1.59.0` fails if the `Default Admin Registration provided by FusionAuth` form name (shipped in `1.20.0`) is changed prior to the upgrade.
  </Issue>
...
### Known Issues
* <IssueResolvedVia resolvedIn="1.59.1" viaIssue="3153">After releasing FusionAuth version `1.59.0` we identified an issue in FusionAuth `1.58.0` and newer, where, if the `Default Admin Registration provided by FusionAuth` form name is changed prior to the upgrade, a FusionAuth upgrade can fail. If you are planning an upgrade to version `1.59.0`, it is recommended that you upgrade to version `1.59.1`.</IssueResolvedVia>
...
### Known Issues
* <IssueResolvedVia resolvedIn="1.58.3" viaIssue="3153">After releasing FusionAuth version `1.59.0` we identified an issue in FusionAuth `1.58.0` and newer, where, if the `Default Admin Registration provided by FusionAuth` form name is changed prior to the upgrade, a FusionAuth upgrade can fail. If you are planning an upgrade to version `1.58.2`, it is recommended that you upgrade to version `1.58.3`.</IssueResolvedVia>
...
### Known Issues
* <IssueResolvedVia resolvedIn="1.58.3" viaIssue="3153">After releasing FusionAuth version `1.59.0` we identified an issue in FusionAuth `1.58.0` and newer, where, if the `Default Admin Registration provided by FusionAuth` form name is changed prior to the upgrade, a FusionAuth upgrade can fail. If you are planning an upgrade to version `1.58.1`, it is recommended that you upgrade to version `1.58.3`.</IssueResolvedVia>
...
* <IssueResolvedVia resolvedIn="1.58.3" viaIssue="3153">After releasing FusionAuth version `1.59.0` we identified an issue in FusionAuth `1.58.0` and newer, where, if the `Default Admin Registration provided by FusionAuth` form name is changed prior to the upgrade, a FusionAuth upgrade can fail. If you are planning an upgrade to version `1.58.0`, it is recommended that you upgrade to version `1.58.3`.</IssueResolvedVia>
