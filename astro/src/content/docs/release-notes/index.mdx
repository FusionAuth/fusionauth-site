...
<ReleaseNoteHeading version='1.62.0' releaseDate='December 18, 2025' />

<DatabaseMigrationWarning />

<ThemeUpdateWarning version="1.62.0">
    Several changes are required to support pre-verification.
</ThemeUpdateWarning>
...
### New
* Pre-verification (TBD GitHub issue)
