...
* <Issue issue="3289">
    When a custom theme was missing a template, FusionAuth could fail to render the fallback template from the default theme. Fallback templates are now rendered correctly.
  </Issue>
