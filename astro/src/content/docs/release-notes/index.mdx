...
<Aside type="caution">
FusionAuth version `1.58.0` was released with a bug that prevented the Groups page from loading properly. We removed this release from distribution. If you happened to install version `1.58.0` during the brief time that it was available, it is recommended that you upgrade to version `1.58.2`.
</Aside>
