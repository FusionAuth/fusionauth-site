...
* <Issue issue="3186">
    Performing a user reindex intermittently results in an `email`, `username`, or `phoneNumber` being omitted from Elastic/OpenSearch and not being searchable. This has been corrected.
  </Issue>
* <Issue issue="3225">
