...
### Fixed
* A bug was introduced in `1.53.0` that prevented a user from enrolling a new Passkey (WebAuthn credential) used for reauthentication during a login workflow.
