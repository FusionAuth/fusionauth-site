...
* <Issue issue="3032">
    Performance of bulk user import using the User API was improved. Customers with hundreds or thousands of applications will benefit the most. Application cache refreshing has also improved for customers with thousands of applications.
