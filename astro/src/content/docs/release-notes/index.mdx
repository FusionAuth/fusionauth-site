...
* <Issue issue="1841">
    Multiple instances of all identity provider types are now supported. Previously, many gaming and social identity provider types were limited to a single configuration per FusionAuth instance.
  </Issue>
