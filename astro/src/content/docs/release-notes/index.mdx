...
* <Issue issue="2589">
  Passwordless OTP - supports phone out of the box, API users can use email
  </Issue>
...
* Resolves [GitHub Issue #1573](https://github.com/FusionAuth/fusionauth-issues/issues/1573)

### Enhancements
* Add debug/error event logging to generic messenger and other enhancements
* Resolves [GitHub Issue #1574](https://github.com/FusionAuth/fusionauth-issues/issues/1574)
