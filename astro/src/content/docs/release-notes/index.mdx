...
Note, this change can affect new integrations as any new application will default to `Strict` (please specify a `Compatibility` field value in your API calls if neede).
