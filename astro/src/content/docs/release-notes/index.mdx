...
* <Issue issue="3171">
    Maintenance Mode error messaging was improved. Should an error occur in maintenance mode. you'll see more descriptive erros now, which should help with troubleshooting the problem.
  </Issue>
