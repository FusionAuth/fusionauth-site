...
* <Issue issue="3073">
  PENDING PR merge. During a slow migration of a user using a generic or LDAP connector, the known device cookie is not created. The new device webhook and new device email are still invoked if configured.
  </Issue>
