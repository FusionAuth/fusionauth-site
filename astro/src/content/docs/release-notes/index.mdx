...
* <Issue issue="3164">
    Validation and error handling can be improved around setting up MFA during self-serve registration
  </Issue>
...
* <IssueResolvedVia resolvedIn="1.60.0" viaIssue="3175">
    It is impossible to set webhooks for the following event types as transactional:
