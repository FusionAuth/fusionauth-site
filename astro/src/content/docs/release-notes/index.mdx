...
* <Issue issue="2905">
    FusionAuth can now run in a mode that allows the use of FIPS-compliant verified cryptographic modules. See our [Security &amp; Compliance page](http://fusionauth.io/security) for more details.
  </Issue>
