...
* <Issue issue="2936">
    After an account has been locked after too many failed login attempts, resetting the password isn't resetting the failed login count. After resetting their password, a user should have the full set of login attempts available to them.
  </Issue>
