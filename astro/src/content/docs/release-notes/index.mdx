...
<ReleaseNoteHeading version='1.63.0' releaseDate='TBD' />

### New
* <Issue issue="2800">
    The default hosted pages now display a button on password fields to toggle showing the unmasked password.
  </Issue>

### Fixed
* <Issue issue="2041">
    Charts displayed in the Reports section of the admin UI could show data from an incorrect time range after toggling between bar and line view. Separately, errors would sometimes appear in the JavaScript console when changing the time range or chart type.
  </Issue>
