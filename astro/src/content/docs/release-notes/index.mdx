...
### Fixed
* <Issue issue="3150">
    In version `1.59.0` we started indexing the new `user.phoneNumber` field. `IndexUser` had a new field added, but the doc annotation was missing the version.
  </Issue>
* <Issue issue="3179">
...
* <Issue issue="3140">
    There are situations where a user can be re-prompted for authentication when already having valid FusionAuth and Google IdP sessions. SSO should be honored correctly in these cases.
  </Issue>
* <Issue issue="2949">
...
* <Issue issue="3208">
    During startup, FusionAuth can output duplicate log entries. This is especially present with silent mode off. Logging should be efficient.
  </Issue>
* <Issue issue="3227">
...
* <Issue issue="3064">
    When using SCIM PATCH to add a user field, exiting fields are being removed. PATCH should be handled as expected.
  </Issue>
* <Issue issue="3186">
...
* <Issue issue="3225">
    Some unwanted JavaScript errors are reported in the browser console on some pages, including the maintenance mode page and the application scope management page. These errors should be handled more gracefully.
  </Issue>
* <Issue issue="3111">
