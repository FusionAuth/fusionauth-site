...
<GeneralMigrationWarning>
  When designing integrations that leverage the User Registrations API, please be aware that the `data` field for the FusionAuth application, Id `3c219e58-ed0e-4b18-ad48-f4f92793ae32`, may now contain a `preferences` object with variable fields within.
</GeneralMigrationWarning>
...
### New
* Version `1.52.0` introduces support for Licensed Community. After upgrading, those with a community plan can now get even more out of FusionAuth with a free license.
