...
* <Issue issue="3032">
    Bulk user import with the User API has been improved.

    Performance will particularly be improved for importing with hundreds, or thousands of applications.
  </Issue>
