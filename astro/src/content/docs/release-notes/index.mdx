...
* <Issue issue="2814">
  The passwordless API returns a 500 error when a non-esistent application Id is provided. This should return a correct response code and meaningful error.
  </Issue>
* <Issue issue="2826">
...
* <Issue issue="2970">
  A nondescript error is returned when trying to save system settings via the FusionAuth admin application.
  </Issue>
* <Issue issue="2990">
...
### Enhancements
* <Issue issue="2975">
  Allow the post-login bootstrapping of a FusionAuth SSO session using an access token
  </Issue>

### Internal
* <Issue issue="2963">
  Remove duplicated storage of internal messages relating to SCIM group operations
  </Issue>
...
* You can't save the System Settings in the admin UI. 
  * This is being tracked via [GitHub Issue #2970](https://github.com/FusionAuth/fusionauth-issues/issues/2970). The current workaround is to use the API to change your system settings.
