...
* In previous versions of FusionAuth, if a new themed page was added that you were missing in your theme, the end user may be shown a page indicate the page was missing. This was shown because it was assumed that a new page would only be shown for new feature that had not been enabled, and this page would only ever been seen during development. In this release we are adding a new theme page that may be shown w/out any additional features being enabled. For this reason, we have removed this page, and we will always fall back to the default theme in this scenario.
