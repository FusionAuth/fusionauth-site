...
* When creating a user through Kickstart with `passwordChangeRequired` set to <InlineFieldValue>true</InlineFieldValue> and exception will occur during the next login request. This issue was introduced in version 1.15.0.
