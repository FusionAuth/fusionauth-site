...
import GeneralUpgradeInfo from 'src/content/docs/release-notes/_general-upgrade-info.mdx';
...
import SearchIndexWarning from 'src/content/docs/release-notes/_search-index-warning.mdx';
