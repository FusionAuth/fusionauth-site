...
<GeneralUpgradeInfo info_message="The FusionAuth link:/docs/get-started/download-and-install/system-requirements[System Requirements] have been updated. Please review the updated requirements to ensure you have met the minimum supported versions of operating system and database." />
