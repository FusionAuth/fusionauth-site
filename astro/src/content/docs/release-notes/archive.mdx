...
* If you are using the [SAML v2 Populate Lambda](/docs/extend/code/lambdas/samlv2-response-populate) or the [SAML v2 Reconcile Lambda](/docs/extend/code/lambdas/samlv2-response-reconcile) the <InlineField>NameID</InlineField> field has been changed to an array. You will need to update your lambda code if you are using this field.
