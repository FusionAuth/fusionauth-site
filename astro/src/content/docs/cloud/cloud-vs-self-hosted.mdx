...
You can estimate the total cost of cloud-hosting using our [pricing calculator](https://account.fusionauth.io/pricing-calculator/). Compare this to the cost of maintaining FusionAuth with your own resources, and the potential cost of downtime if your local FusionAuth instance were to become misconfigured. 
