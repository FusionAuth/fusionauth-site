...
import CloudLimits from '_cloud-limits.mdx';
...
import LoadTestingIntro from '_load-testing-intro.mdx';
import LoadTestingTips from '_load-testing-tips.mdx';
...
![On the <Breadcrumb>Hosting</Breadcrumb> tab with no deployments.](/img/docs/get-started/run-in-the-cloud/deployments-tab-no-deployments.png)
...
![On the <Breadcrumb>Hosting</Breadcrumb> tab with invoicing set up after trying to launch.](/img/docs/get-started/run-in-the-cloud/deployments-tab-invoiced.png)
...
* Navigate to the <Breadcrumb>Hosting</Breadcrumb> tab. Manage the deployment, then choose the <Breadcrumb>Upgrade</Breadcrumb> option. Select `1.x` from the **Version** dropdown.
