...
FusionAuth will start, and you will be able to log in at `http://localhost:9011/admin` with username `admin@example.com` and password `password`. In <Breadcrumb>Users</Breadcrumb>, [add a new user](/docs/get-started/core-concepts/users) by clicking the green <Breadcrumb>+</Breadcrumb> button.
...
<Aside type="note">
  FusionAuth also has a paid version that [runs in the cloud](/docs/cloud/cloud). If you want to avoid the hassle of managing, backing up, and upgrading FusionAuth yourself, this might be the solution for you. Tests in this guide will still work after the version of FusionAuth has been upgraded.
</Aside>
...
- [FusionAuth cloud version](/docs/cloud/cloud)
