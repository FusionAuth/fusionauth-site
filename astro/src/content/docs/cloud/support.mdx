...
tags: fusionauth cloud, cloud support, customer support, managed hosting, help, support plans
order: 700
---
...
Support for FusionAuth Cloud is limited in scope. For official support, you must use a version of FusionAuth released in the last 6 months.
