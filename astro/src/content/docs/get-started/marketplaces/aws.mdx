...
tags: aws marketplace, amazon web services, aws deployment, cloud marketplace, fusionauth aws, ec2
---
...
![FusionAuth's AWS Marketplace listing screenshot.](/img/docs/cloud/marketplaces/aws.png)
