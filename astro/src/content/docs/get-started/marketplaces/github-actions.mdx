...
tags: github actions, ci/cd, automated testing, github marketplace, workflows, github integration
---
...
![FusionAuth's GitHub Actions Marketplace listing screenshot.](/img/docs/cloud/marketplaces/gha.png)

## More Resources

Read more about using [FusionAuth and GitHub actions](/docs/cloud/operate/test) for testing purposes
