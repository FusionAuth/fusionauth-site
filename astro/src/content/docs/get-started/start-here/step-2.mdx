...
<div class="gap-6 grid grid-cols-1 not-prose lg:grid-cols-2">
	<Card variant="compact" href="step-1" label="<-" labelFirst={false} title="Step 1: Install"/>
	<Card variant="compact" href="step-3" label="->" labelFirst={true} title="Step 3: Protected Pages"/>
</div>
