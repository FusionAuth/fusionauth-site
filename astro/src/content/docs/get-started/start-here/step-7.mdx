...
<div class="gap-6 grid grid-cols-1 not-prose lg:grid-cols-2">
  <Card variant="compact" href="step-6" label="<-" labelFirst={false} title="Step 6: Logout"/>
  <Card variant="compact" href="step-8" label="->" labelFirst={true} title="Step 8: Finished"/>
</div>
