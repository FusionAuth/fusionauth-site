...
---
import InstallOrStartTrial from 'src/components/install-or-start/InstallOrStartTrial.astro';
...
Pick your preferred method of installation below. And remember, these are not exhaustive. FusionAuth also provides platform specific options and services such as DEB and RPM packages.

<InstallOrStartTrial kickstartEnabled={true} kickstartName={"get-started"}/>
