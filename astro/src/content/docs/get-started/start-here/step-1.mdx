...
Once you've thoroughly explored the UI, log out before proceeding to the next step. The next set of steps all work with an admin user, but it's better to demonstrate login and protected pages as a non-admin instead. To log out, click the <Breadcrumb>Log out</Breadcrumb> button in the top right.
