...
Now, log out of the admin UI. Visit your application and click the <InlineUiElement>Login</InlineUiElement> button. You'll see a 'Login With Magic Link' button (TODO might not be that text).

Click on it and enter your users email address.

<Aside type="note">
Typically you'd need to configure an email server and the email template, but this has been done for you.
</Aside>
...
You enabled Magic Link login for the sample application without touching a single line of code.
