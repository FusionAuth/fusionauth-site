...
import SelectApplication from 'src/components/get-started/SelectApplication.astro'
import ApplicationAuthentication from 'src/components/get-started/ApplicationAuthentication.astro'
import StartUpApplication from 'src/components/get-started/StartUpApplication.astro'
...
<h3>Open the Admin Interface</h3>
<SelectApplication />

<h3>Set up Authentication for your Application</h3>
<ApplicationAuthentication />

<h3>Open the Application URL in your Browser and Login</h3>
<StartUpApplication />
