...
To understand how the JavaScript application integrates with FusionAuth, take a quick look at some of the code from the repository.
...
Docker:
<Code code="open http://localhost:9011/admin" />
