...
<div class="gap-6 grid grid-cols-1 not-prose lg:grid-cols-2">
	<Card variant="compact" href="step-4" label="<-" labelFirst={false} title="Step 4: Role-Based Access Control"/>
	<Card variant="compact" href="step-6" label="->" labelFirst={true} title="Step 6: Logout"/>
</div>
