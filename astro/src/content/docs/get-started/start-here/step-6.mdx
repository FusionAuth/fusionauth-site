...
<div class="gap-6 grid grid-cols-1 not-prose lg:grid-cols-2">
	<Card variant="compact" href="step-5" label="<-" labelFirst={false} title="Step 5: Session Management"/>
	<Card variant="compact" href="step-7" label="->" labelFirst={true} title="Step 7: Testing"/>
</div>
