...
The database of the secondary deployment is automatically and securely kept up date with the primary deployment.
...
The RPO (Recovery Point Objective) is the maximum amount of data loss, which depends on the database replication. You may lose up to 5 minutes of data due to lag between the primary and secondary database.
