...
You'll also need to set up hostnames pointing to ABC
TODO is this needed
...
The primary and secondary deployments must be on the same version of FusionAuth and be the same size.  TODO how do upgrades work
