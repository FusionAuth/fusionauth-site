...
tags: render, cloud, blueprint, render.io, setup, infrastructure-as-code
---
...
1. Use the default values and click **Create fork** to create your fork.
...
1. Click **Deploy Blueprint**. This may take some time, but remember that free tier deploys shut down after 15 minutes of idle time. Stay close so you can use your new instance before it automatically shuts down.
...
1. In the Render account dashboard, open the **Resources** section of your blueprint. Click the URL provided to open the FusionAuth Admin UI.

1. Before you can access the FusionAuth Admin UI, you must finish the FusionAuth [setup wizard](/docs/get-started/download-and-install/setup-wizard) by creating an admin user:
   ...
   * Mark the checkbox labelled **I accept the terms of the license agreement.**
   Click **Continue setup** to create an admin user using the email and password that you entered.
...
- [Complete the rest of the recommended configuration.](/docs/get-started/download-and-install/setup-wizard)
