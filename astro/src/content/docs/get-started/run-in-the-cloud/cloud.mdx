...
At that point the [Setup Wizard](/docs/get-started/download-and-install/setup-wizard) will begin.
...
This guide to [Common configuration](/docs/get-started/download-and-install/reference/common-configuration) is helpful at this point.
