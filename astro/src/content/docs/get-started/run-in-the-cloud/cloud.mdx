...
<Aside type="caution">
    Before adding a custom domain, a CNAME record targeting the durable URL for your deployment will need to be created for this domain, otherwise the form submission will fail.
</Aside>
