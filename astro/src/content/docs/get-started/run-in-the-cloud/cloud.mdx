...
Choose a deployment configuration by clicking <InlineUIElement>Add</InlineUIElement> on the <InlineUIElement>Deployments</InlineUIElement> section to get an estimated cost.
