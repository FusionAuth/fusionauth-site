...
```
{/*
TODO remove comments when Mermaid works
...
graph LR
  ...
  app <--> auth
```
![App components](./github_actions_images/fa_app_components.png)
*/}
...
```
![App components](./github_actions_images/fa_github_action_flow.png)
*/}
```bash
┌────────────────────────────────────────────────────────┐
 │  👨‍💻 Programmer                                         │
