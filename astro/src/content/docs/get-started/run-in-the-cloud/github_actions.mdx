...
While building your app is simple, deploying it is more complex. Your production environment might be a physical server, a virtual server such as Digital Ocean, or a large service provider such as AWS or Azure.
