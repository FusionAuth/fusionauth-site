...
If a user logs into an application and then switches to another app with different requirements, they will be forced to satisfy the second apps' requirements. Suppose that an ecommerce application requires MFA and the forum application does not. If the user starts on the forum application and then switches to the ecommerce application, they will be prompted to complete MFA.
