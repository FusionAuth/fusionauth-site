...
Any applications with [self-service registration](https://fusionauth.io/docs/lifecycle/register-users/basic-registration-forms) enabled will automatically register a user with default roles when the user is redirected to the login URL for that application. 
