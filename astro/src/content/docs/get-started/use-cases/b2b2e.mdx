...
When using FusionAuth Cloud, you can [configure FusionAuth to respond to different hostnames](/docs/cloud/cloud#custom-domains). You can also do the same with self-hosted FusionAuth. In addition to the hostnames above, you could also have:
