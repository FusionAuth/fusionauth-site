...
Suppose your company, ClownTix, sells a time tracking system for circuses. Your software package lets circus clowns and performers track their hours.

Your customers are the circuses, and their users are *their* employees or contractors. Each circus has its own remote user directory, and wants to control access to ClownPass through those directories. Acces is not simply allows or disallowed; some employees are managers and should have greater access to reports in ClownPass.

You are super excited because you've landed both Ringling Bros. and Barnum & Bailey Circus and Cirque du Soleil as customers; they have large staffs to manage. Here's a diagram of the relationship between ClownPass, its customers and the end users.
