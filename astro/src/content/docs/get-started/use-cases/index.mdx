...
By asking a few questions about your use case, you can narrow down how FusionAuth might fit into your application solution.

<DecisionChart />

You can also combine these options, using FusionAuth to provide more than one core application service.
