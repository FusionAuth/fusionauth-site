...
* set `debug` to <InlineFieldValue>false</InlineFieldValue>
* set `createRegistration` to <InlineFieldValue>true</InlineFieldValue>
* set `enabled` to <InlineFieldValue>true</InlineFieldValue> for your application to enable this identity provider
...
* `application.oauthConfiguration.requireRegistration` to <InlineFieldValue>true</InlineFieldValue> to require user registration
