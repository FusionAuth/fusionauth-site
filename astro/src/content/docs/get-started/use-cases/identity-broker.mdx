...
* set `name` to <InlineFieldValue>Customer identity provider</InlineFieldValue>
* set `debug` to `false`
...
* <InlineFieldValue>developer</InlineFieldValue>
* <InlineFieldValue>business_analyst</InlineFieldValue>
...
|--------------------|-----------------|------------------|
| <InlineFieldValue>admin</InlineFieldValue>            | <InlineFieldValue>administrator</InlineFieldValue> | <InlineFieldValue>superadmin</InlineFieldValue>     |
| <InlineFieldValue>developer</InlineFieldValue>        | <InlineFieldValue>dev</InlineFieldValue>           | <InlineFieldValue>engineer</InlineFieldValue>       |
| <InlineFieldValue>business_analyst</InlineFieldValue> | <InlineFieldValue>ba</InlineFieldValue>            | <InlineFieldValue>data_analyst</InlineFieldValue>   |
