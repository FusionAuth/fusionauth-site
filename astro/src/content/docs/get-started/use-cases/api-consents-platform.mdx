...
You can read more about [the other parameters for the authorization code grant](/docs/apis/oauth#authorization-code-grant-request) to learn about the other parameters.
