...
You can read more about [the other parameters for the authorization code grant](/docs/api/oauth#authorization-code-grant-request) to learn about the other parameters.
...
* [The Authorization endpoint](/docs/api/oauth#authorize)
