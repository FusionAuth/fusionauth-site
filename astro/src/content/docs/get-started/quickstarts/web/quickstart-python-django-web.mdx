...
Log in using <InlineFieldValue>richard@example.com</InlineFieldValue> and <InlineFieldValue>password</InlineFieldValue>. The change page will allow you to enter a number and see the result of the POST. Log out and verify that you can't browse to the [account page](http://localhost:8000/app/account).
