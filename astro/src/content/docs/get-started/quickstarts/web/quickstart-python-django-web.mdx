...
tags: django quickstart, django authentication, python web login, django oauth, python authentication
...
* [Python](https://www.python.org/downloads/) 3.10 or later. This QuickStart was built and tested with Python 3.12 and Django 5.2.
...
<ExtractedCode src="quickstart-django-web/complete-application/requirements.txt" lang="shell" />
...
<ExtractedCode src="quickstart-django-web/complete-application/mysite/.env" lang="shell" />
...
```shell-session
cd mysite && python manage.py startapp app && cd ..
```
...
<ExtractedCode src="quickstart-django-web/complete-application/mysite/mysite/settings.py" lang="python" />
...
<ExtractedCode src="quickstart-django-web/complete-application/mysite/mysite/urls.py" lang="python" />
...
<ExtractedCode src="quickstart-django-web/complete-application/mysite/app/urls.py" lang="python" />
...
<ExtractedCode src="quickstart-django-web/complete-application/mysite/app/views.py" lang="python" />
...
```shell-session
cp -r complete-application/mysite/app/static mysite/app && cp -r complete-application/mysite/app/templates mysite/app
```

On Windows:

```shell-session
xcopy /e complete-application\mysite\app\static mysite\app && xcopy /e complete-application\mysite\app\templates mysite\app
```
...
Update the default SQLite database:
