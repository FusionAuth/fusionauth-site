...
tags: drupal quickstart, drupal authentication, php cms login, drupal oauth, drupal sso
...
<Details title="I get 'This site can't be reached localhost refused to connect.' when I click the login button.">
...
<Details title="I get an error '/usr/bin/env: php: No such file or directory' when trying to run Drush commands.">
...
<Details title="I get the following error during the Drupal installation wizard: 'The Settings file does not exist'.">
