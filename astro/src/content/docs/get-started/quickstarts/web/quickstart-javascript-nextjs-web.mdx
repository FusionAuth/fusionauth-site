...
Next.js 13.2 introduced <a href="https://nextjs.org/docs/app/api-reference/file-conventions/route" target="_blank">Route Handlers</a>, which are the preferred way to handle REST-like requests. In the `Changebank` application you can configure NextAuth.js FusionAuth's provider in a new route handler by creating a file within `src/app/api/auth/[...nextauth]/route.ts`.
