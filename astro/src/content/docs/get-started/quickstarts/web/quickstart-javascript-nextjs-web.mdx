...
You can then login to FusionAuth with Email: <InlineFieldValue>richard@example.com</InlineFieldValue> Password: <InlineFieldValue>password</InlineFieldValue> (as you might expect not ideal for production.)
