...
To create a new Laravel project run the following command. There are other ways of creating the project as suggested in the Laravel [documentation](https://laravel.com/docs/10.x#your-first-laravel-project).
...
Authentication in Laravel is managed by [Socialite](https://laravel.com/docs/10.x/socialite). For this application, you need the [FusionAuth Socialite provider](https://github.com/SocialiteProviders/FusionAuth). To install it, run the following command.
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/config/services.php"} lang="php" tags="fusionauth" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/app/Providers/EventServiceProvider.php"} lang="php" tags="fusionauth" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/app/Models/User.php"} lang="php" tags="fusionauth" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/database/migrations/2023_11_03_112258_add_fusionauth_fields_user_table.php"} lang="php" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/resources/views/index.blade.php"} lang="php" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/resources/views/account.blade.php"} lang="php" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/resources/views/change.blade.php"} lang="php" />
...
<RemoteCode url={frontmatter.codeRoot + "/complete-application/routes/web.php"} lang="php" />
