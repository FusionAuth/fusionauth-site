...
tags: laravel quickstart, laravel authentication, php web login, laravel oauth, laravel sso
...
<ExtractedCode src="quickstart-php-laravel-web/services.snippet.fusionauth.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/AppServiceProvider.snippet.a.php" lang="php" />

Then add the following code to the `boot()` method:

<ExtractedCode src="quickstart-php-laravel-web/AppServiceProvider.snippet.b.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/User.snippet.fusionauth.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/complete-application/database/migrations/2023_11_03_112258_add_fusionauth_fields_user_table.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/complete-application/resources/views/index.blade.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/complete-application/resources/views/account.blade.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/complete-application/resources/views/change.blade.php" lang="php" />
...
<ExtractedCode src="quickstart-php-laravel-web/complete-application/routes/web.php" lang="php" />
