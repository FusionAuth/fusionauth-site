...
Browse to [the app](http://localhost:8000) at http://localhost:8000. Log in using <InlineFieldValue>richard@example.com</InlineFieldValue> and <InlineFieldValue>password</InlineFieldValue>. The change page will allow you to enter a number. Log out and verify that you can't browse to the [account page](http://localhost:8000/account).
