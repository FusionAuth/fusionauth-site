...
tags: remix quickstart, remix authentication, remix login, react full-stack, node.js authentication
htmlTitle: FusionAuth QuickStart for Remix
...
Change into the `mysite` directory and add the additional npm packages the site will use:

```shell-session
cd mysite && npm install remix-auth remix-auth-oauth2 jwt-decode
```
...
<ExtractedCode src="quickstart-remix/complete-application/.env" lang="shell" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/root.tsx" lang="tsx" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/services/session.server.ts" lang="ts" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/services/auth.server.ts" lang="ts" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/routes/_index.tsx" lang="tsx" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/routes/login.tsx" lang="tsx" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/routes/logout.tsx" lang="tsx" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/routes/auth.callback.tsx" lang="tsx" />
...
Create a `css` directory within `app`:
...
<ExtractedCode src="quickstart-remix/complete-application/app/routes/account.tsx" lang="tsx" />
...
<ExtractedCode src="quickstart-remix/complete-application/app/routes/change.tsx" lang="tsx" />
...
```shell-session
git clone https://github.com/FusionAuth/fusionauth-quickstart-javascript-remix-web.git && cd fusionauth-quickstart-javascript-remix-web
```
...
```shell-session
cd complete-application && npm install && npm run dev
```
