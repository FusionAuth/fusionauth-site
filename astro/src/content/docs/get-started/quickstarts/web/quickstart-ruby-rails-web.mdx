...
This lets you have a nice `logout` method and also handle the callback from omniauth. The latter sets a <InlineField>session</InlineField> attribute with user data, which can be used by views later.
