...
<LocalCode src="quickstart-rust-actix-web/complete-application/.env" />
...
Browse to the app at http://localhost:9012. Log in using <code><LocalValue path="quickstart-rust-actix-web/kickstart/kickstart.json" selector="$.variables.userEmail" /></code> and <code><LocalValue path="quickstart-rust-actix-web/kickstart/kickstart.json" selector="$.variables.userPassword" /></code>. The change page allows you to enter a number. If you don't log in, you won't be able to access the change or account pages.
