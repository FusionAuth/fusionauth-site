...
<LocalCode src="quickstart-golang-web/complete-application/go.mod" lang="go" title="go.mod" />
...
<LocalCode src="quickstart-golang-web/base-app.snippet.baseApplication.go" lang="go" title="main.go" />
...
<LocalCode src="quickstart-golang-web/complete-application/templates/home.html" lang="html" title="templates/home.html" />

And the stylesheet for the application:

<LocalCode src="quickstart-golang-web/complete-application/static/css/changebank.css" lang="css" title="static/css/changebank.css" />
...
<LocalCode src="quickstart-golang-web/main.snippet.imports.go" lang="go" />

Next, create some constants after your `import` block and before `func main()`:

<LocalCode src="quickstart-golang-web/main.snippet.constants.go" lang="go" />
...
<LocalCode src="quickstart-golang-web/main.snippet.oidcClient.go" lang="go" />
...
<LocalCode src="quickstart-golang-web/main.snippet.loginRoute.go" lang="go" />
...
<LocalCode src="quickstart-golang-web/main.snippet.callbackRoute.go" lang="go" />
...
<LocalCode src="quickstart-golang-web/main.snippet.accountRoute.go" lang="go" />

Here's the account page template:

`templates/account.html`
<LocalCode src="quickstart-golang-web/complete-application/templates/account.html" lang="html" />
...
<LocalCode src="quickstart-golang-web/main.snippet.homeRoute.go" lang="go" />
...
<LocalCode src="quickstart-golang-web/main.snippet.logoutRoute.go" lang="go" />
