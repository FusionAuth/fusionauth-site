...
You can set <InlineField>Product Name</InlineField> to <InlineFieldValue>Quickstart</InlineFieldValue>, <InlineField>Organization Identifier</InlineField> to <InlineFieldValue>io.fusionauth</InlineFieldValue> and click <Breadcrumb>Next</Breadcrumb> and <Breadcrumb>Create</Breadcrumb> your project in a folder as per your preference.
