...
You can set <InlineField>Product Name</InlineField> to <InlineFieldValue>Quickstart</InlineFieldValue>, <InlineField>Organization Identifier</InlineField> to `io.fusionauth` and click <InlineUIElement>Next</InlineUIElement> and <InlineUIElement>Create</InlineUIElement> your project in a folder as per your preference.
