...
tags: rails api, ruby api quickstart, ruby on rails api, rails authentication, ruby authentication, bearer token
...
- [Ruby 3.4.x](https://www.ruby-lang.org/): This QuickStart was built using Ruby 3.4.10. This example may work on different versions of Ruby, but it has not been tested.
- [Rails 8.1.x](https://rubyonrails.org/): This QuickStart was built using Rails 8.1.3. This example may work on different versions of Rails, but it has not been tested.
...
```shell-session
cd complete-application && bundle install
```
...
```shell-session
rails new your-application --api && cd your-application
```
...
<ExtractedCode src="quickstart-rails-api/complete-application/Gemfile" lang="text" />
...
<ExtractedCode src="quickstart-rails-api/complete-application/config/routes.rb" lang="ruby" />
...
<ExtractedCode src="quickstart-rails-api/complete-application/config/initializers/jwt_rack.rb" lang="ruby" />
...
<ExtractedCode src="quickstart-rails-api/complete-application/app/controllers/make_change_controller.rb" lang="ruby" />
...
<ExtractedCode src="quickstart-rails-api/complete-application/app/controllers/panic_controller.rb" lang="ruby" />
...
```shell-session
git clone https://github.com/FusionAuth/fusionauth-quickstart-ruby-on-rails-api.git && cd fusionauth-quickstart-ruby-on-rails-api
```
