...
tags: golang api, go quickstart, go rest api, golang authentication, go api authentication, bearer token
htmlTitle: FusionAuth QuickStart for Golang API
...
<DockerSpinup kickstartUri="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-golang-api/main/kickstart/kickstart.json" api />
...
* Follow the instructions at [Run the API](#run-the-api).
</Aside>
...
<ExtractedCode src="quickstart-golang-api/main.snippet.packageImports.go" lang="go" />

Next, you will need to add a couple of structures to help manage the data for making change.

<ExtractedCode src="quickstart-golang-api/main.snippet.defineStruct.go" lang="go" />
...
<ExtractedCode src="quickstart-golang-api/main.snippet.verifyKey.go" lang="go" />

### Add Handlers and Functions

Create the main function for the application.

<ExtractedCode src="quickstart-golang-api/main.snippet.main.go" lang="go" />
...
<ExtractedCode src="quickstart-golang-api/main.snippet.handlers.go" lang="go" />
...
<ExtractedCode src="quickstart-golang-api/main.snippet.panicFunction.go" lang="go" />
...
<ExtractedCode src="quickstart-golang-api/main.snippet.makeChangeFunction.go" lang="go" />
...
<ExtractedCode src="quickstart-golang-api/main.snippet.authorization.go" lang="go" />
...
<ExtractedCode src="quickstart-golang-api/main.snippet.helper.go" lang="go" />
