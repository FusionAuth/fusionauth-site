...
<LocalCode src="quickstart-golang-api/main.snippet.packageImports.go" lang="go" />

Next, you will need to add a couple of structures to help manage the data for making change.

<LocalCode src="quickstart-golang-api/main.snippet.defineStruct.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.verifyKey.go" lang="go" />

### Add Handlers and Functions

Create the main function for the application.

<LocalCode src="quickstart-golang-api/main.snippet.main.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.handlers.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.panicFunction.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.makeChangeFunction.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.authorization.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.setPublicKey.go" lang="go" />

Then add the code to compare the required roles to the user's roles based on the token.

<LocalCode src="quickstart-golang-api/main.snippet.containsRole.go" lang="go" />
...
<LocalCode src="quickstart-golang-api/main.snippet.helper.go" lang="go" />
