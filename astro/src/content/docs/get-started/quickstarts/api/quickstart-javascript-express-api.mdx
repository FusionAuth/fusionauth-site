...
tags: express api, node.js api, javascript api quickstart, express authentication, node authentication, bearer token
...
```json
{
  "token": "eyJhbGciOiJSUzI1NiIs...bbkipjKq2peSjG7qA",
