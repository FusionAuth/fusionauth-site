...
tags: java api, spring boot quickstart, spring boot api, java authentication, spring security, bearer token
...
<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/resources/application.properties" lang="ini" />
...
<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/java/io/fusionauth/quickstart/springapi/PanicResponse.java" lang="java" />
...
<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/java/io/fusionauth/quickstart/springapi/Change.java" lang="java" />

### Add Controllers

Next you need to add controllers to handle API calls. In the base package add a new class `MakeChangeController.java`.

<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/java/io/fusionauth/quickstart/springapi/MakeChangeController.java" lang="java" />
...
<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/java/io/fusionauth/quickstart/springapi/PanicController.java" lang="java" />
...
<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/java/io/fusionauth/quickstart/springapi/CustomJwtAuthenticationConverter.java" lang="java" />
...
<ExtractedCode src="quickstart-springboot-api/complete-application/src/main/java/io/fusionauth/quickstart/springapi/SecurityConfiguration.java" lang="java" />
