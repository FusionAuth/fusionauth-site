...
tags: vue quickstart, vue.js authentication, vue login, vue oauth, javascript authentication, spa authentication
...
```shell-session
npm create vue@3.15.1 -- changebank --typescript --router
cd changebank
```

This command pins Create Vue to a version compatible with Node.js 18. If you use a different Node.js version, you can select a compatible Create Vue version instead.
