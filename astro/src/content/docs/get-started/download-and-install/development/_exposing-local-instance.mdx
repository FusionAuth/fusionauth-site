...
FusionAuth lets you develop locally with a full featured auth system. To do so, [install FusionAuth](/docs/v1/tech/installation-guide/) using one of the options, such as Homebrew or a .deb file.
