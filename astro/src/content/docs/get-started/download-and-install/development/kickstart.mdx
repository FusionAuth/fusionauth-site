...
If you have an [air-gapped license](/docs/get-started/download-and-install/air-gapping), you can add the license text in the `license` field of your Kickstart file. For example:
