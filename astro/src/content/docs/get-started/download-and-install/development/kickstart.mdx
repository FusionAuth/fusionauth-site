...
You may modify the Tenant Manager application Id in your kickstart file by setting a special variable: `tenantManagerApplicationId`. In this example the Tenant Manager application Id is `9a145715-bfbd-4c06-bff2-009315b9761e`. This value must be a valid UUID.
