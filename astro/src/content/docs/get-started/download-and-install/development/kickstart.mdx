...
You can also provide `license` text if you have an [air-gapped license](/docs/get-started/download-and-install/air-gapping). Use the `license` field. Here's an example of what that might look like.
