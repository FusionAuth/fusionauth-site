...
### Different entity types, templates, or lambdas exist in a kickstarted instance of FusionAuth than a clean install

The following resources will not be present in a kickstarted instance of FusionAuth. The reason for this to allow full control (and consistency) over what data is seeded into a FusionAuth instance:
...
#### Lambdas
* \[FusionAuth Default] Apple Reconcile
* \[FusionAuth Default] Facebook Reconcile
* \[FusionAuth Default] Google Reconcile
* \[FusionAuth Default] LinkedIn Reconcile
* \[FusionAuth Default] OpenID Connect Reconcile
* \[FusionAuth Default] SAML v2 Reconcile
* \[FusionAuth Default] SCIM Group Request Converter
* \[FusionAuth Default] SCIM Group Response Converter
* \[FusionAuth Default] SCIM User Request Converter
* \[FusionAuth Default] SCIM User Response Converter
* \[FusionAuth Default] Twitter Reconcile
