...
description: Learn how to install the FusionAuth Search bundle.
order: 5
---
...
<Tabs>
	...
	Next, install the Windows service by changing to the directory designated as `FUSIONAUTH_HOME` and runing the install command:
...
<Tabs>
	...
	```powershell title="Windows Service"
