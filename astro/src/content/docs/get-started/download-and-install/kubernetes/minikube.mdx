...
When you <ScrollRef target="deploy PostgreSQL" /> and <ScrollRef target="deploy Elasticsearch" />, each service that was created was assigned the following dns names respectively by **kube-dns**:
