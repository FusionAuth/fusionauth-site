...
tags: docker, kubernetes, k8s, container, eks, elastic
---
...
![EKS Architecture](/img/docs/get-started/download-and-install/kubernetes/eksctl-architecture.png)
...
The resulting output should contain an <InlineField>Endpoint</InlineField> attribute. This value will be necessary when configuring your FusionAuth deployment.
