...
Community provided [Istio configurations can be found here](https://github.com/FusionAuth/fusionauth-contrib/tree/master/kubernetes/istio).

Here's a sample, community contributed, Istio configuration file.

<RemoteCode lang="yaml" url="https://raw.githubusercontent.com/FusionAuth/fusionauth-contrib/master/kubernetes/istio/fusionauth-all-in-one.yaml" />
