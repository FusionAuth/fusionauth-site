...
tags: docker, kubernetes, k8s, container, aws, aks
---
...
![EKS Architecture](/img/docs/get-started/download-and-install/kubernetes/aks.png)
...
![Navigate to Elasticsearch service](/img/docs/get-started/download-and-install/kubernetes/az-es-start.png)

Click on the <Breadcrumb>Create Elasticsearch (Elastic Cloud)</Breadcrumb> button.

![Create Elasticsearch](/img/docs/get-started/download-and-install/kubernetes/az-es-create.png)

Create an Elastic Resource by selecting the resource group you created in the first section of this guide and a name for the resource. Click on <Breadcrumb>Review + Create</Breadcrumb> after providing the required fields.

![Create resource screen](/img/docs/get-started/download-and-install/kubernetes/az-es-create-resource.png)

Review your selections and press the <Breadcrumb>Create</Breadcrumb> button when ready.

![Review and create screen](/img/docs/get-started/download-and-install/kubernetes/az-es-review-create.png)

Your deployment will now be in-progress as indicated on the next screen. This may take a few minutes to complete.

![In-progress screen](/img/docs/get-started/download-and-install/kubernetes/az-es-in-progress.png)

When the deployment is complete, click on <Breadcrumb>Go to resource group</Breadcrumb> and then click on the Elasticsearch resource that you just created.

![Resources screen](/img/docs/get-started/download-and-install/kubernetes/az-es-resource-group.png)

Click on the <Breadcrumb>Manage changes in Elastic Cloud</Breadcrumb> link.

![Elasticsearch resource detail screen](/img/docs/get-started/download-and-install/kubernetes/az-es-example.png)
...
Under <Breadcrumb>pplications</Breadcrumb>, click on the <Breadcrumb>Copy endpoint</Breadcrumb> link next to <Breadcrumb>Elasticsearch</Breadcrumb> to copy the URL to your clipboard. You will need to save this URL for use when [deploying FusionAuth](/docs/get-started/download-and-install) to your AKS cluster.
Next, click on the <Breadcrumb>Security</Breadcrumb> link seen on the left navigation panel.

![Example dashboard on Elastic Cloud](/img/docs/get-started/download-and-install/kubernetes/az-es-copy-endpoint.png)

Click on the <Breadcrumb>Reset Password</Breadcrumb> button to set your administrative credentials for your cluster.

![Security screen](/img/docs/get-started/download-and-install/kubernetes/az-es-security.png)
