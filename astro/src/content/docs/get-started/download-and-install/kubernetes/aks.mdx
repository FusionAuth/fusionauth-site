...
Click on the <InlineUIElement>Create Elasticsearch (Elastic Cloud)</InlineUIElement> button.
...
Create an Elastic Resource by selecting the resource group you created in the first section of this guide and a name for the resource. Click on <InlineUIElement>Review + Create</InlineUIElement> after providing the required fields.
...
Review your selections and press the <InlineUIElement>Create</InlineUIElement> button when ready.
...
When the deployment is complete, click on <InlineUIElement>Go to resource group</InlineUIElement> and then click on the Elasticsearch resource that you just created.
...
Click on the <InlineUIElement>Manage changes in Elastic Cloud</InlineUIElement> link.
...
Click on the <InlineUIElement>Reset Password</InlineUIElement> button to set your administrative credentials for your cluster.
