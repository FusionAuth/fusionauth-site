...
tags: docker, kubernetes, k8s, container, gke
---
...
![GKE Architecture](/img/docs/get-started/download-and-install/kubernetes/gke-architecture.png)
...
* `database-version` - Database engine type and version. See FusionAuth supported databases [here](/docs/get-started/download-and-install/reference/system-requirements#database).
...
There are two options available to configure search in FusionAuth. The first is a simple search through the database search engine and the second is the Elasticsearch engine. For more details on the differences, please see [Search And FusionAuth](/docs/lifecycle/manage-users/search).
...
From the navigation menu in the GCP console, click on [Elasticsearch Service](https://console.cloud.google.com/marketplace/product/endpoints/elasticsearch-service.gcpmarketplace.elastic.co) and then click the <Breadcrumb>Enable</Breadcrumb> button. Follow the instructions on the next screen to set up a new Elastic Cloud subscription.

![Elasticsearch service enable subscription screen](/img/docs/get-started/download-and-install/kubernetes/es-enable.png)

After you have set up a subscription you will land on the [GCP Elasticsearch Service Overview](https://console.cloud.google.com/apis/api/elasticsearch-service.gcpmarketplace.elastic.co/) page. From here, click on the <Breadcrumb>Manage Via Elastic</Breadcrumb> button near the top of the window.

![GCP Elasticsearch service screen](/img/docs/get-started/download-and-install/kubernetes/es-manage-via.png)
...
After logging in, you will arrive at your Elastic Cloud dashboard. To begin creating a new Elasticsearch cluster, click on the <Breadcrumb>Create deployment</Breadcrumb> button.

![Elastic Cloud dashboard screen](/img/docs/get-started/download-and-install/kubernetes/es-cloud-dashboard.png)

Input a name for your deployment and again click on <Breadcrumb>Create deployment</Breadcrumb>.

![Create deployment screen](/img/docs/get-started/download-and-install/kubernetes/es-create-deployment.png)
...
![Save credentials screen](/img/docs/get-started/download-and-install/kubernetes/es-save-credentials.png)

When your deployment creation process is complete, click on the <Breadcrumb>Continue</Breadcrumb> button. You will then be directed to your Elastic Cloud dashboard and will see your new deployment listed.

Click on the name of your deployment to manage it.

![Elastic Cloud dashboard with deployment screen](/img/docs/get-started/download-and-install/kubernetes/es-cloud-dashboard-2.png)
...
![Elastic Cloud deployment dashboard screen](/img/docs/get-started/download-and-install/kubernetes/es-dashboard.png)

Under **Applications**, click on the <Breadcrumb>Copy endpoint</Breadcrumb> link next to <Breadcrumb>Elasticsearch</Breadcrumb> to copy the URL to your clipboard. You will need to save this URL for use when [deploying FusionAuth](/docs/get-started/download-and-install/kubernetes/fusionauth-deployment) to your GKE cluster.
