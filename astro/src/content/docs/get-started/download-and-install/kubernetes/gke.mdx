...
```text title="Output of the default project selection command"
...
After you have set up a subscription you will land on the [GCP Elasticsearch Service Overview](https://console.cloud.google.com/apis/api/elasticsearch-service.gcpmarketplace.elastic.co/overview) page. From here, click on the `Manage Via Elastic` button near the top of the window.
