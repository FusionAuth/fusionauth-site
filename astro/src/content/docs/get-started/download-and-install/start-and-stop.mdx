...
``` title="Start FusionAuth services using command line - Versions < 1.37.0"
\fusionauth\fusionauth-search\elasticsearch\bin\elasticsearch.bat
...
``` title="Unregister Windows Services"
...
``` title="Register Windows Services"
...
``` title="Unregister Windows Services - Versions < 1.37.0"
...
``` title="Register Windows Services - Versions < 1.37.0"
\fusionauth\fusionauth-search\elasticsearch\bin\FusionAuthSearch.exe /install
