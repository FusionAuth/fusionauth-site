...
<Aside type="caution">
  Ensure the instance's network connection has been blocked, as documented in the [Preparing Your Instance](#preparing-your-instance) section. Otherwise you may certain circumstances end up with a regular license replacing your air-gapped license.
...
You might also use kickstart to bundle your software package to your customers, in which case you'd use Kickstart to configure FusionAuth to a known state. In this scenario, you'd use the production license key and text in the Kickstart file.
