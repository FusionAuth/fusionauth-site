...
tags: fusionauth setup, initial setup, setup wizard, first run, admin account creation, getting started
order: 1
---
...
The **Issuer**, found by navigating to <Breadcrumb>Tenants -> Your Tenant -> General</Breadcrumb> defaults to the public base URL.
