...
If you would like to learn more about what metrics we collect and how they are used, you can find that information [here](/docs/get-started/download-and-install/collected-metrics).
