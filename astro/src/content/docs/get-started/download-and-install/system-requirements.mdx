...
If you alter, damage or modify the FusionAuth software, except as directed by the FusionAuth team, FusionAuth cannot support you. See [section 5, Exhibit A of the FusionAuth license for more](/license).
