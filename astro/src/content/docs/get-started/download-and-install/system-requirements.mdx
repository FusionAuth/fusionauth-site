...
Once on a paid plan, you must enable network access to FusionAuth or your license will not function properly. You must also allow access to enable advanced features provided by FusionAuth Reactor cloud services.
