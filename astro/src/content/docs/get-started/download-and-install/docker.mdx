...
|---------------|-------------|--------------------------------------------------------------------|
| `development` | <InlineFieldValue>true</InlineFieldValue>      | Migration applied automatically                                    |
| `development` | <InlineFieldValue>false</InlineFieldValue>     | Maintenance mode UI displayed, user prompted to run migrations     |
| `production`  | <InlineFieldValue>true</InlineFieldValue>      | Migration applied automatically                                    |
| `production`  | <InlineFieldValue>false</InlineFieldValue>     | Migration never applied by FusionAuth, must be applied out of band |
