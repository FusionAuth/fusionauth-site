...
All of the FusionAuth Docker images live on [Docker Hub](https://hub.docker.com/u/fusionauth/).

The FusionAuth Docker Compose YAML files live in the [FusionAuth containers repository](https://github.com/FusionAuth/fusionauth-containers).

If you're looking for a complete configuration to get up and running quickly, follow our [Getting Started guide](/docs/get-started/start-here/step-1). This will walk you through install FusionAuth, configuring it using [Kickstart](/docs/get-started/download-and-install/development/kickstart), and using an example application to illustrate core concepts such as login, logout, and access control.
