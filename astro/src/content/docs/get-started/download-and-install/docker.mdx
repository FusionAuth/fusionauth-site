...
The runtime requirements and configuration for OpenSearch will differ from the docker compose examples as they're configured without any security and redundancy.
