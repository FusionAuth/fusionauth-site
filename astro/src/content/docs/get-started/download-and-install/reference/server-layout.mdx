---
title: Server Layout
description: Learn about the different server layouts that FusionAuth can be installed with to optimize performance and security.
section: get started
...
* [Install a Database](/docs/get-started/download-and-install/reference/database)
...
<img src="/img/docs/get-started/download-and-install/single-server.png" alt="One Server" />
...
<img src="/img/docs/get-started/download-and-install/two-servers-external-db.png" alt="Two servers with an external database" />
...
<img src="/img/docs/get-started/download-and-install/n-servers-external-db.png" alt="Horizontally scaled with an external database" />
