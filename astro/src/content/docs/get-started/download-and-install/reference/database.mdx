...
FusionAuth requires a database that meets the [System Requirements](/docs/get-started/download-and-install/system-requirements). This page explains how to install a supported database.
