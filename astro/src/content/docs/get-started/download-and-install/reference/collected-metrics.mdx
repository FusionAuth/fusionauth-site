...
tags: metrics, telemetry, analytics, usage data, collected data, monitoring, system metrics
---
...
Self-hosted users can disable data collection without affecting functionality. Customers on a paid plan must allow metrics collection [per the license agreement](/license) unless they have an [air-gapped license](/docs/get-started/download-and-install/reference/air-gapping).
...
FusionAuth never collects personally identifiable information about your users or customers. We may collect new usage data as we add new features; those will be outlined in our [release notes](/docs/release-notes).
...
To disable usage data collection in a running instance, navigate to <Breadcrumb>Settings -> System -> Analytics & Improvements</Breadcrumb> in the admin UI and switch off the <Breadcrumb>Enable usage data collection</Breadcrumb> toggle:
