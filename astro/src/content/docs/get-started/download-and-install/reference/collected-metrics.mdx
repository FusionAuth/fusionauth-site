...
To disable usage data collection in a running instance, navigate to <Breadcrumb>Settings -> System -> Analytics & Improvements</Breadcrumb> in the admin UI and disable the <InlineUIElement>usage data collection</InlineUIElement> toggle:
