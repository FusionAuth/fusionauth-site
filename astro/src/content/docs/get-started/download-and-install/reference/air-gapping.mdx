...
Check the <InlineField>I have an air-gap license</InlineField> box underneath the <Breadcrumb>License Key</Breadcrumb> field. Add the license text into the <InlineField>License text</InlineField> field.
...
Once activated, the <InlineField>Licensed</InlineField> field on the <Breadcrumb>Reactor</Breadcrumb> tab changes to a green checkmark. This may require a page refresh. You will also see a list of features and the expiration date of the license.
