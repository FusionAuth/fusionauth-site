---
title: Packages
description: Learn how to determine which installation packages you need.
tags: fusionauth packages, installation packages, rpm, deb, zip, package management, download
---
