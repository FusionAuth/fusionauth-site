...
tags: get started, fusionauth getting started, quickstart, install fusionauth, authentication setup, onboarding
order: 0
...
For a quick interactive introduction to FusionAuth, check out our [Get Started](/docs/get-started/start-here/step-1) guide.
...
A user is uniquely identified in any particular tenant by an email address or username. [Learn more.](/docs/get-started/core-concepts/types/users)

### Applications

A FusionAuth Application represents an authenticated resource such as a web application, mobile application or any other application that requires authenticated users. A FusionAuth Application is defined by a name and a set of Roles. [Learn more.](/docs/get-started/core-concepts/types/applications)

### Registrations

A User can be registered to one or more FusionAuth Applications. A User Registration can define one to many Application Roles. [Learn more.](/docs/get-started/core-concepts/types/registrations)
...
* [Common Configuration](/docs/get-started/download-and-install/setup)

### Install Options

* [Docker](/docs/get-started/download-and-install/docker)
* [FastPath Install](/docs/get-started/download-and-install/fusionauth-app)
