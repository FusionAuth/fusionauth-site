...
import CloudLimits from 'src/content/docs/cloud/_cloud-limits.mdx';
...
To learn how to use cloud hosting in detail, read the [FusionAuth Cloud guide](/docs/cloud/cloud). To estimate the fees for the deployments in your account, use the [pricing calculator](https://account.fusionauth.io/pricing-calculator/).
