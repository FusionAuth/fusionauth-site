...
<APIBlock>
  <APIField name="Base URL" optional since="1.68.0" renderif={props.page === "application"}>
  ...
  <APIField name="Password update" optional since="1.30.0">
    The email or message template to use when notifying a user that their password has been successfully updated. This is different from <InlineField>Password reset success</InlineField> in that this event occurs outside of the reset workflow.
  ...
  <APIField name="Verification complete template" optional since="1.30.0" renderif={props.page === "application"}>
    The email or message template to use when notifying a user that their identity has been verified.

    <EnterprisePlanBlurbApi feature="this feature" />

  </APIField>
  <APIField name="Verification template" optional since="1.27.0" renderif={props.page === "application"}>
