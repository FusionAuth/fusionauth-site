...
<APIBlock>
  ...
  <APIField name="Login Id duplicate on update" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Login Id duplicate on update" />
  ...
  <APIField name="Login with new device" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Login with new device" />
  ...
  <APIField name="Suspicious login" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Suspicious login" />
  ...
  <APIField name="Password reset success" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Password reset success" />
  ...
  <APIField name="Password update" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Password update" />
  ...
  <APIField name="Two-factor method added" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Two-factor method added" />
  ...
  <APIField name="Two-factor method removed" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Two-factor method removed" />
