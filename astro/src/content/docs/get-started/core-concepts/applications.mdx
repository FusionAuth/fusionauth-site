...
<APIBlock>
  <APIField name="Registration mode" optional since="1.65.0">
    ...
    * Create registration. Users can self-register for this application.
  </APIField>
  <APIField name="Type" optional>
    When <InlineUIElement>Registration mode</InlineUIElement> is set to <InlineUIElement>Complete registration</InlineUIElement> or <InlineUIElement>Create registration</InlineUIElement>, select <InlineUIElement>Basic</InlineUIElement> or <InlineUIElement>Advanced</InlineUIElement> self-service registration forms.
...
![Basic Self Service Registration](/img/docs/get-started/core-concepts/application-registration-self-service-basic.png)
...
![Advanced Self Service Registration](/img/docs/get-started/core-concepts/application-registration-self-service-advanced.png)
