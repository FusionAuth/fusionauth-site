...
<img src="/img/docs/get-started/core-concepts/application-identities.png" alt="Application Identities" width="1200" />
...
<APIBlock>
  <APIField name="Confirm password" optional>
    Toggle this field if you want FusionAuth to require a password confirmation during registration. Note that password fields are not displayed if <InlineField>tenant.passwordEnabled</InlineField> is set to `false`.
  </APIField>
