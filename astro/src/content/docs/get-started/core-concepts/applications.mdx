...
<APIBlock>
  ...
  <APIField name="Voice template" optional since="1.65.0">
    When a template is selected, it will be used to send a multi-factor authentication code when voice delivery is used for the SMS MFA method and a user is signing in to this application.
  </APIField>
