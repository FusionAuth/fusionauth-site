---
title: FusionAuth Types And Their Relationships
...
The second set of types are **Entity Types**, **Entities**, **Permissions**, and **Entity Grants**. These types are used for machine-to-machine authentication, and provide a case-specific way to model things (entities), rather than organizations.
