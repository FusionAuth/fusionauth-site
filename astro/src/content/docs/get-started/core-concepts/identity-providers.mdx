...
Identity providers are assigned on an application by application basis and can be managed from the administrative user interface or the [identity provider API](/docs/apis/identity-providers/overview).

Learn more about the various [identity providers](/docs/v1/tech/identity-providers/), including which ones are supported and how to integrate this functionality into your site.

Here's a brief video covering some aspects of identity providers:

<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/5oycV6LYXTM?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
