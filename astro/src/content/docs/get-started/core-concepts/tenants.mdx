...
Control Email and Phone Number identity verification settings from one place.

<img src="/img/docs/get-started/core-concepts/tenant-configuration-identities-settings.png" alt="Tenant Configuration - Identities settings" width="1200" role="shadowed top-cropped bottom-cropped" />

<APIBlock>
  <APIField name="Verify identity" optional since="1.99.9">
    When enabled, users will be required to verify their email address or phone number identity.
  </APIField>
  <APIField name="Verification strategy" optional since="1.99.9">
  ...
  <APIField name="Verification complete template" optional since="1.99.9">
...
Once you have configured your email settings, you may test your configuration with the <InlineUIElement>Send test email</InlineUIElement> button.
...
<img src="/img/docs/get-started/core-concepts/tenant-configuration-phone-settings.png" alt="Tenant Configuration - Phone settings" width="1200" role="shadowed top-cropped bottom-cropped" />

<APIBlock>
  <APIField name="Messenger" required since="1.99.9">
    The Messenger used to deliver phone number verification and passwordless templates.

    Required when the <InlineField>Verify identity</InlineField> toggle is enabled for phone numbers.
  </APIField>
  <APIField name="Passwordless login" optional since="1.99.9">
    The message template to use to send the link for passwordless login requests.
  </APIField>
</APIBlock>
...
<APIBlock>
  <APIField name="Password enabled" optional since="1.99.9">
    When enabled, users will be required to set a password during registration and can later change it. When disabled, applications must be configured to allow passwordless login or have an IdP configured to allow login. Defaults to true.
  </APIField>
