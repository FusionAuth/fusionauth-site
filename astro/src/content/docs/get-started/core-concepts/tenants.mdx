...
<APIBlock>
  <APIField name="Additional properties" optional>
    The custom SMTP configuration properties that may be necessary in some cases. This can contain any Java mail property. It will override anything FusionAuth sets by default.

   Since 1.44.0, the following two properties have default values:
