...
<APIBlock>
  <APIField name="On login" optional>
    ...
    * Only challenge on medium or high login risk &nbsp; <AvailableSince since="1.68.0"/>
    * Only challenge on high login risk &nbsp; <AvailableSince since="1.68.0"/>
  ...
  <APIField name="Debug Enabled">
    When enabled, debug information will be written to the event log during login for multi-factor authentication decisions
  </APIField>
</APIBlock>
...
<APIBlock>
  <APIField name="SMS enabled" optional>
  ...
  <APIField name="SMS messenger" required>
    ...
    Required when the <InlineField>SMS enabled</InlineField> toggle is enabled.
  </APIField>
  ...
  <APIField name="Voice enabled" optional>
  ...
  <APIField name="Voice messenger" required>
    ...
    Required when the <InlineField>Voice enabled</InlineField> toggle is enabled.
  </APIField>
