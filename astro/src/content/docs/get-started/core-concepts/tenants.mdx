...
<APIBlock>
  ...
  <APIField name="Setup password" optional>
    The email or message template to use when accounts are created and the user needs to setup their password.
  </APIField>
...
<APIBlock>
  <APIField name="Password enabled" optional defaults="enabled" since="1.99.9">
...
<APIBlock>
  ...
  <APIField name="Passwordless Login one-time code" required since="1.99.9">
