...
<APIBlock>
  ...
  <APIField name="Completion token" required>
    The number of seconds before the Completion Token identifier is no longer valid to complete post-authentication steps in the OAuth workflow.
  </APIField>
