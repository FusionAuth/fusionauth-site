...
Full documentation on [Connectors](/docs/lifecycle/migrate-users/connectors/) and [Connector Policies](/docs/lifecycle/migrate-users/connectors/) can be found [here](/docs/lifecycle/migrate-users/connectors/).
