...
<APIBlock>
  <APIField name="Unique usernames" optional defaults="false" since="1.27.0">
    When <InlineFieldValue>true</InlineFieldValue>, FusionAuth will handle username collisions.
...
<APIBlock>
  ...
  <APIField name="Verification strategy" optional since="1.27.0">
    The process by which the user will verify their email address. Using the "Form Field" method works only when the <InlineField>Unverified behavior</InlineField> is <InlineFieldValue>Gated</InlineFieldValue>.
  </APIField>
