...
tags: fusionauth types, core types, applications, users, groups, tenants, registrations, roles
order: 600
sectionIndex: true
---
...
To implement permissions in FusionAuth, use [Fine-Grained Authorization](/docs/extend/fine-grained-authorization).
