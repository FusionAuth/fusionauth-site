...
Federated authentication, where FusionAuth isn't the system of record for users, is provided by [Connectors](/docs/apis/connectors/) and [Identity Providers](/docs/v1/tech/identity-providers/).
...
To configure FusionAuth as the Service Provider, see  [SAML v2 Identity Provider](/docs/lifecycle/authenticate-users/identity-providers/) and  [SAML v2 IdP Initiated Identity Provider](/docs/v1/tech/identity-providers/samlv2-idp-initiated/). To configure FusionAuth as the Identity Provider, see [SAML v2](/docs/lifecycle/authenticate-users/saml/).
...
| Service Provider  | Identity Provider  | Yes                            | [SAML v2 IdP Initiated Identity Provider](/docs/v1/tech/identity-providers/samlv2-idp-initiated/), [SAML v2 Identity Provider](/docs/lifecycle/authenticate-users/identity-providers/) |
