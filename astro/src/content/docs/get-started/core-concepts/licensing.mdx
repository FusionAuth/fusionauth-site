...
<Aside type="note">
You will need either the <InlineFieldValue>admin</InlineFieldValue> or `reactor_manager` roles in the FusionAuth application to view the <Breadcrumb>Reactor</Breadcrumb> tab.
</Aside>
