...
<Aside type="note">
  You can always find your license Id by logging in to your [Account](https://account.fusionauth.io/account) and then navigating to the <Breadcrumb>Plan</Breadcrumb> tab. If you do not have a license Id there, you are on Community edition. In that case, no license is required.
</Aside>
...
Should you need to deactivate your license Id, either because you are changing your editions or rotating your license Id, you can do so by using the <InlineUIElement>Deactivate</InlineUIElement> link, in the upper right hand corner of the Reactor page.
