...
You can run FusionAuth with limited or no network access by using an [air-gapped license](/docs/get-started/download-and-install/reference/air-gapping). Please [contact sales](/contact) for more information.
