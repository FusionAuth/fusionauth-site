...
In an air-gapped configuration where outbound network access is not available, the license text will be available in your [account](https://account.fusionauth.io/account/plan). See [air-gapping documentation](/docs/get-started/download-and-install/air-gapping) for more information.
