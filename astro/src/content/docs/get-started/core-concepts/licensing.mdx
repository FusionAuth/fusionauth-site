...
tags: fusionauth licensing, license, community edition, enterprise license, paid plans, license key
order: 250
---
...
This page explains how to use a license with a FusionAuth instance.

For information about plans and corresponding features, see [plans and features](/docs/get-started/core-concepts/plans-features).

To access features that require a license, visit the account portal at [account.fusionauth.io](https://account.fusionauth.io). In the account portal, you can register for a free **Licensed Community** plan or purchase a license for a **Starter**, **Essentials**, or **Enterprise** plan. For information about pricing, see our [price calculator](/pricing) or [contact our sales team](/contact).

## Add Your License to Your Instance
...
[Learn more about MAU here](/docs/get-started/core-concepts/types/users#what-makes-a-user-active).
...
Navigate to the <Breadcrumb>Reactor</Breadcrumb> tab and enter your license Id in the **License key** field.
...
To do so, log into your [Account](https://account.fusionauth.io/account). Then navigate to the <Breadcrumb>Plan</Breadcrumb> tab. Then click the <Breadcrumb>Action</Breadcrumb> button to display the dropdown.
...
## Activate, Deactivate, or Check License Status with the License API
...
You can set your license Id using Kickstart. Doing so allows you to use features requiring a license in your development environment and continuous integration systems. To do this, use the non-production license Id in your Kickstart files.
...
You can run FusionAuth with limited or no network access with an [air-gapped license](/docs/get-started/download-and-install/reference/air-gapping). For more information, [contact sales](/contact).

## Active User Count

Any user who logs in during the time period. It doesn't matter if they log in once or one thousand times. [Learn more about what counts as a login here](/docs/get-started/core-concepts/types/users#what-makes-a-user-active).
