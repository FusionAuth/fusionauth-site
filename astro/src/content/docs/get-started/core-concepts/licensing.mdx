...
In an air-gapped configuration where outbound network access is not available, the license text will be available in your [account](https://account.fusionauth.io/account/plan). See the [air-gapping documentation](/docs/get-started/download-and-install/air-gapping) for more information.
...
If you are running FusionAuth with limited or no network access, you can do so using an [air-gapped configuration](/docs/get-started/download-and-install/air-gapping). If you need an air-gapped license, please [contact sales](/contact) for more information. 
