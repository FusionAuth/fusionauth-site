...
After the user has a locale assigned, you can add it to a JWT using a [JWT populate lambda](/docs/v1/tech/lambdas/jwt-populate), so it can be utilized by other applications.
...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/RWQsRXPCUVc?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
