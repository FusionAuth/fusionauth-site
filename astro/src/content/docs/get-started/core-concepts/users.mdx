...
Learn more about [WebAuthn and passkeys](/docs/v1/tech/premium-features/webauthn/).
...
Learn more about [Identity Providers](/docs/v1/tech/core-concepts/identity-providers/) and  [Identity Provider links](/docs/v1/tech/identity-providers/#linking-strategies).
