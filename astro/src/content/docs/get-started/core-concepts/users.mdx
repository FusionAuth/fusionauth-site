...
<APIBlock>
  ...
  <APIField name="Skip verification" optional>
    ...
    <Aside>
      If both an email address and phone number are supplied and **Skip verification** is checked, then verification will be skipped for both the email address and the phone number.
    </Aside>
  </APIField>
