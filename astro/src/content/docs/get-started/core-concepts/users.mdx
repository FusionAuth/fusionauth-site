...
To display a list of users, navigate to <strong>Users</strong>.

<img src="/img/docs/get-started/core-concepts/user-list.png" alt="List of Users" width="1200" role="bottom-cropped" />
...
You can use the <ScrollRef target="User Search, search field to search for users" />.

### Add a User

To add a new user, navigate to <strong>Users</strong>.
...
To edit a user, navigate to <strong>Users</strong> and click the <InlineUIElement>Manage</InlineUIElement> button next to the user you wish to edit.
...
* <InlineUIElement>Add a comment</InlineUIElement> Add a comment to the user's profile. This will be visible in the user's <ScrollRef target="History" />.
* <InlineUIElement>Action User</InlineUIElement> Perform a user action on the user. See <ScrollRef target="Current actions" /> for more information.
...
<img src="/img/docs/get-started/core-concepts/user-dropdown.png" alt="User edit dropdown in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-locked.png" alt="Locked user in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-registrations.png" alt="User registrations in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-mfa.png" alt="User multi-factor screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
Learn more about [WebAuthn and passkeys](/docs/lifecycle/authenticate-users/passwordless/webauthn-passkeys.mdx).

<img src="/img/docs/get-started/core-concepts/user-passkeys.png" alt="User passkeys screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-families.png" alt="User families screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
Learn more about [Identity Providers](/docs/core-concepts/identity-providers/) and  [Identity Provider links](/docs/identity-providers/#linking-strategies).

<img src="/img/docs/get-started/core-concepts/user-identity-providers.png" alt="User identity providers screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-groups.png" alt="User groups screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
<APIBlock>
  ...
  <APIField name="Action">
    You can view and delete a group membership by clicking the <Icon name="fa-search"/> or icon:trash-alt[role=ui-button red,type=fa] buttons.
  </APIField>
</APIBlock>
...
<img src="/img/docs/get-started/core-concepts/user-entity-grants.png" alt="User entity grants screen in the administrative user interface." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-recent-logins.png" alt="User recent logins screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-consents.png" alt="User consents screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-session.png" alt="User session screen in the administrative user interface." width="1200" role="bottom-cropped" />
...
With <InlineUIElement>Delete all session</InlineUIElement> button, you can revoke all sessions for a user.
...
<img src="/img/docs/get-started/core-concepts/user-current-actions.png" alt="User current actions screen in the administrative user interface." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-history.png" alt="User history screen in the administrative user interface." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-data.png" alt="User data screen in the administrative user interface." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-source.png" alt="User source screen in the administrative user interface." width="1200" />
...
User search requests may be made through the [User Search API] or within the FusionAuth admin UI under [breadcrumb](/docs/apis/users#search-for-users)#Users#.
...
<img src="/img/docs/get-started/core-concepts/user-search-database.png" alt="User Search with Database Search Engine" width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-search-query-string.png" alt="User Search by Query String" width="1200" role="bottom-cropped" />
...
<img src="/img/docs/get-started/core-concepts/user-search-json-query.png" alt="User Search with JSON Query." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-search-extended-a.png" alt="User Search with over 10,000 results first page." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-search-extended-b.png" alt="User Search with over 10,000 results paged to 10,000." width="1200" />
...
<img src="/img/docs/get-started/core-concepts/user-search-extended-c.png" alt="User Search with over 10,000 results paged to end." width="1200" />

For more information see [Extended Pagination](/docs/v1/tech/core-concepts/search#extended-pagination)
...
You can add add arbitrary JSON to the `user.data` field, such as `org_type` and `org_id` fields. You can do this using the [User API](/docs/apis/users) on user creation.

The `user.data` fields can then be read in a [JWT Populate Lambda](/docs/extend/code/lambdas/jwt-populate) and pushed into the tokens generated during authentication.
