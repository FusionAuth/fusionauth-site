...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/cXvvcOOAp6U?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
...
A session can be created by using the Login API, as long as <InlineField>[Generate refresh tokens](/docs/get-started/core-concepts/applications#security)</InlineField> is enabled, or by completing the [OAuth Authorization Code grant](/docs/lifecycle/authenticate-users/oauth/overview#example-authorization-code-grant) when the `offline_access` scope is requested.
