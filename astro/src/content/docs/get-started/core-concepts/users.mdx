...
The following screenshot shows a query string being constructed to search for users that belong to the `Moderators` group and are in the <InlineUIElement>Default</InlineUIElement> tenant:
