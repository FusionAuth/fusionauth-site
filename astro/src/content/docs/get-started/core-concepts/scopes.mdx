...
tags: oauth scopes, oidc scopes, permissions, access tokens, scope configuration, api scopes
order: 400
---
...
Scopes in FusionAuth are associated with an [application](/docs/get-started/core-concepts/types/applications). While there is no limit to the number of scopes an application can have, each must have a unique name.
...
![Scope Consent Prompt](/img/docs/get-started/core-concepts/scopes-consent.png)
...
![Manage Scopes Page](/img/docs/get-started/core-concepts/manage-scopes.png)
...
![Manage Scopes - Create Scope](/img/docs/get-started/core-concepts/manage-scopes-create.png)

Here is what you can expect when updating an existing scope:

![Manage Scopes - Edit Scope](/img/docs/get-started/core-concepts/manage-scopes-edit.png)
...
![Manage Scopes - View Scope](/img/docs/get-started/core-concepts/manage-scopes-view.png)
...
<Aside type="note">
  ...
  [Unknown scope policy](/docs/get-started/core-concepts/types/applications#scopes) configured for that application.
  It will also affect resource servers or APIs which may be expecting a scope to be presented in a token.
</Aside>

![Manage Scopes - Delete Scope](/img/docs/get-started/core-concepts/manage-scopes-delete.png)
