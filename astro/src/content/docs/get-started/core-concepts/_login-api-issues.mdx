You can use the [Login API](/docs/apis/login) to sign your users in directly. In this case, you will likely use one of the [FusionAuth client libraries](/docs/sdks/index).
