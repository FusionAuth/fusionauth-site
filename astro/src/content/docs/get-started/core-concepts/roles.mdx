...
Below are all the roles available in the FusionAuth Admin UI. There is [additional documentation for the `user_support_manager`](#the-user_support_manager-role) following this table.
...
| `system_manager`           | `631ecd9d-8d40-4c13-8277-80cedb8236e9` | Can add and edit system configuration. Can also delete themes.                                                                                                                 |
...
| `user_manager`             | `631ecd9d-8d40-4c13-8277-80cedb8236f3` | Can add and edit users.<br/><br/>Please note that because this role can fully manage users, it is similar to `admin`. The `user_support_manager` is recommended in most cases. {/* eslint-disable-line */} |
