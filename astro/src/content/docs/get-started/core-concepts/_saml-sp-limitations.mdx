...
Map between SAML claims and user claims using a [reconcile lambda](/docs/v1/tech/lambdas/samlv2-response-reconcile) or [FusionAuth SAMLv2 Identity Provider configuration](/docs/lifecycle/authenticate-users/identity-providers/overview).
