...
* <strong>Plan</strong> - select or modify the account's FusionAuth plan (also known as an edition). More details on the [plan differences here](/pricing). This is also where you will find your license keys when you are not using the Community edition.
