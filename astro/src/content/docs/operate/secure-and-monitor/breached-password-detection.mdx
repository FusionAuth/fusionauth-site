...
While the default settings are secure, you may want to configure this feature further. The <InlineUIElement>(.*)</InlineUIElement> section contains additional configuration options:
