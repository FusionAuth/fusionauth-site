...
- [Import Data Into Elastic](#import-data-into-elastic)
...
An Elastic Agent sends data from your server to the Elastic Cloud for processing and monitoring. To use the Cloud, you first have to install the Elastic Agent on your server.
...
<img src='../../../../../public/img/docs/operate/secure-and-monitor/elastic/elastic1.png' alt='Elastic home' />
