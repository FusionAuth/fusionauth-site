...
faUrl="http://localhost:9011/api/system/login-record/export" # "http://fa:9011/api/system/login-record/export"
...
- In the Elastic Cloud web interface, open the sidebar and browse to <strong>Search -> Elasticsearch -> Indices -> falogins -> Documents</strong>.
