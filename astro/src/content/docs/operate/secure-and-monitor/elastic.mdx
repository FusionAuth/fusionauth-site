...
- [Use otel container](#use-otel-container)
...
- Use an [Elastic APM (application perfomance monitoring) app for Java](https://www.elastic.co/guide/en/observability/current/monitor-java-app.html) inside the FA container to monitor the Java Virtual Machine. Since monitoring Java won't give you any useful information that monitoring the container doesn't already, you can ignore this idea. To use Java APM for an app, you ideally need to integrate it into the source code, which is impossible for FA, and would be too much work anyway.
- Use an OpenTelemetry Java monitoring agent, or container, to send information about FA to Elastic. This is similar to previous point - OpenTelemetry won't provide any useful information that container monitoring doesn't already.


https://www.elastic.co/guide/en/observability/current/_step_3_install_apm_agents.html
...
https://www.elastic.co/guide/en/observability/8.14/apm-open-telemetry.html
...
Regularly request FA HTTP page with Heartbeat container
