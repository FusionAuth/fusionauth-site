...
- [Self-host Elastic](#self-host-elastic)
...
Now that you are able to monitor FusionAuth in Elastic, you should enable [alerts](https://www.elastic.co/kibana/alerting) to notify you by email or in Slack if something goes wrong, like a massive decrease in login rates, a container restarting, or a log output containing `error`.
