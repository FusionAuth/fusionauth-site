...
- [Overview Of Popular Monitoring Tools](#overview-of-popular-monitoring-tools)
	...
	- [What Can You Do With A Custom Script?](#what-can-you-do-with-a-custom-script)
	- [Monitoring Tools Compared](#monitoring-tools-compared)
- [Which Tools Should You Choose?](#which-tools-should-you-choose)
	- [A Sample Of Monitoring Tool Choices](#a-sample-of-monitoring-tool-choices)
...
If you want to monitor any FusionAuth metrics directly, instead of just the FusionAuth container, you will need to write a custom script to call the FusionAuth API anyway.

### Monitoring Tools Compared

The diagram below shows which tools are available for each type of activity in the monitoring flow.
...
- How much you need to know about your system. Do you want to know only that FusionAuth is running, or monitor the login count per hour?
...
Below are some examples of how you could monitor FusionAuth.

TODO

table of option, cost, effort, detail
