...
<Aside type="note">
 If you have restarted you FusionAuth instance you need to regenerate the API Key using the steps mentioned in <ScrollRef target="Set Up Prometheus API Access In FusionAuth" /> section.
</Aside>
