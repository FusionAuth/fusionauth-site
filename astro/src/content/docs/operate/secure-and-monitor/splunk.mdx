...
dateFormat=$(echo -n "yyyy-MM-dd'T'HH:mm:ss" | jq -sRr @uri)
end=$(date +%s)000
start=$(($end - 3600000))
...
# curl --request POST \
# --header "Content-Type: application/json" \
# --header "X-SF-TOKEN: C1-ff_BwOOfnEFs-gkv31g" \
# --data \
# '{"
#     "gauge": ["
#         {"
#             "metric": "memory.docker","
#             "dimensions": { "host": "server2" },"
#             "value": 42"
#         }"
#     ]"
# }' \
...
---|---|---|---|---|---|---|---|---|---
00000000-0000-0000-0000-000000000001 | 2024-06-21T05:14:56 | 3c219e58-ed0e-4b18-ad48-f4f92793ae32 | 172.20.0.1 |  |  |  |  |  |
00000000-0000-0000-0000-000000000001 | 2024-06-21T05:07:06 | 3c219e58-ed0e-4b18-ad48-f4f92793ae32 | 172.20.0.1 |  |  |  |  |  |
