...
While you can use stock Docker monitoring apps to monitor Docker containers and store logs, you are always going to need to write custom code or [webhooks](https://fusionauth.io/docs/apis/webhooks) to get FusionAuth specific information, like numbers of successful logins.
