...
OpenTelemetry does not handle data aggregation, storage, or visualization (dashboards).

### What Is Prometheus?

[Prometheus](https://prometheus.io/docs/introduction/overview) is a database specifically designed to store metrics efficiently, as well as provide data through a custom query language. Prometheus also provides dashboards and alerts, but its dashboards are not as sophisticated as Grafana.
