...
- Browse to https://api.slack.com/tutorials/tracks/posting-messages-with-curl and click <InlineElement>Create app</InlineElement>. (If this tutorial page doesn't exist in the future, create an app in the [apps homepage](https://api.slack.com/apps) using the combobox at the top left.)
...
- Note the "Client ID" and "Client Secret" values for later use.
- Click <InlineElement>Install to Workspace</InlineElement>.
- On the page that opens, click <InlineElement>Allow</InlineElement>.
