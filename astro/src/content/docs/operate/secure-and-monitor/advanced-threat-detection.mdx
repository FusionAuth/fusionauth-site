...
FusionAuth supports:
- Google reCAPTCHA version 2 (puzzle)
- Google reCAPTCHA version 3 (one click)
- hCaptcha and hCaptcha Enterprise

FusionAuth does not support Google reCAPTCHA enterprise (invisible verification that reports a score to your site).
