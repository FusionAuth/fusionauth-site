...
<Aside type="danger">
Be careful when enabling CAPTCHA that your keys in FusionAuth are correct and your domain name in Google or hCaptcha is correct. If you make a mistake you will not be able to log in with your administrator account to make changes because CAPTCHA will fail. You will have to remove CAPTCHA manually by connecting to the FusionAuth database and altering tables. Test on a copy of your live site first.
</Aside>
