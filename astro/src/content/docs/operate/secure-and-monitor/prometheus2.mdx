...
https://grafana.com/docs/loki/latest/get-started/overview/?pg=oss-loki&plcmt=resources

http://localhost:3100/

https://hub.docker.com/r/ubuntu/loki

docker exec -it faLoki /bin/bash
...
- [Grafana Ubuntu Docker image](https://hub.docker.com/r/ubuntu/grafana)
