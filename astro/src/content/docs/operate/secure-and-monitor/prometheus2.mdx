...
This guide explains how monitor FusionAuth events and logs with the open-source tools Prometheus and Loki, as well as create a dashboard with Grafana, and send you alerts when problems occur.
