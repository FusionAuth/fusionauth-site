...
tags: breached password detection, compromised passwords, haveibeenpwned, password security, security, authentication security, credential stuffing
---
...
You can then use the [Change a User's Password API](/docs/apis/users/change-password) to, well, change the user's password.
