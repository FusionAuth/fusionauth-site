...
* December 2025 - FusionAuth version `1.62.0` is updated
  * To leverage [Bouncy Castle's FIPS compliant cryptography modules](https://www.bouncycastle.org/download/bouncy-castle-java-fips/)
  * To remove uses of the [`md5`](https://www.postgresql.org/docs/current/functions-binarystring.html) function in PostgreSQL database scripts
