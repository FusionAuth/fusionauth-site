...
* November 2025 - [`fusionauth-jwt`](https://github.com/FusionAuth/fusionauth-jwt) is updated to support Bouncy Castle's FIPS compliant library
* November 2025 - FusionAuth is updated to remove uses of the [`md5`](https://www.postgresql.org/docs/current/functions-binarystring.html) function in PostgreSQL database scripts
