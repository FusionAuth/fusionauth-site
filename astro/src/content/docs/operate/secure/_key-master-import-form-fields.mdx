...
<If condition={props.has_hmac_secret}>
  <APIField name="Secret" required>
    The HMAC secret to import.
  </APIField>
</If>

<If condition={props.has_secret}>
  <APIField name="Secret" required>
    The secret value to import.
  </APIField>
</If>

<If condition={props.has_length}>
