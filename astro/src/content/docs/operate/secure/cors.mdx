...
<APIBlock>
  <APIField name="Enabled">
    <InlineFieldValue>false</InlineFieldValue>, but you need this to be <InlineFieldValue>true</InlineFieldValue> to process any CORS requests.
  </APIField>
  <APIField name="Allow credentials">
    <InlineFieldValue>false</InlineFieldValue>
  </APIField>
  <APIField name="Allowed headers">
