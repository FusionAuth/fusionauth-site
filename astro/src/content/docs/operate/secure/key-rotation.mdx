...
tags: key rotation, api key rotation, jwt signing key, secret rotation, security, defense in depth, cryptography
---
...
<ExtractedCode src="example-scripts/key-expiration-check/find-expiring-keys.sh" lang="shell" title="Script to query for keys expiring in 30 days" />
