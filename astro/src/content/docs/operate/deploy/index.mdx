...
tags: deployment, configuration management, environment promotion, infrastructure as code, devops, deploy fusionauth, staging, production
---
...
You can use the [FusionAuth CLI](/docs/customize/cli) to manage complex configuration such as themes.
