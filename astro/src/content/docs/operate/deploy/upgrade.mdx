...
If you are running a FusionAuth Cloud deployment, you can find instructions for rolling back an upgrade here: [Rolling Back From a Problematic Upgrade](/docs/cloud/cloud#rolling-back-from-a-problematic-upgrade).
...
To upgrade your FusionAuth Cloud instance, see the [Cloud Installation Guide](/docs/cloud/cloud#upgrading-a-deployment).
