...
If you are running a FusionAuth Cloud deployment, you can find instructions for rolling back an upgrade here: [Rolling Back From a Problematic Upgrade](/docs/cloud/upgrade-a-deployment#roll-back-from-a-problematic-upgrade).
