...
Upgrading FusionAuth is similar to upgrading a library that your application depends on. Go through each of the points below to see if any of them apply to your situation.
