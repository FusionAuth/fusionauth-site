...
* In the first major or point version release where the behavior is deprecated, the deprecation is noted in the release notes. The feature is also marked as deprecated in the documentation.
* The deprecation note remains for three months.
* During any release after the three month period, the feature and corresponding documentation are removed.
* In the first major or point version release where the feature is removed, the removal is noted in the release notes. The documentation for the feature is also removed.

While the team commits to maintaining features for at least three months after they are deprecated, that is a minimum and it may be longer than that.
...
| -------- | ------- | ------- | ------- |
| 1.52.0  | March 1, 2024 | No change | N/A |
| 1.52.1  | March 8, 2024 | No change | N/A |
| 1.53.0  | April 1, 2024 | Feature documentation marked as deprecated. | Deprecation announced in release notes. |
| 1.53.1  | April 5, 2024 | Feature documentation remains marked as deprecated. | N/A |
| 1.53.2  | April 15, 2024 | Feature documentation remains marked as deprecated. | N/A |
| 1.54.0  | May 15, 2024 | Feature documentation remains marked as deprecated. | N/A |
| 1.55.0  | July 12, 2024 | Feature and documentation removed. | Feature removal announced in release notes. |
