...
| Metrics       | System metrics, such as JVM buffers, memory, and threads.                                                                                                                                                                                                                                                                                                                                              | Read using API endpoints. Data available in Prometheus-compatible format.                                                                            | [More info](/docs/operate/monitor/monitor#metrics)            | Affected by metrics collisions. [Learn more](https://github.com/FusionAuth/fusionauth-issues/issues/2379). |
