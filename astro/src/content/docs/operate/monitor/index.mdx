...
| Login API    | The authentication response for an individual user.                                                                                                                                                                                                                                                                                                                                              | Read using API endpoints.                                                                            | [More info](/docs/apis/login)            | API calls may be affected by [rate limits](/docs/get-started/run-in-the-cloud/cloud#captcha-and-rate-limits). |
