...
<Aside type="note">
FusionAuth is compatible with OpenTelemetry metric and log collection, which this guide covers.

FusionAuth does not support OpenTelemetry traces collection. There is an [open GitHub issue to add such instrumentation](https://github.com/FusionAuth/fusionauth-issues/issues/1665).
</Aside>
