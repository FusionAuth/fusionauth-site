...
<Aside type="note">
OpenTelemetry allows you to instrument, generate, collect, and export telemetry data. This guide discusses collecting and exporting telemetry data.

FusionAuth does not currently support instrumentation through OpenTelemetry. See this [GitHub issue for more details](https://github.com/FusionAuth/fusionauth-issues/issues/1665).
</Aside>
