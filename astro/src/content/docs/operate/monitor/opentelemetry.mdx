...
<Aside type="note">
OpenTelemetry is a collection of APIs, SDKs, and tools, allowing you to instrument, generate, collect, and export telemetry data.

While FusionAuth supports collecting and exporting telemetry data (which this guide covers), it does not currently support OpenTelemetry instrumentation. There is an [open GitHub issue to add such instrumentation](https://github.com/FusionAuth/fusionauth-issues/issues/1665).
</Aside>
