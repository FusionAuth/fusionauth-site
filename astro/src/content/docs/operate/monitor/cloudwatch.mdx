...
FusionAuth offers a wide range of [metrics](/docs/operate/monitor/monitor#metrics), which are detailed in the documentation. It's up to you to determine which metrics are important for your monitoring needs.
