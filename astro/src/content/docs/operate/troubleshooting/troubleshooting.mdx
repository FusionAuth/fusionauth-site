...
The additional debugging information will be written to the [Event Log](#event-log). You can find in the administrative user interface by navigating to <strong>System -> Event Log</strong>.
