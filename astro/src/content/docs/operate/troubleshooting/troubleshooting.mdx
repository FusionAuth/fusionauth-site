...
The additional debugging information will be written to the <ScrollRef target="Event Log" />. You can find in the administrative user interface by navigating to <Breadcrumb>System -> Event Log</Breadcrumb>.
