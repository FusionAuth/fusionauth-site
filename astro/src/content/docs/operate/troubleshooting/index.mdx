...
If you are using the Elasticsearch search engine, attributes in the <InlineField>user.data</InlineField>, `registration.data`, and <InlineField>entity.data</InlineField> fields are indexed. The data fields can contain arbitrary JSON objects.
