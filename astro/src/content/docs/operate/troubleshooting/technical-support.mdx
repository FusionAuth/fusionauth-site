...
Click the <InlineUIElement>Open a support ticket</InlineUIElement> button to create a new ticket or use the <InlineUIElement>View support tickets</InlineUIElement> button to see existing support tickets.
