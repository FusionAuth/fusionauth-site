...
If you have a paid edition which includes technical support, please [open a ticket via your account portal](https://account.fusionauth.io/account/support/). This ensures that we will see it; slack messages or emails can unfortunately get lost.
...
When you open a ticket, you will get a response within [the documented time window for your edition](/pricing/), and typically sooner.
...
If you run the Community or Starter editions and need technical support, please [search the forum](/community/forum/search), [post your question to the forum](/community/forum/), or [review our extensive documentation](/docs/v1/tech/).
...
If you have such needs, please consider [purchasing an edition with support](/pricing).
...
The first is self-directed. In this case, you don't interact with the sales team at all. Use our [documentation](/docs/v1/tech/) to get started, our community support options such as the [forums](/community/forum/) for questions, and review our [GitHub issues](https://github.com/fusionauth/fusionauth-issues/issues) for known limitations or bugs.
