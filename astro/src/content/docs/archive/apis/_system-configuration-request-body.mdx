...
<APIBlock>
  ...
  <APIField name="systemConfiguration.emailConfiguration.enabled" type="Boolean" optional defaults="false" deprecated>
    ...
    <span class="text-red-700">Removed in version 1.8.0</span>
...
<JwtAlgorithm />
    ...
    <span class="text-red-700">Removed in version 1.6.0</span>
  ...
  <APIField name="systemConfiguration.jwtConfiguration.privateKey" type="String" optional deprecated>
    ...
    Removed in version 1.6.0# In version 1.8.0 and beyond, JWT configuration is managed per [Tenant](/docs/apis/tenants) and Keymaster.
  </APIField>
  ...
  <APIField name="systemConfiguration.passwordEncryptionConfiguration.encryptionScheme" type="String" optional deprecated>
    ...
    * [salted-pbkdf2-hmac-sha256-512](/docs/reference/password-hashes#salted-pbkdf2-hmac-sha-256) <span class="text-green-600">Available since 1.34.0</span>
