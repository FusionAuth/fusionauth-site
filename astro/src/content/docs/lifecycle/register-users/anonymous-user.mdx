...
This guide uses Python to interact with the APIs, but you can use any of the supported [client libraries](/docs/v1/tech/client-libraries/) or the [REST API](/docs/apis/overview).
...
There are two [webhook](/docs/extend/events-and-webhooks/overview) events you could listen for and process cleanup after.
...
This guide will use the latter option. You'll need to [create and register the webhook](/docs/extend/events-and-webhooks/overview#add-webhook), which can be done via admin UI or API.
