...
To use advanced registration forms, you must have a valid license key. Please visit [our pricing page](/pricing) to review paid edition options and buy a license.
...
To begin building this real estate application form, navigate to <Breadcrumb>Customizations -> Forms</Breadcrumb>. Click the green <Breadcrumb>+</InlineUIElement> button to create a new form.
