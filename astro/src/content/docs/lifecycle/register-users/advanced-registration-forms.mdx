...
* User data, which is associated with the user. This could be in standard fields such as `mobilePhone` or custom data fields in <InlineField>user.data</InlineField>.
