...
tags: user registration, register users, self-service registration, user signup, registration overview
---
...
You can enable self-service registration, which lets users create accounts without any interaction from your team. There are two kinds of registration forms:
...
If you want to collect missing profile information from users who are already registered, without allowing new visitors to create accounts, you can use [complete registration](/docs/lifecycle/register-users/complete-registration). During a hosted login workflow, FusionAuth will prompt the user to complete their registration when required fields are missing.
