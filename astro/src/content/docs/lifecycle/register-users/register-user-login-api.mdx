...
A user can also log in via the [hosted login pages](/docs/v1/tech/core-concepts/integration-points/#hosted-login-pages). These use the Authorization Code grant or a SAML flow. FusionAuth owns the user interface for authentication in this scenario.
