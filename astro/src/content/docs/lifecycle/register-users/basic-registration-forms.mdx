...
- First name: <Breadcrumb>Enabled</Breadcrumb> and <Breadcrumb>Required</Breadcrumb> on.
- Last name: <Breadcrumb>Enabled</Breadcrumb> on and <Breadcrumb>Required</Breadcrumb> off.

Set all the other fields to <Breadcrumb>Enabled</Breadcrumb> off.
