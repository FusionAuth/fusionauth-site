...
As a developer, you can manage them via the [Recovery Code API](/docs/apis/two-factor/generate-recovery-codes). As of `1.68.0`, recovery codes are hashed at rest — they are only available in plaintext at the moment of generation and cannot be retrieved afterward.
