...
<Aside type="version">
Tenant-scoped identity providers require version 1.62.0 and later FusionAuth.
</Aside>
...
All identity providers can use reconciliation lambdas except `Anonymously Link`, which has no information to pass to a lambda.
