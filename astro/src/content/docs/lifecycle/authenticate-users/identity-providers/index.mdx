...
To configure managed domains, open <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and edit a SAML v2 or OIDC identity provider. Navigate to the <Breadcrumb>Managed domains</Breadcrumb> tab and specify one domain on each line.
