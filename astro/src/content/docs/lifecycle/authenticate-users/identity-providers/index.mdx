...
Find the FusionAuth Identity Providers in the UI by navigating to <strong>Settings -> Identity Providers</strong> or use the [Identity Providers](/docs/apis/identity-providers/overview) APIs.
...
* [External JWT](/docs/lifecycle/authenticate-users/identity-providers/external-jwt/overview)
* [OpenID Connect](/docs/lifecycle/authenticate-users/identity-providers/overview)
* [SAML v2](/docs/lifecycle/authenticate-users/identity-providers/overview)
* [SAML v2 IdP Initiated](/docs/v1/tech/identity-providers/samlv2-idp-initiated/) - requires an Essentials or Enterprise plan.
...
The FusionAuth hosted login pages are being used. Similar behavior is available via the [Identity Provider API](/docs/apis/identity-providers/overview). 
