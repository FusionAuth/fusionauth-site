...
<img src="/img/docs/lifecycle/authenticate-users/identity-providers/social/login-facebook.png" alt="Facebook Login" width="1200" role="shadowed" />
...
<APIBlock>
  ...
  <APIField name="Linking strategy" optional>
    The linking strategy for Facebook. [See Linking Strategies for more](/docs/v1/tech/identity-providers/#linking-strategies).
  </APIField>
...
<LoginApiIntegration apiRef="/docs/apis/identity-providers/facebook#complete-the-facebook-login" />
