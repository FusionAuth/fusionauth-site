---
title: Add a Facebook IdP
description: Learn how to add a login with Facebook button to your application.
tags: facebook login, social login, facebook identity provider, login with facebook, facebook oauth
---
...
The last step will be to create a Facebook Identity Provider in FusionAuth. To create an Identity Provider navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and click <Breadcrumb>Add provider</Breadcrumb> and select `Facebook` from the dialog.
...
<IdpApplicationConfiguration identity_provider="Facebook" details_link="/docs/lifecycle/authenticate-users/identity-providers/social/facebook#form-fields" image="/img/docs/lifecycle/authenticate-users/identity-providers/social/identity-provider-facebook-add.png"/>
