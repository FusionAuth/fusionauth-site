...
Under the <Breadcrumb>App Info</Breadcrumb> section register a <InlineField>Callback URI / Redirect URL</InlineField> and specify your website URL.
...
<APIBlock>
  ...
  <APIField name="Consumer key" required>
    The Twitter API key found in your Twitter App Keys and tokens settings in the <InlineField>API key</InlineField> field.
  </APIField>
  <APIField name="Consumer secret" required>
    The Twitter API secret key found in your Twitter App Keys and tokens settings in the <InlineField>API secret key</InlineField> field.
  </APIField>
