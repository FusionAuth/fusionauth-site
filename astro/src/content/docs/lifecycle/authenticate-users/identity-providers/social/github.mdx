...
You will need to set <InlineField>Client authentication method</InlineField> to <InlineFieldValue>HTTP Basic authentication (client_secret_basic)</InlineFieldValue>.
...
- <InlineField>Unique Id claim</InlineField> of <InlineFieldValue>id</InlineFieldValue>
- <InlineField>Email claim</InlineField> of <InlineFieldValue>email</InlineFieldValue>
- <InlineField>Username claim</InlineField> of <InlineFieldValue>login</InlineFieldValue>
