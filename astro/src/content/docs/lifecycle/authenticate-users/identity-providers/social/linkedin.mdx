...
If these are not there you may need to add them to FusionAuth and trying a login first. See [Create a LinkedIn Identity Provider](#create-a-linkedin-identity-provider).
