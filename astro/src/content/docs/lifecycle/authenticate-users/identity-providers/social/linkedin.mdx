---
title: Add a LinkedIn IdP
description: Learn how to add a login with LinkedIn button to your application.
tags: linkedin login, social login, linkedin identity provider, login with linkedin, linkedin oauth
---
...
<IdpApplicationConfiguration identity_provider="LinkedIn" details_link="/docs/lifecycle/authenticate-users/identity-providers/social/linkedin#form-fields" image="/img/docs/lifecycle/authenticate-users/identity-providers/social/identity-provider-linkedin-add.png"/>
