...
<APIBlock>
  ...
  <APIField name="Linking strategy" optional>
    The linking strategy for the Google FusionAuth Identity Provider. [See Linking Strategies for more](/docs/v1/tech/identity-providers/#linking-strategies).
  </APIField>
...
<LoginApiIntegration apiRef="/docs/apis/identity-providers/google#complete-the-google-login" />
...
* Create an [OpenId Connect Identity Provider](/docs/lifecycle/authenticate-users/identity-providers/overview).
