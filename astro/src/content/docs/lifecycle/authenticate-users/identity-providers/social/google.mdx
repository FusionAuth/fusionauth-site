...
* Add your needed scopes to <InlineField>Scope</InlineField>. You'll typically include `openid`, `profile` and `email`, but you can [provide any of the Google OAuth2 scopes](https://developers.google.com/identity/protocols/oauth2/scopes).
