...
<APIBlock>
  ...
  <APIField name="Scope" optional>
    ...
    The <InlineField>Scope</InlineField> value may only be used when the <InlineField>Login method</InlineField> is set to <InlineFieldValue>Use redirect for login</InlineFieldValue>. The <InlineField>email</InlineField>, <InlineField>profile</InlineField>, and <InlineFieldValue>openid</InlineFieldValue> scopes will always be requested for all other configurations.
  </APIField>
