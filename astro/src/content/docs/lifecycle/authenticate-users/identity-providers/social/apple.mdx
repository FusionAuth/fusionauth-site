...
The next step is creating an Apple Identity Provider in FusionAuth. Switch to your FusionAuth portal and navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and click <UIelement>Add Apple</UIelement> from the top right selection button.
