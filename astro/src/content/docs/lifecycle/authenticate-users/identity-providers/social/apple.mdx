...
<img src="/img/docs/lifecycle/authenticate-users/identity-providers/social/login-apple.png" alt="Apple Login" width="1200" />
...
<LoginApiIntegration identity_provider_path="apple" identity_provider_fragment="apple" identity_provider_name="Apple" />
