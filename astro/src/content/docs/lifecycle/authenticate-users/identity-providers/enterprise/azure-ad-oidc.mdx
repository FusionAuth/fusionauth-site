---
title: Add an OpenID Connect with Azure AD IdP
description: Set up user login using Azure AD/Microsoft Entra ID as an OpenID Connect Identity Provider.
tags: azure active directory, microsoft entra id, openid connect, azure login, enterprise sso, microsoft identity, oidc azure ad
---
...
You will first need to login to the [Azure Portal](https://learn.microsoft.com/en-us/azure/azure-portal/azure-portal-overview).
