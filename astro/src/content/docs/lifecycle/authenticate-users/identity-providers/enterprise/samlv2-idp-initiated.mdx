...
<APIBlock>
  ...
  <APIField name="Assertion decryption key" optional since="1.55.1">
    The key used to decrypt SAML responses. Required when <InlineField>Require encrypted assertions</InlineField> is enabled. To create, manage or import a key, navigate to <strong>Settings -> Key Master</strong>.
  </APIField>
</APIBlock>
