...
<APIBlock>
  ...
  <APIField name="Tenant" optional since="1.62.0">
    The tenant to which this identity provider belongs. This field only displays when the user selects a specific tenant on the previous page. When <code>Global identity provider</code> is selected on the previous page, this field does not display.{ }
  </APIField>
