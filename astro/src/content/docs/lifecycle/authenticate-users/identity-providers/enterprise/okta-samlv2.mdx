...
If it is all set up correctly, you should be redirected back to your app, successfully logged in. The user will be added to FusionAuth and you can examine the <InlineUIElement>(.*)</InlineUIElement> section of the user details screen to see that the Okta SAML link was created.
