...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/lEeCqm7sVUs?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
...
To create an Identity Provider navigate to <strong>Settings -> Identity Providers</strong> and click `Add provider` and select `HYPR` from the dialog.
