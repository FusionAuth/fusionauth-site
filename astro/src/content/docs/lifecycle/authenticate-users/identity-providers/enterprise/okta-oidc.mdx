...
Select <InlineUIElement>OIDC - OpenID Connect</InlineUIElement> and <InlineUIElement>Web Application</InlineUIElement> then click <InlineUIElement>Next</InlineUIElement>.
...
Under <Breadcrumb>Sign On</Breadcrumb>, navigate to the section <InlineUIElement>OpenID Connect ID Token</InlineUIElement> and change the <InlineField>Issuer</InlineField> to use the <InlineField>Okta URL</InlineField>. Hit <InlineUIElement>Save</InlineUIElement> and copy this URL into a text file.
...
Select <InlineUIElement>Add OpenID Connect</InlineUIElement> from the <InlineUIElement>Add</InlineUIElement> dropdown at the top right of the page.
