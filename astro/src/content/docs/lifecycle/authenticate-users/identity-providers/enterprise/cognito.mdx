...
- Set the <InlineField>Callback URL</InlineField> to `<YOUR_FUSIONAUTH_URL>/oauth2/callback` under <InlineUIElement>Allowed callback URLs</InlineUIElement>; for example <InlineFieldValue>https://auth.piedpiper.com/oauth2/callback</InlineFieldValue>.
...
- In the <InlineUIElement>Hosted UI settings</InlineUIElement> section, set the <InlineField>Callback URL</InlineField> to `<YOUR_FUSIONAUTH_URL>/oauth2/callback` under <InlineUIElement>Allowed callback URLs</InlineUIElement>; for example <InlineFieldValue>https://auth.piedpiper.com/oauth2/callback</InlineFieldValue>.
