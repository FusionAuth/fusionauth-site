...
Before you can complete your integration, assign Azure AD users to your Azure AD application. Add a user by navigating to <Breadcrumb>Users and groups</Breadcrumb> and clicking on the <Breadcrumb>Add user/group</InlineUIElement> button. Follow the instructions to select and add a user.
