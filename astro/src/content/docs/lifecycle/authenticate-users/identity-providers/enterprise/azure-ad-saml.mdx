...
Once saved, you may receive a CORS warning. Be sure to follow the onscreen instructions and this [documentation](/docs/lifecycle/authenticate-users/identity-providers/overview#cors-configuration).

### Linking Options

If you are [linking to a user on email](/docs/v1/tech/identity-providers/#linking-strategies), please configure the SAML IdP to find the email claim. This can be done by navigating to
