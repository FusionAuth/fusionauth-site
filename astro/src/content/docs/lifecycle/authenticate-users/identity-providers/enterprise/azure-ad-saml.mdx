...
- <InlineField>IdP endpoint</InlineField>. This value can be obtained from your Azure AD Application as demonstrated below. You will want to copy the <InlineField>Login URL</InlineField> value from Azure AD into this field.
...
Be sure to check <InlineField>Debug Enabled</InlineField>. This will ensure debug information is written to the Event Log, which you can see by navigating to <Breadcrumb>System -> Event Log</Breadcrumb>.
