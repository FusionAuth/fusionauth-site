...
If you are looking for instructions to set up FusionAuth as a SAML v2 IdP (i.e. you want FusionAuth to be the system of record for your users, and other applications authenticate against FusionAuth), consult the [SAML v2 IdP](/docs/lifecycle/authenticate-users/saml/overview) documentation.
</Aside>
...
* [Configure SAML v2 for Okta](/docs/v1/tech/identity-providers/samlv2/okta-saml)
...
<APIBlock>
  ...
  <APIField name="Linking strategy" optional since="1.28.0">
    The linking strategy for the SAMLv2 provider. [See Linking Strategies for more](/docs/v1/tech/identity-providers/#linking-strategies).
  </APIField>
