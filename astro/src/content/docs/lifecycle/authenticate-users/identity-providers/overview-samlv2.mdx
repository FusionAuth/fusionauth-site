...
<APIBlock>
  ...
  <APIField name="Issuer" optional since="1.43.0">
    The EntityId (unique identifier) of the SAML v2 identity provider. Required when **Enable IdP initiated login** is enabled. This value should be provided to you.
  </APIField>
