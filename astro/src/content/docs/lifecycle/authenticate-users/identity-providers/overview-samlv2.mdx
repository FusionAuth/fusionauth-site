...
This guide explains how to enable a SAML v2 Identity Provider.
...
To create an Identity Provider navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and click <Breadcrumb>Add provider</Breadcrumb>, and select `SAML v2` from the dialog.
