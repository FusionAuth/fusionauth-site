...
<APIBlock>
  ...
  <APIField name="Alternate destinations" optional since="1.43.0">
    The array of URLs that FusionAuth will accept as SAML login destinations if the <InlineField>Destination Assertion Policy</InlineField> is <InlineFieldValue>Allow alternates</InlineFieldValue>.
  </APIField>
