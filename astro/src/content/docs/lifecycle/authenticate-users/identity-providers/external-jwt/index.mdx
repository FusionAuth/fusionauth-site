...
All configured claim mappings will be visible here. Use the <Breadcrumb>Add Claim</InlineUIElement> button to add additional claim mappings. You may optionally perform all of the claim mapping using a Reconcile lambda function.
