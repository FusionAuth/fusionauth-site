...
tags: external jwt, jwt identity provider, reconcile jwt, federated login, third party jwt, jwt authentication
---
...
<APIBlock>
  ...
  <APIField name="Verification keys" required since="1.69.0">
    The keys stored in Key Master that are used to verify the third-party JWT sent back to FusionAuth from the identity provider.
  </APIField>
