...
The [Identity Providers](/docs/apis/identity-providers/overview) APIs allow you to configure and manage how these external identity providers are utilized by FusionAuth to perform federated authentication.
...
For example, during Login, collect the User's email address and utilize the [Lookup](/docs/apis/identity-providers/overview#lookup-an-identity-provider) API to
