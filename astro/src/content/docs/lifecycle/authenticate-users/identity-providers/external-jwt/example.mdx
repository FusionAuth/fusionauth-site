---
title: External JWT IdP Example Usage
description: Learn how to federate identity using the External JWT Identity Provider.
tags: external jwt, jwt identity provider, federated identity, jwt reconcile, active directory, adfs integration
---
...
<API method="GET" uri="/api/identity-provider/lookup?domain=playtronics.com"/>
...
A successful response from the Reconcile API should look identical to a [Login](/docs/apis/login/authenticate) API response.
