...
![Unable to login with a managed domain and misconfigured Identity Provider.](/img/docs/lifecycle/authenticate-users/identity-providers/unable-to-login-managed-domains.png)
