---
title: Contextual Multi-Factor Authentication (Lambda)
...
## Application Level
Once a MFA requirement lambda has been created it can be confgured at the application level under the Multi-Factor tab and choosing a "MFA requirement Llambda".

## Licensing
An Enterprise license is required to use MFA Lambdas.

## Using MFA Lambda during login (hosted pages)

## Using MFA Lambda during password change
