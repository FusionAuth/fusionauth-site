...
* Turn on **Passwordless Login** under the <Breadcrumb>Security</Breadcrumb> tab of the application configuration:
...
1. Turn on **Passwordless Login** under the <Breadcrumb>Security</Breadcrumb> tab of the application configuration:
   ![Turn on magic links passwordless login](/img/docs/lifecycle/authenticate-users/passwordless/turn-on-passwordless.png)
...
1. Go to your application login page and click the <Breadcrumb>Login with a magic link</Breadcrumb> button
   ![The magic links login magic link](/img/docs/lifecycle/authenticate-users/passwordless/login-page-with-magic-link.png)

1. Enter the user's email or phone number
   ![The magic links login request form](/img/docs/lifecycle/authenticate-users/passwordless/passwordless-request-form.png)
