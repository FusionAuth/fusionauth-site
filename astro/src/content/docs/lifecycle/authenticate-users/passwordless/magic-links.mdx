...
<img src="/img/docs/lifecycle/authenticate-users/passwordless/passwordless-email-request-form.png" alt="The magic links login request form." width="1200" role="bottom-cropped" />
...
<Aside title="SMS/phone form">
  <img src="/img/docs/lifecycle/authenticate-users/passwordless/passwordless-phone-otp-request-form.png" alt="The magic links request form." width="1200" role="bottom-cropped" />
</Aside>
...
Since the template references "FusionAuth", start with duplicating the email template:
