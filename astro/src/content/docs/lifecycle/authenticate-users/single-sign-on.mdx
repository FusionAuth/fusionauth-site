...
If, instead, another datastore is your system of record, check out the [Identity Providers](/docs/v1/tech/identity-providers/) documentation, which allows users to authenticate with third party login. This includes both social sign-on providers like Google as well as providers implementing standards such as OIDC.
</Aside>
...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/UV9FW57dfbQ?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
...
Please see the [SAML IdP](/docs/lifecycle/authenticate-users/saml/overview) and [OIDC documentation](/docs/lifecycle/authenticate-users/oauth/overview) or the single sign-on documentation for the application you're looking to integrate with for more.
