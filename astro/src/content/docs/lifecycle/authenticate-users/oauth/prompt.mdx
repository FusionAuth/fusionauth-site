...
The `auth_time` claim represents the time of the actual user authentication measured in seconds since January 1 1970 00:00:00 UTC. This point in time reference point is generally referred to as the unix epoch.
