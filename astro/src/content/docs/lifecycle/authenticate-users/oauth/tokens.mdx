...
<APIBlock>
  ...
  <APIField name="phone_number_verified" type="Boolean" since="1.59.0">
    The OpenID Connect claim indicating if the User's phone number has been verified. This claim is based only on the <InlineField>user.phoneNumber</InlineField> verification status.
