...
<APIBlock>
  ...
  <APIField name="birthdate" type="String" since="1.50.0">
    ...
    When the `Scope handling policy` is <InlineFieldValue>Strict</InlineFieldValue>, this field is only populated when the <InlineField>scope</InlineField> claim contains the `profile` scope.
  </APIField>
  ...
  <APIField name="email" type="String">
    ...
    In version `1.50.0` and later, when the `Scope handling policy` is <InlineFieldValue>Strict</InlineFieldValue>, this field is only populated when the <InlineField>scope</InlineField> claim contains the `email` scope.
  </APIField>
  ...
  <APIField name="phone_number" type="String" since="1.50.0">
    ...
    When the `Scope handling policy` is <InlineFieldValue>Strict</InlineFieldValue>, this field is only populated when the <InlineField>scope</InlineField> claim contains the `phone` scope.
  </APIField>
  ...
  <APIField name="preferred_username" type="String" since="1.5.0">
    ...
    In version `1.50.0` and later, when the `Scope handling policy` is <InlineFieldValue>Strict</InlineFieldValue>, this field is only populated when the <InlineField>scope</InlineField> claim contains the `profile` scope.
  </APIField>
