...
<APIBlock>
  ...
  <APIField name="phone_number" type="String" since="1.50.0">
    ...
    When the `Scope handling policy` is <InlineFieldValue>Strict</InlineFieldValue>, this field is only populated when the <InlineField>scope</InlineField> claim contains the <InlineFieldValue>phone</InlineFieldValue> scope.
  </APIField>
