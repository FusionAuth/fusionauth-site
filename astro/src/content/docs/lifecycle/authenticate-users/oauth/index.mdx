...
The Client Credentials grant takes place between two Entities. You can learn more about [Entities](/docs/get-started/core-concepts/entity-management) in the <Breadcrumb>Core Concepts</Breadcrumb> section.
...
These values may be adjusted through the <Breadcrumb>Advanced</Breadcrumb> tab of [Tenant Configuration](/docs/get-started/core-concepts/tenants#advanced).
