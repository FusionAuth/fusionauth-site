...
FusionAuth supports the following grant types as defined by the OAuth 2.0 framework in [RFC 6749](https://tools.ietf.org/html/rfc6749), [RFC 8628](https://tools.ietf.org/html/rfc8628), [RFC9449](https://datatracker.ietf.org/doc/html/rfc9449) and [OpenID Connect Core](https://openid.net/specs/openid-connect-core-1_0.html).
