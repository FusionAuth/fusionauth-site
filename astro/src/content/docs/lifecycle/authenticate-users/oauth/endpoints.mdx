---
title: OAuth2 Endpoints | FusionAuth
description: This page details FusionAuth's OAuth2 endpoints. Learn about the authorization code grant, implicit grant, and other OAuth2 flows. 
