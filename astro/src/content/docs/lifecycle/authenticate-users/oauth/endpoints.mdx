...
In that case, a value of <InlineFieldValue>true</InlineFieldValue> is equivalent to a <InlineField>clientAuthenticationPolicy</InlineField> of <InlineFieldValue>Required</InlineFieldValue> and a value of <InlineFieldValue>false</InlineFieldValue> is equivalent to a <InlineField>clientAuthenticationPolicy</InlineField> of <InlineFieldValue>NotRequired</InlineFieldValue>.
