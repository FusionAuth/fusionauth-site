...
<APIBlock>
  <APIField name="Authorization" type="String" optional>
    ...
    See [Bootstrapping Single Sign On](/docs/lifecycle/authenticate-users/single-sign-on#bootstrapping-an-sso-session-after-login) for additional information and examples.
  </APIField>
</APIBlock>
...
<APIBlock>
  ...
  <APIField name="prompt" type="String" optional since="1.60.0">
    ...
    * `consent` - The user will be prompted for consent regardless of a previous consent decision to approve or reject a scope.
    ...
    See [OIDC Prompt](docs/lifecycle/authenticate-users/oauth/prompt) for additional information, limitations and example usage.
  </APIField>
