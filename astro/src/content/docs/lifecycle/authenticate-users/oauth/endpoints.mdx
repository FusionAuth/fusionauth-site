...
In that case, a value of <InlineFieldValue>true</InlineFieldValue> is equivalent to a <InlineField>clientAuthenticationPolicy</InlineField> of `Required` and a value of <InlineFieldValue>false</InlineFieldValue> is equivalent to a <InlineField>clientAuthenticationPolicy</InlineField> of `NotRequired`.
