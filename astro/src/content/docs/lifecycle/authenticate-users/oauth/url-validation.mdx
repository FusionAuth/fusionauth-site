...
| `https://pass:[*]midpass:[*].example.com` | <i class="fas fa-times text-red-600 font-bold"></i>   | The domain contains multiple wildcards      |
...
| `https://example.com/pass:[*]/par*tial/pass:[*]`        | <i class="fas fa-times text-red-600 font-bold"></i>   |                                              |
| `https://example.com/path/pass:[*]midpass:[*]/resource` | <i class="fas fa-times text-red-600 font-bold"></i>   | The path segment contains multiple wildcards |
|                                                         |                                                       |                                              |
...
| `https://example.com?foo=pass:[*]&bar=pass:[*]&baz=blah` | <i class="fas fa-check text-green-600 font-bold"></i> | &nbsp;                                                              |
...
| `https://example.com/pass:[*]/par*tial/pass:[*]` | `https://example.com/path/partotial/resource` | <i class="fas fa-check text-green-600 font-bold"></i> |                                                                                 |
...
| `https://example.com/pass:[*]/par*tial/pass:[*]` | `https://example.com/path/partial/resource`   | <i class="fas fa-times text-red-600 font-bold"></i>   | The segment `partial` does not contain a replacement character for the wildcard |
|                                                  |                                               |                                                       |                                                                                 |
