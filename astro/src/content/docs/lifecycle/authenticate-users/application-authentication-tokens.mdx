...
To enable Authentication Tokens, open the FusionAuth web interface and navigate to <strong>Applications</strong> from the main menu. Edit the Application you want to use Authentication Tokens for and click the Security tab. You'll see an option like this:
...
<APIURI method="PUT">/api/user/registration</APIURI>
...
Note that you must provide a valid API key unless you've also unchecked the <InlineField>Require an API key</InlineField> setting in the <strong>Login API Settings</strong>.
