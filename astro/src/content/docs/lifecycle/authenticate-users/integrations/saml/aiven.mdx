...
When arriving back to the teams page, click on the newly created team and go to the <Breadcrumb>Projects and Roles</Breadcrumb> tab. Click <InlineUIElement>Add projects</InlineUIElement>, select the project, the desired <InlineField>Permission level</InlineField> (e.g. <InlineFieldValue>Developer</InlineFieldValue>) and click <InlineUIElement>Add project</InlineUIElement> to finish setting up the team.
