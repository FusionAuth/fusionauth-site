...
After being redirected back to the <Breadcrumb>API Keys</Breadcrumb> page, click on the `Key` field to reveal its actual value. Then copy it. You'll have to provide this value to the script below.
