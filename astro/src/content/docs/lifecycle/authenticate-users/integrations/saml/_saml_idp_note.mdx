...
If, on the other hand, you are looking for instructions on setting up FusionAuth as a SAML v2 service provider (i.e. you want to allow users to log into either FusionAuth's UI or your applications via a third party SAML v2 identity provider), consult the [SAML v2 Identity Provider](/docs/lifecycle/authenticate-users/identity-providers/overview) documentation. 

A bit confusing, we know. But in FusionAuth, [Identity Providers are third party sources of record for user data](/docs/v1/tech/core-concepts/identity-providers/).
</Aside>
