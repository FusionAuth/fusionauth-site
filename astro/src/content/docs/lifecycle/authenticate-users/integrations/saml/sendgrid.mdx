...
Scroll down to <InlineUIElement>Authentication response</InlineUIElement> and change <InlineField>Signature canonicalization method</InlineField> to <InlineFieldValue>Exclusive</InlineFieldValue>.
