...
In <Breadcrumb>Match attributes</Breadcrumb>, map email, first and last name fields like shown in the image below and click <InlineUIElement>Apply</InlineUIElement>.
