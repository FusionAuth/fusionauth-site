...
Now, log in to your FusionAuth instance to create a new application. In your FusionAuth dashboard, navigate to <Breadcrumb>Applications</Breadcrumb> in the sidebar, then click the **➕** button in the top right and give it a meaningful name such as `Tableau`. Select the tenant you want to use from the <InlineField>Tenant</InlineField> dropdown.
