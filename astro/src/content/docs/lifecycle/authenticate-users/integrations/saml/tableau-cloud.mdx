...
![Enable SAML in Tableau CLoud.](/img/docs/lifecycle/authenticate-users/integrations/saml/navigation.png)
...
![View the Application Metadata.](/img/docs/lifecycle/authenticate-users/integrations/saml/metadata-view.png)
...
![Uploading metadata file.](/img/docs/lifecycle/authenticate-users/integrations/saml/config.png)
...
![Map email  first and last name fields](/img/docs/lifecycle/authenticate-users/integrations/saml/mapping.png)
