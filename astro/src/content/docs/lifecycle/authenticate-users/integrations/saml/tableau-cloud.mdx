...
Finally, you can edit your FusionAuth application, go to the <Breadcrumb>SAML</strong> tab and click <InlineUIElement>Debug enabled</InlineUIElement> to create an event log with more information. To see these logs, browse to <strong>System -> Event Log</Breadcrumb>.
