...
Open the URL in your browser, and you will see XML code configuration for the metadata. Copy the configuration into a file called `metadata.xml` and edit the file to remove the `ns2:` prefixes to make it valid for Tableau.
