...
* Copy the <InlineField>Login URL</InlineField> and paste it into the <InlineField>Sign-in page URL</InlineField>
* Copy the <InlineField>Logout URL</InlineField> and paste it into the <InlineField>Sign-out page URL</InlineField>
* FusionAuth does not support the Change password feature of Google, so you can just set the <InlineField>Change password URL</InlineField> to anything you want
