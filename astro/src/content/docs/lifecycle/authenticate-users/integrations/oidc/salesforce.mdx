...
tags: salesforce, openid connect, oidc integration, salesforce sso, fusionauth salesforce
---
...
<ExtractedCode lang="java" src="example-salesforce-oidc/RegistrationHandler.cls" />
