...
You may optionally include a `name` field to give the method a friendly label (for example, `Work email` or `Work authenticator`).
...
If you provided a method name during enrollment, that friendly name will be shown in this list.
