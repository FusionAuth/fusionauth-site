...
Navigate to <Breadcrumb>Users -> The User</strong> and manage the user. Then go to the <strong>Multi-Factor</Breadcrumb> tab. Remove any of the MFA methods by clicking the red trash can icon and confirming the deletion:
