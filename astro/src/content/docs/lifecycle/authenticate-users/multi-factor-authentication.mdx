...
## The End User Login Experience (with MFA flow diagram)
...
[See licensing](/license-faq) for more details on plan features.
...
- Check [tenant/app messenger + template configuration](/docs/customize/email-and-messages/message-templates) and delivery basics
...
- [Why MFA triggers with external IdPs and how to adjust policy](https://fusionauth.io/community/forum/topic/2653/mfa-is-forced-also-on-identity-provider-users)
...
- [See community discussion on enabling MFA for specific projects](https://fusionauth.io/community/forum/topic/3025/enabling-mfa-for-all-users-or-specific-projects-in-fusionauth-essentials-plan)
