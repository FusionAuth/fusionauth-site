...
[Review tenant concepts and where MFA defaults live.](/docs/get-started/core-concepts/tenants)
...
[See application settings that affect MFA.](/docs/get-started/core-concepts/applications)
