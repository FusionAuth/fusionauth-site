...
For a full practical guide with code to connect a Node.js website to FusionAuth as an identity provider with SAML, please see the guide [here](/docs/lifecycle/examples/authenticate-users-with-saml).
