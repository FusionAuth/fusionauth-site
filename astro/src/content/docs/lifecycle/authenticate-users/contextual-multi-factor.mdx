...
You may need more granularity on who is challenged for an additional factor during login. For example, you might want everyone who is a member of a certain group or who has a certain `user.data` field to complete an MFA challenge.
