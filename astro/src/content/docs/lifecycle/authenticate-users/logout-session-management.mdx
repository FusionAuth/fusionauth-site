...
FusionAuth does not implement the [OIDC backchannel logout specification](https://openid.net/specs/openid-connect-backchannel-1_0.html), though there is [an open GitHub issue for it](https://github.com/FusionAuth/fusionauth-issues/issues/465).
