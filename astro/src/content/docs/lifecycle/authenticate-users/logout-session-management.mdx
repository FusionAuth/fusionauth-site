...
<Aside type="note">
Previous to version 1.52, setting the SSO session to a low value and enabling other post authentication workflows such as an OAuth consent screen could cause a login workflow to be restarted. See this [release 1.53.0](https://fusionauth.io/docs/release-notes/#version-1-53-0), where this was fixed.
</Aside>
