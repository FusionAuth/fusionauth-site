...
This guide will show you how to enable SAML for your website and how to authenticate users with SAML via FusionAuth. To learn more about SAML, please see the [FusionAuth SAML overview](https://fusionauth.io/docs/lifecycle/authenticate-users/saml).

Consider the following example. You provide a financial service on the Internet to users who log in to your website, called Changebank.com. Until now, the website has managed its own authentication with a username and password. You have a new corporate client who wants all employees to use your service, but authentication will be done with SAML, using the client as the identity provider.
