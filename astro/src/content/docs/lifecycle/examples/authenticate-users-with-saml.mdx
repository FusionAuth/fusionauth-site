...
import DownloadWidget from 'src/components/DownloadWidget.astro';
...
- Use
  ...
  ```
  to clone the [FusionAuth Example Repository](https://github.com/FusionAuth/fusionauth-example-saml) or download and unzip it.
...
If you do this, you will need to update `cert/cert.pem` and the SAML URL in `.env`.
</Aside>
