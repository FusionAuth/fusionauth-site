...
However, the OAuth page is still available. To remove it entirely, you will need to edit the FusionAuth theme for your application. Start learning about themes [here](https://fusionauth.io/docs/customize/look-and-feel/). There is also a forum issue about this question [here](https://fusionauth.io/community/forum/topic/2194/disable-username-and-password-fields).

### Set Up SAML Using The FusionAuth API

If you have many SAML identity providers to configure, using the web interface to create them all is tedious. You can instead use the [FusionAuth API](https://fusionauth.io/docs/apis/identity-providers/samlv2) to create providers programmatically.
