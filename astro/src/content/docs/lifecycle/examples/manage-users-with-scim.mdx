...
- Click <InlineField>Manaage</InlineField> for the BankClient entity, and <InlineField>Add</InlineField>.
...
- Tenants - Default - Edit - SCIM tab - Enable Enabled
  - Choose new server and clients
  - Note this link is for Entity Type, not Entity. Confusing.
- If you want to edit the user creation data mapping, browse to Customizations - Lambdas - SCIM User Request Converter - Edit
- To understand machine authentication, see /content/articles/authentication/service-to-service article
