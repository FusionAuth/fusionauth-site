...
(You could even do a bulk migration with the [users](https://fusionauth.io/docs/apis/users#search-for-users) API instead of a database script, but it would be slower unless your database is small).
