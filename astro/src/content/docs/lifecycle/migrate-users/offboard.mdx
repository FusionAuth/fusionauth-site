...
<Aside type="note">
If you want to browse the diagram above in DBeaver, you can download the diagram file [here](../../../../../public/img/docs/lifecycle/migrate-users/offboard/databaseDiagram.erd).
</Aside>
