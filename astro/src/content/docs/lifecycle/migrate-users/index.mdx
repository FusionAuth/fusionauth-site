...
* If they do not exist in FusionAuth but do in the legacy system, migrate the user data via the [User API](/docs/apis/users#create-a-user), setting **sendSetPasswordEmail** to `true`.
