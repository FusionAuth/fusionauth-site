...
However, you cannot drop the <InlineUIElement>Default</InlineUIElement> tenant containing the FusionAuth application. This is why you must create a new tenant. Alternatively, you could also drop the entire database and perform a fresh FusionAuth install.
