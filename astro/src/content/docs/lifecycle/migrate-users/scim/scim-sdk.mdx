...
Then, run the command below, with the value of <InlineField>YOUR_CLIENT_SECRET</InlineField> updated to the real value, such as <InlineFieldValue>i2kN2KFBPKKj3FsxfilPXDDreBUskn2Sl-27QbQRYQM</InlineFieldValue>.
