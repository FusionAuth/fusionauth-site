...
tags: scim sdk, scim java, scim integration, user provisioning, scim client
---
...
<ExtractedCode lang="java" title="Configuration to change for the example" src="example-scim-integration/ScimExample.snippet.scimConfiguration.java" />
...
<ExtractedCode lang="java" title="The getCredentials method" src="example-scim-integration/ScimExample.snippet.getCredentials.java" />
...
<ExtractedCode lang="java" title="The createUser method" src="example-scim-integration/ScimExample.snippet.createUser.java" />
