...
- Stores all {frontmatter.technology} user details that don't map to FusionAuth in the <InlineField>data</InlineField> field. If there are details you want to include or exclude, alter the `dataToIgnore` list at the top of the file.
