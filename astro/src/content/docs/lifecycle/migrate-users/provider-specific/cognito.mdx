...
tags: migrate from amazon cognito, aws cognito migration, user migration, import users to fusionauth
---
...
<ExtractedCode lang="js" src="example-cdk-cognito-migration/resources/index.js" title="AWS Connector Lambda code" />
...
<ExtractedCode lang="yaml" src="example-cdk-cognito-migration/cloudformation/cloudformation.yaml" title="CloudFormation AWS Lambda Deployment Template" />
