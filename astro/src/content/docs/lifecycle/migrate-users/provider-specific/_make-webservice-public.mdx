...
For this tutorial, running locally, you don't need to use any of the services below.
...
Take note of the URL ngrok prints to your terminal. You can then use this URL as the <InlineField>Authentication URL</InlineField> value when setting up a Connector in FusionAuth. The URL should look something like <InlineFieldValue>https://random-ngrok-string.ngrok-free.app</InlineFieldValue>.