...
If you have external dependencies on an Id stored in Supabase, you can add a new attribute under <InlineField>user.data</InlineField> (such as <InlineField>user.data.originalId</InlineField>) with the value of the Supabase Id. Because everything under <InlineField>user.data</InlineField> is indexed and available via search, you'll be able to find your users using either the new FusionAuth Id, or the original Supabase one.
...
* <InlineField>user_id</InlineField>
* <InlineField>email</InlineField>
* <InlineField>email_verified</InlineField>
