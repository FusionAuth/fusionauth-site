...
The migrated user will have the Auth0 tenant Id and original user Id stored on the <InlineField>user.data</InlineField> object. If you have additional user attributes to migrate, review and modify the `map_user` method.
