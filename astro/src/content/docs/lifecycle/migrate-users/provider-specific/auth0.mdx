...
## Overview
This document explains how to migrate common Auth0 configurations to FusionAuth. If you are looking to compare FusionAuth and Auth0, [see our comparison](/blog/2018/10/19/auth0-and-fusionauth-a-tale-of-two-solutions). For general migration information, see the [FusionAuth migration guide](/docs/lifecycle/migrate-users).
