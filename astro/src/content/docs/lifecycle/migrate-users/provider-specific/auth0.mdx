...
- If you are already a paid FusionAuth customer, please work with your solutions engineer or From your dashboard, navigate to <Breadcrumb>Get Support</Breadcrumb>, and then open a ticket by scrolling to the bottom of the support page.
...
There are many ways to integrate with Auth0; this guide focuses on the most common configurations we've seen.
