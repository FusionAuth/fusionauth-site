...
importCodeRepo: https://github.com/FusionAuth/fusionauth-import-scripts
javaCodeRepo: https://github.com/FusionAuth/fusionauth-contrib
---

import InlineUIElement from 'src/components/InlineUIElement.astro';
import InlineField from 'src/components/InlineField.astro';
import Aside from 'src/components/Aside.astro';
import RemoteSnippet from 'src/components/RemoteSnippet.astro';
...
<RemoteSnippet
    url={frontmatter.importCodeRepo}
    branch="main"
    filepath="stytch/exampleData/3_responseDecryption/stytch_password_hashes.csv"
    lang="plaintext"
/>
...
<RemoteSnippet
    url={frontmatter.importCodeRepo}
    branch="main"
    filepath="stytch/js/2_checkHash.mjs"
    lang="js"
/>
...
<RemoteSnippet
    url={frontmatter.importCodeRepo}
    branch="main"
    filepath="stytch/exampleData/4_hashFilePreparation/hash.csv"
    lang="csv"
/>
...
<RemoteSnippet
    url={frontmatter.importCodeRepo}
    branch="main"
    filepath="stytch/exampleData/5_userDetailAndHashPreparation/user.json"
    lang="json"
/>
...
<RemoteSnippet
    url={frontmatter.javaCodeRepo}
    branch="master"
    filepath="Password Hashing Plugins/src/main/java/com/mycompany/fusionauth/plugins/ExampleStytchScryptPasswordEncryptor.java"
    lang="java"
/>
