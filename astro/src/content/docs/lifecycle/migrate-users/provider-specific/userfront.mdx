...
tags: migrate from userfront, userfront migration, user migration, import users to fusionauth
---
...
Once you have confirmed that FusionAuth meets your needs, you will want to export your Userfront users into FusionAuth. You can obtain users from Userfront using an Admin option in the Userfront dashboard. You can then create corresponding users in FusionAuth using the [bulk migration (Import)](/docs/lifecycle/migrate-users/#bulk-offline-migration) or [Users](/docs/apis/users) endpoints, depending on how many users you want to migrate at a time. Because you can't migrate hashed passwords, you'll generate a random initial password; users can set a new custom password using the forgot password workflow.
...
If you are using FusionAuth Cloud, the FusionAuth Support team will work with you to import your data into your FusionAuth Cloud environment. This can be scheduled to coincide with your application's conversion to FusionAuth.
