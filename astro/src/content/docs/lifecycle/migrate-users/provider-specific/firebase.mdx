...
<RemoteSnippet repo="https://github.com/ritza-co/fusionauth-contrib"
            branch="draft_codeSnippetBluehawk"
            filepath="Password Hashing Plugins/src/main/java/com/mycompany/fusionauth/plugins/ExampleFirebaseScryptPasswordEncryptor.java"
            lang="java"
