...
To preserve your users' passwords, you need to perform a gradual migration. Users log in to FusionAuth with their Azure AD B2C credentials, and FusionAuth transparently migrates their data. Grdual migrations in FusionAuth use Connectors, a paid feature.
