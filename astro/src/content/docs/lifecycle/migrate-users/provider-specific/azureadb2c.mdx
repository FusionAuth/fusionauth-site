...
If the user was not migrated or the login was unsuccessful, you can troubleshoot. In the administrative user interface, enable the **Debug enabled** field in the Connector configuration by navigating to <Breadcrumb>Settings -> Connectors</Breadcrumb> and editing the Generic Connector you added.
