...
Once you have user available, test if you can verify the user's email address and password with the curl command below. More information on this command is available in the [documentation](https://techdocs.akamai.com/identity-cloud-auth/reference/post-oauth-auth-native-traditional).
