...
{frontmatter.technology} and FusionAuth both support images (for example, user profile photos) as URLs to files hosted on cloud storage. After migration, check that your photo storage host is still usable.
