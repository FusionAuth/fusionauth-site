...
Exporting users from your Node.js/Passport.js application is a two-step process: first export the raw user data from your database, then convert it to FusionAuth format.
