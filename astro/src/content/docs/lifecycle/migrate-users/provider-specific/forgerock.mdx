...
The migrated user will have the original {migration_source_name} user Id stored on the <InlineField>user.data</InlineField> object. If you have additional user attributes to migrate, review and modify the `map_user` method.
