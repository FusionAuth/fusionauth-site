...
![The LDAP Connector creation screen.](/img/docs/lifecycle/migrate-users/connectors/ldap-connector-create-screen.png)
...
![The LDAP Connector creation screen.](/img/docs/lifecycle/migrate-users/connectors/ldap-connector-create-directory-tab.png)
...
* Create an [LDAP reconcile Lambda](/docs/extend/code/lambdas/reconcile/ldap-connector-reconcile) to map the directory attributes to FusionAuth user attributes.
