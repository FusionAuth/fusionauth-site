...
* Create an [LDAP reconcile Lambda](/docs/v1/tech/lambdas/ldap-connector-reconcile) to map the directory attributes to FusionAuth user attributes.
...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/Cqd7EgK4ess?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
