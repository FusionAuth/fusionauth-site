...
Find Connectors in the administrative user interface by navigating to <strong>Settings -> Connectors</strong> or use the [Connectors](/docs/apis/connectors/overview) APIs.
...
Connectors share many features with [Identity Providers](/docs/v1/tech/identity-providers/). Both can connect FusionAuth to an external system of record for user identity.
