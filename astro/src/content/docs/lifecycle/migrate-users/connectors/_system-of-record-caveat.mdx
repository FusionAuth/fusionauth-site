...
As [documented](/docs/lifecycle/migrate-users/connectors/overview), there are a number of differences between these two choices. However, one difference is worth emphasizing. 
