...
description: Learn more about the FusionAuth Connector.
tags: fusionauth connector, default connector, user authentication, connector configuration, identity store
---
