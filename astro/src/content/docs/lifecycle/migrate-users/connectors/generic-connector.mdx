...
You can load test your Connector using [FusionAuth's load testing framework](/docs/operate/monitor#load-testing) or any other HTTP based load testing framework.
...
[Here's more about load testing FusionAuth](/docs/operate/monitor#load-testing).
