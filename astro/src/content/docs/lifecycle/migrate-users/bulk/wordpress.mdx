...
The two users you have export have roles Adminstrator and Subscriber, as seen in the `wp_capabilities` meta field. Create them in FusionAuth. In a terminal in the
