...
The next script is the most important. It maps the fields of `users.json` into FusionAuth fields. You may wish to alter this script to change which fields are ignored, or where they are mapped. The script is `3_convertWpUserToFaUser.mjs`.
