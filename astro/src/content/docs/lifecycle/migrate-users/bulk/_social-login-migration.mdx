...
* The Identity Provider Id is found on the corresponding [Identity Provider API documentation]. Look for [field](/docs/apis/identity-providers/overview)#identityProvider.id#.
...
Here's more information about [IdP Linking Strategies](/docs/v1/tech/identity-providers/#linking-strategies).
