...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-import-scripts/master/supabase/supabase_user_migration_script.sql"
            lang="shell"
...
<img src={`/img/docs/lifecycle/migrate-users/bulk/${migration_source_dir}/supabase-sql.png`} alt="Adding an API key," width="1200" />
