...
Stytch has pre-built UI flows or you can custom build your own with headless SDK methods.
...
To export users from Stytch, you'll perform the following steps:

1. Request user password hashes from Stytch via email.
2. Get all user details and combine with hashes.
...
3. Import Users
4. Verify the Import
5. The Final Destination of Imported Users
