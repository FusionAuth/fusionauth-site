...
- [ ] branch
- [ ] duplicate firebase hasher into new file - fusionauth/plugins/ExampleFirebaseScryptPasswordEncryptor.java
- [ ] change it
- [ ] copy test and test it
- [ ] add new plugin to index file
- [ ] build
- [ ] add jar file to my copy of fusionauth's plugin folder
- [ ] try it in kotlin
