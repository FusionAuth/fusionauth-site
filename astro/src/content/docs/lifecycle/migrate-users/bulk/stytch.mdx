...
Below is JavaScript code to get user details from Stytch. (Stytch also has SDKs for [Go, Java, Python, and Ruby](https://stytch.com/docs/sdks), or you can use `curl` directly).
...
const u = await client.users.get({ user_id: "user-test-c1be12e4-fc61-4e7a-8831-0fc14cb87b65" });
console.log(u);
```

The reply will look similar to the JSON below.

```js
{
  biometric_registrations: [],
  created_at: '2024-01-11T09:55:02Z',
  crypto_wallets: [],
  emails: [
    {
      email: 'user2@example.com',
      email_id: 'email-test-21e7b4d6-fc9b-45a1-af0a-519b6536e9b6',
      verified: false
    }
  ],
  name: { first_name: 'B', last_name: 'Example', middle_name: '' },
  password: {
    password_id: 'password-test-dd564ea4-5711-414e-a5a4-052e671609a7',
    requires_reset: false
  },
  phone_numbers: [
    {
      phone_id: 'phone-number-test-767f26e1-34bd-41a9-86af-1411b4c20be6',
      phone_number: '+272223334445',
      verified: false
    }
  ],
  providers: [],
  request_id: 'request-id-test-04a96a55-2eca-4691-a2aa-77f095911275',
  status: 'active',
  status_code: 200,
  totps: [],
  trusted_metadata: {},
  untrusted_metadata: {},
  user_id: 'user-test-c1be12e4-fc61-4e7a-8831-0fc14cb87b65',
