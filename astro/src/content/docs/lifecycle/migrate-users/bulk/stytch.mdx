...
You now have the users file `users.json` and installed the Scrypt plugin. To import the users into FusionAuth you need to install the FusionAuth SDK for Node.js, then run the script below.
