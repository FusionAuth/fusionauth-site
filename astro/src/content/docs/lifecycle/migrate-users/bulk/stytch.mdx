...
- [ ] Probably convert it to Ruby because I see all their scripts are in Ruby (2:4)
- [ ] See what other Stytch authentication types FA supports and work out how to import them (magic email, passkeys, social login, etc). This could be huge, no idea yet. (2:36)
- [ ] Review the other import articles and see what sections I need to add (1:8)
- [ ] Review the overview article on migration strategy and add missing sections (2:4)
