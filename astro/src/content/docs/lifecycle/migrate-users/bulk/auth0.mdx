...
<img src="/img/docs/lifecycle/migrate-users/bulk/auth0-export-complete.png" alt="View when the import/export extension is finished." width="1200" role="bottom-cropped" />
