...
If your user uses TOTP, where they provide a one time code provided by an application like Google Authenticator, you'll need to re-enroll users. As of Oct 2022, [Auth0 doesn't support export of TOTP secrets](https://community.auth0.com/t/can-mfa-secrets-be-exported/91656).
