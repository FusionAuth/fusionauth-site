...
Click the <InlineUIElement>Manage</InlineUIElement> button (black button) to the right of a user in the list of users to review the details of the imported user’s profile. In the <Breadcrumb>Source</Breadcrumb> tab, you can see all the user details as a JSON object.
