...
description: Learn how to migrate your users from Passport.js-based authentication to FusionAuth.
section: lifecycle
...
- [Node.js 22.x or higher](https://nodejs.org/en/download) to run migration scripts.
...
To migrate users from your {frontmatter.technology} application, you'll need to export user data from your database. Since {frontmatter.technology} doesn't manage user data directly, the export process depends on your database and user schema.
