...
importCodeRoot: https://raw.githubusercontent.com/ritza-co/fusionauth-import-scripts/feat/add-ruby-on-rails-script
---
...
This guide provides general migration strategies with working example {frontmatter.technology} apps available [here](https://github.com/FusionAuth/fusionauth-import-scripts/rails/example-apps). The example contains three sample Rails applications, each using a different authentication framework:
...
A sample user exported from the script will look like:
