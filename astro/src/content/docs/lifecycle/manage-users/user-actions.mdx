...
Below is a visual reminder of the relationships between [Tenants&#44; Groups&#44; and Applications](/docs/v1/tech/core-concepts/).
...
It is faster to use FusionAuth client libraries rather than make HTTP calls directly. You can read how to use client libraries in the [client library guide](/docs/v1/tech/client-libraries/) before continuing. This guide uses the TypeScript client library.
...
<Aside type="note">
Enabling the webhooks in two places gives you fine-grained control across Tenants. More information on webhooks is available [here](/docs/extend/events-and-webhooks/overview#overview).
</Aside>
