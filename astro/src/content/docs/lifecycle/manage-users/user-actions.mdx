...
* Log in to FusionAuth and navigate to <Breadcrumb>Tenants</Breadcrumb>. Edit the <InlineUIElement>Default</InlineUIElement> tenant by clicking on the <Icon name="edit"/> icon.
...
* Navigate to <Breadcrumb>Tenants</Breadcrumb> and edit <Icon name="edit" /> the <InlineUIElement>Default</InlineUIElement> tenant.
