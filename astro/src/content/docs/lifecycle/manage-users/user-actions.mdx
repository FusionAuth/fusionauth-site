...
* Save <Icon name="save" /> the User.
* Click <InlineUIElement>Add registration</InlineUIElement> under the <Breadcrumb>Registrations</Breadcrumb> tab to register the user to the <InlineFieldValue>PiedPiper</InlineFieldValue> application.
  * <InlineField>Application</InlineField>: <InlineFieldValue>PiedPiper</InlineFieldValue>
...
* Navigate to <Breadcrumb>Tenants</Breadcrumb> and edit <Icon name="edit" /> the <InlineFieldValue>Default</InlineFieldValue> tenant.
