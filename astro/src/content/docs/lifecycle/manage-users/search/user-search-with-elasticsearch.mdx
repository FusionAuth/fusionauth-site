...
Examples are in curl, but you may also use any of the [supported client libraries](/docs/v1/tech/client-libraries/) to run user searches in your favorite development language.
...
Note that you'll only be able to get back 10000 results no matter how you paginate. See the <ScrollRef target="Limitations" /> section for workarounds.
