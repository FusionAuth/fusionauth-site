...
<LocalCode src="example-user-search/examples/search.sh" lang="bash" title="search.sh: An Example Shell Script For Searching" />

## Searching By User Ids

Here's an example of an `ids` query.

<LocalCode src="example-user-search/examples/ids/ids-request.json" lang="json" />
...
<LocalCode src="example-user-search/examples/queryString/all-fields-data-request.json" lang="json" title="Example Request JSON For Searching Across All Indexed Fields With queryString" />
...
<LocalCode src="example-user-search/examples/queryString/email-data-request.json" lang="json" title="Example Request JSON For Searching By Emails With queryString" />
...
<LocalCode src="example-user-search/examples/queryString/email-verified-data-request.json" lang="json" title="Example Request JSON For Searching By Emails And The Verified Field" />
...
<LocalCode src="example-user-search/examples/query/user-data-simple.json" lang="json" title="Example Elasticsearch Query JSON Searching the Company User Attribute" />
...
<LocalCode src="example-user-search/examples/query/user-data-simple-escaped.json" lang="json" title="Example Escaped Elasticsearch Query JSON For Searching the Company User Attribute" />

Next, add that string as the `query` parameter to a request.

<LocalCode src="example-user-search/examples/query/user-data-simple-request.json" lang="json" title="Example Request JSON For Searching By the Company User Attribute Emails With queryString" />
...
<LocalCode src="example-user-search/examples/query/user-data-complex.json" lang="json" title="Example Elasticsearch Complex Query JSON" />
...
<LocalCode src="example-user-search/examples/query/user-data-complex-escaped.json" lang="json" title="Example Escaped Elasticsearch Complex Query JSON" />

The next step is to add that string as the `query` parameter to a request.

<LocalCode src="example-user-search/examples/query/user-data-complex-request.json" lang="json" title="Example Request JSON For a Complex Query" />
...
<LocalCode src="example-scripts/full-user-search/paginatefulluserdownload.sh" lang="bash" title="An Example Shell Script For Searching Using Extended Pagination" />
