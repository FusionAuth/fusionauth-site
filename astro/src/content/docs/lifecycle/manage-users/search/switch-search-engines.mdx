...
tags: switch search engines, elasticsearch, database search engine, fusionauth search configuration
---
...
They have different [strengths and limitations](/docs/get-started/core-concepts/types/users#user-search).
