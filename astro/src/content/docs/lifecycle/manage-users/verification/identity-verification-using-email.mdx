...
<img src="/img/docs/lifecycle/manage-users/verification/identity-verification-form-field-user-email-address.png" alt="The Form Field configuration for user.email, set to Required" width="1200" />
