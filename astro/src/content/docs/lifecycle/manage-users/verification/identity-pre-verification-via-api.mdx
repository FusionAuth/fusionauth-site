...
tags: identity pre-verification, api verification, verify email api, verify phone api, verification api
---
...
<Aside type="note">
  For complete parameter and response details, refer to [Create a User](/docs/apis/users/create)
</Aside>
