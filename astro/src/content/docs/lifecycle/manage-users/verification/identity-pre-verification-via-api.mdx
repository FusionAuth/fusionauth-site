...
1. Start Verification Flow
   ...
   * For pre-verifying identities before user creation, set <InlineField>existingUserStrategy</InlineField> to <InlineFieldValue>mustNotExist</InlineFieldValue>.
...
![Identity verification settings for Email and Phone in the Tenant configuration](/img/docs/lifecycle/manage-users/verification/identity-pre-verification-user-email-and-phoneNumber-verified.png)
