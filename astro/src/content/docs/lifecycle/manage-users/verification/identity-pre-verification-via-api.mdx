...
<Aside type="note">
  ...
  See the [hosted pages](/docs/get-started/core-concepts/hosted-login-vs-api-login#hosted-login-pages) guides if you prefer FusionAuth to enforce gating for you.
</Aside>
...
These examples assume a local FusionAuth instance at http://localhost:9011 and that you're sending an [API key in the headers](/docs/apis/authentication) as required by your configuration. Adjust host, tenant header, and authorization to match your environment.
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-user-email-and-phoneNumber-verified.png" alt="Identity verification settings for Email and Phone in the Tenant configuration" width="1200" />
