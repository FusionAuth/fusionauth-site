...
You can configure additional settings around registration verification in the application you set up for registrations. Navigate to <Breadcrumb>Applications -> Your Application</strong> and then select the <strong>Registration</strong> tab. Scroll up to the <strong>Registration Verification Settings</Breadcrumb> section, just above the "Registration Fields" section.
