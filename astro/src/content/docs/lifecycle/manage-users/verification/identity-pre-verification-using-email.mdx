...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-form-field-user-email-address.png" alt="The Form Field configuration for user.email, set to Required" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-form-email-verification.png" alt="The Email Verification form with a verification step" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-application-registration-self-service-advanced-form-email-verification.png" alt="The Application registration configuration enabling self-service registration with an Advanced Registration Form" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-user-email-verified.png" alt="The User Manage page with the Email verified checkmark icon" width="1200" />
