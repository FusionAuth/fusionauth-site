...
1. Open your application's Self-service Registration page using the <InlineUIElement>Self-service Registration URL</InlineUIElement>.
...
* Users are not Gated with a unverified phone.
