...
Navigate to <Breadcrumb>Applications-> Your Application</strong> and then select the <Breadcrumb>Registration</Breadcrumb> tab. Scroll to the <strong>Registration verification settings</Breadcrumb> section.
