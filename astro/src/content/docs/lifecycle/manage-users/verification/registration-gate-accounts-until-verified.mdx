...
<Aside type="note">
As of 1.59.0 registration verification is deprecated and will be removed in a future version of FusionAuth.
</Aside>
...
Click on the <InlineUIElement>View</InlineUIElement> button of your application to see the details of your application.
