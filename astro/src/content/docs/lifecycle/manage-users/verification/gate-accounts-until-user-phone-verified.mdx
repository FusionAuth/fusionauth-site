...
<img src="/img/docs/lifecycle/manage-users/verification/phone-verification-gate-screen-form-field.png" alt="Form field default phone verification gate screen" width="1200" role="bottom-cropped" />
