...
Navigate to <Breadcrumb>Customizations -> Message Templates</Breadcrumb>. Edit the `Phone Verification` template by clicking on the blue <InlineUIElement>Edit</InlineUIElement> button.
