...
As of version 1.99.9, FusionAuth can be configured to gate users' accounts until their phone numbers have been verified. While users can successfully start the login process, they will be blocked from completing it until they have verified possession of the phone number they registered with.
...
* <InlineField>Verification strategy</InlineField>. For this tutorial, keep the default value of `FormField`. For future reference, this can be either:
