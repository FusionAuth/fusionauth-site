...
6. Confirm the verification status by viewing the user in the admin UI by navigating to <Breadcrumb>Users -> [select user] -> Manage</Breadcrumb>. Verified phone numbers display a green checkmark icon next to the number.
