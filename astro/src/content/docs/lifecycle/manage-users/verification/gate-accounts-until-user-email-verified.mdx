...
<img src="/img/docs/lifecycle/manage-users/verification/unverified-email-user-details-screen.png" alt="Unverified user details screen" width="1200" role="bottom-cropped" />
