...
tags: email verification, gate accounts, verify email, email confirmation, user verification gating
---
...
- Under email, enable **Verify identity**.
...
Navigate to <Breadcrumb>Customizations -> Email Templates</Breadcrumb>. Edit the `Email Verification` template by clicking on the blue <Breadcrumb>Edit</Breadcrumb> button.
