...
If a user is created and email verification is disabled, the verified attribute of the identity object will be `false` with a reason of `Disabled`.
...
If a user is created while email verification is enabled, the verified attribute of the identity object will be `false` with a reason of `Pending`
