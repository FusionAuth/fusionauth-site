...
Navigate to <Breadcrumb>Customizations -> Email Templates</Breadcrumb>. Edit the <InlineFieldValue>Email Verification</InlineFieldValue> template by clicking on the blue <InlineUIElement>Edit</InlineUIElement> button.
