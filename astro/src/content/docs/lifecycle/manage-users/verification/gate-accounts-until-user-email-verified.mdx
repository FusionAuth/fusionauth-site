...
Navigate to <Breadcrumb>Tenants -> Your Tenant</Breadcrumb> and then select the <Breadcrumb>Identities</Breadcrumb> tab. Scroll to the <InlineUIElement>Identity verification settings</InlineUIElement> section.
