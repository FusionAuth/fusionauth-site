...
Navigate to <Breadcrumb>Tenants -> Your Tenant</Breadcrumb> and then select the <Breadcrumb>Email</Breadcrumb> tab. Scroll to the <Breadcrumb>Email verification settings</Breadcrumb> section.
...
Navigate to <Breadcrumb>Applications</Breadcrumb>. Edit your application by clicking on the blue "Edit" button.
