...
[Pre-verification](/docs/lifecycle/manage-users/verification/mail-identity-verification) applies the same concept, but user identities must be verified *before* user creation.
