...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-settings-messengers-twilio.png" alt="Twilio messenger configuration in FusionAuth" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-default-tenant-identity-phone.png" alt="Identity verification settings for Phone in the Tenant configuration" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-form-field-user-phone-number.png" alt="The Form Field configuration for user.phoneNumber, set to Required" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-form-phone-verification.png" alt="The Phone Verification form with a verification step" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-application-registration-self-service-advanced-form-phone-verification.png" alt="The Application registration configuration enabling self-service registration with an Advanced Registration Form" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-application-details.png" alt="The Application details page with the Self-service registration URL" width="1200" />
...
<img src="/img/docs/lifecycle/manage-users/verification/identity-pre-verification-user-phoneNumber-verified.png" alt="The User Manage page with the Phone verified checkmark icon" width="1200" />
