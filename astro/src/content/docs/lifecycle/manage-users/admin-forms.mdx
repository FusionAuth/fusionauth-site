...
With custom admin forms, you can modify the administrative user interface (admin UI) and customize your view of Users or Registrations.
...
All custom fields are always viewable in the <Breadcrumb>User data</Breadcrumb> tab. Encrypt any secret data stored in a custom data field.
