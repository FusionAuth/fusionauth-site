...
2. Click <InlineUIElement>Manage passkeys</InlineUIElement>
3. Click <InlineUIElement>Add passkey</InlineUIElement>
...
1. Click the <InlineUIElement>Fingerprint, device or key</InlineUIElement> button to go to the WebAuthn bootstrap login page.
2. Enter your username or email address.
3. Click the <InlineUIElement>Submit</InlineUIElement> button.
