...
Erlich Bachman for any <InlineFieldValue>admin</InlineFieldValue> facing actions. Imagine Erlich is you or a customer service rep at your company.
...
![Account Home](/img/docs/lifecycle/manage-users/account-management/registered-account-home.png)
