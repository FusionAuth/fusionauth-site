...
To view the account and self service pages, login as an admin and navigate to <strong>Applications</strong> and click on the icon:search[role=ui-button green,type=fas] icon to view the application details. 
