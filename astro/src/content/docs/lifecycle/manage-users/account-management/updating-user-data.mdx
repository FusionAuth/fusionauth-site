...
![Self Serve home](/img/docs/lifecycle/manage-users/account-management/account-management-index-crop.png)

Once on the account self service edit screen your information (user object) can be updated directly.

![Self Serve Edit](/img/docs/lifecycle/manage-users/account-management/user-self-serve-edit-crop.png)
...
![User Edit Password](/img/docs/lifecycle/manage-users/account-management/user-self-serve-edit-password-crop.png)
