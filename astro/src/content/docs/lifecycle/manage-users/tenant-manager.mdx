...
2. Select <Breadcrumb>Manage</Breadcrumb> from the <Breadcrumb>Action</Breadcrumb> menu
3. Open the <Breadcrumb>Registrations</Breadcrumb> tab and click <Breadcrumb>Add a registration</Breadcrumb>
