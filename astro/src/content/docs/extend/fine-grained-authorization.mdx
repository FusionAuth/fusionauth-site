...
<RemoteCode lang="typescript"
            url="https://raw.githubusercontent.com/FusionAuth/fusionauth-example-fine-grained-authorization/refs/heads/main/permify-setup/authmodel.txt"
            title="FGA schema" 
            />
