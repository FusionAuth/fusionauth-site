...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing a SAML v2 configuration or click <strong>Add provider</Breadcrumb> and select SAML v2 if it has not yet been configured.
