...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing a SAML v2 configuration or click <UIelement>Add provider</UIelement> and select SAML v2 if it has not yet been configured.
