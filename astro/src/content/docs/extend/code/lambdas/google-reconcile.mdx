...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Google configuration or click <strong>Add provider</Breadcrumb> and select Google if it has not yet been configured.
