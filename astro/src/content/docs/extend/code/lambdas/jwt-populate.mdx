...
* `registration` - the FusionAuth UserRegistration object. This parameter is `undefined` when the user is not registered for the application. This object is read-only.
