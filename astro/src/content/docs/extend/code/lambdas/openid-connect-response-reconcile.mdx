...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing an OpenID Connect configuration or click <UIelement>Add provider</UIelement> and select OpenID Connect if it has not yet been configured.
