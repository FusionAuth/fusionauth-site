...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing an OpenID Connect configuration or click <strong>Add provider</Breadcrumb> and select OpenID Connect if it has not yet been configured.
