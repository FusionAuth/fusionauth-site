...
* `id_token` - the JSON payload returned in the `id_token` when available. This parameter will be `undefined` in that case. This object is read-only. <span class="px-3 text-green-500 italic capitalize">Available since 1.31.0</span>
