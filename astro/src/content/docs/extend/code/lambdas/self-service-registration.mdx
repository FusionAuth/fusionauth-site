...
tags: self-service registration lambda, registration validation, fusionauth lambda, custom form validation, advanced registration form
---
...
```javascript
function validate(result, user, registration, formContext, context) {
...
* `formContext` - an object containing data about the current form state. This object is read-only. This object has the following properties:
  ...
  - `step` - the current step number (see note below)
...
![Self-Service registration example form setup](/img/docs/extend/code/lambdas/self-service-reg-form-setup.png)

You will also add appropriate messaging to your theme.

![Self-Service registration example theme messages](/img/docs/extend/code/lambdas/self-service-reg-messages.png)
...
![Self-Service registration example blank form step](/img/docs/extend/code/lambdas/self-service-reg-form-blank.png)

When the user submits the wrong future auth provider FusionAuth will trigger the validation and supply the error message

![Self-Service registration example invalid form step](/img/docs/extend/code/lambdas/self-service-reg-form-invalid.png)
