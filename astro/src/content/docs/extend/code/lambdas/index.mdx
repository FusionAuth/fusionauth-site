...
As of FusionAuth 1.49, the only available Javascript engine is GraalJS.

As of FusionAuth 1.35, the choices of JavaScript engine were:

* Nashorn <span class="text-red-700">Removed in 1.49.0</span>
* GraalJS
...
<Aside type="caution">
  As of version 1.49 the Nashorn engine has been removed. Upon upgrading to 1.49 any existing lambdas using the Nashorn engine will be migrated to GraalJS.
</Aside>
...
The Nashorn JavaScript engine has officially been deprecated. The engine has been removed in 1.49.0. There are no known technical limitations that would require you to use the Nashorn engine instead of the GraalJS engine.
...
<Aside type="note">
As of version 1.49.0 the Nashorn engine has been removed from FusionAuth.
</Aside>
