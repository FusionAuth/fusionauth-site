...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/aKIWILh3qxM?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/_TnDUPQm3aQ?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
...
If the Identity Provider linking strategy is set to `Link Anonymously`, no lambdas will be used by FusionAuth. More information about the [Identity Provider linking strategies is available here](/docs/v1/tech/identity-providers/#linking-strategies).
