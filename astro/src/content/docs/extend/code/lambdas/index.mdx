...
<Aside type="caution">
  As of version 1.49 of FusionAuth the Nashorn engine has been removed. Upon upgrading to 1.49 any existing lambdas using the Nashorn engine will be migrated to GraalJS.
</Aside>
