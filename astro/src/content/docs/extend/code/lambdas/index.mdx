...
1. Specify a unique <InlineField>secret name</InlineField>, which you will use to access your secret from a lambda.
1. Specify your <InlineField>secret value</InlineField>.
