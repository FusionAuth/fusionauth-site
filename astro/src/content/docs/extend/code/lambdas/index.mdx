...
tags: fusionauth lambda, lambda function, custom code, javascript, jwt populate, custom claims, reconcile lambda, authentication hook, token customization
order: 0
---
...
<AvailableSince since="1.64.0"/>

Lambda secrets help you securely store secret values used in lambdas, like API keys and application passwords.
...
To view exception details, enable debugging on the lambda via the <Breadcrumb>Enable debug logging</Breadcrumb> toggle in the administrative user interface or the API.
