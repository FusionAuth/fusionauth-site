...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Steam configuration or click <strong>Add provider</Breadcrumb> and select Steam if it has not yet been configured.
