...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Epic Games configuration or click <UIelement>Add provider</UIelement> and select Epic Games if it has not yet been configured.
