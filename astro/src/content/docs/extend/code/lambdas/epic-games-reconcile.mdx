...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Epic Games configuration or click <strong>Add provider</Breadcrumb> and select Epic Games if it has not yet been configured.
