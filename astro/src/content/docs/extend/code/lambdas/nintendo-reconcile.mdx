...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Nintendo configuration or click <strong>Add provider</Breadcrumb> and select Nintendo if it has not yet been configured.
