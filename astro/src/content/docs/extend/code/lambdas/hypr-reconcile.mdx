...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing HYPR configuration or click <strong>Add provider</Breadcrumb> and select HYPR if it has not yet been configured.
