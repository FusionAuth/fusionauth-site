...
Navigate to <strong>Settings -> Identity Providers</strong> and select your existing HYPR configuration or click <strong>Add provider</strong> and select HYPR if it has not yet been configured.
