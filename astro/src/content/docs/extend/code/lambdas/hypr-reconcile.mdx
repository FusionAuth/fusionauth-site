...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing HYPR configuration or click <UIelement>Add provider</UIelement> and select HYPR if it has not yet been configured.
