...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Twitter configuration or click <UIelement>Add provider</UIelement> and select Twitter if it has not yet been configured.
