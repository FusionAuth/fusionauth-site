...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Twitter configuration or click <strong>Add provider</Breadcrumb> and select Twitter if it has not yet been configured.
