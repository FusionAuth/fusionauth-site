...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Xbox configuration or click <UIelement>Add provider</UIelement> and select Xbox if it has not yet been configured.
