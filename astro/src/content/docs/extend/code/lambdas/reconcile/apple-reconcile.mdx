...
tags: apple reconcile lambda, apple sign in, social login, fusionauth lambda, identity provider reconcile, custom claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Apple configuration or click <Breadcrumb>Add provider</Breadcrumb> and select Apple if it has not yet been configured.
