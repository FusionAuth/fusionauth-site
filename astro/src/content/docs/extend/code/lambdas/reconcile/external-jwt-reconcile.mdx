...
tags: external jwt reconcile lambda, external jwt provider, fusionauth lambda, identity provider reconcile, jwt claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing External JWT configuration or click <Breadcrumb>Add provider</Breadcrumb> and select External JWT if it has not yet been configured.
