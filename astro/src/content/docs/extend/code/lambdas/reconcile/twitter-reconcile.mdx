...
tags: twitter reconcile lambda, twitter login, social login, fusionauth lambda, identity provider reconcile, custom claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Twitter configuration or click <Breadcrumb>Add provider</Breadcrumb> and select Twitter if it has not yet been configured.
