...
tags: saml v2 reconcile lambda, saml reconcile, fusionauth lambda, identity provider reconcile, saml claims, custom attributes
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing a SAML v2 configuration or click <Breadcrumb>Add provider</Breadcrumb> and select SAML v2 if it has not yet been configured.
