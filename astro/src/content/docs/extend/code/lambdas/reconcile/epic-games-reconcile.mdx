...
tags: epic games reconcile lambda, epic games login, social login, fusionauth lambda, identity provider reconcile, custom claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Epic Games configuration or click <Breadcrumb>Add provider</Breadcrumb> and select Epic Games if it has not yet been configured.
