...
tags: playstation network reconcile lambda, psn login, gaming login, fusionauth lambda, identity provider reconcile, custom claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Sony PlayStation Network configuration or click <Breadcrumb>Add provider</Breadcrumb> and select Sony PlayStation Network if it has not yet been configured.
