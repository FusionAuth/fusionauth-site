...
tags: google reconcile lambda, google login, social login, fusionauth lambda, identity provider reconcile, custom claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Google configuration or click <Breadcrumb>Add provider</Breadcrumb> and select Google if it has not yet been configured.
