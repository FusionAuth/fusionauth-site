...
tags: twitch reconcile lambda, twitch login, social login, fusionauth lambda, identity provider reconcile, custom claims
---
...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Twitch configuration or click <Breadcrumb>Add provider</Breadcrumb> and select Twitch if it has not yet been configured.
