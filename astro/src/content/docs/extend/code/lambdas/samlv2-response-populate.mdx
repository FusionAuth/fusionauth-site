...
tags: saml v2 lambda, saml response populate, fusionauth lambda, identity provider, saml populate, custom attributes, saml idp
---
...
Once a lambda is created, you may assign it to one or more applications in the SAML configuration. See the <Breadcrumb>SAML</Breadcrumb> tab in the Application configuration.
