...
import LocalSnippet from 'src/components/LocalSnippet.astro';
...
<LocalSnippet filepath="extend/code/lambdas/samlv2-response-populate/signature.js" lang="javascript" />
...
<LocalSnippet filepath="extend/code/lambdas/samlv2-response-populate/example.js" lang="javascript" />
