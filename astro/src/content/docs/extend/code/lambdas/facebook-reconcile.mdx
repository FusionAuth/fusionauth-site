...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Facebook configuration or click <strong>Add provider</Breadcrumb> and select Facebook if it has not yet been configured.
