...
tags: lambda http connect, fetch, external api, fusionauth lambda, remote api call, http request from lambda, essentials plan
order: 10
---
import LambdaTypes from 'src/content/docs/_shared/_lambda-types.astro';
import MembershipLambda from 'src/content/docs/extend/code/_membership-lambda.mdx';
