...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Apple configuration or click <UIelement>Add provider</UIelement> and select Apple if it has not yet been configured.
