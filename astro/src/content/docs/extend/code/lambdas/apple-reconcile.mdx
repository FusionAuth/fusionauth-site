...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Apple configuration or click <strong>Add provider</Breadcrumb> and select Apple if it has not yet been configured.
