...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing LinkedIn configuration or click <strong>Add provider</Breadcrumb> and select LinkedIn if it has not yet been configured.
