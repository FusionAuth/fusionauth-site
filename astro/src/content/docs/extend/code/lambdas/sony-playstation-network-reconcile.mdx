...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Sony Playstation Network configuration or click <strong>Add provider</Breadcrumb> and select Sony Playstation Network if it has not yet been configured.
