...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Sony Playstation Network configuration or click <UIelement>Add provider</UIelement> and select Sony Playstation Network if it has not yet been configured.
