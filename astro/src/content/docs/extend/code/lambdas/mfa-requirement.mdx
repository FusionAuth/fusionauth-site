...
TODO - Explain that `eventInfo.location` will only be available if the [Advanced Threat Detection](/docs/operate/secure/advanced-threat-detection) feature is licensed.
