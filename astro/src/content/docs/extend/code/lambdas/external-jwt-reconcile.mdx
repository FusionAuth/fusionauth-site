...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing External JWT configuration or click <strong>Add provider</Breadcrumb> and select External JWT if it has not yet been configured.
