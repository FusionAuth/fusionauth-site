...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing External JWT configuration or click <UIelement>Add provider</UIelement> and select External JWT if it has not yet been configured.
