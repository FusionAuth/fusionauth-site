...
Navigate to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> and select your existing Twitch configuration or click <UIelement>Add provider</UIelement> and select Twitch if it has not yet been configured.
