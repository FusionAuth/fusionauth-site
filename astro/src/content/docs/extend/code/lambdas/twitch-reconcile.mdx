...
Navigate to <Breadcrumb>Settings -> Identity Providers</strong> and select your existing Twitch configuration or click <strong>Add provider</Breadcrumb> and select Twitch if it has not yet been configured.
