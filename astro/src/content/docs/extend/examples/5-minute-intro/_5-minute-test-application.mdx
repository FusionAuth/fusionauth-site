...
![The Node.js Application Home Screen](/img/docs/extend/examples/5-minute-intro/nodejs-application-login.png)

Click the <InlineUIElement>Login</InlineUIElement> link, this will take us to FusionAuth's login page.

![The Login Screen](/img/docs/extend/examples/5-minute-intro/login.png)
...
![Successful Login](/img/docs/extend/examples/5-minute-intro/login-succeeded.png)
...
![Login Without Registration](/img/docs/extend/examples/5-minute-intro/login-failed-registration-required.png)
