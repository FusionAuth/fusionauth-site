...
tags: sandbox, quick start, fusionauth sandbox, getting started, login tutorial, shared sandbox
cta: EmailListCTA
---
...
The sandbox also runs a licensed version of FusionAuth, so if you want to explore any of the [premium features](/docs/get-started/core-concepts/plans-features) without paying, you can use it to do so.
...
Navigate to the sandbox server, at [sandbox.fusionauth.io](https://sandbox.fusionauth.io).

Log in following the instructions on the login screen. 

![Sandbox Login](/img/docs/extend/examples/5-minute-intro/login-sandbox.png)

After doing so you'll arrive at the sandbox dashboard.

![Sandbox Dashboard](/img/docs/extend/examples/5-minute-intro/dashboard-sandbox.png)
