...
tags: fast path install, quick start, fusionauth install, getting started, login tutorial, fastpath
cta: EmailListCTA
---
...
```shell-session title="Testing the Postgresql Installation"
psql --version
```

```shell-session title="Result Of Testing the Postgresql Installation"
