...
```console title="Testing the Node.js Installation"
node -v
```

```console title="Result Of Testing the Node.js Installation"
v18.10.0
```
...
If you do not have a database installed, follow the instructions in our [Database Installation Guide](/docs/get-started/download-and-install/reference/database) to install a database. Below, you see commands to test if the PostgreSQL command line tool, `psql`, is present.

```console title="Testing the Postgresql Installation"
psql --version
```

```console title="Result Of Testing the Postgresql Installation"
