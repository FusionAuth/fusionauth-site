...
or anything else that might be required to use the application. In this guide, we will prompt the user to enter an address and then redirect him to the changes page.
...
On the Make Change page, you can now notice that the reson for the change is displayed if the amount is superior or equal to 500.
