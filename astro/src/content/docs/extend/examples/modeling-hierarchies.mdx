...
tags: entity management, hierarchical organizations, entity permissions, fusionauth entities, organizational hierarchy, b2b
---
...
Before continuing, please read the [review of FusionAuth types](/docs/get-started/core-concepts/types/) and how they relate. You need to understand these types well to adjust the hierarchical system design in this guide to suit your situation.
...
In this section, you'll write a script to get all the direct and indirect (through the company hierarchy) permissions a user has to all documents in FusionAuth. All you need is the user's email address or Id. Though this is a simple script, you can use exactly the same code after the user has logged in to your website with FusionAuth. (To learn how to make a simple Node.js website that uses FusionAuth, read the [QuickStart](/docs/get-started/quickstarts/web/express).)
