...
This section is a practical tutorial that shows you how to create a hierarchical organization model in FusionAuth, and write a script to determine a user's permissions to any entity in the hierarchy.
