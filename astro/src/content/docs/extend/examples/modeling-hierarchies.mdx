...
You can model the hierarchy using this schema:
...
When a new company or other entity is added, update the relationships to ensure access to the documents for that company. You can use the authorization SDKs to create and update the relationships between the corporations, companies, departments, documents and users.
