...
Fine-grained authorization (FGA) allows for more granular permissions than Entities. This includes:
...
* relationship based access control (ReBAC) where you can assign relationships and have authorization decisions be based on those, like granting access to a folder and all subfolders and files contained therein
