...
assuming a linear tree

You can see that the user has no permissions to the financial statements. In the FA web interface, browse to the list of users and manage Richard. Give him an entity grant with permission `Write` to the Change Bank entity.
