...
This guide will show two ways to extend the [Express](https://expressjs.com)-based [ChangeBank application](/docs/get-started/quickstarts/express) to limit concurrent logins.
