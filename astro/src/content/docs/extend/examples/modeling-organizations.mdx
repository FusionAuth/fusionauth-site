...
You can also checkout our companion application that implements the concepts in this guide at [https://github.com/fusionauth/example-modeling-organizations](https://github.com/fusionauth/example-modeling-organizations). The application repo includes a Kickstart file with all the settings detailed in this guide and a docker compose file to run FusionAuth locally. If you use the Kickstart and docker compose file, you can skip the setup steps below. Follow the steps in the [companion application's README](https://github.com/fusionauth/example-modeling-organizations/blob/main/README.md) to get setup.
