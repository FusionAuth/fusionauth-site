...
Next, copy the value in the <InlineField>Redirect URI</InlineField> read-only field. This should be something like <InlineFieldValue>https://idp.ngrok.com/oauth2/callback</InlineFieldValue>.
