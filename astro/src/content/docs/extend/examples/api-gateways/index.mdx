...
```mermaid title="API gateway sample architecture."
sequenceDiagram
...
[Hasura](https://hasura.io/learn/graphql/hasura-authentication/integrations/fusion-auth/) also provides external documentation for integrating with FusionAuth.
