...
Navigate to <Breadcrumb>Applications</Breadcrumb> and create a new application. Fill out the **Name** field, then click the <Breadcrumb>JWT</Breadcrumb> tab and toggle the <Breadcrumb>Enabled</Breadcrumb> switch. Select `Auto generate a new key on save...` for the **Access Token signing key** field. This will generate an RS256 asymmetric key pair specifically for this application.
