...
On the <Breadcrumb>JWT</Breadcrumb> tab, toggle the <Breadcrumb>Enabled</Breadcrumb> switch and set the <InlineField>Access Token signing key</InlineField> and <InlineField>Id Token signing key</InlineField> to <InlineFieldValue>Auto generate a new key on save...</InlineFieldValue>.
