...
On the <Breadcrumb>JWT</Breadcrumb> tab, toggle the <Breadcrumb>Enabled</Breadcrumb> switch and set the **Access Token signing key** and **Id Token signing key** to `Auto generate a new key on save...`.
