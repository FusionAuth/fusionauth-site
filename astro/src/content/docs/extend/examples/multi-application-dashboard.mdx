...
- Browse to FusionAuth at http://localhost:9011/admin and log in with <InlineFieldValue>admin@example.com</InlineFieldValue> and <InlineFieldValue>password</InlineFieldValue>.
