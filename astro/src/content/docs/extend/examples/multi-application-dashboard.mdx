...
tags: multi-application dashboard, idp-initiated login, application list, sso, fusionauth dashboard, app selector
---
...
- Click the <Icon name="edit" /> edit button in the Bank theme row's action column.
...
- Click the <Icon name="save" /> save button at the top right.
