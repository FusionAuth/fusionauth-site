...
- The screenshot belows a project called <InlineField>fauth</InlineField> and a database called <InlineField>fa</InlineField>.
  ![Aiven database connection details](/img/docs/extend/examples/segmentAivenDatabase.webp)
...
- ![DBeaver](/img/docs/extend/examples/segmentDbeaver.webp)
...
![Synchronize warehouse](/img/docs/extend/examples/segmentSyncWarehouse.webp)
...
- In Segment you should see your event arriving. You may have to refresh the page. If you cannot see your event, consult the troubleshooting section at the end of this guide.
  ![Segment event debugger](/img/docs/extend/examples/segmentEventReceived.webp)
...
- Browse to http://localhost:9011/admin/user and create a new user with any details you want.
  ![New FusionAuth user](/img/docs/extend/examples/segmentNewUser.webp)
- In the terminal you should see a notification from the filtering script:
  ```sh
