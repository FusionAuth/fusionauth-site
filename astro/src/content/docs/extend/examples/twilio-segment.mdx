...
It is assumed that you already have an instance of FusionAuth running locally that can be used to test this process. If you haven't already installed FusionAuth, follow our [Getting Started](/docs/get-started/start-here/step-1) guide first.
