...
![Google app selector](/img/docs/extend/examples/multiapplicationDashboard/googleGrid.png)
...
Use `git clone` to clone the repository at https://github.com/ritza-co/fusionauth-example-multiapp-dashboard, or download it and unzip. Open a terminal in the directory containing the repository files.
