...
Finally, add checks to your application code, including:
...
TODO The following example of a check [explain what the check does]:
TODO suggestion: This example is pretty large. We should provide some minimal explanation of what it does! If checks return either true or false, maybe we should explain that in the introduction of this section instead of in the introduction of an example?
