...
When the Kafka integration is enabled, all [webhook events](/docs/v1/tech/events-webhooks/events/) across all tenants will be sent to Kafka with all fields included.
...
Other fields applicable to the event may also be included. You can find the full schema for each event in the [webhook events](/docs/v1/tech/events-webhooks/events/) documentation.
