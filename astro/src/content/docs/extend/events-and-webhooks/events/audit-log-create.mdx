...
htmlTitle: Audit Log Create Event
description: Learn about the Audit Log Create event.
tags: audit log create event, webhook event, fusionauth webhook, audit log notification, audit event
---
...
<EventBody eventType={eventType}
  ...
  <APIField slot="leading-fields" name="event.auditLog" type="Object">
