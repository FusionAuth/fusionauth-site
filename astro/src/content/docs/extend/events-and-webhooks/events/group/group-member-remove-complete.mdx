---
title: Member Remove Complete
htmlTitle: Group Member Remove Complete Event
description: Learn about the Group Member Remove Complete.
tags: group member remove complete event, group webhook, fusionauth groups, webhook event, group membership
---
...
<EventBody eventType={eventType}
  ...
  <APIField slot="trailing-fields" name="event.linkedObjectId" type="UUID" since="1.53.0">
