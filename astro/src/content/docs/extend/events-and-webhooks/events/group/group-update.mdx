---
title: Update
htmlTitle: Group Update Event
description: Learn about the Group Update event.
tags: group update event, group webhook, fusionauth groups, webhook event, group management
---
