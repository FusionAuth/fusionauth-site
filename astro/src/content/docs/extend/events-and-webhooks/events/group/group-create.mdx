---
title: Create
htmlTitle: Group Create Event
description: Learn about the Group Create event.
tags: group create event, group webhook, fusionauth groups, webhook event, group management
---
