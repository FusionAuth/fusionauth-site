...
htmlTitle: Group Member Update Complete Event
description: Learn about the Group Member Update Complete event.
tags: group member update complete event, group webhook, fusionauth groups, webhook event, group membership
---
...
<Event name="Group Member Update Complete"
       eventType={eventType}
       version="1.38.0"
       description="This event is generated when updating members in group. The JSON includes the Group and an array of current members."
       scope="tenant"
       transactional="false" />

<EventBody eventType={eventType}
           jsonFile="group-member-update-complete.json">
