---
title: Member Add
htmlTitle: Group Member Add Event
description: Learn about the Group Member Add event.
tags: group member add event, group webhook, fusionauth groups, webhook event, group membership
---
...
<EventBody eventType={eventType}
           jsonFile="group-member-add.json">
  ...
  <APIField slot="leading-fields" name="event.members" type="Array">
