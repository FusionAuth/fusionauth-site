---
title: Member Remove
htmlTitle: Group Member Remove Event
description: Learn about the Group Member Remove event.
tags: group member remove event, group webhook, fusionauth groups, webhook event, group membership
---
...
<Event name="Group Member Remove"
       eventType={eventType}
       version="1.38.0"
...
<EventBody eventType={eventType}
           jsonFile="group-member-remove.json">
