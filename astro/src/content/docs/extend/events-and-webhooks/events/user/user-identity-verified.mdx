...
htmlTitle: User Identity Verified Event
description: Learn about the User Identity Verified event.
tags: user identity verified event, identity verification webhook, fusionauth user, webhook event
---
...
<Aside>
  The [User Email Verified](/docs/extend/events-and-webhooks/events/user/user-email-verified) event is also created when email identities are verified and will continue to function for compatibility reasons. This event is more generic and will be used for all identity verifications, including phone numbers.
</Aside>
