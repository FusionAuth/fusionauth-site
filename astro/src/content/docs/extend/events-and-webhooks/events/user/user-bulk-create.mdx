---
title: Bulk Create
htmlTitle: User Bulk Create Event
description: Learn about the User Bulk Create event.
tags: user bulk create event, bulk import webhook, fusionauth user, webhook event, user import
---
...
<Event description="This event is generated when multiple users are created via the [User Import API](/docs/apis/users/import). The JSON includes each of the Users that were created."
       eventType={eventType}
