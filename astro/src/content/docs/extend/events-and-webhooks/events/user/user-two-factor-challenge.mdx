...
htmlTitle: User Two-factor Challenge Event
description: Learn about the User Two-factor Challenge event.
tags: two-factor challenge event, mfa webhook, fusionauth user, webhook event, multi-factor authentication
---
...
export const eventType = 'user.two-factor.challenge';

<Event description="This event is generated when a two-factor challenge is started (before the user submits a code)."
       plan="enterprise"
       eventType={eventType}
...
<EventBody eventType={eventType}
           jsonFile="user-two-factor-challenge.json">
