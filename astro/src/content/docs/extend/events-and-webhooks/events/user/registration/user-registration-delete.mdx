---
title: Delete
htmlTitle: User Registration Delete Event
description: Learn about the User Registration Delete event.
tags: user registration delete event, registration webhook, fusionauth user, webhook event
---
...
<Event description="This event is generated when a user registration has been deleted."
       eventType={eventType}
...
<EventBody eventType={eventType}
           ...
           jsonFile="user-registration-delete.json">
