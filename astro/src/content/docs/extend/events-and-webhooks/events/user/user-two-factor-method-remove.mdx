---
title: Two-factor Method Remove
htmlTitle: User Two-factor Method Remove Event
description: Learn about the User Two-factor Method Remove event.
tags: two-factor method remove event, mfa webhook, fusionauth user, webhook event, multi-factor authentication
---
