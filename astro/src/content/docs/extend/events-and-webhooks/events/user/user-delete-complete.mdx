...
htmlTitle: User Delete Complete Event
description: Learn about the User Delete Complete event.
tags: user delete complete event, user webhook, fusionauth user, webhook event, user management
---
...
<Event description="This event is generated when a user delete transaction has completed.. The JSON includes the User that was deleted."
       eventType={eventType}
...
<EventBody eventType={eventType}
           jsonFile="user-delete-complete.json">
