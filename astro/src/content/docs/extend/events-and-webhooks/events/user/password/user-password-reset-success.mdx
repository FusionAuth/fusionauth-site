---
title: Reset Success
htmlTitle: User Password Reset Success Event
description: Learn about the User Password Reset Success event.
tags: password reset success event, password reset webhook, fusionauth user, webhook event
---
...
<Event description="This event is generated when the reset password flow has completed successfully."
       plan="enterprise"
       eventType={eventType}
...
<EventBody eventType={eventType}
           jsonFile="user-password-reset-success.json">
