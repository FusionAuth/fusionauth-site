---
title: Update
htmlTitle: User Registration Update Event
description: Learn about the User Registration Update event.
tags: user registration update event, registration webhook, fusionauth user, webhook event
---
...
<Event description="This event is generated when a user registration has been updated."
       eventType={eventType}
...
<EventBody eventType={eventType}
           ...
           jsonFile="user-registration-update.json">
