---
title: Success
htmlTitle: User Login Success Event
description: Learn about the User Login Success event.
tags: user login success event, login webhook, fusionauth authentication, webhook event, successful login
---
...
<Event description="This event is generated when a user completes a successful login."
       eventType={eventType}
...
<EventBody eventType={eventType}
           ...
           jsonFile="user-login-success.json">
