---
title: Update
htmlTitle: User Password Update Event
description: Learn about the User Password Update event.
tags: password update event, password change webhook, fusionauth user, webhook event
---
...
<Event description="This event is generated when a user's password has been updated."
       plan="enterprise"
       eventType={eventType}
