---
title: Two-factor Method Add
htmlTitle: User Two-factor Method Add Event
description: Learn about the User Two-factor Method Add event.
tags: two-factor method add event, mfa webhook, fusionauth user, webhook event, multi-factor authentication
---
