...
<Event eventType={eventType}
  ...
  This event is not generated when importing users via the [User Import API](/docs/apis/users#import-users). The [`user.bulk.create`](/docs/extend/events-and-webhooks/events/user/user-bulk-create) event is generated when importing users.
</Event>
