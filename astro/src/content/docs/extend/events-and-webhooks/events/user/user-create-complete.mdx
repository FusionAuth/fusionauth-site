...
htmlTitle: User Create Complete Event
description: Learn about the User Create Complete event.
tags: user create complete event, user webhook, fusionauth user, webhook event, user management
---
...
<Event eventType={eventType}
  ...
  This event is not generated when importing users via the [User Import API](/docs/apis/users/import). The [`user.bulk.create`](/docs/extend/events-and-webhooks/events/user/user-bulk-create) event is generated when importing users.
</Event>
...
<EventBody eventType={eventType}
  ...
  <APIField slot="trailing-fields" name="event.linkedObjectId" type="UUID" since="1.53.0">
    The Id of the user created by this event.
  </APIField>
