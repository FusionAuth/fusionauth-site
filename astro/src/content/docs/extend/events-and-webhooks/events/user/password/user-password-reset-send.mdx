---
title: Reset Send
htmlTitle: User Password Reset Send Event
description: Learn about the User Password Reset Send event.
tags: password reset send event, password reset webhook, fusionauth user, webhook event
---
...
<Event description="This event is generated when a reset password request has been sent."
       plan="enterprise"
       eventType={eventType}
...
<EventBody eventType={eventType}
           jsonFile="user-password-reset-send.json">
