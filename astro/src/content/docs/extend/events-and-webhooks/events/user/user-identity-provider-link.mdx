---
title: Identity Provider Link
htmlTitle: User Identity Provider Link Event
description: Learn about the User Identity Provider Link event.
tags: identity provider link event, social login webhook, fusionauth user, webhook event, idp link
---
