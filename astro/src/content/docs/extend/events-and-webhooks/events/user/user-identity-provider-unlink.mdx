---
title: Identity Provider Unlink
htmlTitle: User Identity Provider Unlink Event
description: Learn about the User Identity Provider Unlink event.
tags: identity provider unlink event, social login webhook, fusionauth user, webhook event, idp unlink
---
