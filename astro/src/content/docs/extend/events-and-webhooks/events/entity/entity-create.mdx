---
title: Create
htmlTitle: Entity Create Event
description: Learn about the Entity Create event.
tags: entity create event, entity webhook, fusionauth entity, webhook event, entity management event
---
...
export const eventType = 'entity.create';
