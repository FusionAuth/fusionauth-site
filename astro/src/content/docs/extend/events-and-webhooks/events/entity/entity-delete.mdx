---
title: Delete
htmlTitle: Entity Delete Event
description: Learn about the Entity Delete event.
tags: entity delete event, entity webhook, fusionauth entity, webhook event, entity management event
---
...
export const eventType = 'entity.delete';
