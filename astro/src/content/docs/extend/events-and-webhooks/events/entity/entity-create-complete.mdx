...
htmlTitle: Entity Create Complete Event
description: Learn about the Entity Create Complete event.
tags: entity create complete event, entity webhook, fusionauth entity, webhook event, entity management event
---
...
<Event name="Entity Create Complete"
       eventType={eventType}
       version="1.69.0"
       description="This event is generated when an entity is created. The JSON includes the Entity that was created."
       scope="tenant"
       transactional="false" />
