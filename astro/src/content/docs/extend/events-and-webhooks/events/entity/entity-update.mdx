---
title: Update
htmlTitle: Entity Update Event
description: Learn about the Entity Update event.
tags: entity update event, entity webhook, fusionauth entity, webhook event, entity management event
---
...
export const eventType = 'entity.update';
