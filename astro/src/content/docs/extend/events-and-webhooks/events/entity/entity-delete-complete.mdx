...
htmlTitle: Entity Delete Complete Event
description: Learn about the Entity Delete Complete event.
tags: entity delete complete event, entity webhook, fusionauth entity, webhook event, entity management event
---
...
export const eventType = 'entity.delete.complete';

<Event name="Entity Delete Complete"
       eventType={eventType}
       version="1.69.0"
       description="This event is generated when an entity is deleted. The JSON includes the Entity that was deleted."
       scope="tenant"
       transactional="false" />

<EventBody eventType={eventType}
           jsonFile="entity-delete-complete.json">
  ...
  <APIField slot="leading-fields" name="event.entity" type="Object">
    The entity that has been deleted. See the [Entity API](/docs/apis/entities/entities) for property definitions and example JSON.
  </APIField>
