---
title: Refresh Token Revoke
htmlTitle: JWT Refresh Token Revoke Event
description: Learn about the JWT Refresh Token Revoke event.
tags: jwt refresh token revoke event, token revocation webhook, fusionauth jwt, webhook event, logout event
---
