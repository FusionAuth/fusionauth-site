---
title: Public Key Update
htmlTitle: JWT Public Key Update Event
description: Learn about the JWT Public Key Update event.
tags: jwt public key update event, key rotation webhook, fusionauth jwt, webhook event, token security
---
