---
title: Refresh
htmlTitle: JWT Refresh Event
description: Learn about the JWT Refresh event.
tags: jwt refresh event, token refresh webhook, fusionauth jwt, webhook event, access token
---
...
<EventBody eventType={eventType}
  ...
  <APIField slot="trailing-fields" name="event.linkedObjectId" type="UUID" since="1.53.0">
    The Id of the JWT impacted by this event.
  </APIField>
