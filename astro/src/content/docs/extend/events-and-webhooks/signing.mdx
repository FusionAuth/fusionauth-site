...
Next, you configure your webhook to sign the event with this key. From <Breadcrumb>Settings -> Webhooks</strong>, click on the Edit button for your webhook (or create a new webhook). Select the <strong>Security</Breadcrumb> tab panel. Once you enable <InlineField>Sign events</InlineField>, a <InlineField>Signing key</InlineField> select dropdown allows you to choose the generated key. Be sure to click Save in the upper right corner.
