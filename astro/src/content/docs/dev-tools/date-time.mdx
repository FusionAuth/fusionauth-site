...
<div className="gap-6 grid grid-cols-[1fr_200px] items-center mt-8 no-prose">
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    ...
    <button data-widget="copy-button" data-copy-source="current-time-milliseconds" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Milliseconds</span>
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    <span id="current-time-seconds">Seconds</span>
    <button data-widget="copy-button" data-copy-source="current-time-seconds" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Seconds</span>
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    <span id="current-date">Date</span>
    <button data-widget="copy-button" data-copy-source="current-date" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Date</span>
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    <span id="current-time">Time</span>
    <button data-widget="copy-button" data-copy-source="current-time" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Time</span>
</div>
...
<div className="gap-6 grid grid-cols-[1fr_200px] items-center mt-8 no-prose">
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    ...
    <button data-widget="copy-button" data-copy-source="date-when-seconds" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Date (when seconds)</span>
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    <span id="date-when-milliseconds">Date (when milliseconds)</span>
    <button data-widget="copy-button" data-copy-source="date-when-milliseconds" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
...
<div className="gap-6 grid grid-cols-[1fr_200px] items-center mt-8 no-prose">
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    ...
    <button data-widget="copy-button" data-copy-source="seconds-since-epoch" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Seconds</span>
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    <span id="milliseconds-since-epoch">Milliseconds</span>
    <button data-widget="copy-button" data-copy-source="milliseconds-since-epoch" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>{/* eslint-disable-line */}
  </div>
  <span>Milliseconds</span>
</div>
