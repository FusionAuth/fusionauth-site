...
description: Create random 32-character unique identifiers for secure and standardized identification.
faIcon: fa-id-badge
color: red
---
...
<div className="flex gap-x-6 items-stretch mt-8 no-prose">
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    <span id="uuid-value">UUID</span>
    <button data-widget="copy-button" data-copy-source="uuid-value" className="flex items-center justify-center bg-slate-200 leading-4 w-10 h-8 rounded text-indigo-700 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" title="Copy contents"><Icon name="fa7-solid:copy" size={18} /></button>
  </div>
