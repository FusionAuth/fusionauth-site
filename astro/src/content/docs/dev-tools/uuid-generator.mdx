...
<div className="flex gap-x-6 items-stretch mt-8 no-prose">
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 ps-2 pe-1"]}>
    ...
    <button data-widget="copy-button" data-copy-source="uuid-value" title="Copy contents"><Icon pack="fa7-solid" name="copy" className="bg-slate-200 leading-4 py-2 px-2.5 rounded text-center text-indigo-700 w-10 dark:bg-slate-800 dark:text-indigo-400 dark:hover:bg-slate-700 dark:hover:text-indigo-400 hover:bg-slate-300 hover:text-indigo-600" /></button>
  </div>
  <button id="uuid-button" className="bg-blue-700 flex items-center px-6 py-1.5 rounded-lg text-white hover:bg-blue-800" type="button">
    <Icon pack="fa7-solid" name="sync" class="inline h-4" />
