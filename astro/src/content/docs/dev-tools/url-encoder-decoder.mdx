...
description: Convert special characters for safe transmission as URL parameters and decode encoded URLs.
tags: url encoder, url decoder, url encoding, query string, developer tools, online tool, percent encoding
faIcon: fa-globe
color: rose
---
