...
tags: jwt decoder, json web token, jwt debugger, token inspection, access token, refresh token, developer tools
faIcon: fa-brackets-curly
color: blue
---
import Textarea from "src/components/Textarea.astro";
import JWTDebugger from 'src/components/dev-tools/Jwt-Debug.astro'
...
{/* eslint-disable-line */}<h3 class="text-3xl mb-6 font-bold">Take JWTs further</h3>
{/* eslint-disable-line */}<p class="mb-10">JWTs are the backbone of modern authentication and authorization. See how FusionAuth lets you take ownership of your tokens and authentication, by installing for free with Docker.</p>
