...
{ }<h3 class="text-3xl mb-6 font-bold">Take JWTs further</h3>
{ }<p class="mb-10">JWTs are the backbone of modern authentication and authorization. See how FusionAuth lets you take ownership of your tokens and authentication, by installing for free with Docker.</p>
