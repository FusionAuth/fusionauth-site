...
* In the administrative user interface, navigate to <Breadcrumb>Tenants -> Your Tenant -> Password</strong> and then to the <strong>Cryptographic hash settings</Breadcrumb> section. Here you will configure both the new scheme and the rehash on login behavior.
