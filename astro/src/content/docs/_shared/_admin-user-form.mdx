...
Configure the FusionAuth admin UI to use these forms by navigating to <Breadcrumb>Tenants -> Your Tenant -> General</Breadcrumb> and then to the <InlineUIElement>Form settings</InlineUIElement> section. Set the <InlineField>Admin user form</InlineField> field to your new form.
