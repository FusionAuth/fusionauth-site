...
Create a form, by navigating to <Breadcrumb>Customizations -> Forms</Breadcrumb>. Select <Breadcrumb>Admin User</Breadcrumb> as the type. Add the needed sections and fields.
...
Configure the FusionAuth admin UI to use these forms by navigating to <Breadcrumb>Tenants -> Your Tenant -> General</Breadcrumb> and then to the <Breadcrumb>Form settings</Breadcrumb> section. Set the **Admin user form** field to your new form.

Learn more in the [Tenant documentation](/docs/get-started/core-concepts/types/tenants#general).
