...
Then, configure the FusionAuth admin UI to use these forms by navigating to <Breadcrumb>Applications -> Your Application -> Registration</Breadcrumb> and then to the <InlineUIElement>Form settings</InlineUIElement> section. Set the <InlineField>Admin Registration</InlineField> field to your new form.
