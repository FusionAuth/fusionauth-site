...
To remove your deployments, please [log into your account and navigate to your deployments](https://account.fusionauth.io/account/deployment/). Once you see your deployment, you can click the [uielement]#Action# button and select [uielement]#Delete#. After a deployment is destroyed, you won't be charged going forward for this instance going forward. Any previous usage outside of a free trial will be billed.
...
<img src="/img/docs/get-started/run-in-the-cloud/delete-account.png" alt="Deleting your account." width="1200" role="bottom-cropped" />
