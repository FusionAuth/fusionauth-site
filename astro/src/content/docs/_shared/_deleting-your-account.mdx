...
To remove your deployments, please [log into your account and navigate to your deployments](https://account.fusionauth.io/account/deployment/). Once you see your deployment, you can click the <InlineUIElement>Action</InlineUIElement> button and select <InlineUIElement>Delete</InlineUIElement>. After a deployment is destroyed, you won't be charged going forward for this instance going forward. Any previous usage outside of a free trial will be billed.
...
<img src="/img/docs/delete-account.png" alt="Deleting your account." width="1200" role="bottom-cropped" />
