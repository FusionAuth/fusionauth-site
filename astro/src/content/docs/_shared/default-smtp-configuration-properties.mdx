...
Since version `1.44.0`, the following two properties have default values:
  * `mail.smtp.timeout` has a default value of <InlineFieldValue>2000</InlineFieldValue>.
  * `mail.smtp.connectiontimeout` has a default value of <InlineFieldValue>2000</InlineFieldValue>.
