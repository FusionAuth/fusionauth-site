...
1. The `locale` request parameter, if present, on the HTTP request (e.g. `locale=fr`). This is useful if you already know the user's preferred locale prior to redirecting them to FusionAuth to complete authentication.
