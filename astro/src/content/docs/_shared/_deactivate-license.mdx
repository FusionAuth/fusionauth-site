...
Deactivating your license disables [premium functionality](/docs/get-started/core-concepts/plans-features) for the associated instance. This includes both using and managing that functionality. Any saved configurations aren't removed when the license is deactivated.
