...
![How to decommission the Reactor.](/img/docs/get-started/core-concepts/reactor-activated-decommission.png)

Deactivating your license will disable any [premium functionality](/docs/get-started/core-concepts/premium-features) for this instance. It will not affect any other instances using this license.
