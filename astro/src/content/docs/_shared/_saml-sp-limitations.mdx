...
Map between SAML claims and user claims using a [reconcile lambda](/docs/extend/code/lambdas/reconcile/samlv2-response-reconcile) or [FusionAuth SAMLv2 Identity Provider configuration](/docs/lifecycle/authenticate-users/identity-providers/).
