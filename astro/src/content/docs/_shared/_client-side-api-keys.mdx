...
If you are using one of the APIs which does not require an API key, such as the [change password API](/docs/apis/users/forgot-password), you can interact directly with the API.
