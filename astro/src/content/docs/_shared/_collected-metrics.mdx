...
If you are using FusionAuth Cloud, you will not see the same options as users who self-host. Your setup wizard will have the option to disable grayed out as seen here:

![Grayed out checkbox option in FusionAuth setup wizard](/img/docs/stats-setup-cloud.png)
