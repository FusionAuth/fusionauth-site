...
If you are using FusionAuth Cloud, you will not see the same options as users who self-host. Your setup wizard option to disable stats collection will be grayed out as seen here:

![Grayed out checkbox option in FusionAuth setup wizard](/img/docs/stats-setup-facloud.png)
