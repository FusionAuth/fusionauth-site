...
As of version 1.54.0, we have started collecting further usage data. We're committed to being up front about the data that we collect and how we use it. 
...
### What Steps are You Taking to Avoid Scope Creem and Collecting Ever-More Data?
