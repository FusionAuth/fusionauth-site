...
The alternative theming, which occurs at the tenant level and is included in the community edition, is [documented as well](/docs/customize/look-and-feel/overview).
