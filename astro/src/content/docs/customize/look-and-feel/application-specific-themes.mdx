...
The alternative theming, which occurs at the tenant level and is included in the community edition, is [documented as well](/docs/customize/look-and-feel/).
...
Next, you need to create a theme. Navigate to <Breadcrumb>Customizations -> Themes</Breadcrumb> and create a new theme.

<img src="/img/docs/customize/look-and-feel/add-theme.png" alt="Create a new theme." width="1200" role="bottom-cropped" />

Next, assign it to the application. Navigate to <Breadcrumb>Applications -> Your Application</Breadcrumb> and choose a theme from the list of themes.
