...
tags: password validation, client-side validation, password rules, javascript validation, password strength, user registration, password policy
---
...
FusionAuth provides password rules, configurable at the [tenant level](/docs/get-started/core-concepts/types/tenants). These include checks on a password value such as:
...
<ExtractedCode src="example-scripts/client-side-password-rules/FusionAuthPasswordChecker.js" lang="javascript" />
