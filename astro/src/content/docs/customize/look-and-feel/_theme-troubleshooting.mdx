...
### Theme will not "save" or retain changes

* If you have upgraded your version of FusionAuth and are using an Advanced Theming, likely you will need to make changes post upgrade.  Specifically, you will need to add or update the message bundle as well as any new pages present in the upgraded version (our UI has prompts for this).  FusionAuth will not save theme changes until these modifications are complete (a validation message in the UI will be present)
* The video below covers what you can expect here:
