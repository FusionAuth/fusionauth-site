...
### Theme not allowing for "save"

* If you have upgraded your version of FusionAuth and are using an Advanced Theming, likely you will need to make changes to your theme.  You will need to add or update the theme message bundle as well as any new pages present in the upgraded version (our UI has prompts for this).
