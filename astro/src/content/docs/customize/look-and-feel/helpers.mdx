...
* `captchaBadge`
  * Macro that adds a CAPTCHA badge to the template. See [template variables](/docs/v1/tech/themes/template-variables/) for more information on the template variables. The macro's parameters are:
