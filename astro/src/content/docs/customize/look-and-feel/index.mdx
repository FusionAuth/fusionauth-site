...
<Aside type="version">
  If you are using [simple themes](/docs/customize/look-and-feel/simple-theme-editor) then new messages will automatically be applied to your theme after an upgrade, the only thing stored in your theme are customizations that override the default text.

  Simple themes are available starting in version 1.51.0.
</Aside>
