...
**OPTIONAL - ONLY NEEDED FOR ADVANCED THEMES WITH NON-TEXT CUSTOM FORM CONTROLS ON ONE OF THESE TEMPLATES: ACCOUNT EDIT, OAUTH2 REGISTER, OR OAUTH2 COMPLETE REGISTRATION**
...
You need to apply the updates below only if all the following are true:
...
If any of these conditions are false, no template updates are required. If all conditions are true, apply the updates below to your advanced theme.
