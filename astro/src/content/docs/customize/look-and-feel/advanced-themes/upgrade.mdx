...
<Aside type="caution">
If you are upgrading from a version prior to FusionAuth `1.61.2` and you have customized your theme, upgrade to `1.61.2` first, add missing templates to your theme, then upgrade to `1.62.0`.
