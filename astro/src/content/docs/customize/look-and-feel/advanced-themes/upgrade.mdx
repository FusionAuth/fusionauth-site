...
**OPTIONAL - ONLY NEEDED IF YOU OVERRIDE THESE TEMPLATES**

Version `1.69.0` updates the default theme templates to display labels for custom form fields. If your advanced theme includes customized versions of these templates, update them as described below.
