...
tags: freemarker macros, theme helpers, theme templates, advanced theme, html helpers, fusionauth theme, recaptcha
---
...
The `_helpers.ftl` template provides a macro to embed [CAPTCHA challenges](/docs/get-started/core-concepts/types/tenants#captcha-settings) into your templates.
