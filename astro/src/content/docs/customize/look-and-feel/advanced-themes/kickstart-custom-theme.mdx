---
title: Add a Theme to a Kickstart
description: Learn how to use Kickstart to create a FusionAuth Instance with a custom theme.
tags: kickstart, custom theme, theme automation, docker setup, theme deployment, freemarker, login page customization, branding
---
...
![Application settings.](/img/docs/customize/look-and-feel/app-settings.png)
...
![Manage user.](/img/docs/customize/look-and-feel/manageuser.png)
...
![Preview theme](/img/docs/customize/look-and-feel/preview-oauth.png)

The OAuth logout template looks like this:

![OAuth logout FusionAuth](/img/docs/customize/look-and-feel/preview-oauth-logout.png)

We are going to create a dark theme so these templates that will look like this:

![OAuth authorize Dark](/img/docs/customize/look-and-feel/preview-authorize-dark.png)

![OAuth logout Dark](/img/docs/customize/look-and-feel/preview-logout-dark.png)
...
If you'd like to skip ahead to the <Breadcrumb>Running Kickstart</Breadcrumb> section, you can [download the completed files here](https://github.com/FusionAuth/fusionauth-example-kickstart/tree/main/theme-css-only).
...
Let's define one CSS rule together. First, preview the FusionAuth theme and open up the web inspector by right-clicking and selecting "Inspect". Click the <Breadcrumb>Select element</Breadcrumb> button and click the area of the page you would like to style, for example, the `div` element with the class `.panel`.

![Panel background color](/img/docs/customize/look-and-feel/div-panel-bg.png)

This element has a `background` property with a value of `#fff`, or pure white.

Let's change the background from white to black. With the element selected, click the plus <Breadcrumb>+</Breadcrumb> icon and type `background: black`.

![Panel background color](/img/docs/customize/look-and-feel/background-black.png)

We've just defined our first `css` rule. Copy the text that you generated, including the part that the browser made for you when you clicked the plus <Breadcrumb>+</Breadcrumb> icon, into a text editor and save it as `darkTheme.css`, like this:
...
To enable Kickstart to run from this `docker-compose.yml` file, we must make some modifications. They are described in detail at [this link](/docs/get-started/download-and-install/docker) and copied here for your convenience:
...
You will be taken to the same landing page that you saw in the 5-minute guide. However, when you click <Breadcrumb>Login</Breadcrumb> this time, you will see your custom theme applied to the OAuth authorize page.

![Dark theme applied](/img/docs/customize/look-and-feel/dark-authorize.png)

Enter the same credentials you used to login to the admin panel and click <Breadcrumb>Logout</Breadcrumb> to see the OAuth logout page.
...
![Forgot password](/img/docs/customize/look-and-feel/forgot-password.png)
...
The messages can be accessed by editing your custom theme, navigating to the <Breadcrumb>Messages</Breadcrumb> page, and clicking the <Breadcrumb>Edit</Breadcrumb> button.

![Theme messages](/img/docs/customize/look-and-feel/messages.png)
...
![Updated message](/img/docs/customize/look-and-feel/updated-message.png)
