---
title: Customize Advanced Themes
...
tags: advanced theme editor, freemarker, theme customization, login page customization, html templates, css customization, branding, white label
order: 0
---
...
<Aside type="note">
Since version `1.51.0`, you can instead use the [Simple Theme Editor](/docs/customize/look-and-feel/simple-theme-editor) to quickly and easily style FusionAuth with no code.
...
Navigate to <Breadcrumb>Customizations -> Themes</Breadcrumb>. Choose your theme, then click <IconButton icon="view" />:

![Preview your theme](/img/docs/customize/look-and-feel/theme-preview-button.png)

This will open a new tab. Click on any of the pages you've modified in the left hand navigation, for example <Breadcrumb>OAuth register</Breadcrumb>, and you'll see the page as it would be rendered.
