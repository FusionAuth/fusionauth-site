...
If you can meet your look and feel customization needs by only modifying the CSS file, rather than the theme templates, upgrades to later versions of FusionAuth will be easier.

When you limit yourself to making CSS changes, you'll still need to review the release notes and verify that any new pages introduced look good, but you won't have to propagate customized template changes.
