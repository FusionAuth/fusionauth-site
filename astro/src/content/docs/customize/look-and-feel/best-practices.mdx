...
- use the [Advanced Theme Editor](http://localhost:3000/docs/customize/look-and-feel/advanced-theme-editor) to overhaul everything with custom CSS and JS, using the [Java FreeMarker template language](https://freemarker.apache.org/).
- write custom pages in your own app that call the [FA API for authentication](http://localhost:3000/docs/apis/authentication).
