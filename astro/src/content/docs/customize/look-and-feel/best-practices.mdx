...
Make labels clickable and make the label focus its related textbox on click. This looks like:
```html
...
This includes HTML5, OAuth 2, and cross-browser compatibility with functions like [autocomplete](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete) and password managers.
