...
- ✅ Links between pages. Because the page uses tabs, links aren't needed.
...
- ✅ VPN safe · Country restrictions. <Breadcrumb>Settings -> IP Access Control</Breadcrumb> handles IP restrictions. This setting is independent of the theme. By default there are no restrictions, which is fine.
