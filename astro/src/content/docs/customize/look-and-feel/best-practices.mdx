...
- Minimal. At first, the page might look minimal, but interactions show it lacks attention to detail and hasn't been tested. For example, if your password at login is incorrect, the error is shown in two places and the toast moves the entire page, instead of floating above it.
  ![Invalid password clutter](../../../../../public/img/docs/customize/look-and-feel/best-practices/invalidClutter.webp)
  Additionally, on the forgot password page, there is an unnecessary person logo and unstyled spacing. These small flaws say a lot about the lack of the attention to detail of your business.
...
- Colorblind safe. You can use a website like [Pilestone](https://pilestone.com/pages/color-blindness-simulator) to see how an image appears with various forms of colorblindess.
  ...
  However, the simplest test is to remove color all together and preview your site in black and white. If any information is conveyed exclusively by color, it should be improved. For example, on this page the invalid password message is red but with no exclamation symbol. To preview an entire site in black and white, use your browser developer tools. In Chromium-based browsers, you can find the "rendering" setting from the "more tools" option.
  ![Rendering tools](../../../../../public/img/docs/customize/look-and-feel/best-practices/renderingTools.webp)
  As well as previewing color problems, you can also preview your site blurred or at reduced contrast. In the image below you can see a user with contrast issues would struggle to read the fields hint text and that should be improved — something already noted earlier in the clickable labels practice.
  ![Rendering tools](../../../../../public/img/docs/customize/look-and-feel/best-practices/reducedContrast.webp)
