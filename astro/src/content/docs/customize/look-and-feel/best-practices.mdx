...
- ✅ Few KB. To test page load speed, you can choose data throttling (shown in the screenshot above). This theme loads quickly, and is a point in favor of removing the large game screenshots shown in the desktop version of the site.
