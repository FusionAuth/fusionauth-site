...
You can look at <Breadcrumb>Applications</strong>, <strong>Users</strong>, and <strong>Customizations -> Themes</Breadcrumb> to verify that all of the settings have been configured correctly.
