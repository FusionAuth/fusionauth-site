...
You can keep using this process to add rules to your `darkTheme.css` file until you've got a fully defined style that you're happy with. Feel free to use [this file](https://github.com/FusionAuth/fusionauth-example-kickstart-theme/blob/main/theme-css-only/darkTheme.css) for this tutorial.
