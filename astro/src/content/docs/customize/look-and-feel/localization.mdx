...
<img src="/img/docs/customize/look-and-feel/messages-tab-localization.png" alt="The Messages tab in the theme editor showing localization options" width="1600" role="bottom-cropped" />
