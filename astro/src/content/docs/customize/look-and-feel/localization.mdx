...
tags: theme localization, internationalization, i18n, message bundles, language support, translation, locale, multilingual
---
...
In the <Breadcrumb>Messages</Breadcrumb> tab of your theme editor you may specify one to many languages. Once you have specified a key and value the key may be used in any template to display a localized string.
