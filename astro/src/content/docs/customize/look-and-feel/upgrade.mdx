...
Add the following JavaScript to the `head` macro to enable the show password toggle button functionality. This code should be added inside the `<script>` tag, after the `FusionAuth.Version = "${version}";` line.
