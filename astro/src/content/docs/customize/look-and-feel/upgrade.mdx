...
User passwords are optional starting in version `1.59.0`. While theme updates are not required, there are some areas that you may want to consider making changes:
