...
<Aside type="note">
For an explanation of how to upgrade a custom theme, see [Upgrade an Advanced Theme](/docs/customize/look-and-feel/upgrade-advanced-theme).
</Aside>
...
See [Theme Upgrades](/docs/customize/look-and-feel/upgrade-advanced-theme) for additional information about the upgrade process.
</Aside>
