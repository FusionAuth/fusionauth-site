...
<Aside type="danger">
    If you are upgrading from a version prior to FusionAuth 1.59.0, you will need to add several templates to your custom theme, as part of the upgrade process. Please contact support before upgrading for assistance.
</Aside>
