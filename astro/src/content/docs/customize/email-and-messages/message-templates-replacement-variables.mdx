...
import RegistrationVerificationPhone from 'src/content/docs/_shared/message/_registration-verification-txt.mdx';
...
import BreachedPasswordPhone from 'src/content/docs/_shared/message/_breached-password-txt.mdx';
...
<APIBlock>
  ...
  <APIField name="verificationId" type="String">
    The verification Id intended to be used by the [Verify Phone](/docs/apis/users#verify-a-users-phone) API.
  </APIField>
...
<APIBlock>
  ...
  <APIField name="verificationOneTimeCode" type="String">
    The verification One Time Code to be used with the Gated Registration workflow. The user enters this code to verify their phone number.
  </APIField>
</APIBlock>
