...
description: Learn which replacement variables and corresponding message templates are available.
---
...
import AdminTwoFactorRemovePhone from 'src/content/docs/_shared/message/_admin-two-factor-remove-txt.mdx';
