...
- [Troubleshoot](#troubleshoot)
  ...
  - [Free Accounts May Send Only To Specified Targets](#free-accounts-may-send-only-to-specified-targets)
...
### Free Accounts May Send Only To Specified Targets
...
You will get this error with Mailgun and other providers that limits their free services. To fix it, add your target email address in the allowed list of receivers in the SMTP provider's settings.
