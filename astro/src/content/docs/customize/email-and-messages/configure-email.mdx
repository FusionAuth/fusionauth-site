...
- Gmail — require phone authentication, and email is intended only for small tests.
...
- Mailgun — require domain authentication, phone authentication, and limited to five recipient addresses.
...
They automatically disable your account on sign-up and require you to manually contact to support to have it activated. Generally this involves having a business website ready for review, explaining what your purpose in sending email is, and explaining how you obtained your recipients' email addresses.
