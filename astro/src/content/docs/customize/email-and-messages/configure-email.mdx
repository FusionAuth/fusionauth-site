...
This section lists some recommendations by SMTP providers. Your primary aim should be to keep your sender reputation high to avoid emails being marked as spam.
...
- Send as few emails to users as possible to avoid emails being marked as spam.
...
Send your transactional email and your marketing email through different IP addresses, as marketing email is more likely to be marked as spam. (Since FusionAuth is entirely transactional email, you don't need to take any action here.)
