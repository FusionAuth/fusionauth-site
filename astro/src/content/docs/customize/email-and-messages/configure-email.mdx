...
We want to add more comprehensive documentation to Fusionauth about how to set up various SMTP providers
...
Also restructure the current document to put a ‘best practices’  section at the top, before going into each provider that covers
