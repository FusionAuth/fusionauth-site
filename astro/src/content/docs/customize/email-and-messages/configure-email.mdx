...
- Send your transactional email and your marketing email through different IP addresses, as marketing email is more likely to be marked as spam. FusionAuth uses only transactional email.
