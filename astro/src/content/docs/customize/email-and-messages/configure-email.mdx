...
These providers automatically disable your account on signup and require you to contact to support to have it activated. This involves having a business website ready for review, explaining what your purpose in sending email is, and explaining how you obtained your recipients' email addresses. However, Mailgun and Brevo support were friendly, quick, and unlocked the FusionAuth test account after reasonable discussion. SendGrid is most onerous provider, with full company details needed for ever sender address.

The worst provider is Mailchimp (Mandrill). Mailchimp was the only SMTP provider that refused to provide FusionAuth an account, without any explanation except accusations of prohibited content. Mailchimp support was poor — entirely automated and no human could be contacted.

Be aware that providers can cancel your account at any time, without explanation or chance to appeal. This can cripple your business.
