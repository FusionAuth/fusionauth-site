...
tags: customize messages, customize email messages, custom
---
...
Message templates are used by messengers. Templates support both SMS and Voice message types. Just as with emails, these can be customized and localized, but unlike email templates, there are not HTML and text versions of a messenger template.
