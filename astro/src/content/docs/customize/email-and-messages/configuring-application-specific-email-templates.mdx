...
First, navigate to <Breadcrumb>Tenant -> Email -> Template Settings -> Forgot Password</Breadcrumb>. Select `Forgot Password` from the dropdown, then click the blue save icon.
