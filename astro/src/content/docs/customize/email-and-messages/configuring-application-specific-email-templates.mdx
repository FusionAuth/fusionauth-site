...
Make sure you've created an Application in the <Breadcrumb>Application overview</Breadcrumb>. Then navigate to your application login page by clicking on <Breadcrumb>Applications</Breadcrumb> in the navigation sidebar, selecting <IconButton icon="view"/>, and copying and pasting the [Login URL](/docs/get-started/core-concepts/applications) into an incognito browser.
