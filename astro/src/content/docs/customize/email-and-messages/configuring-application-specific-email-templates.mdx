...
Make sure you've created an Application in the [Application overview]. Then navigate to your application login page by clicking on <Breadcrumb>Applications</Breadcrumb> in the navigation sidebar, selecting the green magnifying glass icon, and copying and pasting the [<InlineUIElement>Login URL</InlineUIElement>](/docs/get-started/core-concepts/applications) into an incognito browser.
