...
<APIBlock>
  ...
  <APIField name="Debug enabled" optional>
    When enabled, each message sent using this messenger will generate a new Debug Event Log which can be viewed using the Event Log API or from the admin UI by navigating to <strong>Sytem -> Event Log</strong>.
  </APIField>
</APIBlock>
