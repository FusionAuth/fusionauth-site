---
title: Add a Custom Generic Messenger
description: Learn how to add and configure generic messengers.
tags: generic messenger, custom messenger, sms integration, push notification, messaging configuration, webhook messenger, http messenger
order: 2
---
...
To create a new generic messenger, navigate to <Breadcrumb>Settings -> Messengers</Breadcrumb>. Click <Breadcrumb>Add Generic Messenger</Breadcrumb> from the dropdown in the upper right.

## Add Generic Messenger

![Add Generic Messenger Home](/img/docs/customize/email-and-messages/add-generic-messenger-home-crop.png)
...
<APIBlock>
  ...
  <APIField name="Message types" required since="1.65.0">
...
![Generic Messenger Security Tab](/img/docs/customize/email-and-messages/security-sub-add-generic.png)
...
![Generic Messenger Headers Tab](/img/docs/customize/email-and-messages/headers-sub-add-generic-crop.png)
...
![Test Configuration Generic](/img/docs/customize/email-and-messages/configuration-test-generic.png)

You also can test your generic messenger configuration. By hitting <Breadcrumb>Test generic configuration</Breadcrumb> FusionAuth will fire a JSON message to the messenger to ensure everything is set up correctly.
...
<APIBlock>
  <APIField name="code" type="String">
    The multi-factor code embedded in the message.
  </APIField>
  ...
  <APIField name="message" type="String">
    The voice message text to send. This is built from the configured [message template](/docs/customize/email-and-messages/message-templates) and is localized.
  </APIField>
  <APIField name="type" type="String">
    The type of the message. This will be either `SMS` or `Voice`.
  </APIField>
  <APIField name="userId" type="UUID">
    The unique Id for the user to whom the message is being sent.
  </APIField>
</APIBlock>
