...
You also can test your generic messenger configuration. By hitting <InlineUIElement>Test generic configuration</InlineUIElement> FusionAuth will fire a JSON message to the messenger to ensure everything is set up correctly.
