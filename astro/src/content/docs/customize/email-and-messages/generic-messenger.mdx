...
To create a new generic messenger, navigate to <Breadcrumb>Settings -> Messengers</Breadcrumb>. Click `Add Generic Messenger` from the dropdown in the upper right.
