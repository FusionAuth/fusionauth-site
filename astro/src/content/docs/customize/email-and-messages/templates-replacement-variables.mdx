...
import ConfirmChildAccountHTML from 'src/content/docs/_shared/email/_confirm-child-account-html.mdx';
import ConfirmChildAccountText from 'src/content/docs/_shared/email/_confirm-child-account-text.mdx';
import TwoFactorAuthenticationMethodRemovedHTML from 'src/content/docs/_shared/email/_two-factor-authentication-method-removed-html.mdx';
import TwoFactorAuthenticationMethodRemovedText from 'src/content/docs/_shared/email/_two-factor-authentication-method-removed-text.mdx';
import COPPANoticeHTML from 'src/content/docs/_shared/email/_coppa-notice-html.mdx';
import COPPANoticeText from 'src/content/docs/_shared/email/_coppa-notice-text.mdx';
import ParentRegistrationHTML from 'src/content/docs/_shared/email/_parent-registration-html.mdx';
import ParentRegistrationText from 'src/content/docs/_shared/email/_parent-registration-text.mdx';
import RegistrationVerificationHTML from 'src/content/docs/_shared/email/_registration-verification-html.mdx';
import RegistrationVerificationText from 'src/content/docs/_shared/email/_registration-verification-text.mdx';
import PasswordlessLoginHTML from 'src/content/docs/_shared/email/_passwordless-login-html.mdx';
import PasswordlessLoginText from 'src/content/docs/_shared/email/_passwordless-login-text.mdx';
import SetupPasswordHTML from 'src/content/docs/_shared/email/_setup-password-html.mdx';
import SetupPasswordText from 'src/content/docs/_shared/email/_setup-password-text.mdx';
import BreachedPasswordNotificationHTML from 'src/content/docs/_shared/email/_breached-password-notification-html.mdx';
import BreachedPasswordNotificationText from 'src/content/docs/_shared/email/_breached-password-notification-text.mdx';
import COPPANoticeReminderHTML from 'src/content/docs/_shared/email/_coppa-notice-reminder-html.mdx';
import COPPANoticeReminderText from 'src/content/docs/_shared/email/_coppa-notice-reminder-text.mdx';
import ForgotPasswordHTML from 'src/content/docs/_shared/email/_forgot-password-html.mdx';
import ForgotPasswordText from 'src/content/docs/_shared/email/_forgot-password-text.mdx';
import TwoFactorAuthenticationHTML from 'src/content/docs/_shared/email/_two-factor-authentication-html.mdx';
import TwoFactorAuthenticationText from 'src/content/docs/_shared/email/_two-factor-authentication-text.mdx';
import EmailVerificationHTML from 'src/content/docs/_shared/email/_email-verification-html.mdx';
import EmailVerificationText from 'src/content/docs/_shared/email/_email-verification-text.mdx';
import ThreatDetectedHTML from 'src/content/docs/_shared/email/_threat-detected-html.mdx';
import ThreatDetectedText from 'src/content/docs/_shared/email/_threat-detected-text.mdx';
import TwoFactorAuthenticationMethodAddedHTML from 'src/content/docs/_shared/email/_two-factor-authentication-method-added-html.mdx';
import TwoFactorAuthenticationMethodAddedText from 'src/content/docs/_shared/email/_two-factor-authentication-method-added-text.mdx';
...
To get all the latest email templates at once, you can run the following command in your desired destination directory:
...
<BreachedPasswordNotificationHTML />

<BreachedPasswordNotificationText />
...
<ConfirmChildAccountHTML />

<ConfirmChildAccountText />
...
<COPPANoticeReminderHTML />

<COPPANoticeReminderText />
...
<TwoFactorAuthenticationMethodAddedHTML />

<TwoFactorAuthenticationMethodAddedText />
...
<TwoFactorAuthenticationMethodRemovedHTML />

<TwoFactorAuthenticationMethodRemovedText />
