...
<Aside type="version">
The <Breadcrumb>Send Test Email</Breadcrumb> button has been available since 1.16.0
</Aside>
...
![Sending a test email](/img/docs/customize/email-and-messages/send-test-email.png)
