...
tags: two-factor authentication, twilio push, sms authentication, deprecated, multi-factor authentication, push notification
---
...
![Example Push Configuration](/img/docs/customize/email-and-messages/deprecated/example-enable-push.png)
...
<API method="POST" uri="/api/two-factor/send"/>
...
request to the [Complete Two-Factor Authentication](/docs/apis/login/complete-mfa) API.
