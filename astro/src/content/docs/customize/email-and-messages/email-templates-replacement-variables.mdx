...
tags: email template variables, replacement variables, freemarker, email template customization, forgot password template, email verification template, email branding
---
...
import AdminTwoFactorRemoveHTML from 'src/content/docs/_shared/email/_admin-two-factor-remove-html.mdx';
import AdminTwoFactorRemoveText from 'src/content/docs/_shared/email/_admin-two-factor-remove-txt.mdx';
...
<APIBlock>
  ...
  <APIField name="baseUrl" type="String" since="1.68.0">
...
<AdminTwoFactorRemoveHTML />

<AdminTwoFactorRemoveText />

#### Replacement Variables

<APIBlock>
  <APIField name="method" type="Object" since="1.68.0">
  ...
  <APIField name="tenant" type="Tenant" since="1.68.0">
    The Tenant object, see the [Tenant API](/docs/apis/tenants) for field definitions.
  </APIField>
  <APIField name="user" type="User" since="1.68.0">
    The User object, see the [User API](/docs/apis/users) for field definitions of a User.
  </APIField>
</APIBlock>
