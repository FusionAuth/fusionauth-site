...
To configure a messenger, navigate to <strong>Settings-> Messengers</strong> and click on the appropriate messenger type in the top right.
...
To configure a message template, navigate to <strong>Customizations -> Message Templates</strong>.
