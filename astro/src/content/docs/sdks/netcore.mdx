---
title: .NET Core Client Library
description: The FusionAuth .NET Core Client library allows you to call FusionAuth from a .NET Core application.
tags: .net client library, c# sdk, dotnet sdk, fusionauth dotnet, asp.net, c# authentication
---
...
- `--client-id` is the [Client Id](/docs/get-started/core-concepts/types/applications) associated with your application. The default value is `3c219e58-ed0e-4b18-ad48-f4f92793ae32`.
...
To create a new project from a template, first create or open a Solution. Then select <Breadcrumb>File -> New Project</Breadcrumb>. In the <Breadcrumb>New Project</Breadcrumb> dialog, select <Breadcrumb>Custom</Breadcrumb> from the left-hand menu. Select the FusionAuth template you want to use and click <Breadcrumb>Continue</Breadcrumb>. Fill in the required information, including the fully qualified URL to your FusionAuth server and your FusionAuth Application Client Id. Click <Breadcrumb>Continue</Breadcrumb>.

Set the project name and click <Breadcrumb>Create</Breadcrumb>.

#### Visual Studio for Windows

FusionAuth .NET templates require Visual Studio for Windows version 17.6 or higher. 

To create a new project from a template, first create or open a Solution. Then select <Breadcrumb>File -> New Project</Breadcrumb>. In the <Breadcrumb>New Project</Breadcrumb> dialog, select `FusionAuth` from the **All project types** dropdown. Select the FusionAuth template you want to use. Set the project name and click <Breadcrumb>Next</Breadcrumb>. Fill in the required information, including the fully qualified URL to your FusionAuth server and your FusionAuth Application Client Id.
