...
In this scenario, you should disable **Require authentication** in the FusionAuth Application configuration and use [PKCE](https://tools.ietf.org/html/rfc7636) to secure communication with the Token endpoint.
