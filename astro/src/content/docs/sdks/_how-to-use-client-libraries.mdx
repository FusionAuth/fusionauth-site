...
First, they can be used to access the FusionAuth [APIs](/docs/apis/overview) in a familiar format, leveraging language features like auto-completion.
...
All the client libraries use the [REST API](/docs/apis/overview).
