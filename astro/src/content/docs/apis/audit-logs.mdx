...
<APIAuthentication icon="lock">Create an Audit Log</APIAuthentication>
<APIURI method="POST">/api/system/audit-log</APIURI>
...
<APIAuthentication icon="lock">Retrieve an Audit Log by Id</APIAuthentication>
<APIURI method="GET">/api/system/audit-log/`{logId}`</APIURI>
...
<APIAuthentication icon="lock">Searches the Audit Logs using the given search criteria</APIAuthentication>
<APIURI method="GET">/api/system/audit-log/search`?message={message}&start={start}&end={end}&user={user}`</APIURI>
...
<APIAuthentication icon="lock">Searches the Audit Logs using the given search criteria</APIAuthentication>
<APIURI method="POST">/api/system/audit-log/search</APIURI>
...
<APIAuthentication icon="lock">Export the Audit Logs matching the criteria</APIAuthentication>
<APIURI method="GET">/api/system/audit-log/export`?message={message}&start={start}&end={end}&user={user}`</APIURI>
...
<APIAuthentication icon="lock">Export the Audit Logs matching the criteria</APIAuthentication>
<APIURI method="POST">/api/system/audit-log/export</APIURI>
