...
<APIBlock>
  ...
  <APIField name="auditLog.tenantId" type="UUID" optional>
...
<APIBlock>
  ...
  <APIField name="auditLog.tenantId" type="UUID">
    The Id of the Tenant associated with this Audit Log. This field may be null for instance-scoped audit logs.
  </APIField>
...
<APIBlock>
  ...
  <APIField name="search.tenantId" type="UUID" optional>
    Restricts the results to Audit Logs belonging to the given Tenant. This parameter will be overridden if the request contains an `X-FusionAuth-TenantId` header, or if the supplied API key is scoped to a specific Tenant.
  </APIField>
...
<APIBlock>
  ...
  <APIField name="auditLogs[x].tenantId" type="UUID">
    The Id of the Tenant associated with this Audit Log. This field may be null for instance-scoped audit logs.
  </APIField>
...
<APIBlock>
  ...
  <APIField name="criteria.tenantId" type="UUID" optional>
    Restricts the results to Audit Logs belonging to the given Tenant. This parameter will be overridden if the request contains an `X-FusionAuth-TenantId` header, or if the supplied API key is scoped to a specific Tenant.
  </APIField>
