...
htmlTitle: Retrieve a User Action API
description: API documentation for the FusionAuth Retrieve a User Action API.
tags: fusionauth api, rest api, http api, user action, user moderation, user management, retrieve user action
order: 200
---
...
import UserActionsResponseBody from 'src/content/docs/apis/user-actions/_user-actions-response-body.mdx';
