...
<APIAuthentication icon="lock">Retrieve all Connectors</APIAuthentication>
<APIURI method="GET">/api/connector</APIURI>

<APIAuthentication icon="lock">Retrieve a Connector by Id</APIAuthentication>
