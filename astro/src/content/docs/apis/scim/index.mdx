...
FusionAuth supported [Service Provider Configuration](/docs/apis/scim/scim-service-provier) endpoints:

* [SCIM ResourceTypes](/docs/apis/scim/scim-service-provier#retrieve-resource-types)
* [SCIM Schemas](/docs/apis/scim/scim-service-provier#retrieve-schemas)
* [SCIM Service Provider Configuration](/docs/apis/scim/scim-service-provier#retrieve-service-provider-configuration)
