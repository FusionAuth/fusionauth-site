...
<APIBlock>
  ...
  <APIField name="excludedAttributes" type="String" optional since="1.39.0">
    ...
    For example, a value of <InlineFieldValue>phoneNumbers</InlineFieldValue> will remove the <InlineField>phoneNumbers</InlineField> attribute from all Users returned in the response.
  </APIField>
