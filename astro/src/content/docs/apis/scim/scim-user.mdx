---
title: User
description: Learn about the APIs for provisioning SCIM Users in FusionAuth using a SCIM Client.
---
...
Create a SCIM User by sending the User attributes in the request body.

<API method="POST" uri="/api/scim/resource/v2/Users" authentication={["client-credentials"]} title="Create a User"/>
...
Retrieve a SCIM User by its Id.

<API method="GET" uri="/api/scim/resource/v2/Users/{userId}" authentication={["client-credentials"]} title="Retrieves a User"/>
...
Retrieve a paginated list of SCIM Users, optionally filtered.

<API method="GET" uri="/api/scim/resource/v2/Users" authentication={["client-credentials"]} title="Retrieve Users"/>
...
Update a SCIM User by sending the full set of attributes to replace the existing User.

<API method="PUT" uri="/api/scim/resource/v2/Users/{userId}" authentication={["client-credentials"]} patchSupported={false} title="Updates a User"/>
...
Delete a SCIM User by its Id.

<API method="DELETE" uri="/api/scim/resource/v2/Users/{userId}" authentication={["client-credentials"]} title="Delete a User"/>
