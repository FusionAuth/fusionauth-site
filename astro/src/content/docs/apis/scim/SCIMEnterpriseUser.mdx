...
<APIAuthentication icon="undefined">Create a User</APIAuthentication>
...
<APIAuthentication icon="undefined">Retrieves an EnterpriseUser</APIAuthentication>
...
<APIAuthentication icon="undefined">Retrieves users</APIAuthentication>
...
<APIAuthentication icon="undefined">Updates an EnterpriseUser from a SCIM request</APIAuthentication>
...
For SCIM endpoints, error responses will be returned in standard SCIM schema. See more details in the [SCIM API Overview](/docs/apis/scim/overview).
