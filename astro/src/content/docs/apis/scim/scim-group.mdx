...
<APIBlock>
  ...
  <APIField name="excludedAttributes" type="String" optional since="1.39.0">
    ...
    For example, a value of <InlineFieldValue>members</InlineFieldValue> will remove the <InlineField>members</InlineField> attribute from all Groups returned in the response.
  </APIField>
  <APIField name="filter" type="String" optional since="1.39.0">
    ...
    * The <InlineField>externalId</InlineField> attribute may be used for an equals comparison
    * The <InlineField>displayName</InlineField> attribute may be used with the following operators:
      * <InlineFieldValue>eq</InlineFieldValue> case-insensitive equals
      * <InlineFieldValue>co</InlineFieldValue> case-insensitive contains
      * <InlineFieldValue>sw</InlineFieldValue> case-insensitive starts with
      * <InlineFieldValue>ew</InlineFieldValue> case-insensitive ends with
  </APIField>
