...
tags: fusionauth api, rest api, http api, webauthn, passkey, fido2, passkey management, biometric authentication
sectionIndex: true
---
...
<ExtractedCode src="webauthn/base64url-to-buffer.snippet.base64url-to-buffer.js"
           lang="javascript"
...
<ExtractedCode src="webauthn/buffer-to-base64url.snippet.buffer-to-base64url.js"
           lang="javascript"
