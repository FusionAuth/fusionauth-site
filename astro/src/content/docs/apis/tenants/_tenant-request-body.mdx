...
import EventTypes from 'src/content/docs/apis/_shared/_event-types.mdx';
import ExpiryUnit from 'src/content/docs/apis/_shared/_expiry_unit.mdx';
import JSON from 'src/components/JSON.astro';
import RecaptchaValues from 'src/content/docs/_shared/_recaptcha-values.mdx';
import TenantApplicationEmailConfiguration from 'src/content/docs/apis/_shared/_tenant-application-email-configuration.mdx';
import TenantApplicationPhoneConfiguration from 'src/content/docs/apis/_shared/_tenant-application-phone-configuration.mdx';
import TenantGeneratorLengthConfigRules from 'src/content/docs/apis/_shared/_tenant-generator-length-config-rules.mdx';
import TenantGeneratorTypeConfigRules from 'src/content/docs/apis/_shared/_tenant-generator-type-config-rules.mdx';
import TransactionTypes from 'src/content/docs/apis/_shared/_transaction-types.mdx';
...
<APIBlock>
  <APIField name="tenant.accessControlConfiguration.uiIPAccessControlListId" type="UUID" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="IP ACLs" />
  ...
  <APIField name="tenant.captchaConfiguration.captchaMethod" type="String" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="CAPTCHA" />
  ...
  <APIField name="tenant.externalIdentifierConfiguration.rememberOAuthScopeConsentChoiceTimeToLiveInSeconds" type="Integer" optional defaults="2592000" since="1.50.0">
    ...
    <PlanBlurbApi plan="essentials" feature="advanced OAuth scopes" />
  </APIField>
  ...
  <APIField name="tenant.externalIdentifierConfiguration.webAuthnAuthenticationChallengeTimeToLiveInSeconds" type="Integer" optional defaults="180" since="1.41.0">
    ...
    <PlanBlurbApi plan="licensed" feature="WebAuthn" />
  ...
  <APIField name="tenant.formConfiguration.adminUserFormId" type="UUID" optional since="1.20.0">
    ...
    <PlanBlurbApi plan="starter" feature="custom forms" />
  </APIField>
  ...
  <APIField name="tenant.jwtConfiguration.accessTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of access token verification key Ids that are trusted by this tenant. **`tenant.jwtConfiguration.accessTokenKeyId`** is implicitly included in this list.

    Facilitates key rotation by trusting multiple keys: if you change **`tenant.jwtConfiguration.accessTokenKeyId`** to a new key and supply the previous key in this field, FusionAuth will trust JWTs signed by both keys, while only signing JWTs with the new key.
  </APIField>
  ...
  <APIField name="tenant.jwtConfiguration.idTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of Id token verification key Ids that are trusted by this tenant. **`tenant.jwtConfiguration.idTokenKeyId`** is implicitly included in this list.

    Facilitates key rotation by trusting multiple keys: if you change **`tenant.jwtConfiguration.idTokenKeyId`** to a new key and supply the previous key in this field, FusionAuth will trust JWTs signed by both keys, while only signing JWTs with the new key.
  </APIField>
  ...
  <APIField name="tenant.jwtConfiguration.refreshTokenExpirationPolicy" type="String" optional defaults="Fixed" since="1.17.0">
    ...
    * `SlidingWindowWithMaximumLifetime` - the expiration is calculated from the last time the token was used, or until the **maximumTimeToLiveInMinutes** is reached. &nbsp; <AvailableSince since="1.46.0"/>
  </APIField>
  ...
  <APIField name="tenant.lambdaConfiguration.multiFactorRequirementId" type="UUID" optional since="1.62.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="Multi-Factor Requirement Lambdas" />
  </APIField>
  ...
  <APIField name="tenant.lambdaConfiguration.scimEnterpriseUserRequestConverterId" type="UUID" optional since="1.36.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="SCIM" />
  ...
  <APIField name="tenant.multiFactorConfiguration.loginPolicy" type="String" optional since="1.37.0">
    ...
    * `Required` - Require a two-factor challenge during login. A user will be required to configure 2FA if no eligible methods are available. <AvailableSince since="1.42.0"/>
    ...
    <PlanBlurbApi plan="starter" feature="an Intelligent MFA Policy" />
  </APIField>
  ...
  <APIField name="tenant.multiFactorConfiguration.voice.messengerId" type="UUID" optional since="1.65.0">
    The messenger that is used to deliver a voice multi-factor authentication request. This field is required when **tenant.multiFactorConfiguration.voice.enabled** is set to `true`.
  </APIField>

  <APIField name="tenant.multiFactorConfiguration.voice.templateId" type="UUID" optional since="1.65.0">
    The Id of the voice template that is used when notifying a user to complete a multi-factor authentication request. This field is required when **tenant.multiFactorConfiguration.voice.enabled** is set to `true`.
  </APIField>
  ...
  <APIField name="tenant.oauthConfiguration.clientCredentialsAccessTokenPopulateLambdaId" type="UUID" optional since="1.26.0">
    ...
    <PlanBlurbApi plan="starter" feature="client credentials grant" />
  ...
  <APIField name="tenant.passwordEncryptionConfiguration.encryptionScheme" type="String" optional since="1.8.0">
    ...
    * **[salted-pbkdf2-hmac-sha256-512](/docs/reference/password-hashes#salted-pbkdf2-hmac-sha-256)**
    * **[salted-pbkdf2-hmac-sha512-512](/docs/reference/password-hashes#salted-pbkdf2-hmac-sha-512)**
    * **[bcrypt](/docs/reference/password-hashes#salted-bcrypt)**
    * **[phpass-md5](/docs/reference/password-hashes#phpass-md5)**
    * **[phpass-sha512](/docs/reference/password-hashes#phpass-sha-512)**
  ...
  <APIField name="tenant.rateLimitConfiguration.failedLogin.enabled" type="Boolean" optional defaults="false" since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="rate limiting" />
  ...
  <APIField name="tenant.registrationConfiguration.blockedDomains" type="Array<String>" optional since="1.30.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="blocked domains" />
  ...
  <APIField name="tenant.userDeletePolicy.unverified.enabled" type="Boolean" optional defaults="false" since="1.13.0">
    Indicates that users with neither a verified email address nor a verified phone number will be permanently deleted after **tenant.userDeletePolicy.unverified.numberOfDaysToRetain** days.
  </APIField>

  <APIField name="tenant.userDeletePolicy.unverified.numberOfDaysToRetain" type="Integer" optional since="1.13.0">
    The number of days from creation users will be retained before being deleted for not completing email or phone number verification. This field is required when **tenant.userDeletePolicy.unverified.enabled** is set to `true`. Value must be greater than 0.
  </APIField>
...
<PlanBlurbApi plan="starter" feature="unique usernames" />
  ...
  <APIField name="tenant.webAuthnConfiguration.bootstrapWorkflow.authenticatorAttachmentPreference" type="String" optional defaults="crossPlatform" since="1.41.0">
    ...
    <PlanBlurbApi plan="enterprise" feature="WebAuthn cross-platform authenticators" />
