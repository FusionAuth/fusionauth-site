...
<APIField name="users[x].mobilePhone" type="String" optional>
  ...
  <Aside>
    This differs from <InlineField>users\[x].phoneNumber</InlineField> and cannot be used to login.
  </Aside>
</APIField>
...
<APIField name="users[x].phoneNumber" type="String" optional since="1.99.9">
  ...
  <Aside>
    This differs from <InlineField>users\[x].mobilePhone</InlineField> in that <InlineField>users\[x].phoneNumber</InlineField> can be used to login, just like an email address or a username.
  </Aside>
</APIField>
