...
<APIField name="users[x].mobilePhone" type="String" optional>
  ...
  <Aside>
    This differs from <InlineField>users\[x].phoneNumber</InlineField> and cannot be used to log in.
  </Aside>
</APIField>
...
<APIField name="users[x].password" type="String" optional>
  ...
  <Aside title="Since 1.99.9" type="version">
    Prior to version 1.99.9, this field is required. Beginning with version 1.99.9, this field is only required when <InlineField>tenant.passwordEnabled</InlineField> is `true`.
  </Aside>
</APIField>
...
<APIField name="users[x].phoneNumber" type="String" optional since="1.99.9">
  The phone number of the User.

  <Aside>
    This differs from <InlineField>users\[x].mobilePhone</InlineField> in that <InlineField>users\[x].phoneNumber</InlineField> can be used to log in, just like an email address or a username.
  </Aside>
</APIField>
...
<APIField name="users[x].verifiedInstant" type="Long" optional defaults="now">
  The [instant](/docs/reference/data-types#instants) this user's email address or phone number was verified. This value will be ignored unless <InlineField>identity.verified</InlineField> is `true` or <InlineField>identity.verifiedReason</InlineField> is `Trusted`, `Disabled`, or `Skipped`.
</APIField>
