...
<APIField name="users[x].password" type="String" optional>
  ...
  <Aside title="Available since 1.99.9" type="version">
    Prior to version 1.99.9, this field is required. Beginning with version 1.99.9, this field is only required when the tenant you are importing users into requires passwords.
  </Aside>
</APIField>
