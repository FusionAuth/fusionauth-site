...
<UserDataEmailFieldImportRequest />
  ...
  <APIField name="users[x].verified" type="Boolean" optional defaults="false">
    Set this value to <InlineFieldValue>true</InlineFieldValue> in order to mark the user as having a verified email address.
  </APIField>

  <APIField name="users[x].verifiedInstant" type="Long" optional defaults="now">
    The [instant](/docs/reference/data-types#instants) this user's email address was verified. This value will be ignored if <InlineField>verified</InlineField> is <InlineFieldValue>false</InlineFieldValue>.
  </APIField>
