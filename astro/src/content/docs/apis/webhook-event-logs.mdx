...
htmlTitle: Webhook Event Log API
description: Learn about the APIs for searching and retrieving webhook event and attempt logs.
tags: fusionauth api, rest api, http api, webhook event log, event log, webhook attempts, event history
---
import StandardGetResponseCodes from 'src/content/docs/apis/_shared/_standard-get-response-codes.astro';
import WebhookAttemptLogResponseBody from 'src/content/docs/apis/_shared/_webhook-attempt-log-response-body.mdx';
import WebhookEventLogResponseBody from 'src/content/docs/apis/_shared/_webhook-event-log-response-body.mdx';
import WebhookEventLogSearchResponseBody from 'src/content/docs/apis/_shared/_webhook-event-log-search-response-body.mdx';
