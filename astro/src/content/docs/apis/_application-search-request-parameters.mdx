...
<APIBlock>
  ...
  <APIField name={ props.parameter_prefix + "universal" } type="Boolean" since="1.65.0" optional>
    Restricts the results to Applications with the specified universal setting.
  </APIField>
</APIBlock>
