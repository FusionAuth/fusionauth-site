...
<LocalCode src="example-scripts/import-helpers/convert-md5-hexadecimal-to-base64.rb" lang="ruby" title="Example of Converting a Base16 Password Hash Value to Base64" />
...
<LocalCode src="example-scripts/import-helpers/convert-md5-hexadecimal-to-base64.rb" lang="ruby" title="Convert a Hexadecimal Password Hash Value to Base64" />
