...
tags: fusionauth api, rest api, http api, user management, user api, import users, bulk import, user migration
order: 800
---
...
<ExtractedCode src="example-scripts/import-helpers/convert-md5-hexadecimal-to-base64.rb" lang="ruby" title="Example of Converting a Base16 Password Hash Value to Base64" />
...
<ExtractedCode src="example-scripts/import-helpers/convert-md5-hexadecimal-to-base64.rb" lang="ruby" title="Convert a Hexadecimal Password Hash Value to Base64" />
