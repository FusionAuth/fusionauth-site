---
title: Update a User
htmlTitle: Update a User API
description: API documentation for the FusionAuth Update a User API.
tags: fusionauth api, rest api, http api, user management, user api, update user, modify user
order: 400
---
...
import UserRequestBody from 'src/content/docs/apis/users/_user-request-body.mdx';
