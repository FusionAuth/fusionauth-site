...
<CodeExample method="DELETE" uri="/api/user/bulk?userId=YOUR_USER_ID&userId=YOUR_USER_ID" />
...
<CodeExample method="DELETE" uri="/api/user/bulk?queryString=YOUR_QUERY_STRING" />
...
<CodeExample method="DELETE" uri="/api/user/bulk?query=YOUR_ELASTICSEARCH_QUERY" />
...
<CodeExample method="DELETE" uri="/api/user/bulk" body='{"userIds": ["YOUR_USER_ID", "YOUR_USER_ID"]}' />
