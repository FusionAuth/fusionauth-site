...
<CodeExample
  curl={`curl -X DELETE \\
  "https://your-fusionauth-host/api/user/bulk?userId=YOUR_USER_ID&userId=YOUR_USER_ID" \\
...
response = requests.delete(
    "https://your-fusionauth-host/api/user/bulk",
    headers=headers,
    params=[("userId", "YOUR_USER_ID"), ("userId", "YOUR_USER_ID")],
)
print(response.json())`}
/>
...
<CodeExample
  curl={`curl -X DELETE \\
  "https://your-fusionauth-host/api/user/bulk?queryString=YOUR_QUERY_STRING" \\
  -H "Authorization: YOUR_API_KEY"`}
  python={`import requests
...
response = requests.delete(
    "https://your-fusionauth-host/api/user/bulk",
    headers=headers,
    params={"queryString": "YOUR_QUERY_STRING"},
)
print(response.json())`}
/>
...
<CodeExample
  curl={`curl -X DELETE \\
  "https://your-fusionauth-host/api/user/bulk?query=YOUR_ELASTICSEARCH_QUERY" \\
  -H "Authorization: YOUR_API_KEY"`}
  python={`import requests
...
response = requests.delete(
    "https://your-fusionauth-host/api/user/bulk",
    headers=headers,
    params={"query": "YOUR_ELASTICSEARCH_QUERY"},
)
print(response.json())`}
/>
...
<CodeExample
  ...
  -d '{"userIds": ["YOUR_USER_ID", "YOUR_USER_ID"]}'`}
  python={`import requests
...
body = {
    "userIds": ["YOUR_USER_ID", "YOUR_USER_ID"],
}
