...
htmlTitle: Bulk Delete Users API
description: API documentation for the FusionAuth Bulk Delete Users API.
tags: fusionauth api, rest api, http api, user management, user api, bulk delete users, mass delete users
order: 600
---
...
import UserBulkDeleteRequestBody from 'src/content/docs/apis/users/_user-bulk-delete-request-body.mdx';
import UserBulkDeleteResponseBody from 'src/content/docs/apis/users/_user-bulk-delete-response-body.mdx';
...
<Aside type="note">
This API has some limitations when FusionAuth is configured to use the database as the user search engine, noted on the impacted request parameters below.
</Aside>
...
For even larger bulk requests, pass your parameters in the request body.
