...
<CodeExample method="GET" uri="/api/user/search?queryString=YOUR_QUERY_STRING" />
...
<CodeExample method="POST" uri="/api/user/search" body='{"search": {"queryString": "example@fusionauth.io"}}' />
