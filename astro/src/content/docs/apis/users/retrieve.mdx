...
htmlTitle: Retrieve a User API
description: API documentation for the FusionAuth Retrieve a User API.
tags: fusionauth api, rest api, http api, user management, user api, retrieve user, get user
order: 300
---
...
import XFusionauthTenantIdHeaderAmbiguousOperation from 'src/content/docs/apis/users/_x-fusionauth-tenant-id-header-ambiguous-operation.mdx';
