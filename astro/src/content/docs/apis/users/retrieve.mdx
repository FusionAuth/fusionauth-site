...
<CodeExample method="GET" uri="/api/user/{userId}" />
...
<CodeExample method="GET" uri="/api/user?loginId={loginId}" />
...
<CodeExample method="GET" uri="/api/user?loginId={loginId}&loginIdTypes={type1}" />
...
<CodeExample method="GET" uri="/api/user?email={email}" />
...
<CodeExample method="GET" uri="/api/user?username={username}" />
...
<CodeExample method="GET" uri="/api/user?changePasswordId={changePasswordId}" />
...
<CodeExample method="GET" uri="/api/user?verificationId={verificationId}" />
