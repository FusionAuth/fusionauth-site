...
<CodeExample method="POST" uri="/api/user/refresh-token/import" body='{"refreshTokens": [{"applicationId": "YOUR_APPLICATION_ID", "startInstant": "YOUR_START_INSTANT", "token": "YOUR_REFRESH_TOKEN", "userId": "YOUR_USER_ID"}]}' />
