...
<APIBlock>
  ...
  <APIField name="orderBy" type="String" optional defaults="insertInstant ASC, userId ASC, groupId ASC">
    ...
    The possible values are:
      ...
      * <InlineFieldValue>groupId</InlineFieldValue> - the unique Id of the Group
      * <InlineFieldValue>id</InlineFieldValue> - the id of the Group Member
      * <InlineFieldValue>insertInstant</InlineFieldValue> - the [instant](/docs/reference/data-types#instants) when the Group Member was created
      * <InlineFieldValue>userId</InlineFieldValue> - the unique Id of the User

    For example, to order the results by the insert instant in descending order, the value would be provided as `insertInstant DESC`. The final string is optional, can be set to <InlineFieldValue>ASC</InlineFieldValue> or <InlineFieldValue>DESC</InlineFieldValue>, or omitted and will default to <InlineFieldValue>ASC</InlineFieldValue>.
