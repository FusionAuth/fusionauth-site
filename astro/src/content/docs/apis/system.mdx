...
| Code | Description                                                                                                                                                                |
|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 200  | The FusionAuth service functioning properly and can accept requests.                                                                                                       |
| 500  | The FusionAuth services is not functioning properly. This will generally indicate that FusionAuth is not able to communicate with the database or complete I/O operations. |
