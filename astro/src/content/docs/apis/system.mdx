...
<APIBlock>
  ...
  <APIField name="level" type="String">
    ...
    * <InlineFieldValue>warn</InlineFieldValue>
    * <InlineFieldValue>info</InlineFieldValue>
    * <InlineFieldValue>debug</InlineFieldValue>
    * <InlineFieldValue>trace</InlineFieldValue>
    * <InlineFieldValue>off</InlineFieldValue>
  </APIField>
</APIBlock>
