...
<APIBlock>
  ...
  <APIField name="eventLog.type" type="String">
    ...
    * <InlineFieldValue>Information</InlineFieldValue>
    * <InlineFieldValue>Debug</InlineFieldValue>
    * <InlineFieldValue>Error</InlineFieldValue>
  </APIField>
</APIBlock>
...
<APIBlock>
  ...
  <APIField name="orderBy" type="String" optional defaults="insertInstant DESC">
     ...
     * <InlineFieldValue>insertInstant</InlineFieldValue> - the [instant](/docs/reference/data-types#instants) when the Event Log was created
     * <InlineFieldValue>insertUser</InlineFieldValue> - the user that create the Event Log
     * <InlineFieldValue>message</InlineFieldValue> - the message of the Event Log
     * <InlineFieldValue>type</InlineFieldValue> - the type of the Event Log
