---
title: Event Log
htmlTitle: Event Log API
description: Learn about the APIs for searching and retrieving event logs.
tags: event log, event logging, audit log, system log, async events, webhook events, error log, retrieve event log, search event log, fusionauth api, rest api, http api
---
