...
htmlTitle: Create a User Registration (for an existing user) API
description: API documentation for the FusionAuth Create a User Registration (for an existing user) API.
tags: fusionauth api, rest api, http api, user registration, create registration, register user, existing user
order: 100
---
