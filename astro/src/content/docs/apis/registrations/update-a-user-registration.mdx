...
htmlTitle: Update a User Registration API
description: API documentation for the FusionAuth Update a User Registration API.
tags: fusionauth api, rest api, http api, user registration, update registration, registration management
order: 400
---
...
import UserRegistrationRequestBody from 'src/content/docs/apis/registrations/_user-registration-request-body.mdx';
import UserRegistrationResponseBody from 'src/content/docs/apis/registrations/_user-registration-response-body.mdx';
