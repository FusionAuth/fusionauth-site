...
<APIBlock>
  ...
  <APIField name="application.jwtConfiguration.algorithm" type="String" optional deprecated>
    ...
    <span class="text-red-700">Removed in version 1.6.0</span> In version 1.6.0 and beyond, JWT configuration can be managed in the `[Keys API](/docs/apis/keys)` and Keymaster.
  </APIField>
  ...
  <APIField type="String" optional defaults="Fixed" since="1.17.0">
  ...
  <APIField type="Integer" optional since="1.46.0">
  ...
  <APIField name="application.jwtConfiguration.secret" type="String" optional deprecated>
    ...
    <span class="text-red-700">Removed in version 1.5.0</span> In version 1.5.0 and beyond, when selecting an `HMAC` algorithm, the `client_secret` from the OAuth configuration will be used to sign and verify the JWTs.
  </APIField>
  ...
  <APIField name="application.oauthConfiguration.authorizedOriginURLs" type="Array<String>" optional>
    ...
    <OauthWildcardUsage validation_policy_field_name="application.oauthConfiguration.authorizedURLValidationPolicy" validation_policy_wildcard="pass:quotes[`AllowWildcards`]" />
  </APIField>
  ...
  <APIField name="application.roles" type="Array" optional>
    An array of Role objects.
  </APIField>
  <APIField name="application.roles[x].description" type="String" optional>
    A description for the role.
  </APIField>
  <APIField name="application.roles[x].id" type="UUID" optional>
    The Id of the Role.
  </APIField>
  <APIField name="application.roles[x].name" type="String" required>
    The name of the Role.
  </APIField>
  <APIField name="application.roles[x].isDefault" type="Boolean" optional>
  ...
  <APIField name="application.roles[x].isSuperRole" type="Boolean" optional>
  ...
  <APIField name="webhookIds" type="Array<UUID>" optional deprecated>
    ...
    <span class="text-red-700">Removed in version 1.37.0</span> In version 1.37.0 and beyond, Webhooks configuration can be managed in the `[Tenant API](/docs/apis/tenants)`.
  </APIField>
</APIBlock>

{ props.includeRoles && <JSON title="Example Request JSON" src="applications/post-request.json" /> }

{ !props.includeRoles && <JSON title="Example Request JSON" src="applications/put-request.json" /> }