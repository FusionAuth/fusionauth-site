...
<APIBlock>
  ...
  <APIField name="application.registrationConfiguration.loginIdType" type="String" optional since="1.4.0">
    The unique login Id collected during registration. A value of `email` or `phoneNumber` is preferred because an email or phone number are unique. The possible values are:
