...
<APIBlock>
  ...
  <APIField name="application.registrationConfiguration.loginIdType" type="String" optional since="1.4.0">
    The unique login Id that will be collected during registration. A value of `email` or `phoneNumber` is preferred because they are globally unique. The possible values are:

    - `email`
    - `phoneNumber` <span class="text-green-600">Available since 1.99.9</span>
    - `username`
  </APIField>
