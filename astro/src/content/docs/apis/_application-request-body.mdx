...
<APIBlock>
  ...
  <APIField name="application.registrationConfiguration.loginIdType" type="String" optional since="1.4.0">
    The unique login Id that will be collected during registration, this value can be `email`, `phoneNumber`, or `username`. Leaving the default value of `email` is preferred because an email address is globally unique.
