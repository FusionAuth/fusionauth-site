...
<APIBlock>
  ...
  <APIField name="application.multiFactorConfiguration.email.templateId" type="UUID" optional since="1.26.0">
    ...
    The risk based policies use FusionAuth's Intelligent MFA capabilities, which combine multiple signals to determine whether a user should be challenged with MFA.
