...
<APIBlock>
  ...
  <APIField name="application.baseURL" type="String" optional since="1.68.0">
  ...
  <APIField name="application.jwtConfiguration.accessTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of access token verification key Ids that are trusted by this application. **application.jwtConfiguration.accessTokenKeyId** is implicitly included in this list and does not need to be explicitly specified.

    If **application.jwtConfiguration.accessTokenKeyId** is changed to a new key and the old key is supplied in this field, then this facilitates key rotation because FusionAuth will trust JWTs signed by both keys, while only signing JWTs with the new key.
  </APIField>
  ...
  <APIField name="application.jwtConfiguration.idTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of Id token verification key Ids that are trusted by this application. **application.jwtConfiguration.idTokenKeyId** is implicitly included in this list and does not need to be explicitly specified.

    If **application.jwtConfiguration.idTokenKeyId** is changed to a new key and the old key is supplied in this field, then this facilitates key rotation because FusionAuth will trust JWTs signed by both keys, while only signing JWTs with the new key.
  </APIField>
  ...
  <APIField name="application.multiFactorConfiguration.voice.templateId" type="UUID" optional since="1.65.0">
  ...
  <APIField name="application.oauthConfiguration.authorizedResourceUris" type="Array<String>" optional since="1.67.0">
  ...
  <APIField name="application.registrationConfiguration.completeRegistration" type="Boolean" since="1.65.0" optional defaults="false">
  ...
  <APIField name="application.samlv2Configuration.defaultVerificationKeyId" type="UUID" optional deprecated since="1.20.0">
    ...
    This parameter or **application.samlv2Configuration.verificationKeyIds** is required when **application.samlv2Configuration.requireSignedRequests** is set to `true`.
  ...
  <APIField name="application.samlv2Configuration.logout.defaultVerificationKeyId" type="UUID" optional deprecated since="1.25.0">
    ...
    This parameter or **application.samlv2Configuration.logout.verificationKeyIds** is required when **application.samlv2Configuration.logout.requireSignedRequests** is set to `true`.
  ...
  <APIField name="application.samlv2Configuration.logout.requireSignedRequests" type="Boolean" required since="1.25.0">
    ...
    When set to `true`, one of these parameter is required: **application.samlv2Configuration.logout.verificationKeyIds** (1.69.0 and above) or **application.samlv2Configuration.logout.defaultVerificationKeyId** (before 1.69.0).
  </APIField>
  ...
  <APIField name="application.samlv2Configuration.logout.verificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The verification keys used to verify a signature when the SAML v2 Service Provider is using HTTP Redirect Bindings.

    When HTTP POST Bindings are used, these are the default verification keys used if a `[KeyInfo]` element is not found in the SAML AuthNRequest. If a `[KeyInfo]` element is found, Key Master will be used to resolve the key but the key must still be included in this list.

    This parameter is required when **application.samlv2Configuration.logout.requireSignedRequests** is set to `true`. Use this parameter in version 1.69.0 and above instead of **application.samlv2Configuration.logout.defaultVerificationKeyId**.
  </APIField>
  ...
  <APIField name="application.samlv2Configuration.requireSignedRequests" type="Boolean" optional since="1.20.0">
    ...
    When set to `true`, one of these parameter is required: **application.samlv2Configuration.verificationKeyIds** (1.69.0 and above) or **application.samlv2Configuration.defaultVerificationKeyId** (before 1.69.0).
  </APIField>
  <APIField name="application.samlv2Configuration.verificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The verification keys used to verify a signature when the SAML v2 Service Provider is using HTTP Redirect Bindings.

    When HTTP POST Bindings are used, these are the default verification keys used if a `[KeyInfo]` element is not found in the SAML AuthNRequest. If a `[KeyInfo]` element is found, Key Master will be used to resolve the key but the key must still be included in this list.

    This parameter is required when **application.samlv2Configuration.requireSignedRequests** is set to `true`. Use this parameter in version 1.69.0 and above instead of **application.samlv2Configuration.defaultVerificationKeyId**.
  </APIField>
