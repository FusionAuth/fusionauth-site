...
<APIBlock>
  ...
  <APIField name="application.oauthConfiguration.authorizedResourceUris" type="Array<String>" optional since="1.67.0">
    An array of allowed resource server URIs for this application, per [RFC 8707 (Resource Indicators for OAuth 2.0)](https://www.rfc-editor.org/rfc/rfc8707.html).
