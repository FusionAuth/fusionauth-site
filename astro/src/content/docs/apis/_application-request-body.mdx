...
<APIBlock>
  ...
  <APIField name="application.oauthConfiguration.authorizedResourceUris" type="Array<String>" optional>
    An array of URIs that are the authorized resource URIs for this Application. These are used during the OAuth 2.0 authorization code grant to validate the `resource` parameter.
  </APIField>
