...
<APIBlock>
  ...
  <APIField name="consent.emailPlus.enabled" type="Boolean">
    When this value is <InlineFieldValue>true</InlineFieldValue> the Email Plus workflow is enabled.
  ...
  <APIField name="consent.multipleValuesAllowed" type="Boolean">
    When this value is <InlineFieldValue>true</InlineFieldValue> more than one value may be used when granting this consent to a User.
