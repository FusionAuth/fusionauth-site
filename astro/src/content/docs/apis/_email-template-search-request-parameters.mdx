...
<APIBlock>
  ...
  <APIField name={ props.parameter_prefix + "orderBy" } type="String" optional defaults="name ASC">
     ...
     * <InlineFieldValue>id</InlineFieldValue> - the unique Id of the Email Template
     * `insertInstant` - the [instant](/docs/reference/data-types#instants) when the Email Template was created
