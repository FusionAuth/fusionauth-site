...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/SLc3cTlypwM?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
...
<StandardGetResponseCodes authorization_message="You did not supply a valid Authorization header, the header was omitted or your access token is expired. The response will be empty. See link:/docs/v1/tech/apis/authentication[Authentication]." not_registered never_missing no_errors />
...
The Reconcile API is used to take a JWT issued by a third party identity provider as described by an [External JWT Identity Provider](/docs/v1/tech/apis/identity-providers/external-jwt/)
...
<iframe allowfullscreen="" frameborder="0" width="560" height="315" src="//www.youtube.com/embed/Kd6l5NPd_L0?rel=0" enablejsapi="true" data-gtm-yt-inspected-8="true"></iframe>
