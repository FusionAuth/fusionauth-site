...
<APIBlock>
  ...
  <APIField name="timeToLiveInSeconds" type="Integer" optional since="1.99.9">
    The time to live for the new access token. When provided on the request, this value will override the default <InlineField>tenant.jwtConfiguration.timeToLiveInSeconds</InlineField> or <InlineField>application.jwtConfiguration.timeToLiveInSeconds</InlineField> values, but it must be less than or equal to those values.
  </APIField>
</APIBlock>
