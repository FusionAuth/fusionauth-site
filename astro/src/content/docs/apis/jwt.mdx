...
<APIBlock>
  ...
  <APIField name="timeToLiveInSeconds" type="Integer" optional since="1.99.9">
    ...
    When provided on the request, this value will override the default <InlineField>tenant.jwtConfiguration.timeToLiveInSeconds</InlineField> or <InlineField>application.jwtConfiguration.timeToLiveInSeconds</InlineField> values, but it must be less than or equal to those values.
  </APIField>
</APIBlock>
