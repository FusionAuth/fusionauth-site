...
<APIBlock>
  ...
  <APIField name="timeToLiveInSeconds" type="Integer" optional since="1.99.9">
    The time to live for the new access token. This value will override the default <InlineField>tenant.jwtConfiguration.timeToLiveInSeconds</InlineField> or <InlineField>application.jwtConfiguration.timeToLiveInSeconds</InlineField>, but it must be less than equal to those values.
  </APIField>
</APIBlock>
