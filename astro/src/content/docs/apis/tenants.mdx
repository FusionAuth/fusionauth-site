...
<APIBlock>
  ...
  <APIField name="async" type="Boolean" optional defaults="false">
    Set this value to <InlineFieldValue>true</InlineFieldValue> to perform this request asynchronously, this means the API will return a response indicating the request has been accepted and will not wait for the operation to complete.
  </APIField>
</APIBlock>
