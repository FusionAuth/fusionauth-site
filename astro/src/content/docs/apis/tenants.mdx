...
<APIAuthentication icon="lock">Create a Tenant with a randomly generated Id</APIAuthentication>
<APIURI method="POST">/api/tenant</APIURI>

<APIAuthentication icon="lock">Create a Tenant with the provided unique Id</APIAuthentication>
<APIURI method="POST">/api/tenant/`{tenantId}`</APIURI>
...
<APIAuthentication icon="lock">Create a Tenant from an existing Tenant with a randomly generated I </APIAuthentication>
...
<APIAuthentication icon="lock">Create a Tenant from an existing Tenant with the provided unique Id</APIAuthentication>
...
<APIAuthentication icon="lock">Retrieve all of the Tenants</APIAuthentication>
<APIURI method="GET">/api/tenant</APIURI>

<APIAuthentication icon="lock">Retrieve a Tenant by Id</APIAuthentication>
<APIURI method="GET">/api/tenant/`{tenantId}`</APIURI>
...
<APIAuthentication icon="lock">Search for Tenants</APIAuthentication>
<APIURI method="GET">/api/tenant/search`?name={name}`</APIURI>
...
<APIAuthentication icon="lock">Search for Tenants</APIAuthentication>
<APIURI method="POST">/api/tenant/search</APIURI>
...
<APIAuthentication icon="lock">Update the Tenant with the given Id</APIAuthentication>
<APIURI method="PUT">/api/tenant/`{tenantId}`</APIURI>

<PatchSupport api_endpoint="pass:normal[/api/tenant/`\{tenantId\}`]" />
...
<APIAuthentication icon="lock">Delete a Tenant by Id</APIAuthentication>
<APIURI method="DELETE">/api/tenant/`{tenantId}`</APIURI>
...
<APIAuthentication icon="unlock">Retrieve the Password Validation Rules</APIAuthentication>
<APIURI method="GET">/api/tenant/password-validation-rules/`{tenantId}`</APIURI>
