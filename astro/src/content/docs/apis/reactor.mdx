---
title: Reactor
htmlTitle: Reactor API
description: Learn about the APIs for activating, deactivating, and retrieving the status of a FusionAuth Reactor license.
tags: fusionauth api, rest api, http api, reactor, license management, fusionauth license, feature activation
---
import StandardGetResponseCodes from 'src/content/docs/apis/_shared/_standard-get-response-codes.astro';
import ReactorMetricsResponseBody from 'src/content/docs/apis/_shared/_reactor-metrics-response-body.mdx';
import ReactorStatusResponseBody from 'src/content/docs/apis/_shared/_reactor-status-response-body.mdx';
