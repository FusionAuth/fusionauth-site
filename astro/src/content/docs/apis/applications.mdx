...
<APIBlock>
  <APIField name="inactive" type="Boolean" optional>
    Set this parameter to <InlineFieldValue>true</InlineFieldValue> in order to retrieve only inactive Applications. Setting this parameter to <InlineFieldValue>false</InlineFieldValue> is equivalent omitting the `inactive` parameter.
  </APIField>
</APIBlock>
