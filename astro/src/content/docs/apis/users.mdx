---
title: FusionAuth User API Documentation
description: Learn how to integrate with the FusionAuth User API. This documentation provides a comprehensive reference for managing users, roles, and permissions. 
section: apis
---
