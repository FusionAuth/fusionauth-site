...
<PatchSupport api_endpoint="/api/user/`{userId}`" />
...
<APIURI method="DELETE">/api/user/bulk`?queryString={queryString}&dryRun=false&limit=10000`</APIURI>

<APIAuthentication icon="lock">Deactivate Users by Raw JSON Search Query</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?query={query}&dryRun=false&limit=10000`</APIURI>
...
<APIURI method="DELETE">/api/user/bulk`?queryString={queryString}&hardDelete=true&dryRun=false&limit=10000`</APIURI>

<APIAuthentication icon="lock">Permanently Delete Users by Raw JSON Search Query</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?query={query}&hardDelete=true&dryRun=false&limit=10000`</APIURI>
...
<APIAuthentication icon="lock">Search for Users with a `nextResults` token</APIAuthentication>
<APIURI method="GET">/api/user/search`?nextResults={nextResults}`</APIURI>
