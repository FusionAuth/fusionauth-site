...
Calling this API without an API key will always send a message to the user. If FusionAuth is unable to deliver a message based on the resolved identity and tenant configuration, the request will fail.
