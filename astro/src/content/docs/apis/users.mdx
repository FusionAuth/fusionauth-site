...
<APIAuthentication icon="lock">Create a User with a randomly generated Id</APIAuthentication>
<APIURI method="POST">/api/user</APIURI>

<APIAuthentication icon="lock">Create a User with the provided unique Id</APIAuthentication>
<APIURI method="POST">/api/user/`{userId}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve a User by Id</APIAuthentication>
<APIURI method="GET">/api/user/`{userId}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve a User by login Id</APIAuthentication>
<APIURI method="GET">/api/user`?loginId={loginId}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve a User by email</APIAuthentication>
<APIURI method="GET">/api/user`?email={email}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve a User by username</APIAuthentication>
<APIURI method="GET">/api/user`?username={username}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve a User by Change Password Id</APIAuthentication>
<APIURI method="GET">/api/user`?changePasswordId={changePasswordId}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve a User by Email Verification Id</APIAuthentication>
<APIURI method="GET">/api/user`?verificationId={verificationId}`</APIURI>
...
<APIAuthentication icon="badge">Retrieve a User using a JWT</APIAuthentication>
<APIURI method="GET">/api/user</APIURI>
...
<APIAuthentication icon="lock">Update the User with the given Id</APIAuthentication>
<APIURI method="PUT">/api/user/`{userId}`</APIURI>

<PatchSupport api_endpoint="pass:normal[/api/user/`\{userId\}`]" />
...
<APIAuthentication icon="lock">Deactivate a User (Soft Delete)</APIAuthentication>
<APIURI method="DELETE">/api/user/`{userId}`</APIURI>
<APIAuthentication icon="lock">Permanently Delete a User</APIAuthentication>
<APIURI method="DELETE">/api/user/`{userId}?hardDelete=true`</APIURI>
...
<APIAuthentication icon="lock">Deactivate Users by User Id</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?userId={userId}&userId={userId}`</APIURI>

<APIAuthentication icon="lock">Deactivate Users by Search Query String</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?queryString={queryString}&dryRun=false`</APIURI>

<APIAuthentication icon="lock">Deactivate Users by Raw JSON Search Query</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?query={query}&dryRun=false`</APIURI>

<APIAuthentication icon="lock">Permanently Delete Users by User Id</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?userId={userId}&userId={userId}&hardDelete=true`</APIURI>

<APIAuthentication icon="lock">Permanently Delete Users by Search Query String</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?queryString={queryString}&hardDelete=true&dryRun=false`</APIURI>

<APIAuthentication icon="lock">Permanently Delete Users by Raw JSON Search Query</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk`?query={query}&hardDelete=true&dryRun=false`</APIURI>
...
<APIAuthentication icon="lock">Bulk delete using the request body. This allows for larger requests than are possible using request parameters.</APIAuthentication>
<APIURI method="DELETE">/api/user/bulk</APIURI>
...
<APIAuthentication icon="lock">Reactivate the User</APIAuthentication>
<APIURI method="PUT">/api/user/`{userId}?reactivate=true`</APIURI>
...
<APIAuthentication icon="lock">Import Multiple Users</APIAuthentication>
<APIURI method="POST">/api/user/import</APIURI>
...
<APIAuthentication icon="lock">Import Refresh Tokens</APIAuthentication>
<APIURI method="POST">/api/user/refresh-token/import</APIURI>
...
<APIAuthentication icon="lock">Search for Users by Id</APIAuthentication>
<APIURI method="GET">/api/user/search`?ids={uuid}&ids={uuid}`</APIURI>

<APIAuthentication icon="lock">Search for Users by a query string</APIAuthentication>
<APIURI method="GET">/api/user/search`?queryString={queryString}`</APIURI>

<APIAuthentication icon="lock">Search for Users by a query string and sort the response</APIAuthentication>
<APIURI method="GET">/api/user/search`?queryString={queryString}&sortFields[0].name={name}&sortFields[0].order={order}`</APIURI>
...
<APIAuthentication icon="lock">Search for Users using a JSON request body. This allows for larger requests than are possible using request parameters.</APIAuthentication>
<APIURI method="POST">/api/user/search</APIURI>
...
<APIAuthentication icon="lock">Search for Users by a raw JSON query</APIAuthentication>
<APIURI method="GET">/api/user/search`?query={query}`</APIURI>
...
<APIURI method="PUT">/api/user/search</APIURI>
...
<APIAuthentication icon="lock">Retrieve recent logins</APIAuthentication>
<APIURI method="GET">/api/user/recent-login`?limit={limit}&offset={offset}&userId={userId}`</APIURI>
...
<PremiumEditionBlurbApi premium_feature="login location" />
...
<APIAuthentication icon="unlock">Verifies the User's email address using the `verificationId`.</APIAuthentication>

<APIURI method="POST">/api/user/verify-email</APIURI>

<APIURI method="POST">/api/user/verify-email/`{verificationId}`</APIURI>
...
<APIAuthentication icon="lock">Administratively verify the User's email address.</APIAuthentication>
...
<APIAuthentication icon="unlock">Resend the verification email</APIAuthentication>
<APIURI method="PUT">/api/user/verify-email`?applicationId={applicationId}&email={email}`</APIURI>
...
<APIAuthentication icon="lock">Resend the verification email using an API key</APIAuthentication>
<APIURI method="PUT">/api/user/verify-email`?applicationId={applicationId}&email={email}&sendVerifyEmail={sendVerifyEmail}`</APIURI>
...
<APIBlock>
  <APIField name="verificationId" type="String">
    The email verification Id that was generated by this API request. This identifier may be used by the <ScrollRef target="verify-a-users-email,Verify a User's Email" /> API.
...
<PremiumEditionBlurbApi premium_feature="gated email" />
...
<APIAuthentication icon="unlock">Start the forgot password workflow without an API Key.</APIAuthentication>
<APIURI method="POST">/api/user/forgot-password</APIURI>
...
<APIAuthentication icon="lock">Start the forgot password workflow using an API key</APIAuthentication>
<APIURI method="POST">/api/user/forgot-password</APIURI>
...
<APIBlock>
  ...
  <APIField name="changePasswordId" type="String" optional>
    The optional change password Id to be used on the <ScrollRef target="change-a-users-password,Change a User's Password" /> API.
...
<APIAuthentication icon="undefined"></APIAuthentication>
...
<APIURI method="POST">/api/user/change-password</APIURI>

<APIURI method="POST">/api/user/change-password/`{changePasswordId}`</APIURI>
...
<APIBlock>
  <APIField name="changePasswordId" type="String" required deprecated>
    ...
    <span class="text-red-700">Deprecated in version 1.33.0</span>
...
<APIAuthentication icon="lock">Changes a User's password using an email address or username.</APIAuthentication>
...
<APIAuthentication icon="badge">Changes a User's password using a JWT</APIAuthentication>
...
|400 |The request was invalid and/or malformed. The response will contain an [Errors](/docs/apis/errors) JSON Object with the specific errors. <br /> Beginning in version `1.33.0` a status code of `400` may also be used to indicate additional trust is required to complete this request. In this case the following error will be returned.

<JSON title="Example Response JSON" src="errors/requires-trust-token-response.json" />

|  |  |
| --- | --- |
| | To complete this request you must obtain a `trustToken`. To obtain a `trustToken` complete a Two-Factor Login request. <br /> Beginning in version `1.43.0` a status code of `400` may also indicate that the supplied `currentPassword` or `loginId` were incorrect if the call was made with an API key. For security reasons without an API key this will return a `404`.
|401 |You did not supply a valid Authorization header. The header was omitted or your API key was not valid. The response will be empty. See [Authentication](/docs/apis/authentication).
