...
<APIField name="refreshToken" type="String">
  ...
  Configure the <InlineField>application.loginConfiguration.generateRefreshTokens</InlineField> setting via the API or enable the setting by navigating to the **Application -> My Application -> Security** tab.
</APIField>
