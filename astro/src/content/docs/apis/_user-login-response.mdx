...
<APIField name="refreshToken" type="String">
  ...
  Configure the **application.loginConfiguration.generateRefreshTokens** setting via the API or enable the setting by navigating to the <Breadcrumb>Application -> My Application -> Security</Breadcrumb> tab.
</APIField>
