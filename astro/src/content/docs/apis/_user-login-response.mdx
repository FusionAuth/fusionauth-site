...
<APIField name="emailVerificationId" type="String">
  ...
  This field is only returned when the <InlineField>tenant.emailConfiguration.verificationStrategy</InlineField> is set to `FormField`.
</APIField>

<APIField name="identityVerificationId" type="String" since="1.59.0">
  ...
  * An email address - the <InlineField>tenant.emailConfiguration.verificationStrategy</InlineField> is set to `FormField`.
  * A phone number - the <InlineField>tenant.phoneConfiguration.verificationStrategy</InlineField> is set to `FormField`.
</APIField>
