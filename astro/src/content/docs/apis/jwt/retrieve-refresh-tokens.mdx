...
htmlTitle: Retrieve Refresh Tokens API
description: API documentation for the FusionAuth Retrieve Refresh Tokens API.
tags: fusionauth api, rest api, http api, json web token, jwt, refresh token, retrieve refresh token, session management
order: 500
---
...
import RefreshTokenResponseBody from 'src/content/docs/apis/jwt/_refresh-token-response-body.mdx';
import RefreshTokensResponseBody from 'src/content/docs/apis/jwt/_refresh-tokens-response-body.mdx';
