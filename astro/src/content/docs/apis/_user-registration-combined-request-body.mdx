...
<APIBlock>
  ...
  <APIField name="user.password" type="String" optional>
    ...
    This field is optional only if `sendSetPasswordEmail` is set to <InlineFieldValue>true</InlineFieldValue>. By default `sendSetPasswordEmail` is <InlineFieldValue>false</InlineFieldValue>, and then this field will be required.
  </APIField>
