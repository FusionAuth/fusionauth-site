...
<APIBlock>
  <APIField name="webhook.applicationIds" type="Array<UUID>" optional deprecated>
    The Ids of the Applications that this Webhook should be associated with. If no Ids are specified and the <InlineField>global</InlineField> field is <InlineFieldValue>false</InlineFieldValue>, this Webhook will not be used. Typically <InlineField>global</InlineField> should be set to <InlineFieldValue>true</InlineFieldValue>.
  ...
  <APIField name="webhook.global" type="Boolean" optional defaults="false">
    ...
    <Aside type="version" title="Before version 1.37.0">
      Whether or not this Webhook is used for all events or just for specific Applications. In almost all cases you want to set this field to <InlineFieldValue>true</InlineFieldValue> and filter on the application Id when processing the webhook.
    </Aside>
  </APIField>
  ...
  <APIField name="webhook.signatureConfiguration.signingKeyId" type="UUID" optional defaults="false" since="1.48.0">
    The Id of the key used to sign webhook events. Required when  <InlineField>webhook.signatureConfiguration</InlineField> is set to <InlineFieldValue>true</InlineFieldValue>.
  </APIField>
  ...
  <APIField name="webhook.tenantIds" type="Array<UUID>" optional since="1.37.0">
    The Ids of the Tenants that this Webhook should be associated with. If no Ids are specified and the <InlineField>global</InlineField> field is <InlineFieldValue>false</InlineFieldValue>, this Webhook will not be used.
  </APIField>
