...
* Update <InlineField>Allowed headers</InlineField> to include <InlineFieldValue>authorization</InlineFieldValue>, <InlineFieldValue>accept</InlineFieldValue> and <InlineFieldValue>content-type</InlineFieldValue> headers.
