...
Please install FusionAuth locally, using [Docker or any other supported method](/docs/get-started/download-and-install), to use the <ScrollRef target="Explorer" />.

After you install FusionAuth, make sure you have [created an API key with the correct permissions](/docs/v1/tech/apis/authentication#managing-api-keys). This API key will not be stored.
