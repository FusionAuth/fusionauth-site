...
The general workflow is to call the start API, optionally call the send API to have FusionAuth send the verification message to the user, then call the complete API based on what the user has provided to complete verification.

The main use cases for these APIs are:
...
| DIY Login                        | N/A                      | N/A                     | Yes if you want to use `FormField` verification or if you don't want to use FusionAuth's `ClickableLink` page |
| DIY Resend verification          | Yes                      | Yes                     | N/A                                                                                           |
