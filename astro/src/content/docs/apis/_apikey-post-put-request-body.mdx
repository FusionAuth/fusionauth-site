...
<APIBlock>
  ...
  <APIField name="apiKey.name" type="String" optional since="1.56.0">
    ...
    If <InlineField>apiKey.retrievable</InlineField> is <InlineFieldValue>false</InlineFieldValue> then this field is required.
  </APIField>
  ...
  <APIField name="apiKey.retrievable" type="Boolean" optional since="1.56.0" defaults="true">
    ...
    This value is read-only once the key is created. If this value is set to <InlineFieldValue>false</InlineFieldValue> then the <InlineField>apiKey.name</InlineField> field is required.
  </APIField>
