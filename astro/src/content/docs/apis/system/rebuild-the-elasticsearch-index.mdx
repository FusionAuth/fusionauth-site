...
htmlTitle: Rebuild the Elasticsearch index API
description: API documentation for the FusionAuth Rebuild the Elasticsearch index API.
tags: fusionauth api, rest api, http api, system, elasticsearch, search index, reindex, elasticsearch reindex
order: 600
---
import ReindexRequestBody from 'src/content/docs/apis/system/_reindex-request-body.mdx';
