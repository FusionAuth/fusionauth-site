...
htmlTitle: Search for IP ACLs API
description: API documentation for the FusionAuth Search for IP ACLs API.
tags: fusionauth api, rest api, http api, ip access control list, ip acl, ip restriction, access control, search ip acl
order: 300
---
import IpAclResponseBody from 'src/content/docs/apis/ip-acl/_ip-acl-response-body.mdx';
import IpAclResponseBodySearch from 'src/content/docs/apis/ip-acl/_ip-acl-response-body-search.mdx';
