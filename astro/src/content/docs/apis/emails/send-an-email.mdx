---
title: Send an Email
htmlTitle: Send an Email API
description: API documentation for the FusionAuth Send an Email API.
tags: send email, email template, transactional email, smtp, email notification, send notification, user email, fusionauth api, rest api, http api
order: 700
---
import StandardPostResponseCodes from 'src/content/docs/apis/_shared/_standard-post-response-codes.astro';
import SendResponseBody from 'src/content/docs/apis/emails/_send-response-body.mdx';
