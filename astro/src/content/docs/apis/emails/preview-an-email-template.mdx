...
htmlTitle: Preview an Email Template API
description: API documentation for the FusionAuth Preview an Email Template API.
tags: email template, preview email template, transactional email, smtp, email configuration, freemarker, test email template, fusionauth api, rest api, http api
order: 600
---
import StandardPostResponseCodes from 'src/content/docs/apis/_shared/_standard-post-response-codes.astro';
import EmailPreviewResponseBody from 'src/content/docs/apis/emails/_email-preview-response-body.mdx';
