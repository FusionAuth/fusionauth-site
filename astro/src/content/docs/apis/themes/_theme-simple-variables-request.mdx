...
<APIField name={(props.search ? "themes[x]." : "theme.") + "variables.footerDisplay"} type="Boolean" optional>
  Determines if the "powered by FusionAuth" footer is displayed in the theme. A valid license is required to set this value to <InlineFieldValue>false</InlineFieldValue>.
</APIField>
