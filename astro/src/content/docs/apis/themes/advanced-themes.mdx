...
UI login themes can be configured to enable custom branding for your FusionAuth login workflow.  Themes are configured per Tenant or optionally by Application. This page will assume that the **`theme.type`** of your theme is `advanced`; for a simple theme, see [Simple Themes APIs](/docs/apis/themes/simple-themes).
...
<Tabs>
      ...
      To create a copy of an existing theme, pass the following request body:
