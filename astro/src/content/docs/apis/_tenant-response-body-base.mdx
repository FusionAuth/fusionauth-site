...
{ props.base_field_name !== 'tenant' &&
  ...
  <APIField name={props.base_field_name + '.jwtConfiguration.accessTokenVerificationKeyIds'} type="Array<UUID>" since="1.69.0">
    The list of access token verification key Ids that are trusted by this tenant. **tenant.jwtConfiguration.accessTokenKeyId** is implicitly included in this list and is not explicitly specified.
  </APIField>
  ...
  <APIField name={props.base_field_name + '.jwtConfiguration.idTokenVerificationKeyIds'} type="Array<UUID>" since="1.69.0">
    The list of Id token verification key Ids that are trusted by this tenant. **tenant.jwtConfiguration.idTokenKeyId** is implicitly included in this list and is not explicitly specified.
   </APIField>
