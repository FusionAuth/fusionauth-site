...
{ props.base_field_name !== 'tenant' &&
  ...
  <APIField name={props.base_field_name + '.jwtConfiguration.accessTokenVerificationKeyIds'} type="Array<UUID>" since="1.69.0">
      The list of access token verification key Ids that are trusted by this FusionAuth tenant. **tenant.jwtConfiguration.accessTokenKeyId** is implicitly included in this list and will not be explicitly specified.
  </APIField>
