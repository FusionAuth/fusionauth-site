...
<APIBlock>
  ...
  <APIField name="tenant.jwtConfiguration.accessTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of access token verification key Ids that are trusted by this tenant. **tenant.jwtConfiguration.accessTokenKeyId** is implicitly included in this list and does not need to be explicitly specified.
  ...
  <APIField name="tenant.jwtConfiguration.idTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of Id token verification key Ids that are trusted by this tenant. **tenant.jwtConfiguration.idTokenKeyId** is implicitly included in this list and does not need to be explicitly specified.
