...
htmlTitle: Complete a Passwordless Login API
description: API documentation for the FusionAuth Complete a Passwordless Login API.
tags: fusionauth api, rest api, http api, passwordless, magic link, one-time password, email login, passwordless login
order: 300
---
...
<APIBlock>
  ...
  <APIField name="code" type="String" required>
    The unique code sent to the user that will complete the login request.
  </APIField>
