...
{ props.include_total &&
  ...
  <APIField name={`${props.base_field_name}.applicationIds`} type="Array<UUID>" optional deprecated>
    ...
    The Ids of the Applications that this Webhook is associated with. If no Ids are returned and the <InlineField>global</InlineField> field is <InlineFieldValue>false</InlineFieldValue>, this Webhook is not used. Typically <InlineField>global</InlineField> should be set to <InlineFieldValue>true</InlineFieldValue>.
    </p>{/* eslint-disable-line */}
  ...
  <APIField name={`${props.base_field_name}.tenantIds`} type="Array<UUID>" optional since="1.37.0">
    The Ids of the Tenants that this Webhook is associated with. If no Ids are returned and the <InlineField>global</InlineField> field is <InlineFieldValue>false</InlineFieldValue>, this Webhook is not used.
  </APIField>
