...
<APIBlock>
  ...
  <APIField name="user.identities[x].displayValue" since="1.99.9">
    ...
    will be the same as <InlineField>user.identities[x].value</InlineField>. Otherwise, it will be the username the user has chosen.
  </APIField>
  ...
  <APIField name="user.identities[x].moderationStatus" since="1.99.9"></APIField>
  <APIField name="user.identities[x].primary" since="1.99.9"></APIField>
  <APIField name="user.identities[x].type" since="1.99.9"></APIField>
  <APIField name="user.identities[x].value" since="1.99.9"></APIField>
