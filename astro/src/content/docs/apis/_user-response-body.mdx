...
<APIBlock>
  ...
  <APIField name="user.identities[x].lastLoginInstant" type="Long" since="1.99.9">
    The [instant](/docs/reference/data-types#instants) when the identity was last used to login. If a User has multiple identity
    types (`username`, `email`, and `phoneNumber`), then this value will represent the specific identity they last used to login. This contrasts
    with <InlineField>user.lastLoginInstant</InlineField>, which represents the last time any of the User's identities was used
    to login.
  </APIField>
  ...
  <APIField name="user.identities[x].value" type="String" since="1.99.9">
    The value represented by the identity. The contents of this field depend on <InlineField>user.identities[x].type</InlineField>.
    ...
    It could be one of the following:
       ...
       * Username - User's username
           * If the unique usernames feature is enabled, this will be the unique username (within the tenant)
            For primary username identities, this will be the same value as <InlineField>user.uniqueUsername</InlineField>
           * If the unique usernames feature is not enabled, this will be the same as <InlineField>user.identities[x].displayValue</InlineField>.
            For primary username identities, this will be the same value as <InlineField>user.username</InlineField>
