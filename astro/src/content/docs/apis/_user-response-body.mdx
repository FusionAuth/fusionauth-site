...
<APIBlock>
  ...
  <APIField name="user.identities[x].displayValue" since="1.99.9">
  ...
  <APIField name="user.identities[x].insertInstant" since="1.99.9">
    The [instant](/docs/reference/data-types#instants) when the identity was created.
  </APIField>
  <APIField name="user.identities[x].lastLoginInstant" since="1.99.9">
  ...
  <APIField name="user.identities[x].lastUpdateInstant" since="1.99.9">
    The [instant](/docs/reference/data-types#instants) when the identity was last updated.
  </APIField>
  <APIField name="user.identities[x].moderationStatus" since="1.99.9">
  ...
  <APIField name="user.identities[x].primary" since="1.99.9">
    Reserved for future use.
  </APIField>
  <APIField name="user.identities[x].type" since="1.99.9">
    <IdentityTypeResponse/>
  </APIField>
  <APIField name="user.identities[x].value" since="1.99.9">
  ...
  <APIField name="user.identities[x].verified" since="1.99.9"></APIField>
  <APIField name="user.identities[x].verifiedInstant" since="1.99.9"></APIField>
  <APIField name="user.identities[x].verifiedReason" since="1.99.9"></APIField>
