...
<APIBlock>
  ...
  <APIField name="skipVerification" type="Boolean" optional defaults="false">
    ...
    Setting this to <InlineFieldValue>true</InlineFieldValue> will set the <InlineField>user.verified</InlineField> field to <InlineFieldValue>true</InlineFieldValue> as well.
  </APIField>
