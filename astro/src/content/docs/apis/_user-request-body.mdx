...
<APIBlock>
  ...
  <APIField name="user.password" type="String" optional>
    ...
    { props.http_method === 'POST' &&
        <p>
          This field is optional only if <code>sendSetPasswordEmail</code> or  <code>sendSetPasswordPhone</code> is set to <code>true</code>. By default <code>sendSetPasswordEmail</code> and <code>sendSetPasswordPhone</code> are <code>false</code>, and then this field will be required.
        </p>
      }
