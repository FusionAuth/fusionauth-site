...
<APIBlock>
  ...
  <APIField name="disableDomainBlock" type="Boolean" optional defaults="false" since="1.30.0">
    ...
    Setting this property equal to <InlineFieldValue>true</InlineFieldValue> will override the tenant configuration. See <InlineField>tenant.registrationConfiguration.blockedDomains</InlineField> in the [Tenant API](tenants).
  </APIField>
  ...
  <APIField name="skipVerification" type="Boolean" optional defaults="false">
    ...
    * Set <InlineField>user.identities\[x].verified</InlineField> field to <InlineFieldValue>false</InlineFieldValue>
    ...
    * Set <InlineField>user.verified</InlineField> field to <InlineFieldValue>true</InlineFieldValue> (if an email identity was created or added)
  </APIField>
