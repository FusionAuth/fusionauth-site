...
<APIBlock>
  ...
  <APIField name="user.password" type="String" optional>
    ...
    { props.http_method === 'POST' &&
        <p>
          This field is required unless <code>sendSetPasswordEmail</code> is <code>true</code>, or <code>sendSetPasswordIdentityType</code> is set to something besides <code>doNotSend</code>. Note that by default, <code>sendSetPasswordIdentityType</code> is <code>doNotSend</code>.
        </p>
      }
