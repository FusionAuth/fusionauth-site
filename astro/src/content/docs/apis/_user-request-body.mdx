...
<APIBlock>
  ...
  { props.http_method === 'PUT' &&
    <APIField name="passwordFieldType" since="1.69.0" optional defaults="PLAINTEXT">
        ...
        <table>
            <thead>
                <tr>
                    <th>**passwordFieldType** value</th>
                    <th>**user.password** interpreted as</th>
            ...
            <tr>
                ...
                <td>`user.encryptionScheme`, `user.factor`, `user.password`, and `user.salt`</td>
            </tr>
            <tr>
                <td>`PLAINTEXT`</td>
                <td>a plain text/unhashed value. FusionAuth will hash and store this value according to **user.encryptionScheme** and **user.factor**.</td>
                <td>N/A</td>
            </tr>
            </tbody>
        </table>
