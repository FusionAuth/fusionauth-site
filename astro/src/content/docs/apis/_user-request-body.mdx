...
<APIBlock>
  ...
  <APIField name="user.legacyIdentifier" type="String" optional>
    A legacy identifier for the User. This value is not used by FusionAuth and is provided for migration purposes.
  </APIField>
