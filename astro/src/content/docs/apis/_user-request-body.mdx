...
<APIBlock>
  ...
  <APIField name="user.mobilePhone" type="String" optional>
    ...
    <Aside>
      This differs from <InlineField>user.phoneNumber</InlineField> and cannot be used to log in.
    </Aside>
  </APIField>
  ...
  <APIField name="user.phoneNumber" type="String" optional since="1.99.9">
    ...
    If phoneNumber is not provided, then <InlineField>email</InlineField> or <InlineField>username</InlineField> will be required.
