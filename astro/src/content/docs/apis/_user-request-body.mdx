...
<APIBlock>
  ...
  <APIField name="user.data" type="Object" optional>
    An object that can hold any information about a User that should be persisted. Please review the [limits on data field types](/docs/get-started/core-concepts/limitations#data-field-limitations) as you plan for and build your custom data schema.
  </APIField>
  ...
  <APIField name="user.encryptionScheme" type="String" optional>
    The method for encrypting the User's password. The following encryptors are provided with FusionAuth:
        ...
        * `[salted-pbkdf2-hmac-sha256-512]` &nbsp; [since](/docs/reference/password-hashes#salted-pbkdf2-hmac-sha-256)#Available since 1.34.0#
        * `[bcrypt](/docs/reference/password-hashes#salted-bcrypt)`
        * `[phpass-md5]` &nbsp; [since](/docs/reference/password-hashes#phpass-md5)#Available since 1.45.0#
        * `[phpass-sha512]` &nbsp; [since](/docs/reference/password-hashes#phpass-sha-512)#Available since 1.45.0#
  ...
  <APIField name="user.twoFactorEnabled" type="Boolean" optional defaults="false" deprecated>
    ...
    See the [Enable Two Factor](/docs/apis/messengers/two-factor#enable-multi-factor) and [Disable Two Factor](/docs/apis/messengers/two-factor#disable-multi-factor) APIs
  ...
  <APIField name="user.twoFactorSecret" type="String" optional deprecated>
    ...
    You may optionally use value provided in the `secret` field returned by the [Two Factor Secret](/docs/apis/messengers/two-factor#generate-a-secret) API
