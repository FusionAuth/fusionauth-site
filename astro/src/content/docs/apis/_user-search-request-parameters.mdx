...
<APIBlock>
  ...
  { props.query_string_request &&
    <APIField name={props.parameter_prefix + 'ids'} type="UUID" optional>
      ...
      { props.database_search_engine_type &&
        <p>Using this parameter is mutually exclusive with the <b>queryString</b> field and is not paginated or sorted using the <b>sortFields</b> field.</p>
      }

      { props.elasticsearch_search_engine_type && <>
        <p>Using this parameter is mutually exclusive with the <b>query</b> and <b>queryString</b> fields and is not paginated or sorted using <b>sortFields</b> field.</p>
  ...
  { !props.query_string_request &&
    <APIField name={props.parameter_prefix + 'ids'} type="Array<UUID>" optional>
      <p>A list of User Ids to retrieve. When using this parameter, the results are not paginated or sorted using the <b>sortFields</b>. </p>

      { props.database_search_engine_type &&
        <p>
        The <b>{props.parameter_prefix}ids</b> and <b>queryString</b> parameters are mutually exclusive, they are listed here in order of precedence.
        </p>
      }

      { props.elasticsearch_search_engine_type && <>
        <p>
        The <b>{props.parameter_prefix}ids</b>, <b>query</b>, and <b>queryString</b> parameters are mutually exclusive, they are listed here in order of precedence.
        </p>
  ...
  {props.elasticsearch_search_engine_type &&
    <APIField name={props.parameter_prefix + 'query'} type="String" optional since="1.13.0">
      <p>
      The raw JSON Elasticsearch query that is used to search for Users. The <b>ids</b>, <b>query</b>, and <b>queryString</b> parameters are mutually exclusive, they are listed here in order of precedence.
      </p>

      <p>
      It is necessary to use the <b>{props.parameter_prefix}query</b> parameter when querying against <code>registrations</code> in order to achieve expected results, as this field is defined as a <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.3/nested.html">nested datatype</a> in the Elasticsearch mapping.
      </p>
    </APIField>
  }
  ...
  {props.database_search_engine_type &&
    <APIField name={props.parameter_prefix + 'queryString'} type="String" optional>
      <p>
        A query string that is used to search for Users. Using this parameter is mutually exclusive with the <b>ids</b> field.
      </p>
      ...
      <ul>
        ...
        <li><code>phoneNumber</code> <AvailableSince since="1.59.0" /></li>
  ...
  { props.elasticsearch_search_engine_type &&
    <APIField name={props.parameter_prefix + 'queryString'} type="String" optional>
      <p>
      The Elasticsearch query string that is used to search for Users.  The <b>ids</b>, <b>query</b>, and <b>queryString</b> parameters are mutually exclusive, they are listed here in order of precedence.
      </p>
  ...
  { props.database_search_engine_type &&
    <APIField name={props.parameter_prefix + 'sortFields[x].name'} type="String" required>
      ...
      <p>
      Required if <b>sortFields</b> is provided.
      </p>
  ...
  {props.elasticsearch_search_engine_type &&
    <APIField name={props.parameter_prefix + 'sortFields[x].name'} type="String" optional>
      ...
      <ul>
        ...
        <li><code>email</code></li>
        <li><code>fullName</code></li>
        <li><code>id" since="1.13.0</code></li>
        <li><code>insertInstant</code></li>
        <li><code>lastLoginInstant" since="1.13.0</code></li>
        <li><code>login</code></li>
        <li><code>phoneNumber</code></li>
        <li><code>registrations.applicationId</code></li>
        <li><code>registrations.id</code></li>
        <li><code>registrations.insertInstant</code></li>
        <li><code>registrations.lastLoginInstant</code></li>
        <li><code>registrations.roles</code></li>
        <li><code>tenantId</code></li>
        <li><code>username</code></li>
      </ul>
    </APIField>
