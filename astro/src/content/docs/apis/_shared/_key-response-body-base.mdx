...
<If condition={props.base_field_name === 'key'}>
...
<If condition={props.base_field_name !== 'key' && !!props.include_total}>
  <JSON title="Example Response JSON" src="keys/search-response.json" />
</If>

<If condition={props.base_field_name !== 'key' && !props.include_total}>
  <JSON title="Example Response JSON" src="keys/responses.json" />
</If>
