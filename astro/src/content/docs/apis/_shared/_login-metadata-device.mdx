...
<APIField name="metaData.device.description" type="String" optional since={props.since}>
...
<APIField name="metaData.device.lastAccessedAddress" type="String" optional renderif={props.lastAccessedAddress_mutable} since={props.since}>
The IP address which made this request.
</APIField>
<APIField name="metaData.device.name" type="String" optional since={props.since}>
...
<APIField name="metaData.device.type" type="String" optional since={props.since}>
