...
<If condition={props.include_total}>
  <JSON title="Example Response JSON for Email Template Search" src="email-templates/search-response.json" />
</If>

<If condition={!props.include_total && props.base_field_name === 'emailTemplate'}>
  <JSON title="Example Response JSON for a Single Email Template" src="email-templates/response.json" />
</If>

<If condition={!props.include_total && props.base_field_name !== 'emailTemplate'}>
  <JSON title="Example Response JSON for all the Email Templates" src="email-templates/responses.json" />
</If>
