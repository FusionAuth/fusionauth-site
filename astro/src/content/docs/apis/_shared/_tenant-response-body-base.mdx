...
{ props.base_field_name !== 'tenant' &&
  ...
  <APIField name={props.base_field_name + '.familyConfiguration.deleteOrphanedAccounts'} type="Boolean" since="1.8.0">
    Indicates that child users without parental verification will be permanently deleted after **{props.base_field_name}.familyConfiguration.deleteOrphanedAccountsDays** days.
  </APIField>
  ...
  <APIField name={props.base_field_name + '.jwtConfiguration.accessTokenVerificationKeyIds'} type="Array<UUID>" since="1.69.0">
  ...
  <APIField name={props.base_field_name + '.jwtConfiguration.idTokenVerificationKeyIds'} type="Array<UUID>" since="1.69.0">
  ...
  <APIField name={props.base_field_name + '.userDeletePolicy.unverified.enabled'} type="Boolean" since="1.13.0">
    Indicates that users without a verified email address will be permanently deleted after **{props.base_field_name}.userDeletePolicy.unverified.numberOfDaysToRetain** days.
  </APIField>
...
{ props.include_total &&
  <APIField name="total" type="Integer">
    The total number of Tenants matching the search criteria. Use this value along with the <b>numberOfResults</b> and <b>startRow</b> in the Search request to perform pagination.
  </APIField>
}
</APIBlock>
