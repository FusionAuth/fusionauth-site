...
htmlTitle: Search for Group Members API
description: API documentation for the FusionAuth Search for Group Members API.
tags: fusionauth api, rest api, http api, group management, user groups, group membership, search group members
order: 900
---
import MembersResponseBodySearch from 'src/content/docs/apis/groups/_members-response-body-search.mdx';
