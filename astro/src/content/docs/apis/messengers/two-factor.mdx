...
import EditionBlurb from 'src/content/docs/_shared/_edition-blurb.astro';
...
import TwoFactorEnableRequestBody from 'src/content/docs/apis/messengers/_two-factor-enable-request-body.mdx';
import TwoFactorEnableResponse from 'src/content/docs/apis/messengers/_two-factor-enable-response.mdx';
import TwoFactorDisableRequestParameters from 'src/content/docs/apis/messengers/_two-factor-disable-request-parameters.mdx';
import TwoFactorDisableRequestBody from 'src/content/docs/apis/messengers/_two-factor-disable-request-body.mdx';
import JSON from 'src/components/JSON.astro';
import StandardGetResponseCodes from 'src/content/docs/apis/_standard-get-response-codes.astro';
import TwoFactorStartRequestBody from 'src/content/docs/apis/messengers/_two-factor-start-request-body.mdx';
import StandardPostResponseCodes from 'src/content/docs/apis/_standard-post-response-codes.astro';
import TwoFactorStartResponseBody from 'src/content/docs/apis/messengers/_two-factor-start-response-body.mdx';

<EditionBlurb>
  Email and SMS multi--factor methods are only available in paid editions of FusionAuth. Please visit [our pricing page](/pricing) to learn more about paid editions.
</EditionBlurb>

<Aside type="caution">
This API underwent breaking changes in version 1.26.

If you are using a version of FusionAuth prior to 1.26.0, you should upgrade. 😎 &nbsp; But if you cannot - here is the doc you are looking for: [old Two Factor doc](two-factor-1-25).
</Aside>
...
<APIAuthentication icon="lock">Enable Multi-Factor Authentication by User Id</APIAuthentication>
...
<APIAuthentication icon="badge">Enable Multi-Factor Authentication Using a JWT</APIAuthentication>
...
<APIAuthentication icon="lock">Disable a single multi-factor method by User Id</APIAuthentication>
<APIURI method="DELETE">/api/user/two-factor/`{userId}?code={code}&methodId={methodId}`</APIURI>
...
<APIAuthentication icon="lock">Disable a single multi-factor method by User Id</APIAuthentication>
<APIURI method="DELETE">/api/user/two-factor/`{userId}`</APIURI>
...
<APIAuthentication icon="badge">Disable a single multi-factor method using a JWT</APIAuthentication>
<APIURI method="DELETE">/api/user/two-factor</APIURI>
...
<APIAuthentication icon="badge">Disable a single multi-factor method using a JWT</APIAuthentication>
<APIURI method="DELETE">/api/user/two-factor`?code={code}&methodId={methodId}`</APIURI>
...
<APIAuthentication icon="lock">Generate a multi-factor Secret</APIAuthentication>
<APIURI method="GET">/api/two-factor/secret</APIURI>

<APIAuthentication icon="badge">Generate a multi-factor Secret</APIAuthentication>
<APIURI method="GET">/api/two-factor/secret</APIURI>
...
<APIAuthentication icon="lock">Start multi-factor authentication</APIAuthentication>
<APIURI method="POST">/api/two-factor/start</APIURI>
...
<APIAuthentication icon="lock">Retrieve multi-factor status</APIAuthentication>
<APIURI method="GET">/api/two-factor/status/`{twoFactorTrustId}`</APIURI>
...
<APIAuthentication icon="unlock">Send a multi-factor code to complete Multi-Factor Login</APIAuthentication>
...
<APIAuthentication icon="lock">Send a Multi-Factor code to an existing User by Id</APIAuthentication>
...
<APIAuthentication icon="badge">Send a Multi-Factor code to an authenticated User using a JWT</APIAuthentication>
<APIURI method="POST">/api/two-factor/send</APIURI>
...
<APIAuthentication icon="lock">Create Recovery Codes</APIAuthentication>
<APIURI method="POST">/api/user/two-factor/recovery-code/`{userId}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve Recovery Codes</APIAuthentication>
<APIURI method="GET">/api/user/two-factor/recovery-code/`{userId}`</APIURI>
