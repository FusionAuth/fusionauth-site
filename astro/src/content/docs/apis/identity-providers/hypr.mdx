...
<API method="PUT" uri="/api/identity-provider?type=HYPR" authentication={["api-key"]} title="Update the HYPR Identity Provider by type"/>

<PatchSupport api_endpoint="/api/identity-provider`?type=HYPR`" />

<br/>

<API method="PUT" uri="/api/identity-provider/778985b7-6fd8-414d-acf2-94f18fb7c7e0" authentication={["api-key"]} title="Update the HYPR Identity Provider by Id"/>
