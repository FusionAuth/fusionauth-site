...
<APIBlock>
  ...
  { props.api_type === 'Google' && <>

  <APIField name="identityProvider.applicationConfiguration[applicationId].properties" type="Object" since="1.44.0">
    This is an optional Application specific override for the top level <InlineField>properties</InlineField>.
  </APIField>
  <APIField name="identityProvider.applicationConfiguration[applicationId].properties.api" type="String" since="1.44.0">
    This is an optional Application specific override for the top level <InlineField>properties.api</InlineField>.
  </APIField>
  <APIField name="identityProvider.applicationConfiguration[applicationId].properties.button" type="String" since="1.44.0">
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].webAPIKey" type="String">
    This is an optional Application specific override for the top level <InlineField>webAPIKey</InlineField>.
  </APIField>
  <APIField name="identityProvider.apiMode" type="String" since="1.44.0">
  ...
  <APIField name="identityProvider.id" type="UUID">
    The Id of the {props.idp_display_name} identity provider, which will always be `{idp_id}`.
  </APIField>
  ...
  { props.idp_type === 'Gooogle' && <>

  <APIField name="identityProvider.properties" type="Object" since="1.44.0">
  ...
  <APIField name="identityProvider.properties.api" type="String" since="1.44.0">
  ...
  <APIField name="identityProvider.properties.button" type="String" since="1.44.0">
