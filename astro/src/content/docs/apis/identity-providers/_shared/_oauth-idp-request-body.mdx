...
import IdentityProviderTenantConfiguration from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-tenant-configuration.mdx';
import IdentityProviderDebugRequestParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-debug-request-parameter.mdx';
import IdentityProviderAttributeMappingsRequestParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-attribute-mappings-request-parameter.mdx';
import IdentityProviderReconcileidRequestParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-reconcileid-request-parameter.mdx';
import IdentityProviderLinkingStrategyRequestParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-linking-strategy-request-parameter.mdx';
import IdentityProviderLoginMethodRequestParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-login-method-request-parameter.mdx';
import IdentityProviderSourceRequestParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-source-request-parameter.mdx';
...
<APIBlock>
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].apiMode" type="String" optional since="1.44.0" renderif={props.idp_type === 'Steam'}>
    This is an optional Application specific override for the top level <b>apiMode</b>.
  </APIField>
  <APIField name="identityProvider.applicationConfiguration[applicationId].buttonText" type="String" optional>
    This is an optional Application specific override for the top level <b>buttonText</b>.

    {props.idp_type === 'Google' && <>
      <Aside type="version" title="Since 1.44.0">

        <p>
        The <b>identityProvider.applicationConfiguration[applicationId].buttonText</b> value may only be used when the <b>identityProvider.loginMethod</b> is set to <code>UseRedirect</code>. The button text is managed by Google for all other configurations. Google allows for minor adjustments using their API. You may specify any valid API parameter in the <b>identityProvider.properties.button</b> configuration.
        </p>
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].client_id" type="String" optional>
    This is an optional Application specific override for the top level <b>client_id</b>.
  </APIField>
  <APIField name="identityProvider.applicationConfiguration[applicationId].client_secret" type="String" optional renderif={props.idp_type !== 'Steam'}>
    This is an optional Application specific override for the top level <b>client_secret</b>.
  </APIField>
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].properties" type="Object" optional since="1.44.0">
    This is an optional Application specific override for the top level <b>properties</b>.
  </APIField>
  <APIField name="identityProvider.applicationConfiguration[applicationId].properties.api" type="String" optional since="1.44.0">
    This is an optional Application specific override for the top level <b>properties.api</b>.

    If this Application's <b>loginMethod</b> is set to <code>UsePopup</code>, or the Application configuration is unset and the top level <b>loginMethod</b> is set to <code>UsePopup</code>, and this value contains the conflicting <code>ux_mode=redirect</code> property, that single property will be replaced with <code>ux_mode=popup</code>.

    <Aside type="version" title="Since 1.45.1">
      The properties specified in this field will override individual properties on the top level <b>properties.api</b> rather than overriding the entire <b>properties.api</b> value.
    </Aside>
  </APIField>
  <APIField name="identityProvider.applicationConfiguration[applicationId].properties.button" type="String" optional since="1.44.0">
    This is an optional Application specific override for the top level <b>properties.button</b>.

    <Aside type="version" title="Since 1.45.1">
      The properties specified in this field will override individual properties on the top level <b>properties.button</b> rather than overriding the entire <b>properties.button</b> value.
    </Aside>
  </APIField>
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].scope" type="String" optional renderif={props.idp_type !== 'Steam'}>
    This is an optional Application specific override for the top level <b>scope</b>.

    { props.idp_type === 'Google' && <>
      <Aside type="version" title="Since 1.44.0">
        The <b>identityProvider.applicationConfiguration[applicationId].scope</b> value may only be used when the <b>identityProvider.loginMethod</b> is set to <code>UseRedirect</code>. The <code>email</code>, <code>profile</code>, and <code>openid</code> scopes will always be requested for all other configurations.
      </Aside>
    </>}
  </APIField>
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].webAPIKey" type="String" optional renderif={props.idp_type === 'Steam'}>
    This is an optional Application specific override for the top level <b>webAPIKey</b>.
  </APIField>
  ...
  <APIField name="identityProvider.buttonText" type="String" required>
    ...
    { props.idp_type === 'Google' && <>
      <Aside type="version" title="Since 1.44.0">
        The <b>identityProvider.buttonText</b> value may only be used when the <b>identityProvider.loginMethod</b> is set to <code>UseRedirect</code>. The button text is managed by Google for all other configurations. Google allows for minor adjustments using their API. You may specify any valid API parameter in the <b>identityProvider.properties.button</b> configuration.
      </Aside>
    </>}
  </APIField>
  ...
  <APIField name="identityProvider.name" type="String" optional>
    The display name of this provider instance. Required when using a provided <b>identityProviderId</b> or <b>identityProvider.tenantId</b>.
  </APIField>
  <APIField name="identityProvider.properties" type="Object" optional since="1.44.0" renderif={props.idp_type === 'Google'}>
    An object to hold configuration parameters for the [Google Identity Services API](https://developers.google.com/identity/gsi/web/reference/html-reference). See the <b>identityProvider.properties.api</b> and <b>identityProvider.properties.button</b> fields for more detail on format and configurable values.
  </APIField>
  <APIField name="identityProvider.properties.api" type="String" optional since="1.44.0" renderif={props.idp_type === 'Google'}>
    ...
    If the <b>identityProvider.loginMethod</b> is set to `UsePopup` and this value contains the conflicting `ux_mode=redirect` property, that single property will be replaced with `ux_mode=popup`.
  ...
  <APIField name="identityProvider.scope" type="String" optional renderif={props.idp_type !== 'Steam'}>
    ...
    { props.idp_type === 'Google' && <>
      <Aside type="version" title="Since 1.44.0">
        The <b>identityProvider.scope</b> value may only be used when the <b>identityProvider.loginMethod</b> is set to <code>UseRedirect</code>. The <code>email</code>, <code>profile</code>, and <code>openid</code> scopes will always be requested for all other configurations.
      </Aside>
    </>}
  </APIField>
