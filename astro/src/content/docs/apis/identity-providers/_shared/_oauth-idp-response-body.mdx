...
import IdentityProviderDebugResponseParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-debug-response-parameter.mdx';
...
import IdentityProviderLoginMethodResponseParameter from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-login-method-response-parameter.mdx';
...
<APIBlock>
  ...
  <APIField name="identityProvider.properties.button" type="String" since="1.44.0" renderif={props.idp_type === 'Google'}>
    <Breadcrumb>Google Identity Services</Breadcrumb> button configuration in a properties file formatted String. Properties can be referenced in templates that support Google login to render the login button via HTML or JavaScript.
  </APIField>
