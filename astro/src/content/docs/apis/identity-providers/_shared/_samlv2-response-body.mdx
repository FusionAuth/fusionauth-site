...
<APIBlock>
  ...
  <APIField name="identityProvider.issuer" type="String" renderif={!props.samlv2_idp_initiated}>
    ...
    When not configured, the default value is `{'<base_url>/samlv2/sp/<identityProviderId>'}`.
  </APIField>
  <APIField name="identityProvider.issuer" type="String" renderif={props.samlv2_idp_initiated}>
  ...
  <APIField name="identityProvider.keyId" type="UUID" deprecated>
...
<If condition={!props.samlv2_idp_initiated}>
  <JSON title="Example SAML v2 Response JSON" src="identity-providers/samlv2-response.json" />
</If>

<If condition={props.samlv2_idp_initiated}>
  <JSON title="Example SAML v2 IdP Initiated Response JSON" src="identity-providers/samlv2-idp-initiated-response.json" />
</If>
