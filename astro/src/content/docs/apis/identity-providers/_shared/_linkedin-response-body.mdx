...
<APIBlock>
  ...
  <APIField name="identityProvider.name" type="String">
    The name of this LinkedIn identity provider. This is only used for display purposes.
  </APIField>
...
<JSON title="Example LinkedIn Response JSON" src="identity-providers/linkedin-response.json" />
