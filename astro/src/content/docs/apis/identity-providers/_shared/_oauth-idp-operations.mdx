...
The **type** in the request JSON indicates this is the {props.manual_idp_display_name} Identity Provider type.

#### Request Parameters

<APIBlock>
  <APIField name="identityProviderId" type="UUID" optional immutable defaults="secure random UUID" since="1.61.0">
    The Id to use for the new Identity Provider. If an Id is not provided, a secure random UUID is generated. If neither an Id nor **identityProvider.name** are provided, the legacy fixed {props.manual_idp_display_name} IdP Id <code>{props.idp_id}</code> will be used.{/* eslint-disable-line */}
  </APIField>
</APIBlock>
...
<APIBlock>
  <APIField name="identityProviderId" type="UUID" required>
    The unique Id of the {props.manual_idp_display_name} Identity Provider to retrieve.
  </APIField>
</APIBlock>
...
<APIBlock>
  <APIField name="identityProviderId" type="UUID" immutable required>
    The unique Id of the {props.manual_idp_display_name} Identity Provider to update.
  </APIField>
</APIBlock>
...
<APIBlock>
  <APIField name="identityProviderId" type="UUID" required>
    The unique Id of the {props.manual_idp_display_name} Identity Provider to delete.
  </APIField>
</APIBlock>
