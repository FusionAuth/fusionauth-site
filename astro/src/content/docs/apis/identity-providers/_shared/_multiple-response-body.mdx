...
<If condition={props.include_total}>
  <JSON title="Example Response JSON" src="identity-providers/search-response.json" />
</If>

<If condition={!props.include_total}>
  <JSON title="Example Response JSON" src="identity-providers/multiple-responses.json" />
</If>
