...
<APIField name="identityProvider.linkingStrategy" type="String" optional defaults={props.idp_linking_strategy} since={ props.idp_since < 12800 ?"1.28.0" : ''}>
  ...
  The possible values are:
    ...
    * <InlineFieldValue>CreatePendingLink</InlineFieldValue> - Do not automatically link, instead return a pending link identifier that can be used to link to an existing user.
