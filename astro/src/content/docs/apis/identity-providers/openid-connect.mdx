...
htmlTitle: OpenID Connect API
description: Learn about the APIs for creating, retrieving, updating and deleting OpenID Connect identity providers.
tags: fusionauth api, rest api, http api, identity provider, openid connect, oidc, single sign-on, oauth, federated identity, external login
---
...
import OpenidConnectRequestBody from 'src/content/docs/apis/identity-providers/_shared/_openid-connect-request-body.mdx';
import OpenidConnectResponseBody from 'src/content/docs/apis/identity-providers/_shared/_openid-connect-response-body.mdx';
