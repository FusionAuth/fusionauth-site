...
<APIAuthentication icon="lock">Create an OpenID Connect Identity Provider using a randomly generated Id</APIAuthentication>
<APIURI method="POST">/api/identity-provider</APIURI>

<APIAuthentication icon="lock">Create an OpenID Connect Identity Provider with the provided unique id</APIAuthentication>
...
<APIAuthentication icon="lock">Delete an OpenId Connect Identity Provider by Id</APIAuthentication>
...
<APIAuthentication icon="unlock">Complete OpenID Connect Login</APIAuthentication>
