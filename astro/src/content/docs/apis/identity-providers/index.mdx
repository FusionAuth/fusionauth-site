...
htmlTitle: Identity Provider API
description: Learn about the APIs for creating, retrieving, updating and deleting identity providers.
tags: fusionauth api, rest api, http api, identity provider, social login, single sign-on, saml, openid connect, oauth, federated identity, external login
order: 0
---
import StandardGetResponseCodes from 'src/content/docs/apis/_shared/_standard-get-response-codes.astro';
import MultipleResponseBody from 'src/content/docs/apis/identity-providers/_shared/_multiple-response-body.mdx';
import IdentityProviderSearchRequestParameters from 'src/content/docs/apis/identity-providers/_shared/_identity-provider-search-request-parameters.mdx';
import LookupResponseBody from 'src/content/docs/apis/identity-providers/_shared/_lookup-response-body.mdx';
