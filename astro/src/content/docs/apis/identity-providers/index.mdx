...
* [Epic Games](/docs/apis/identity-providers/epicgames) - requires a paid edition.
...
* [Nintendo](/docs/apis/identity-providers/nintendo) - requires a paid edition.
* [OpenID Connect](/docs/apis/identity-providers/openid-connect)
* [SAML v2](/docs/apis/identity-providers/samlv2)
* [SAML v2 IdP Initiated](/docs/apis/identity-providers/samlv2-idp-initiated) - requires a paid edition.
* [Sony PlayStation Network](/docs/apis/identity-providers/sonypsn) - requires a paid edition.
* [Steam](/docs/apis/identity-providers/steam) - requires a paid edition.
* [Twitch](/docs/apis/identity-providers/twitch) - requires a paid edition.
* [Twitter](/docs/apis/identity-providers/twitter)
* [Xbox](/docs/apis/identity-providers/xbox) - requires a paid edition.
...
To learn how to configure these Identity Providers using the FusionAuth UI, go here [Identity Providers](/docs/v1/tech/identity-providers/).
...
<APIAuthentication icon="lock">Retrieve all of the Identity Providers</APIAuthentication>
<APIURI method="GET">/api/identity-provider</APIURI>
...
<APIAuthentication icon="lock">Search for Identity Providers</APIAuthentication>
<APIURI method="GET">/api/identity-provider/search`?name={name}`</APIURI>
...
<APIAuthentication icon="lock">Search for Identity Providers</APIAuthentication>
<APIURI method="POST">/api/identity-provider/search</APIURI>
...
<APIAuthentication icon="unlock">Lookup an Identity Provider by domain/email</APIAuthentication>
<APIURI method="GET">/api/identity-provider/lookup`?domain={domain}`</APIURI>
