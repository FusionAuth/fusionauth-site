...
<API method="PUT" uri="/api/identity-provider?type=Twitter" authentication={["api-key"]} title="Update the Twitter Identity Provider by type"/>

<PatchSupport api_endpoint="/api/identity-provider`?type=Twitter`" />

<API method="PUT" uri="/api/identity-provider/45bb233c-0901-4236-b5ca-ac46e2e0a5a5" authentication={["api-key"]} title="Update the Twitter Identity Provider by Id"/>
