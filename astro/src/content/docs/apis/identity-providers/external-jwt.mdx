---
title: External JWT
htmlTitle: External JWT API
description: Learn about the APIs for creating, retrieving, updating and deleting external JWT identity providers.
tags: fusionauth api, rest api, http api, identity provider, external jwt, jwt federation, federated identity, token-based login, external login
---
...
import ExternalJwtRequestBody from 'src/content/docs/apis/identity-providers/_shared/_external-jwt-request-body.mdx';
import StandardPostResponseCodes from 'src/content/docs/apis/_shared/_standard-post-response-codes.astro';
import ExternalJwtResponseBody from 'src/content/docs/apis/identity-providers/_shared/_external-jwt-response-body.mdx';
