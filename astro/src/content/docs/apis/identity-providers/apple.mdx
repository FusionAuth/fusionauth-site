...
<DeprecatedSince since="1.61.0">Prefer updating by Id. Updating by type will attempt to update the IdP with the legacy fixed Apple IdP Id `13d2a5db-7ef9-4d62-b909-0df58612e775`.</DeprecatedSince>
...
<DeprecatedSince since="1.61.0">Prefer deleting by Id. Deleting by type will attempt to delete the IdP with the legacy fixed Apple IdP Id `13d2a5db-7ef9-4d62-b909-0df58612e775`.</DeprecatedSince>
