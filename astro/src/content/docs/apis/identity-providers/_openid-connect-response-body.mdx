...
<APIBlock>
  ...
  <APIField name="identityProvider.postRequest" type="Boolean" since="1.20.0">
    When this value is equal to <InlineFieldValue>true</InlineFieldValue> POST bindings will be used instead of the default redirect bindings which utilize an HTTP `GET` request.
  </APIField>
