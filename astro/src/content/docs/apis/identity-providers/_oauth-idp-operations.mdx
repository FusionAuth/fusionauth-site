...
Create a {props.manual_idp_display_name} Identity Provider with either a randomly generated Id or one you provide on the URI.
...
Retrieve the {props.manual_idp_display_name} Identity Provider by its Id or by type.
...
Update the {props.manual_idp_display_name} Identity Provider by sending the fields you want to change.
...
Delete the {props.manual_idp_display_name} Identity Provider by its Id or by type.
...
Complete the {props.manual_idp_display_name} login by providing {props.idp_token_or_code} received from the provider.
