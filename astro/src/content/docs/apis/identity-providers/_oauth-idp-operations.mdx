...
<CompleteLoginText token_text_with_article={"a " + props.idp_token_or_code} token_text={props.idp_token_or_code} />
...
<IdentityProviderLoginRequestBody idp_display_name={props.idp_display_name} idp_lowercase={props.idp_lowercase} />
