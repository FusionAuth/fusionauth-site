...
<DeprecatedSince since="1.61.0">Prefer deleting by Id. Deleting by type attempts to delete the Identity Provider with the legacy fixed Id <code>{props.idp_id}</code>.</DeprecatedSince>{/* eslint-disable-line */}
