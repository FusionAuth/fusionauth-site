...
<APIAuthentication icon="lock">Create the Facebook Identity Provider</APIAuthentication>
...
<APIAuthentication icon="lock">Retrieve the Facebook Identity Provider by type</APIAuthentication>
<APIURI method="GET">/api/identity-provider`?type=Facebook`</APIURI>

<APIAuthentication icon="lock">Retrieve the Facebook Identity Provider by Id</APIAuthentication>
<APIURI method="GET">/api/identity-provider/`56abdcc7-8bd9-4321-9621-4e9bbebae494`</APIURI>
...
<APIAuthentication icon="lock">Update the Facebook Identity Provider by type</APIAuthentication>
<APIURI method="PUT">/api/identity-provider`?type=Facebook`</APIURI>

<PatchSupport api_endpoint="/api/identity-provider`?type=Facebook`" />

<APIAuthentication icon="lock">Update the Facebook Identity Provider by Id</APIAuthentication>
<APIURI method="PUT">/api/identity-provider/`56abdcc7-8bd9-4321-9621-4e9bbebae494`</APIURI>

<PatchSupport api_endpoint="/api/identity-provider/`56abdcc7-8bd9-4321-9621-4e9bbebae494`" />
...
<APIAuthentication icon="lock">Delete the Facebook Identity Provider by type</APIAuthentication>
<APIURI method="DELETE">/api/identity-provider`?type=Facebook`</APIURI>

<APIAuthentication icon="lock">Delete the Facebook Identity Provider by Id</APIAuthentication>
<APIURI method="DELETE">/api/identity-provider/`56abdcc7-8bd9-4321-9621-4e9bbebae494`</APIURI>
...
<APIAuthentication icon="unlock">Complete Facebook Login</APIAuthentication>
