---
title: Facebook
htmlTitle: Facebook API
description: Learn about the APIs for creating, retrieving, updating and disabling a Facebook identity provider.
tags: fusionauth api, rest api, http api, identity provider, facebook login, social login, single sign-on, oauth, federated identity, external login
---
import CompleteLoginText from 'src/content/docs/apis/identity-providers/_shared/_complete-login-text.mdx';
import FacebookPostRequestBody from 'src/content/docs/apis/identity-providers/_shared/_facebook-post-request-body.mdx';
import FacebookPutRequestBody from 'src/content/docs/apis/identity-providers/_shared/_facebook-put-request-body.mdx';
import FacebookResponseBody from 'src/content/docs/apis/identity-providers/_shared/_facebook-response-body.mdx';
