...
<APIBlock>
  ...
  <APIField name="identityProvider.applicationConfiguration[applicationId].scope" type="String" optional renderif={props.idp_type !== 'Steam'}>
    ...
    { props.idp_type === 'Google' && <>
      <Aside type="version" title="Since 1.44.0">
        The <b>identityProvider.applicationConfiguration[applicationId].scope</b> value may only be used when the <b>identityProvider.loginMethod</b> is set to <code>UseRedirect</code>. The `email`, <code>profile</code>, and <code>openid</code> scopes will always be requested for all other configurations.
      </Aside>
    </>}
  </APIField>
  ...
  <APIField name="identityProvider.scope" type="String" optional renderif={props.idp_type !== 'Steam'}>
    ...
    { props.idp_type === 'Google' && <>
      <Aside type="version" title="Since 1.44.0">
        The <b>identityProvider.scope</b> value may only be used when the <b>identityProvider.loginMethod</b> is set to <code>UseRedirect</code>. The `email`, <code>profile</code>, and <code>openid</code> scopes will always be requested for all other configurations.
      </Aside>
    </>}
  </APIField>
