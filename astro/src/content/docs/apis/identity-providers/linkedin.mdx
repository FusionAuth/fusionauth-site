...
<API method="PUT" uri="/api/identity-provider?type=LinkedIn" authentication={["api-key"]} title="Update the LinkedIn Identity Provider by type"/>

<PatchSupport api_endpoint="/api/identity-provider`?type=LinkedIn`" />

<API method="PUT" uri="/api/identity-provider/6177c09d-3f0e-4d53-9504-3600b1b23f46" authentication={["api-key"]} title="Update the LinkedIn Identity Provider by Id"/>
