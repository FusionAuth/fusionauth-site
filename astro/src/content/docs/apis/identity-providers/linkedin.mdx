...
The newer program will always the <InlineFieldValue>openid</InlineFieldValue> scope and `profile` for the user's profile information and `email` for the user's email.
