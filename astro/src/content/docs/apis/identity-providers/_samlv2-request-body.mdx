...
<APIBlock>
  ...
  <APIField name="identityProvider.keyId" type="UUID" required deprecated>
    ...
    <DeprecatedSince since="1.69.0">
      In version 1.69.0 and above, use the **identityProvider.verificationKeyIds** field. **identityProvider.keyId** will continue to be populated with the first entry in **identityProvider.verificationKeyIds** for backward compatibility.
    </DeprecatedSince>
  </APIField>
  ...
  <APIField name="identityProvider.verificationKeyIds" type="Array<UUID>" required since="1.69.0">
    ...
    In versions prior to 1.69.0, use the **identityProvider.keyId** field.
  </APIField>
