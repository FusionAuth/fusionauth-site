...
<APIBlock>
  ...
  <APIField name="identityProvider.assertionDecryptionConfiguration.enabled" type="Boolean" optional defaults="false" since="1.55.1">
    ...
    When <InlineFieldValue>true</InlineFieldValue>, SAML responses from the identity provider containing unencrypted assertions will be rejected by FusionAuth.
  </APIField>
  <APIField name="identityProvider.assertionDecryptionConfiguration.keyTransportDecryptionKeyId" type="UUID" optional since="1.55.1">
    ...
    Required when <InlineField>identityProvider.assertionDecryptionConfiguration.enabled</InlineField> is <InlineFieldValue>true</InlineFieldValue>.
  </APIField>
  ...
  <APIField name="identityProvider.emailClaim" type="String" optional>
    ...
    Required when <InlineField>identityProvider.useNameIdForEmail</InlineField> is <InlineFieldValue>false</InlineFieldValue>.
  </APIField>
  ...
  <APIField name="identityProvider.idpInitiatedConfiguration.issuer" type="String" optional since="1.43.0" renderif={!props.samlv2_idp_initiated}>
    ...
    Required when <InlineField>identityProvider.idpInitiatedConfiguration.enabled</InlineField> is <InlineFieldValue>true</InlineFieldValue>.
  </APIField>
  ...
  <APIField name="identityProvider.loginHintConfiguration.parameterName" type="String" optional defaults="login_hint" since="1.43.0" renderif={!props.samlv2_idp_initiated}>
    ...
    Required when <InlineField>identityProvider.loginHintConfiguration.enabled</InlineField> is <InlineFieldValue>true</InlineFieldValue>.
  </APIField>
  ...
  <APIField name="identityProvider.postRequest" type="Boolean" optional since="1.20.0" renderif={!props.samlv2_idp_initiated}>
    When <InlineFieldValue>true</InlineFieldValue> the authentication request will use the HTTP POST binding with the identity provider instead of the default Redirect binding which uses the HTTP GET method.
  </APIField>
  <APIField name="identityProvider.requestSigningKeyId" type="UUID" optional since="1.20.0" renderif={!props.samlv2_idp_initiated}>
    ...
    Required when <InlineField>identityProvider.signRequest</InlineField> is <InlineFieldValue>true</InlineFieldValue>.
  </APIField>
  <APIField name="identityProvider.signRequest" type="Boolean" optional since="1.20.0" renderif={!props.samlv2_idp_initiated}>
    When <InlineFieldValue>true</InlineFieldValue> authentication requests sent to the identity provider will be signed.
  </APIField>
  ...
  <APIField name="identityProvider.useNameIdForEmail" type="Boolean" optional>
    Whether or not FusionAuth will use the <InlineField>NameID</InlineField> element value as the email address of the user for reconciliation processing. If this is set to <InlineFieldValue>false</InlineFieldValue>, then the <InlineField>emailClaim</InlineField> property must be set.
  </APIField>
  <APIField name="identityProvider.usernameClaim" type="String" optional>
    The name of the claim in the SAML response that FusionAuth uses to identity the username. If this is not set, the <InlineField>NameId</InlineField> value will be used to link a user. This property is required when <InlineField>identityProvider.linkingStrategy</InlineField> is set to <InlineFieldValue>LinkByUsername</InlineFieldValue> or <InlineFieldValue>LinkByUsernameForExistingUser</InlineFieldValue>
  </APIField>
  <APIField name="identityProvider.xmlSignatureC14nMethod" type="String" optional since="1.20.0" renderif={!props.samlv2_idp_initiated}>
    ...
    Required when <InlineField>identityProvider.signRequest</InlineField> and <InlineField>identityProvider.postRequest</InlineField> are <InlineFieldValue>true</InlineFieldValue>.
