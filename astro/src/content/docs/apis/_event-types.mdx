...
* <code>user.password.reset.send</code> - When a forgot password email has been sent to a user  <AvailableSince since="1.30.0" /> <br/>  <EnterpriseEditionBlurbApi>the ``user.password.reset.send`` event</EnterpriseEditionBlurbApi>
