...
<If condition={props.base_field_name === 'grant'}>
  <JSON title="Example Response JSON for a Single Grant" src="entities/grant-response.json" />
</If>

<If condition={props.base_field_name !== 'grant' && props.search_result}>
  <JSON title="Example Response JSON for Multiple Grants" src="entities/grant-responses-with-total.json" />
</If>

<If condition={props.base_field_name !== 'grant' && !props.search_result}>
  <JSON title="Example Response JSON for Multiple Grants" src="entities/grant-responses.json" />
</If>
