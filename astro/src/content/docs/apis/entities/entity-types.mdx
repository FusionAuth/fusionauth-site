---
title: Entity Type
htmlTitle: Entity Type API
description: Learn about the APIs for creating, retrieving, updating and deleting entity types.
tags: entity type, entity management, machine to machine, m2m, entity schema, create entity type, update entity type, retrieve entity type, fusionauth api, rest api, http api
---
...
<APIBlock>
  ...
  <APIField name="permissionId" type="UUID" optional>
    The Id of the permission to delete. Required if a `name` has not been specified.
  </APIField>
  <APIField name="name" type="String" required>
    The name of the permission to delete. Required if a `permissionId` has not been specified.
  </APIField>
</APIBlock>
