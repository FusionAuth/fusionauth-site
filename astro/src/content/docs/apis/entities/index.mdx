...
tags: entity, entity management, machine to machine, m2m, entity type, entity grant, device entity, create entity, update entity, fusionauth api, rest api, http api
order: 1
---
...
You can learn more about [Entities in the Core Concepts section](/docs/get-started/core-concepts/types/entity-management).
