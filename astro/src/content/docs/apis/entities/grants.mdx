...
tags: entity grant, grant permissions, entity management, machine to machine, m2m, permission grant, revoke grant, entity access, fusionauth api, rest api, http api
---
...
<APIBlock>
  ...
  <APIField name="recipientEntityId" type="UUID" optional>
...
<APIBlock>
  ...
  <APIField name="userId" type="UUID" optional>
    The Id of the User who received the Grant. Required if a `recipientEntityId` has not been specified.
  </APIField>
  <APIField name="recipientEntityId" type="UUID" optional>
    The Id of the Entity which received the Grant. Required if a `userId` has not been specified.
  </APIField>
</APIBlock>
