---
title: Entity
htmlTitle: Entity API
description: Learn about the APIs for creating, retrieving, updating and deleting entities, as well as searching them.
tags: entity, entity management, machine to machine, m2m, device entity, create entity, update entity, retrieve entity, search entity, fusionauth api, rest api, http api
---
...
import XFusionauthTenantIdRequired from 'src/content/docs/apis/_shared/_x-fusionauth-tenant-id-required.mdx';
...
This page contains the APIs for managing Entities as well as searching them. [Entity core concepts](/docs/get-started/core-concepts/types/entity-management) may also be helpful.
