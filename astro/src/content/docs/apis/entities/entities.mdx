...
import XFusionauthTenantIdHeaderCreateOperation from 'src/content/docs/apis/entities/_x-fusionauth-tenant-id-header-create-operation.mdx';
...
import XFusionauthTenantIdHeaderScopedOperation from 'src/content/docs/apis/entities/_x-fusionauth-tenant-id-header-scoped-operation.mdx';
...
import XFusionauthTenantIdRequired from 'src/content/docs/apis/entities/_x-fusionauth-tenant-id-required.mdx';
...
<PatchSupport api_endpoint="pass:normal[/api/entity/``\{entityId\}``]" />
