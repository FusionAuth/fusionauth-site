...
htmlTitle: Retrieve an Audit Log API
description: API documentation for the FusionAuth Retrieve an Audit Log API.
order: 200
tags: retrieve audit log, get audit log, fetch audit log, audit log lookup, fusionauth api, rest api, http api, security audit, audit trail
---
