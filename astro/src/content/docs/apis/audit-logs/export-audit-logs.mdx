...
htmlTitle: Export Audit Logs API
description: API documentation for the FusionAuth Export Audit Logs API.
order: 400
tags: export audit logs, download audit log, audit log export, compliance export, fusionauth api, rest api, http api, security audit, audit trail export
---
