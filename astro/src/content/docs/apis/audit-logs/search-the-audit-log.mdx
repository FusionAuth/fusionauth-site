...
htmlTitle: Search the Audit Log API
description: API documentation for the FusionAuth Search the Audit Log API.
order: 3
tags: search audit log, query audit log, filter audit log, audit log search, fusionauth api, rest api, http api, security audit, compliance, audit trail search
---
