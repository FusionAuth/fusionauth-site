...
htmlTitle: Add an Entry to the Audit Log API
description: API documentation for the FusionAuth Add an Entry to the Audit Log API.
order: 100
tags: add audit log entry, create audit log, write audit log, audit logging, compliance logging, fusionauth api, rest api, http api, security audit
---
