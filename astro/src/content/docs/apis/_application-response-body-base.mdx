...
<APIBlock>
  ...
  <APIField name={ props.base_field_name + ".samlv2Configuration.defaultVerificationKeyId" } type="UUID" deprecated since="1.20.0">
    ...
    <DeprecatedSince since="1.69.0">
      In version 1.69.0 and beyond, use the **application.samlv2Configuration.verificationKeyIds** field. **application.samlv2Configuration.defaultVerificationKeyId** will continue to be populated with the first entry in **application.samlv2Configuration.verificationKeyIds** for backward compatibility.
    </DeprecatedSince>
  </APIField>
  ...
  <APIField name={ props.base_field_name + ".samlv2Configuration.logout.defaultVerificationKeyId" } type="UUID" deprecated since="1.25.0">
    ...
    <DeprecatedSince since="1.69.0">
      In version 1.69.0 and beyond, use the **application.samlv2Configuration.logout.verificationKeyIds** field. **application.samlv2Configuration.logout.defaultVerificationKeyId** will continue to be populated with the first entry in **application.samlv2Configuration.logout.verificationKeyIds** for backward compatibility.
    </DeprecatedSince>
  </APIField>
