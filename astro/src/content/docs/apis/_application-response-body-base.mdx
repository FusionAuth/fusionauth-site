...
<APIBlock>
  ...
  <APIField name={ props.base_field_name + ".oauthConfiguration.authorizedResourceUris" } type="Array<String>">
    An array of URIs that are the authorized resource URIs for this Application.
  </APIField>
