...
<APIBlock>
  ...
  <APIField name={ props.base_field_name + ".active" } type="Boolean" deprecated>
    ...
    <span class="text-red-700">Deprecated in version 1.22.0</span>
...
{/*  With "total" field */}
{ props.base_field_name !== 'application' && props.include_total && <JSON title="Example Response JSON for Application Search" src="applications/search-response.json" /> }

{/*  Without "total" field */}
{ props.base_field_name !== 'application' && !props.include_total && <JSON title="Example Response JSON for all the Applications" src="applications/responses.json" /> }
