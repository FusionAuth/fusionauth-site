...
<APIBlock>
  ...
  <APIField name={ props.base_field_name + ".samlv2Configuration.logout.requireSignedRequests" } type="Boolean" since="1.25.0">
    When this value is <InlineFieldValue>true</InlineFieldValue> all Logout requests missing a signature will be rejected.
  </APIField>
  ...
  <APIField name={ props.base_field_name + ".samlv2Configuration.requireSignedRequests" } type="Boolean" since="1.20.0">
    When this value is <InlineFieldValue>true</InlineFieldValue> all requests missing a signature will be rejected.
  </APIField>
  ...
  <APIField name={ props.base_field_name + ".webAuthnConfiguration.bootstrapWorkflow.enabled" } type="Boolean" since="1.41.0">
    Whether the WebAuthn bootstrap workflow is enabled for this application. This overrides the tenant configuration. Has no effect if <InlineField>{props.base_field_name}.webAuthnConfiguration.enabled</InlineField> is <InlineFieldValue>false</InlineFieldValue>.
  </APIField>
  <APIField name={ props.base_field_name + ".webAuthnConfiguration.enabled" } type="Boolean" since="1.41.0">
    Indicates if this application enables WebAuthn workflows based on the configuration defined here or the Tenant WebAuthn configuration. If this is <InlineFieldValue>false</InlineFieldValue>, WebAuthn workflows are enabled based on the Tenant configuration. If <InlineFieldValue>true</InlineFieldValue>, WebAuthn workflows are enabled according to the configuration of this application.
  </APIField>
  <APIField name={ props.base_field_name + ".webAuthnConfiguration.reauthenticationWorkflow.enabled" } type="Boolean" since="1.41.0">
    Whether the WebAuthn reauthentication workflow is enabled for this application. This overrides the tenant configuration. Has no effect if <InlineField>{props.base_field_name}.webAuthnConfiguration.enabled</InlineField> is <InlineFieldValue>false</InlineFieldValue>.
  </APIField>
