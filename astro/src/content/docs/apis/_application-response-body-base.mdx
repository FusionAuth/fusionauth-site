...
<APIBlock>
  ...
  <APIField name={ props.base_field_name + ".oauthConfiguration.consentMode" } type="String" since="1.50.0">
    ...
    * `NeverPrompt` - The user will be never be prompted to consent to requested OAuth scopes. Permission will be granted implicitly as if this were a `First-party` application. This configuration is meant for testing purposes only.
  </APIField>
  ...
  <APIField name={ props.base_field_name + ".oauthConfiguration.relationship" } type="String" since="1.50.0">
    ...
    * `ThirdParty` - The application is external to the authorization server. Users will be prompted to consent to requested OAuth scopes based on <InlineField>Consent mode</InlineField>.
  </APIField>
