...
htmlTitle: Message Template API
description: Learn about the APIs for creating, retrieving, updating and deleting message templates.
tags: fusionauth api, rest api, http api, message template, sms template, email template, notification template, messaging
---
import MessageTemplateRequestBody from 'src/content/docs/apis/_shared/_message-template-request-body.mdx';
import StandardPostResponseCodes from 'src/content/docs/apis/_shared/_standard-post-response-codes.astro';
import MessageTemplateResponseBody from 'src/content/docs/apis/_shared/_message-template-response-body.mdx';
import StandardGetResponseCodes from 'src/content/docs/apis/_shared/_standard-get-response-codes.astro';
import MessageTemplatesResponseBody from 'src/content/docs/apis/_shared/_message-templates-response-body.mdx';
...
import MessagePreviewResponseBody from 'src/content/docs/apis/_shared/_message-preview-response-body.mdx';
