...
<APIBlock>
  ...
  <APIField name="recoveryCodes" type="Array">
    ...
    Since `1.67.0`, these codes are the only time they are available in plaintext — store them securely and provide them to the user immediately. They are hashed at rest and cannot be retrieved afterward.
  </APIField>
</APIBlock>
