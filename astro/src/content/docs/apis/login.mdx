...
<APIBlock>
  ...
  <APIField name="loginIdTypes" type="Array<String>" optional defaults="[email, username]" since="1.99.9">
    List of types (or <InlineField>identityTypes</InlineField>) that FusionAuth will attempt to resolve a user identity with along with <InlineField>loginId</InlineField>. Can be one or more of the following:
