...
<APIBlock>
  ...
  <APIField name="logins[x].loginId" type="String">
    ...
    In version `1.99.9` and later, the <InlineField>loginId</InlineField> is stored in the login record when the correct value can be identified. In these cases the <InlineField>loginIdType</InlineField> will be populated.
  </APIField>
  <APIField name="logins[x].loginIdType" type="String" since="1.99.9">
    The type of identity used to log in. A missing value on the response indicates the login was not associated with a specific identity, or the login record was created prior to version `1.99.9`.
  </APIField>
...
00000000-0000-0000-0000-000000000001,richard@piedpiper.com,email,5/12/2022 12:25:12 AM MDT,3c219e58-ed0e-4b18-ad48-f4f92793ae32,127.0.0.1,,,,,,
```
