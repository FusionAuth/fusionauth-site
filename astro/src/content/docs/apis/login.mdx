...
<LoginResponseCodes auth_optional />
...
<APIAuthentication icon="unlock">Complete a Multi-Factor Login</APIAuthentication>
...
<APIAuthentication icon="lock">Update the login instant for a given User and Application</APIAuthentication>
<APIURI method="PUT">/api/login/`{userId}/{applicationId}?ipAddress={ipAddress}`</APIURI>
...
<br/>
<APIAuthentication icon="badge">Update the login instant for a given User and Application using a JWT</APIAuthentication>
<APIURI method="PUT">/api/login`?ipAddress={ipAddress}`</APIURI>
...
<APIAuthentication icon="unlock">Remove the `access_token` and `refresh_token` cookies if they exist on the client.</APIAuthentication>
<APIURI method="POST">/api/logout</APIURI>
...
<APIAuthentication icon="lock">Searches for Login Records given search criteria</APIAuthentication>
<APIURI method="GET">/api/system/login-record/search`?applicationId={applicationId}&start={start}&end={end}&userId={userId}`</APIURI>
...
<br/>
<APIAuthentication icon="lock">Searches for Login Records given search criteria</APIAuthentication>
<APIURI method="POST">/api/system/login-record/search</APIURI>
...
<APIAuthentication icon="lock">Export the Login Records matching the criteria</APIAuthentication>
<APIURI method="GET">/api/system/login-record/export`?applicationId={applicationId}&start={start}&end={end}&userId={userId}`</APIURI>
...
<br/>
<APIAuthentication icon="lock">Export the Login Records matching the criteria</APIAuthentication>
<APIURI method="POST">/api/system/login-record/export</APIURI>
...
<Aside type="note">
The location information is only included in exports when [Advanced Threat Detection](/docs/v1/tech/advanced-threat-detection/) is enabled.
</Aside>
