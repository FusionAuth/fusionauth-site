...
<LoginMetadataDevice />
  ...
  <APIField name="noJWT" type="Boolean" optional defaults="false">
    When this value is set to <InlineFieldValue>true</InlineFieldValue> a JWT will not be issued as part of this request. The response body will not contain the <InlineField>token</InlineField> or <InlineField>refreshToken</InlineField> fields, and the <InlineField>access_token</InlineField> and <InlineField>refresh_token</InlineField> cookies will not be written to the HTTP response.
...
<LoginMetadataDevice />
  ...
  <APIField name="noJWT" type="Boolean" optional defaults="false">
    When this value is set to <InlineFieldValue>true</InlineFieldValue> a JWT will not be issued as part of this request. The response body will not contain the <InlineField>token</InlineField> field,
  ...
  <APIField name="trustComputer" type="Boolean" optional defaults="false">
    When this value is set to <InlineFieldValue>true</InlineFieldValue> the response will contain a Multi-Factor Trust identifier. This can be used on subsequent Login requests to
...
<APIBlock>
  ...
  <APIField name="fusionauth.trust" type="String">
    The Multi-Factor Trust identifier. This value is returned when <InlineField>trustComputer</InlineField> was set to <InlineFieldValue>true</InlineFieldValue> on the request. This value can be used by
...
<APIBlock>
  <APIField name="global" type="Boolean" optional defaults="false">
    When this value is set to <InlineFieldValue>true</InlineFieldValue>, revokes:
...
<APIBlock>
  ...
  <APIField name="retrieveTotal" type="Boolean" optional defaults="false">
    Set this to <InlineFieldValue>true</InlineFieldValue> if you want the total possible results returned in the response. With a very large number of login records settings this value to <InlineFieldValue>true</InlineFieldValue> will increase the response time of this request.
  </APIField>
...
<APIBlock>
  ...
  <APIField name="total" type="Long">
    The total number of login records available. This will only be provided in the response when <InlineField>retrieveTotal</InlineField> was set to <InlineFieldValue>true</InlineFieldValue> on the request.
  </APIField>
</APIBlock>
