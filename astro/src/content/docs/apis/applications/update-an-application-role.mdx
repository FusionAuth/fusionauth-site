...
htmlTitle: Update an Application Role API
description: API documentation for the FusionAuth Update an Application Role API.
order: 800
tags: update application role, edit role, modify role, application role management, rbac, fusionauth api, rest api, http api, authorization, role-based access control
---
import GenericUpdateExplanationFragment from 'src/content/docs/apis/_shared/_generic-update-explanation-fragment.mdx';
import RoleResponseBody from 'src/content/docs/apis/applications/_role-response-body.mdx';
