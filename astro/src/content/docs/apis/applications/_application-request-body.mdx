...
import ApplicationOauthconfigurationClientauthenticationpolicy from 'src/content/docs/apis/_shared/_application-oauthConfiguration-clientAuthenticationPolicy.mdx';
import ApplicationOauthconfigurationProofkeyforcodeexchangepolicy from 'src/content/docs/apis/_shared/_application-oauthConfiguration-proofKeyForCodeExchangePolicy.mdx';
import Xmlsignaturec14nmethodDescription from 'src/content/docs/apis/_shared/_xmlSignatureC14nMethod-description.mdx';
...
<APIBlock>
  ...
  <APIField name="application.jwtConfiguration.accessTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    ...
    Facilitates key rotation by trusting multiple keys: if you change **`application.jwtConfiguration.accessTokenKeyId`** to a new key and supply the previous key in this field, FusionAuth will trust JWTs signed by both keys, while only signing JWTs with the new key.
  </APIField>
  ...
  <APIField name="application.jwtConfiguration.idTokenVerificationKeyIds" type="Array<UUID>" optional since="1.69.0">
    The list of Id token verification key Ids that are trusted for this application. This list always implicitly includes **`application.jwtConfiguration.idTokenKeyId`**.

    Facilitates key rotation by trusting multiple keys: if you change **`application.jwtConfiguration.idTokenKeyId`** to a new key and supply the previous key in this field, FusionAuth will trust JWTs signed by both keys, while only signing JWTs with the new key.
  </APIField>
...
You may now use URLs for application redirects that use a single slash to denote there is no naming authority for the scheme. Prior to this version a URL such as `com.myApp:/redirect` would fail validation as in invalid URL.
  ...
  <APIField name="application.oauthConfiguration.relationship" type="String" optional since="1.50.0" defaults="FirstParty">
    ...
    * `ThirdParty` - The application is external to the authorization server. Users will be prompted to consent to requested OAuth scopes based on the application object's **oauthConfiguration.consentMode** value.
    ...
    <PlanBlurbApi plan="essentials" feature="third-party applications"/>
  </APIField>
  ...
  <APIField name="application.samlv2Configuration.defaultVerificationKeyId" type="UUID" optional deprecated since="1.20.0">
    ...
    <DeprecatedSince since="1.69.0">
      In version `1.69.0` and above, use **`application.samlv2Configuration.verificationKeyIds`**. For backward compatibility, Fusionauth populates **`application.samlv2Configuration.defaultVerificationKeyId`** with the first entry in **`application.samlv2Configuration.verificationKeyIds`**.
    </DeprecatedSince>
  </APIField>
  ...
  <APIField name="application.samlv2Configuration.logout.defaultVerificationKeyId" type="UUID" optional deprecated since="1.25.0">
    ...
    <DeprecatedSince since="1.69.0">
      In version `1.69.0` and above, use **`application.samlv2Configuration.logout.verificationKeyIds`**. For backwards compatibility, Fusionauth populates **`application.samlv2Configuration.logout.defaultVerificationKeyId`** with the first entry in **`application.samlv2Configuration.logout.verificationKeyIds`**.
    </DeprecatedSince>
  </APIField>
  ...
  <APIField name="application.samlv2Configuration.logout.requireSignedRequests" type="Boolean" required since="1.25.0">
    ...
    When set to `true`, one of these parameters is required: **`application.samlv2Configuration.logout.verificationKeyIds`** (`1.69.0` and above) or **`application.samlv2Configuration.logout.defaultVerificationKeyId`** (before `1.69.0`).
  </APIField>
  ...
  <APIField name="application.samlv2Configuration.requireSignedRequests" type="Boolean" optional since="1.20.0">
    ...
    When set to `true`, one of these parameters is required: **`application.samlv2Configuration.verificationKeyIds`** (`1.69.0` and above) or **`application.samlv2Configuration.defaultVerificationKeyId`** (before `1.69.0`).
  </APIField>
  ...
  <APIField name="application.themeId" type="UUID" optional since="1.27.0">
    ...
    <PlanBlurbApi plan="starter" feature="application themes" />
  </APIField>
  <APIField name="application.universalConfiguration.universal" type="Boolean" optional since="1.58.0">
    Indicates if this application is a [universal application](/docs/get-started/core-concepts/types/applications#universal-applications).
  </APIField>
...
<If condition={props.is_create}>
  <JSON title="Example Request JSON" src="applications/post-request.json" />
</If>

<If condition={!props.is_create}>
  <JSON title="Example Request JSON" src="applications/put-request.json" />
</If>
