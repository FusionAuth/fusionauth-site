...
htmlTitle: Delete an Application API
description: API documentation for the FusionAuth Delete an Application API.
order: 500
tags: delete application, remove application, deactivate application, application management, fusionauth api, rest api, http api, soft delete application
---
