...
htmlTitle: Retrieve an Application API
description: API documentation for the FusionAuth Retrieve an Application API.
order: 200
tags: retrieve application, get application, fetch application, application lookup, application management, fusionauth api, rest api, http api, list applications
---
import ApplicationResponseBody from 'src/content/docs/apis/applications/_application-response-body.mdx';
import ApplicationsResponseBody from 'src/content/docs/apis/applications/_applications-response-body.mdx';
