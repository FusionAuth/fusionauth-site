...
htmlTitle: Create an Application Role API
description: API documentation for the FusionAuth Create an Application Role API.
order: 700
tags: create application role, application role, role management, rbac, add role, fusionauth api, rest api, http api, authorization, role-based access control
---
