...
order: 100
tags: create application, register application, new application, application management, fusionauth api, rest api, http api, application configuration, tenant application
---
