...
<APIURI method="POST" uri="/api/email/template" authentication={["api-key"]} title="Create an Email Template without providing an Id. An Id will be automatically generated."/>

<APIURI method="POST" uri="/api/email/template/{emailTemplateId}" authentication={["api-key"]} title="Create an Email Template with the provided Id"/>
...
<APIURI method="GET" uri="/api/email/template" authentication={["api-key"]} title="Retrieve all of the Email Templates" />

<APIURI method="GET" uri="/api/email/template/{emailTemplateId}" authentication={["api-key"]} title="Retrieve a single Email Template by Id"/>
...
<APIURI method="GET" uri="/api/email/template/search?name={name}" authentication={["api-key"]} title="Search for Email Templates"/>

#### Request Parameters

<EmailTemplateSearchRequestParameters parameter_prefix="" />

<APIURI method="POST" uri="/api/email/template/search"  authentication={["api-key"]} title="Search for Email Templates"/>
...
<APIURI method="PUT" uri="/api/email/template/{emailTemplateId}"  authentication={["api-key"]} title="Update an Email Template by Id"/>
...
<APIURI method="DELETE" uri="/api/email/template/{emailTemplateId}"  authentication={["api-key"]} title="Delete an Email Template By Id"/>
...
<APIURI method="POST" uri="/api/email/template/preview"  authentication={["api-key"]} title="Preview an Email Template"/>
...
<APIURI method="POST" uri="/api/email/send/{emailTemplateId}"  authentication={["api-key"]} title="Send an email using a template by Id"/>
