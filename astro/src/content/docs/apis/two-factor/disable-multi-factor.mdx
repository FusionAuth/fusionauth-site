...
htmlTitle: Disable Multi-Factor API
description: API documentation for the FusionAuth Disable Multi-Factor API.
tags: fusionauth api, rest api, http api, multi-factor authentication, mfa, two-factor authentication, disable mfa, 2fa
order: 200
---
import TwoFactorDisableRequestBody from 'src/content/docs/apis/two-factor/_two-factor-disable-request-body.mdx';
import TwoFactorDisableRequestParameters from 'src/content/docs/apis/two-factor/_two-factor-disable-request-parameters.mdx';
