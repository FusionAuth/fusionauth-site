...
htmlTitle: Send a Multi-Factor Code During Login or Step Up API
description: API documentation for the FusionAuth Send a Multi-Factor Code During Login or Step Up API.
tags: fusionauth api, rest api, http api, multi-factor authentication, mfa, two-factor authentication, send mfa code, step-up auth
order: 600
---
