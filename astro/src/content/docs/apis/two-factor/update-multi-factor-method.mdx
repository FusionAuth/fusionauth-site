...
htmlTitle: Update Multi-Factor Method API
description: API documentation for the FusionAuth Update Multi-Factor Method API.
tags: fusionauth api, rest api, http api, multi-factor authentication, mfa, two-factor authentication, mfa method, update mfa
order: 250
---
