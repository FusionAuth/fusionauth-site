...
htmlTitle: Generate a Secret API
description: API documentation for the FusionAuth Generate a Secret API.
tags: fusionauth api, rest api, http api, multi-factor authentication, mfa, two-factor authentication, mfa secret, totp secret, qr code
order: 300
---
