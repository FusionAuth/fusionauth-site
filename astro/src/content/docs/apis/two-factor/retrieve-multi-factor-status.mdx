...
htmlTitle: Retrieve Multi-Factor Status API
description: API documentation for the FusionAuth Retrieve Multi-Factor Status API.
tags: fusionauth api, rest api, http api, multi-factor authentication, mfa, two-factor authentication, mfa status
order: 500
---
...
Use a `POST` call to instead send your parameters in the request body.
