...
If using message based delivery, you may [Send a Multi-Factor Code When Enabling MFA](/docs/apis/two-factor/send-a-multi-factor-code-when-enabling-mfa) to deliver a
