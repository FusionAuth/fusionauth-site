...
htmlTitle: Send a Multi-Factor Code When Disabling MFA API
description: API documentation for the FusionAuth Send a Multi-Factor Code When Disabling MFA API.
tags: fusionauth api, rest api, http api, multi-factor authentication, mfa, two-factor authentication, disable mfa, send mfa code
order: 800
---
