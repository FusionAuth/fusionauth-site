...
htmlTitle: Export Login Records API
description: API documentation for the FusionAuth Export Login Records API.
tags: fusionauth api, rest api, http api, login api, login records, export login records, login report, audit
order: 700
---
...
Use a `POST` request to instead send the export criteria in a JSON request body.
