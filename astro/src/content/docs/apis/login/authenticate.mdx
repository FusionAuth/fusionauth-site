...
htmlTitle: Authenticate a User API
description: API documentation for the FusionAuth Authenticate a User API.
tags: fusionauth api, rest api, http api, login api, authentication, user login, login request, user authentication
order: 100
---
...
import LoginResponseCodesAuthenticated from 'src/content/docs/apis/login/_login-response-codes-authenticated.mdx';
import LoginIdField from 'src/content/docs/apis/_shared/_login-id-field.mdx';
import LoginIdTypeField from 'src/content/docs/apis/_shared/_login-id-type-field.mdx';
