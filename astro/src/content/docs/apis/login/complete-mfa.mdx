...
htmlTitle: Complete Multi-Factor Authentication API
description: API documentation for the FusionAuth Complete Multi-Factor Authentication API.
tags: fusionauth api, rest api, http api, login api, authentication, multi-factor authentication, mfa login, step-up auth
order: 300
---
...
import LoginApplicationidParameter from 'src/content/docs/apis/login/_login-applicationId-parameter.mdx';
import LoginMetadataDevice from 'src/content/docs/apis/_shared/_login-metadata-device.mdx';
import UserResponseBody from 'src/content/docs/apis/_shared/_user-response-body.mdx';
