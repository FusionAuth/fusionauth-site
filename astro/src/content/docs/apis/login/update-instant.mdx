...
htmlTitle: Update Login Instant API
description: API documentation for the FusionAuth Update Login Instant API.
tags: fusionauth api, rest api, http api, login api, authentication, update login instant, session tracking, single sign-on
order: 400
---
...
### Call With a User ID and Application ID
