...
htmlTitle: Authenticate a User with a One Time Password API
description: API documentation for the FusionAuth Authenticate a User with a One Time Password API.
tags: fusionauth api, rest api, http api, login api, authentication, user login, one-time password, otp login, login request
order: 200
---
