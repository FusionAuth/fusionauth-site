...
<RemoteSnippet
  url="https://github.com/ritza-co/fusionauth-example-javascript-webauthn"
  branch="main"
  filepath="base64url-to-buffer.js"
  tag="base64url-to-buffer"
  lang="javascript"
...
<RemoteSnippet
  url="https://github.com/ritza-co/fusionauth-example-javascript-webauthn"
  branch="main"
  filepath="buffer-to-base64url.js"
  tag="buffer-to-base64url"
  lang="javascript"
