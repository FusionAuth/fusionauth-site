...
import UserResponseBody from 'src/content/docs/apis/identity-providers/_user-response-body.mdx';
...
<APIAuthentication icon="lock">Retrieve a single Passkey by Id</APIAuthentication>
<APIURI method="GET">/api/webauthn/`{id}`</APIURI>
...
<APIAuthentication icon="lock">Retrieve all Passkeys belonging to a User</APIAuthentication>
<APIURI method="GET">/api/webauthn/`?userId={userId}`</APIURI>
...
<APIAuthentication icon="lock">Delete a single Passkey by Id</APIAuthentication>
<APIURI method="DELETE">/api/webauthn/`{id}`</APIURI>
...
<APIAuthentication icon="lock">Delete all Passkeys belonging to a User</APIAuthentication>
<APIURI method="DELETE">/api/webauthn/`?userId={userId}`</APIURI>
...
<APIAuthentication icon="lock">Import Multiple Passkeys</APIAuthentication>
<APIURI method="POST">/api/webauthn/import</APIURI>
...
<APIAuthentication icon="lock">Start a WebAuthn Registration Ceremony and Retrieve Passkey Creation Options</APIAuthentication>
<APIURI method="POST">/api/webauthn/register/start</APIURI>
...
<APIAuthentication icon="unlock">Complete a WebAuthn Registration Ceremony and Return Passkey Details</APIAuthentication>
<APIURI method="POST">/api/webauthn/register/complete</APIURI>
...
<APIAuthentication icon="lock">Start a WebAuthn Authentication Ceremony and Retrieve Passkey Request Options</APIAuthentication>
<APIURI method="POST">/api/webauthn/start</APIURI>
...
<APIAuthentication icon="unlock">Complete a WebAuthn Authentication Ceremony</APIAuthentication>
<APIURI method="POST">/api/webauthn/login</APIURI>
...
<APIAuthentication icon="unlock">Assert a WebAuthn Authentication Ceremony</APIAuthentication>
<APIURI method="POST">/api/webauthn/assert</APIURI>
