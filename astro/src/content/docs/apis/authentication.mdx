...
<img src="/img/docs/create-api-key.png" alt="Create an API Key" width="1200" role="bottom-cropped" />
...
<img src="/img/docs/apis/api-key-endpoint-permissions.png" alt="API Key endpoint permissions." width="1200" role="bottom-cropped" />
