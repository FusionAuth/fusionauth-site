...
<DeprecatedEndpoint since="1.64.0">This endpoint is deprecated. To provide access to a user's recovery codes, [generate new recovery codes](/docs/apis/two-factor#generate-recovery-codes) and deliver those.</DeprecatedEndpoint>
