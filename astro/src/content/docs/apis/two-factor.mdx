...
<DeprecatedSince since="1.64.0">This endpoint is being deprecated to follow security best practices. Going forward we recommend [regenerating recovery codes](/docs/apis/two-factor#generate-recovery-codes) whenever they need to be retrieved.</DeprecatedSince>
