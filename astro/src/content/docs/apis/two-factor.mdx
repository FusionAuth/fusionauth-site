...
<APIBlock>
  ...
  <APIField name="email" type="String" optional>
    The email to which send Multi-Factor codes. If the <InlineField>method</InlineField> is equal to <InlineFieldValue>email</InlineFieldValue>, this is required.
  </APIField>
  <APIField name="method" type="String" required>
    ...
    * <InlineFieldValue>email</InlineFieldValue>
    * <InlineFieldValue>sms</InlineFieldValue>
  </APIField>
  <APIField name="mobilePhone" type="String" optional>
    The mobile phone to which send Multi-Factor codes. If the <InlineField>method</InlineField> is equal to <InlineFieldValue>sms</InlineFieldValue>, this is required.
  </APIField>
  <APIField name="userId" type="UUID" required>
    The User Id.
  </APIField>
