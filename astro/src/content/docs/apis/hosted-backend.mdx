...
Redirect the browser to this route to start the login flow for the given client Id.
...
Redirect the browser to this route to start the registration flow for the given client Id.
...
The browser is redirected here automatically with the authorization code and related parameters after a successful login or registration.
...
Call this endpoint with the client Id to refresh the access token using the `app.rt` cookie.
...
Call this endpoint to retrieve information about the currently logged in user using the `app.at` cookie.
...
Redirect the browser to this route to start the logout flow for the given client Id.
