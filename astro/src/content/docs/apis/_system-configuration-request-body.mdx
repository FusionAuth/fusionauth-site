...
<APIBlock>
  ...
  <APIField name="systemConfiguration.trustedProxyConfiguration.trusted" type="Array<String>">
    An array of IP addresses, representing the set of trusted upstream proxies. This value will be accepted but ignored if `systemConfiguration.trustedProxyConfiguration.trustPolicy` has a value of `All`.
  </APIField>
