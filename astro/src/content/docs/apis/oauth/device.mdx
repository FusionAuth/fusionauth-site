---
title: Device
htmlTitle: Device API
description: API documentation for the FusionAuth Device OAuth2 endpoint.
tags: fusionauth api, rest api, http api, oauth, oauth 2.0, device authorization, device flow, rfc 8628
order: 400
---
...
## Device User Code via Client Credentials

<AvailableSince since="1.46.0"/>
