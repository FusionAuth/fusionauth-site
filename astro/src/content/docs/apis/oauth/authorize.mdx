---
title: Authorize
htmlTitle: Authorize API
description: API documentation for the FusionAuth Authorize OAuth2 endpoint.
tags: fusionauth api, rest api, http api, oauth, oauth 2.0, authorization endpoint, authorization code grant, pkce
order: 100
---
import OauthAuthorizeRedirectParameters from 'src/content/docs/_shared/_oauth-authorize-redirect-parameters.mdx';
import RepeatedParameterLimit from 'src/content/docs/_shared/_repeated-parameter-limit.mdx';
