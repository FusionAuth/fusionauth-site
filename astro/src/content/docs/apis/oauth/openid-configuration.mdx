...
htmlTitle: OpenID Configuration API
description: API documentation for the FusionAuth OpenID Configuration OAuth2 endpoint.
tags: fusionauth api, rest api, http api, oauth, oauth 2.0, openid connect, openid configuration, discovery endpoint, well-known
order: 800
---
