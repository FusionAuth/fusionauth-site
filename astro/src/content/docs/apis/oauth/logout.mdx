---
title: Logout
htmlTitle: Logout API
description: API documentation for the FusionAuth Logout OAuth2 endpoint.
tags: fusionauth api, rest api, http api, oauth, oauth 2.0, logout endpoint, session invalidation, openid connect front-channel logout
order: 200
---
...
Use a `POST` request to instead send the logout criteria in a JSON request body.
...
<APIBlock>
  ...
  <APIField name="post_logout_redirect_uri" type="String" optional since="1.10.0">
    ...
    See the [<Breadcrumb>Core Concepts OAuth</Breadcrumb> section](/docs/get-started/core-concepts/types/applications#oauth) for additional information on configuring redirect URIs.
