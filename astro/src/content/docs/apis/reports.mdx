...
<APIBlock>
  <APIField name="excludes" type="Array<String>" optional>
    Optional parameter to exclude specified fields from the report. The only valid value is `applicationTotals`.
  </APIField>
</APIBlock>
