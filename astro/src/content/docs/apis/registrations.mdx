...
<APIBlock>
  ...
  <APIField name="verificationId" type="String" required since="1.27.0">
    ...
    When using the <InlineFieldValue>Form field</InlineFieldValue> strategy for registration verification, this value is used along with the <InlineField>oneTimeCode</InlineField> as a pair to verify the registration.
