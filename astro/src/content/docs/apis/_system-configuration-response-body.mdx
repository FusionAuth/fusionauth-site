...
<APIBlock>
  ...
  <APIField name="systemConfiguration.trustedProxyConfiguration.trustPolicy" type="String">
  ...
  <APIField name="systemConfiguration.trustedProxyConfiguration.trusted" type="Array<String>">
