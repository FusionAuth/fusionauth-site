...
<If condition={props.update}>
  <JSON src="user-consent/update-request.json" title="Example Request JSON" />
</If>

<If condition={!props.update}>
  <JSON src="user-consent/request.json" title="Example Request JSON" />
</If>
