...
htmlTitle: Identity Verify API
description: Learn about the APIs for starting, sending, and completing identity verification.
tags: fusionauth api, rest api, http api, identity verification, document verification, kyc, know your customer, identity check, user verification
---
