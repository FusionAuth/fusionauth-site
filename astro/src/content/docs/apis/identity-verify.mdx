...
<StandardPostResponseCodes never_search_error missing_message="If an existingUserStrategy value of MustExist was supplied and loginId did not match a user in the selected tenant" />
