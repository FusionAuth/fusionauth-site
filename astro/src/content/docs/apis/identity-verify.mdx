...
<StandardPostResponseCodes never_search_error missing_message="If the request had a existingUserStrategy value of mustExist and the loginId did not match a user in the selected tenant." />
