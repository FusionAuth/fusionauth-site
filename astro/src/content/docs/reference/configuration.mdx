...
tags: configuration reference, system configuration, property reference, fusionauth config, environment variables, jvm options, database configuration
---
...
You can manage most FusionAuth settings in the UI or by using the API. 
...
The lookup process was introduced in version [`1.19.0`](/docs/release-notes#version-1-19-0) and allows any configuration option to be specified in one of three ways: environment variables, Java system properties, or in the `fusionauth.properties` configuration file. Here is the process for looking up configuration options (NOTE: that the name of the configuration options are listed below):
