---
title: GDPR Compliance in FusinonAuth
...
-   User data is not commingled with other companies
...
FusionAuth uses opaque tokens and complex user IDs to pseudonymised user data, making it difficult to match IDs to user data without database access.
...
FusionAuth maintains a strict breach notification policy, aiming to notify customers of any breach or suspected breach within 24 hours1.
