...
In order to send this value to FusionAuth, you would need to convert this date time to the number of milliseconds since epoch and then send the value <InlineFieldValue>1436028300000</InlineFieldValue> as an input parameter. [Convert instants to human readable dates or vice versa.](/learn/expert-advice/dev-tools/date-time)
