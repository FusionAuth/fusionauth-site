...
<img src="/img/docs/quickstarts/nodejs-application-login.png" alt="The Node.js Application Home Screen" width="1200" role="bottom-cropped" />

Click the <InlineUIElement>Login</InlineUIElement> link, this will take us to FusionAuth's login page.

<img src={`/img/docs/quickstarts/login${props.imagesuffix || ''}.png`} alt="The Login Screen" width="1200" role="bottom-cropped" />
...
<img src="/img/docs/quickstarts/login-succeeded.png" alt="Successful Login" width="1200" role="bottom-cropped" />
...
<img src={`/img/docs/quickstarts/login-failed-registration-required${props.imagesuffix || ''}.png`} alt="Login Without Registration" width="1200" role="bottom-cropped" />
