...
Once you arrive in the FusionAuth admin UI, the first thing you need to do is create an Application. An Application is something that a user can log into. This is the application you are building or that you are migrating to use FusionAuth. Click the <InlineUIElement>Applications</InlineUIElement> menu option on the left side of the page.
