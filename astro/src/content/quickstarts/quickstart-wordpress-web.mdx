...
- Under <Breadcrumb label="Template"/> on the far right, view the <Field label="Template"/> field and modify it. Do so by clicking <Uielement label="Pages"/>, and change it to <Uielement label="Blank"/>.
