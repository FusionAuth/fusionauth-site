...
Click on the image once it has uploaded. Copy the "File URL" to use later. It should look like `http://localhost:3000/wp-content/uploads/2023/09/money.jpg`.
...
Now you can use these three page shortcodes on the pages themselves. Browse to <Breadcrumb label="Pages"/> and edit the account page. Click the hamburger menu at the top right and select <Uielement label="Code editor"/>. In the text box under the page title box, paste `[WP-Coder title="account"]` and click <Uielement label="Update"/>.
