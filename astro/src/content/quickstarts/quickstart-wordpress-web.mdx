...
color: green
cta: EmailListCTA
demoUrl: https://github.com/ritza-co/fusionauth-quickstart-wordpress-web
---
...
Find the Docker Compose file and source code for the complete application at {frontmatter.demoUrl}.
...
You create the default Express starter project in a folder called `mysite`, with the EJS view template engine. You also add a few npm packages to help with authentication.
...
On line 21 of `mysite/app.js`, just before it adds the first route, insert the following line.
...
```js
var usersRouter = require('./routes/users'); // delete line 8

app.use('/users', usersRouter); // delete line 23
```
...
The line you added above, `require('./authentication')(app);`, imports a function to add authentication to the Express app instance, and calls it. Let's create that file now.
