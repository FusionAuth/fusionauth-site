...
- <InlineField>Display Name Formatting</InlineField> - <InlineFieldValue>`{email}`</InlineFieldValue> (this is what will be displayed to the user in the {frontmatter.technology} admin screen)
