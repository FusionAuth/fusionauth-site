...
https://github.com/FusionAuth/fusionauth-quickstart-javascript-vue-web
...
Next, you'll need to configure and activate the FusionAuth Vue SDK. You can do this by updating the `src/main.ts` file:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/main.ts"
            lang="typescript"/>
...
The home page will be a simple page with a welcome message and a login link. Update the existing `src/views/HomeView.vue`:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/views/HomeView.vue"
            lang="vue"/>

#### Create An Account Page

The account page will be a simple page that displays a random balance for the logged in user. Create a new file `src/views/AccountView.vue`:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/views/AccountView.vue"
            lang="vue"/>

#### Create A Make Change Page

The make change page will be a simple page that displays an input field for the user to enter a dollar amount and a button to convert that amount into coins. Create a new file `src/pages/MakeChangeView.vue`:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/views/MakeChangeView.vue"
            lang="vue"/>

## Authentication

You now have created a basic Vue.js application with a home page and an account page.
...
<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/components/LogoHeader.vue"
            lang="vue"/>

Additionally, we want to display different menu items. For this create a new file `src/components/MenuBar.vue`:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/components/MenuBar.vue"
            lang="jsx"/>

The next step is to tie it all together. Update the `src/App.vue` file to add the router view and header:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/App.vue"
            lang="vue"/>

And finally we register the routes in `src/router/index.ts`:

<RemoteCode url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/router/index.ts"
            lang="typescript"/>
