---
title: Express.js API Resource Server
...
## Create Your {frontmatter.technology} Resource Server Application

Now you are going to create a {frontmatter.technology} API application. While this section builds a simple API, you can use the same configuration to integrate an existing API with FusionAuth.
...
# npm install passport passport-oauth2  # to authenticate with FusionAuth TODO remove
# npm install jwt-decode # to get user details from the JWT returned by FusionAuth
