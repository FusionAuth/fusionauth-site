...
The docker compose file and source code for a complete application are available at https://github.com/ritza-co/fusionauth-quickstart-javascript-express-api.
...
* If you are on Windows you will also need to install [curl](https://curl.se/windows/).
...
```
git clone https://github.com/ritza-co/fusionauth-quickstart-javascript-express-api.git
...
<RemoteCode url="https://raw.githubusercontent.com/ritza-co/fusionauth-quickstart-javascript-express-api/main/complete-application/.env"
 lang="shell" />
...
You can also delete the lines that relate to the users route. This app won't need them.

```js
var usersRouter = require('./routes/users'); // delete line 7

app.use('/users', usersRouter); // delete line 18
```
...
<RemoteCode url="https://raw.githubusercontent.com/ritza-co/fusionauth-quickstart-javascript-express-api/main/complete-application/services/verifyJWT.js"
 lang="typescript" />
...
<RemoteCode url="https://raw.githubusercontent.com/ritza-co/fusionauth-quickstart-javascript-express-api/main/complete-application/services/hasRole.js"
 lang="typescript" />
...
<RemoteCode url="https://raw.githubusercontent.com/ritza-co/fusionauth-quickstart-javascript-express-api/main/complete-application/routes/index.js"
 lang="typescript" />
...
You were authorized, success! You can try making the request without the JWT or with a different string rather than a valid token, and see that you are denied access.
