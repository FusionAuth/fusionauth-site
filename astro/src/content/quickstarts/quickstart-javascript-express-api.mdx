...
Now, let's try as <InlineFieldValue>customer@example.com</InlineFieldValue>, which has the role `customer`. Acquire a token for <InlineFieldValue>customer@example.com</InlineFieldValue>.
