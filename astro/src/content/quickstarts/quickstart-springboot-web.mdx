...
Now you'll create the model object referenced in the controllers. In the project base directory, create a new directory called `model` and add a new `Change.java` class to it.
...
From the base directory, add a new directory called `config` and add the following two Java classes to it.
