...
description: Quickstart integration of a SpringBoot web application using Thymeleaf with FusionAuth
navcategory: getting-started
prerequisites: Maven, Java
section: web
technology: SpringBoot, Thymeleaf
language: Java
...
In this tutorial, you are going to learn how to integrate a Java SpringBoot application with FusionAuth.
...
The example repository has already set up a SpringBoot template application that includes a Maven wrapper. You can find out more about those by viewing:
- [Spring initializr](https://start.spring.io/): The SpringBoot template generator webpage.
...
## Create your SpringBoot Application with Thymeleaf
...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-springboot-web/main/complete-application/src/main/java/io/fusionauth/example/spring/AccountController.java"
            lang="java"/>
...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-springboot-web/main/complete-application/src/main/java/io/fusionauth/example/spring/HomeController.java"
            lang="java"/>
...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-springboot-web/main/complete-application/src/main/java/io/fusionauth/example/spring/MakeChangeController.java"
            lang="java"/>
...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-springboot-web/main/complete-application/src/main/java/io/fusionauth/example/spring/model/Change.java"
            lang="java" />
...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-springboot-web/main/complete-application/src/main/java/io/fusionauth/example/spring/config/SecurityConfiguration.java"
            lang="java" />
...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-springboot-web/main/complete-application/src/main/java/io/fusionauth/example/spring/config/WebConfig.java"
            lang="java" />
