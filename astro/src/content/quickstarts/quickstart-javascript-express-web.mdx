...
The `/logout` route in your application will redirect to the FusionAuth server. FusionAuth will then end the OAuth session for this user and redirect back to the `logoutURL` specified in your `kickstarter.json` file.
