...
<BlogButton label="Docker" href="/docs/v1/tech/getting-started/5-minute-docker" /><span class="mr-3" />
<BlogButton label="FastPath" href="/docs/v1/tech/getting-started/5-minute-fastpath" /><span class="mr-3" />
<BlogButton label="Sandbox" href="/docs/v1/tech/getting-started/5-minute-sandbox" />
