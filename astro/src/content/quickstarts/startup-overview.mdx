...
<BlogButton label="Cloud" href="/docs/quickstarts/launch-cloud" />
...
* [Cloud](/docs/quickstarts/launch-cloud) creates a cloud-hosted instance for FusionAuth.  This means you don't need to install anything on your local system.  Works best in Chrome.
