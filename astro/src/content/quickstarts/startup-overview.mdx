...
* [Cloud](/docs/quickstarts/launch-cloud) creates a hosted gitpod instance for FusionAuth.  This means you don't need to install anything on your local system, while still giving you your own environment to work with.  Works best in Chrome.
* [Docker](/docs/quickstarts/launch-docker) requires docker and docker compose. This is the best choice if you have docker and docker compose installed.
* [Local](/docs/quickstarts/launch-local) requires a local database (such as PostgreSQL). This is the best option if you have a local database installed and want to get the full installation experience.
