...
These two pages are currently placeholders, with buttons that redirect the user from one page to the other with no authentication.

The last file you need to create is some style.
...
▶️ Run the commands below to install the Node packages for the app, the start the app server with Vite.
