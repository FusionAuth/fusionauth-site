...
import LocalInstall from '/src/components/quickstarts/LocalInstall.astro';
...
import ReactViteConfig from '_react-quickstart-vite-config.md'
...
In this section, you'll get FusionAuth up and running.
...
### Launch FusionAuth with Docker or a Local Install

<DockerSpinup kickstartUri={frontmatter.codeRoot + "/kickstart/kickstart.json"} />
<LocalInstall kickstartUri={frontmatter.codeRoot + "/kickstart/kickstart.json"} />
...
```
<Aside type="note">
    The FusionAuth server is configured with the valid redirect URI of localhost:3000. Ensure your changebank app runs on this port by adding `server: { port: 3000 }` to your `vite.config.ts` as shown below.
</Aside>

| File | Code |
|--------------------------|-----------------------------------------------|
| vite.config.ts    | <RemoteCode url="https://raw.githubusercontent.com/synedra/fusionauth-first-steps-launch/main/complete-application/vite.config.ts" lang="typescript"  />                |
...
The configuration variables you need to set are in the following section of the code:

| File | Code |
|--------------------------|-----------------------------------------------|
|  src/main.tsx: These values are set to match the localhost fusionauth instance running in docker or on your own system.   | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/main.tsx#L10-L22" lang="tsx"/> |
...
| File | Code |
|--------------------------|-----------------------------------------------|
| src/main.tsx    | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/main.tsx#L23-L32" lang="tsx"/> |
...
| File | Code |
|--------------------------|-----------------------------------------------|
| The home page will be a simple page with a welcome message and a login link. Open the src/pages/HomePage.tsx file in your editor. | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/pages/HomePage.tsx" lang="tsx"/> |

#### Create an Account Page

| File | Code |
|--------------------------|-----------------------------------------------|
| The account page will be a simple page that displays a random balance for the logged in user. Open the src/pages/AccountPage.tsx file in your editor. | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/pages/AccountPage.tsx" lang="tsx"/> |

#### Create A Make Change Page

| File | Code |
|--------------------------|-----------------------------------------------|
| The make change page will be a simple page that displays an input field for the user to enter a dollar amount and a button to convert that amount into coins. Open the src/pages/MakeChangePage.tsx file in your editor. | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/pages/MakeChangePage.tsx" lang="tsx"/> |
...
| File | Code |
|--------------------------|-----------------------------------------------|
| Depending on the user's authentication state, the login or logout button should be displayed in the header. Open the src/components/LogoHeader.tsx file in your editor. | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/components/LogoHeader.tsx" lang="tsx"/> |

| File | Code |
|--------------------------|-----------------------------------------------|
| Additionally, we want to display different menu items. Open the src/components/MenuBar.tsx file in your editor. | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/components/MenuBar.tsx" lang="tsx"/> |

| File | Code |
|--------------------------|-----------------------------------------------|
| The next step is to tie it all together. Open the src/App.tsx file in your editor. | <RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-react-web/main/complete-application/src/App.tsx" lang="tsx"/> |
