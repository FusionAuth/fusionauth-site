...
Now you are going to write some Golang code. You need to create a file called `main.go`. Here you will add the package clause and import declarations below:
