...
Assuming you have Docker installed on your machine, you can start FusionAuth on your machine with:
...
You can log in to the [FusionAuth admin UI](http://localhost:9011/admin) and look around if you want to, but with Docker Kickstart, you don't need to.
