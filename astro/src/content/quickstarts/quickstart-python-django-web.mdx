...
All shell commands in this guide can be entered in a terminal in this folder. All the files you'll create in this guide already exist in the `complete-application` folder if you want to copy them.
