...
* Set up [MFA](/docs/v1/tech/guides/multi-factor-authentication), [Social login](/docs/lifecycle/authenticate-users/identity-providers/), or [SAML](/docs/lifecycle/authenticate-users/identity-providers/samlv2/) integrations.
