...
You can [visit it](http://localhost:8000/app) to ensure it is running. If you need to stop it, hit `control-C` to do so. You can leave this running while you build your application so that you can see your progress.
