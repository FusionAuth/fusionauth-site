...
Next, you'll create a page that is only visible to logged in users. This page will be a simple page that input field for the user to enter a dollar amount and a button to convert that amount into coins. You can create a new component for this page with the Angular CLI:
