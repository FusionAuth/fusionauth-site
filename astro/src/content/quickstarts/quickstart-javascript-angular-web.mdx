...
the guard should allow logged in users <InlineFieldValue>true</InlineFieldValue> or anonymous users <InlineFieldValue>false</InlineFieldValue>. The second parameter is the route to redirect to if the guard fails.
