...
Next, grant the sandbox@fusionauth.io user permissions to log into your new Application. This can be done from the User management section of the FusionAuth admin UI. Click the <Breadcrumb>Users</Breadcrumb> link in the navigation. If needed, search for the user.
