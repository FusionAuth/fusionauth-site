...
Here you are using a bootstrapping feature of FusionAuth, called [Kickstart](/docs/get-started/download-and-install/kickstart). When FusionAuth starts for the first time, it will look at the `kickstart/kickstart.json` file and configure FusionAuth to your specified state.
...
* Set up [MFA](/docs/v1/tech/guides/multi-factor-authentication), [Social login](/docs/lifecycle/authenticate-users/identity-providers/), or [SAML](/docs/lifecycle/authenticate-users/identity-providers/overview-samlv2) integrations.
