...
In the `docker-compose.yml` configuration, on the `php` service change the volume parameter `./complete-application:/var/www/html` to reference your application with `./your-application:/var/www/html`.

The `./your-application:/var/www/html` volume parameter shares your application directory with the container so both your physical machine and Docker can read and write the same files.
...
```shell
cp complete-application/public/static/money.jpg your-application/public/static/money.jpg
cp complete-application/public/static/changebank.svg your-application/public/static/changebank.svg
```
