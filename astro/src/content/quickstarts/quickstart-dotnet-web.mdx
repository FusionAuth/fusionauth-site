...
* You may want to customize the [token expiration times and policies](/docs/lifecycle/authenticate-users/oauth/overview#configure-application-oauth-settings) in FusionAuth
...
* Integrate with external systems using [Webhooks](/docs/extend/events-and-webhooks/), [SCIM](/docs/getting-started/core-concepts/scim), and [Lambdas](/docs/extend/code/lambdas/)
