...
* [Hosted pages](/docs/themes/) such as login, registration, email verification, and many more
* [Email templates](/docs/email-templates/email-templates)
...
* You may want to customize the [token expiration times and policies](/docs/oauth/#configure-application-oauth-settings) in FusionAuth
* Choose [password rules](/docs/core-concepts/tenants#password) and a [hashing algorithm](/docs/reference/password-hashes) that meet your security needs

### Tenant and Application Management
* Model your application topology using [Applications](/docs/core-concepts/applications), [Roles](/docs/core-concepts/roles), [Groups](/docs/get-started/core-concepts/groups), [Entities](/docs/core-concepts/groups), and more
* Set up [MFA](docs/v1/tech/guides/multi-factor-authentication), [Social login](/docs/identity-providers/), and/or [SAML](/docs/identity-providers/samlv2/) integrations
* Integrate with external systems using [Webhooks](/docs/events-webhooks/), [SCIM](/docs/core-concepts/scim), and [Lambdas](/docs/extend/code/lambdas/)
