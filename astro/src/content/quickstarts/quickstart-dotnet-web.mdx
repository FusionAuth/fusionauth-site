...
* Model your application topology using [Applications](/docs/core-concepts/applications), [Roles](/docs/core-concepts/roles), [Groups](docs/v1/tech/core-concepts/groups), [Entities](/docs/core-concepts/groups), and more
...
* Integrate with external systems using [Webhooks](/docs/events-webhooks/), [SCIM](/docs/core-concepts/scim), and [Lambdas](docs/v1/tech/lambdas/)
