...
To make the FusionAuth instance running on your machine accessible to the app, you need to [expose it to the Internet following these instructions](/docs/get-started/download-and-install/development/exposing-instance). Then, copy the address `ngrok` gave you as you'll need it shortly. It looks something like `https://SOME-RANDOM-STRINGS.ngrok-free.app`.
