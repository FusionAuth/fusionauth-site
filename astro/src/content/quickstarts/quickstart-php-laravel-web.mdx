...
This quickstart will use a [SQLite](https://www.sqlite.org/index.html) database a small, fast, self-contained database engine but you can use MySQL or Postgres if you have them installed on your machine.
