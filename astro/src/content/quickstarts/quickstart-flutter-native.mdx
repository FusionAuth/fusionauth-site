...
In general, you would introduce FusionAuth to normalize and consolidate user data. This helps make sure it is consistent and up-to-date while offloading your login security and functionality to FusionAuth.
