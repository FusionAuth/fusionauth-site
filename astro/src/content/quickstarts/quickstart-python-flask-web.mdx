...
This quickstart will be referencing the example application in the [Flask Quickstart Repo](https://github.com/FusionAuth/fusionauth-example-python-flask-guide).
...
`requirements.txt`
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/requirements.txt"
 lang="python" />
...
`.env`
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/.env"
 lang="shell" />

In server.py, you'll add all of the imports you'll need, declare some constants, and initialize the OAuth library.

`server.py`
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/server.py"
 lang="python"
...
wget -O templates/home.html https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/templates/home.html && \
wget -O static/css/changebank.css https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/static/css/changebank.css && \
wget -O static/img/money.jpg https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/static/css/money.jpg
...
```shell
wget -O templates/account.html https://raw.githubusercontent.com/FusionAuth/fusionauth-example-python-flask-guide/andrewpai/quickstart-update/complete-application/templates/account.html
```
