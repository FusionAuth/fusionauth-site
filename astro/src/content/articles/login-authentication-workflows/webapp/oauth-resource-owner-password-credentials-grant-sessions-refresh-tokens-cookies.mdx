...
tags: webapp, oauth, resource owner password credentials, sessions, refresh tokens, cookies, authentication workflow, login workflow
...
* [/oauth2/token (grant)](/docs/apis/oauth/token#resource-owner-password-credentials-grant-request)
* [/oauth2/token (refresh)](/docs/apis/oauth/token#refresh-token-grant-request)
