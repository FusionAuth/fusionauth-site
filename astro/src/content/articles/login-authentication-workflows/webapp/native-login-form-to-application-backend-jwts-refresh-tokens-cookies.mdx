...
---
import Diagram from "../../../../diagrams/articles/login-authentication-workflows/webapp/native-login-form-to-application-backend-jwts-refresh-tokens-cookies.astro";
