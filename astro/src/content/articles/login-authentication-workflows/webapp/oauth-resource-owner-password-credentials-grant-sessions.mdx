...
tags: webapp, oauth, resource owner password credentials, sessions, authentication workflow, login workflow
...
* [/oauth2/token](/docs/apis/oauth/token#resource-owner-password-credentials-grant-request)
