...
---
import AdviceGettingStarted from "../../../components/AdviceGetStarted.astro";
...
<AdviceGettingStarted intro={`If you are looking for a solution that provides full support for OAuth Device Authorization, FusionAuth has you covered.`}></AdviceGettingStarted>
