...
tags: oauth, authorization, authentication, oidc, tokens, security, identity, api
...
There are other similar frameworks, such as the Trusted Digital Identity Framework and the [UK digital identity & attributes trust framework](https://www.gov.uk/government/publications/uk-digital-identity-attributes-trust-framework-updated-version).
