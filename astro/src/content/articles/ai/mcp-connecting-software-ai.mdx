...
| | | |
|------------|-----------|-----------|
| **Data layer** | Primitives | The specification defines a set of JSON-RPC endpoints that can be called to perform [tool calls](https://spec.modelcontextprotocol.io/specification/2025-06-18/server/tools) and access other features. |
