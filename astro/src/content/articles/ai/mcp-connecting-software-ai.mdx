...
| | | |
|------------|-----------|-----------|
| **Data layer** | Primitives | The specification defines a set of JSON-RPC endpoints that can be called to perform [tool calls](https://modelcontextprotocol.io/docs/getting-started/introspecification/2025-06-18/server/tools) and access other features. |
...
The simplest transport layer to understand is [the "stdio" transport](https://modelcontextprotocol.io/docs/getting-started/introspecification/2025-06-18/basic/transports#stdio). This is also called "local".
...
This is actually [the second version](https://modelcontextprotocol.io/docs/getting-started/introspecification/2025-06-18/basic/transports#streamable-http) of an HTTP transport in the short life  of MCP – the earlier SSE transport was a little more complicated to implement. This is also called "remote".
