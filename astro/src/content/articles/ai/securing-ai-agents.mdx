...
Agent security is a layered defense with a foundation of secure human identity. Without verified identity, you can't confirm an agent is authorized to act for the person it represents.
...
- Command-line tools like Claude Code and OpenCode that write software
