...
tags: ai, ai agent identity, authentication, authorization, machine identity, oauth, tokens, security
author: Dan Moore
section: AI
...
The [Model Context Protocol](https://modelcontextprotocol.io/docs/getting-started/intro), created by Anthropic, allows AI applications to connect to external data sources and tools. MCP has become popular with SaaS providers—companies like Google, Jira, and GitHub have all launched MCP servers to make their services agent-accessible.
