...
![FusionAuth's admin panel](/img/articles/sso-mfa/1.png)

You must assign the user to both applications for the SSO to work properly.

![Assigning the user to the applications](/img/articles/sso-mfa/2.png)
...
![Enabling MFA for all the registered apps](/img/articles/sso-mfa/3.png)
...
![MFA registration prompt](/img/articles/sso-mfa/4.png)
