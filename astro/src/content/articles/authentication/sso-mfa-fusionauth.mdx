---
title: Combinging SSO and MFA in FusionAuth
...
In this article, you'll learn how to combine single sign-on (SSO) and multifactor authentication (MFA) to strengthen security while making nontechies' lives easier.
...
![FusionAuth's admin panel](https://i.imgur.com/ob0hCxL.png)

You must assign the user to both applications for the SSO to work properly.

![Assigning the user to the applications](https://i.imgur.com/2M8AmP3.png)
...
![Enabling MFA for all the registered apps](https://i.imgur.com/2QdkJ9i.png)
...
![MFA registration prompt](https://i.imgur.com/d3Wz2wf.png)

And that's all it takes to get the convenience and simplicity of SSO with the hardened access control of MFA.

## Conclusion

SSO gives users streamlined access to multiple applications with a single login, while MFA brings an added layer of security. This article explained how combining them gives you the best of both worlds.
...
Aside from SSO and MFA, FusionAuth also supports [passwordless](/features/passwordless) and [biometric authentication](/features/biometric-authentication) to make the login process even smoother. You can also choose to run FusionAuth locally or use [FusionAuth Cloud](/platform/fusionauth-cloud).
