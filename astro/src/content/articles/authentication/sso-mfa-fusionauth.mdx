...
In this article, you'll learn how to combine [single sign-on (SSO)](/articles/authentication/how-sso-works) and [multifactor authentication (MFA)](/articles/authentication/multi-factor-authentication) to strengthen security while making nontechies' lives easier.
