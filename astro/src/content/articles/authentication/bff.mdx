...
- [Competitor Authentication Gateways](#competitor-authentication-gateways)
- [Summary](#summary)
...
## Competitor Authentication Gateways

The ability of FusionAuth to provide a hosted backend greatly simplifies the work you have to do for SPAs and mobile apps. Almost no other authentication gateways offer this feature at the time of writing (early 2025).
...
cookies
tokens bad
mfa on dangerous actions
always use server / bff, even on mobile/desktop
