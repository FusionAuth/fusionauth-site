...
## Introduction
 ...
 OAuth proxy, BFF, or hosted auth proxy. Curity calls it the [token handler pattern]
...
- The easiest way to add an OAuth Proxy is with FusionAuth hosted backend, the Go Auth2 proxy, or building on the Passport.js Node sample in this article.
