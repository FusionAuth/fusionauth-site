...
![Diagram showing a minimal backend for secure token exchange with Dropbox acting as both the OAuth server and resource server](/img/articles/authentication/bff/bff6.svg)
...
![Diagram showing separate Oauth server and resource server](/img/articles/authentication/bff/bff7.svg)
