...
- [A FusionAuth Example](#a-fusionauth-example)
...
## A FusionAuth Example

todo - read entities in fusionauth docs

entities, entity types
your app must know what uuids apps are, must check signature
...
use attributes (cli) and lambdas to manage permissions (roles). or write script to add and remove permissions
