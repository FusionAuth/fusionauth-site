...
participant hooli as Hooli Jobs
...
Browser ->> hooli : Requests Home Page
hooli ->> hooli : Check Session Existence
hooli -->> Browser : Redirect to FusionAuth Because There is No Valid Session
Browser ->> FusionAuth : Request Login Page
FusionAuth ->> FusionAuth : Check FA Session Existence
FusionAuth -->> Browser : Redirects to Home Page
Browser ->> hooli : Requests Application Page
hooli -->> Browser : Sends Application Page
```
