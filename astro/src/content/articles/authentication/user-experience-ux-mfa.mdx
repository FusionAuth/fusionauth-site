...
- [Keeping passwords on a Post-it](https://www.businessinsider.com/hawaii-emergency-agency-password-discovered-in-photo-sparks-security-criticism-2018-1), typically stuck to the computer in an office where people walk around daily
...
[FusionAuth](/) lets you combine MFA, passwordless, and single sign-on (SSO) to offer your users safe, simple, and quick login processes. Its authentication solutions are secure, efficient, and easy to use and implement. Plus, key features like app MFA and SSO are always free. [Try it out](/docs/get-started/download-and-install/docker) if you want to experience the simplistic side of security.
