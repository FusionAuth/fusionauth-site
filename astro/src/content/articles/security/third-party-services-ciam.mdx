...
For example, if you want to let your users log in with their LinkedIn account, [this is how you can do it](/docs/lifecycle/authenticate-users/identity-providers/social/linkedin):  create a LinkedIn app, set permissions, choose to <InlineUIElement>Add LinkedIn</InlineUIElement> inside FusionAuth's identity provider settings, copy over the client credentials from the LinkedIn app, save, and you're done.
