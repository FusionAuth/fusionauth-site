...
1. What is the authentication provider [failover strategy](https://www.techtarget.com/searchstorage/definition/failover)? Are business continuity and disaster recovery policies in place? Outages happen, but your software application won't work without authentication. Understanding your vendor's failover strategy will help you evaluate business risks during outages. For some businesses, and especially in enterprise space, authentication services should be highly available, otherwise SLAs will be breached leading to client loss.
