...
tags: user management, identity management, migration, authentication, identity basics, architecture, ciam, passwords
author: Dan Moore
icon: /img/icons/slow-migration-user-data.svg
darkIcon: /img/icons/slow-migration-user-data-dark.svg
...
See more about slow migration in our Authentication Architecture video below.

<div class="aspect-video">
  <iframe class="w-full h-full" src="https://www.youtube.com/embed/gaKX71qmfic?start=787" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
participant oldauth as Old Auth System
participant oldauthds as Old Auth Datastore
...
sequenceDiagram
  ...
  participant newauthds as New Auth Datastore
  participant oldauthds as Old Auth Datastore
...
sequenceDiagram
  ...
  actor user as User/Browser
  participant newauth as New Auth System
  participant newauthds as New Auth Datastore
...
When a user signs in, the new auth system passes on the credentials to the old auth system, and receives the user data in response.
