...
tags: authentication, identity management, ciam, identity basics, api, self-hosted, open source, sdk
...
[Trying your authentication provider](/docs/get-started/download-and-install/docker) before you commit can save you lots of headaches in the future and should be an important part of choosing an authentication partner.
...
[![FusionAuth free trial](/img/articles/try-before-buy/fusionauth-free-trial.png)](/docs/get-started/download-and-install/docker)
