...
* <InlineField>SameSite</InlineField> with a value of <InlineFieldValue>Lax</InlineFieldValue> or <InlineFieldValue>Strict</InlineFieldValue>. Either of these will ensure that the cookie is only sent to the domain it is associated with.
...
And here's a longer, exhaustive list of possible storage options.
