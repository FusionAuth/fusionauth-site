...
<div className="flex gap-x-6 items-start mt-8 no-prose">
  <div class:list={[border(false, false, true), "flex items-center justify-between py-1 px-2"]}>
    ...
    <button data-widget="copy-button" data-copy-source="uuid-value" title="Copy contents"><i className="fa-duotone fa-copy bg-slate-800 leading-4 py-2 px-2.5 rounded text-center text-indigo-200 w-10 dark:hover:text-indigo-400 hover:text-indigo-600"></i></button>
  </div>
