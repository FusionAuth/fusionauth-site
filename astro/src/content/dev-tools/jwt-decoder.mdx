...
<div class="test-promo">
  ...
  <ModularCTA className="control" image="https://cdn.prod.website-files.com/664cfafd1b780dd90b9bc416/69939e3f8cf883514a146d0e_scale.avif">
...
{/* eslint-disable-line */}<p class="mb-10">JWTs are the backbone of modern authentication and authorization platforms. When you use FusionAuth for your application, you get control over your tokens and your login.</p>
    <BlogButton size="medium" href="/download?utm_medium=cta&utm_source=dev-tools&utm_campaign=dev_promo_adview" label="Install for free" />
