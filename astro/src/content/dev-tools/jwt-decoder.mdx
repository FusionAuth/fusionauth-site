...
* JWTs help [power passwordless auth in Next.js](https://fusionauth.io/blog/nextjs-and-fusionauth-passwordless?utm_medium=cta&utm_source=dev-tools&utm_campaign=dev_promo)
* JWTs can play a role in [securing your APIs](https://fusionauth.io/blog/securing-your-api?utm_medium=cta&utm_source=dev-tools&utm_campaign=dev_promo)
* And don't forget, you can [download and deploy FusionAuth for free](https://fusionauth.io/download?utm_medium=cta&utm_source=dev-tools&utm_campaign=dev_promo) to own your own auth workflow
</Aside>
