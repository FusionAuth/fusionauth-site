...
<div class="test-promo">
  ...
  <ModularCTA className="experiment hidden" image="https://cdn.prod.website-files.com/664cfafd1b780dd90b9bc416/69939e3f8cf883514a146d0e_scale.avif">
    <h3 class="text-3xl mb-6 font-bold">Identity without Constraints</h3>
    <p class="mb-10">FusionAuth is the only CIAM platform built to deploy anywhere, give you total control, and scale across any modern architecture–no matter how complex.</p>
