...
<ModularCTA image="https://cdn.prod.website-files.com/664cfafd1b780dd90b9bc416/69939e3f8cf883514a146d0e_scale.avif">
  <h3 class="text-3xl mb-8 font-bold">Identity without Constraints</h3>
  <p class="mb-8">FusionAuth is the only CIAM platform built to deploy anywhere, give you total control, and scale across any modern architecture–no matter how complex.</p>
  <BlogButton size="medium" href="/download" label="Download for free" />
</ModularCTA>

<div class="test-promo">
  <Aside title="Take JWTs a step further control" type="tip">
  ...
  * And don't forget, you can [download and deploy FusionAuth for free](/download?utm_medium=cta&utm_source=dev-tools&utm_campaign=dev_promo) to own your own auth workflow
  ...
  <Aside classes="hidden" title="Take JWTs a step further test" type="tip">
