...
* JWTs help [power passwordless auth in Next.js](https://fusionauth.io/blog/nextjs-and-fusionauth-passwordless)
* JWTs can play a role in [securing your APIs](https://fusionauth.io/blog/securing-your-api)
* And don't forget, you can [download and deploy FusionAuth for free](https://fusionauth.io/download) to own your own auth workflow
</Aside>
