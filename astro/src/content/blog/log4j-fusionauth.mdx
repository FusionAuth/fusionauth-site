...
* visit the [NIST CVE description](https://www.cve.org/CVERecord?id=CVE-2021-44228)
...
**Update December 15:** There is an additional related CVE: [CVE-2021-45046](https://www.cve.org/CVERecord?id=CVE-2021-45046). This also does not affect FusionAuth because FusionAuth does not use log4j.

## What about Elasticsearch

Elasticsearch is used by many FusionAuth installations. However, in general the Elasticsearch service is not publicly accessible, if [following the recommended security guidance](/docs/operate/secure).
...
**Update December 15:** There is an additional related CVE: [CVE-2021-45046](https://www.cve.org/CVERecord?id=CVE-2021-45046). Per the [Elasticsearch announcement](https://discuss.elastic.co/t/apache-log4j2-remote-code-execution-rce-vulnerability-cve-2021-44228-esa-2021-31/291476):
