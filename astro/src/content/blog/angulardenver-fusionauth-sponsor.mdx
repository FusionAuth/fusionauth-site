...
authors: Bryan Giese
image: /img/blogs/angulardenver/angulardenver-fusionauth-sponsor.jpg
categories: Events
tags: events, angular denver
...
- **Angular Fundamentals** – with [Kevin Schuchard](https://x.com/KevinSchuchard) and Anthony Jones
- **NgRx: A Reactive State of Mind** – with [Mike Ryan](https://x.com/MikeRyanDev) and [Brandon Roberts](https://x.com/brandontroberts)
- **RxJS Level UP: Essentials in Reactive Programming** – with [Michael Hladky](https://x.com/Michael_Hladky) and Jan-Niklas Wortmann
- **Angular Architecture** – with [Dan Wahlin](https://x.com/DanWahlin)
- **ngGirls-Denver** – with [Robert Willemelis](https://x.com/robertSPD)
- **Unit Testing Like a Boss** – with [Joe Eames](https://x.com/josepheames)
