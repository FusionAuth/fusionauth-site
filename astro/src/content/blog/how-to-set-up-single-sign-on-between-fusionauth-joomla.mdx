...
* Navigate to <Breadcrumb>Components</Breadcrumb>, then "miniOrange OAuth Client", then choose "Configure OAuth".
...
To enable this feature, in the backend of your website navigate to <Breadcrumb>System</Breadcrumb>, then "Global Configuration", then the System tab. Then scroll down to "Session Settings" and set "Shared Sessions" to `Yes`. Finally, save your Global Configuration.
