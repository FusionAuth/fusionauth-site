...
* <InlineField>Authorize Endpoint</InlineField>: enter <InlineFieldValue>http(s)://<your FusionAuth URL>/oauth2/authorize</InlineFieldValue>
* <InlineField>Access Token Endpoint</InlineField>: enter <InlineFieldValue>http(s)://<your FusionAuth URL>/oauth2/token</InlineFieldValue>
* <InlineField>Get User Info Endpoint</InlineField>: enter <InlineFieldValue>http(s)://<your FusionAuth URL>/oauth2/userinfo</InlineFieldValue>
...
* Change the filter from `Site` to <InlineFieldValue>Administrator</InlineFieldValue>.
...
To enable this feature, in the backend of your website navigate to <Breadcrumb>System -> Global Configuration -> System</Breadcrumb>. Then scroll down to <InlineUIElement>Session Settings</InlineUIElement> and set <InlineField>Shared Sessions</InlineField> to <InlineFieldValue>Yes</InlineFieldValue>. Finally, save your Global Configuration.
