...
- [An Emerging Standard: OAuth 2.0 for Browser-Based Applications](#an-emerging-standard-oauth-20-for-browser-based-applications)
- [Friends Don't Let Friends Store Tokens in the Browser](#friends-dont-let-friends-store-tokens-in-the-browser)
	- [Where Developers Store Tokens Today](#where-developers-store-tokens-today)
	- [Why No Browser Storage Is Secure](#why-no-browser-storage-is-secure)
		...
		- [The Browser Is the Problem](#the-browser-is-the-problem)
- [Understanding Backend-for-Frontend Architecture](#understanding-backend-for-frontend-architecture)
	- [Architecture Comparison](#architecture-comparison)
	- [How BFF Prevents Attacks](#how-bff-prevents-attacks)
	- [Security Wins](#security-wins)
		- [1. Confidential Client Authentication](#1-confidential-client-authentication)
		- [2. Secure Token Storage](#2-secure-token-storage)
		- [3. Automatic Token Refresh](#3-automatic-token-refresh)
		- [4. Cross-Site Request Forgery (CSRF) Protection](#4-cross-site-request-forgery-csrf-protection)
	- [Trade-offs and Considerations](#trade-offs-and-considerations)
	- [Benefits Beyond Security](#benefits-beyond-security)
- [See BFF in Action: A Complete Demo](#see-bff-in-action-a-complete-demo)
	- [Set Up the Architecture](#set-up-the-architecture)
	- [Architecture Overview](#architecture-overview)
	- [The Authentication Flow](#the-authentication-flow)
		- [1. Session Check on Page Load](#1-session-check-on-page-load)
		- [2. Secure Login with PKCE](#2-secure-login-with-pkce)
		- [3. Proxying API Requests](#3-proxying-api-requests)
		- [4. Automatic Token Refresh](#4-automatic-token-refresh)
- [FusionAuth's Hosted Backend: BFF Made Simple](#fusionauths-hosted-backend-bff-made-simple)
	- [Getting Started](#getting-started)
	- [Architecture Overview](#architecture-overview-1)
- [The Decision Framework: When BFF Is Essential](#the-decision-framework-when-bff-is-essential)
- [Next Steps](#next-steps)
- [Try It Yourself](#try-it-yourself)
- [What's Next in This Series](#whats-next-in-this-series)
...
Update the `.env` file to set the `CLIENT_ID_BFF_TMB` and `CLIENT_ID_BBOC` to the client IDs in the `.env` comments. You can also find these in the FusionAuth admin UI under **Applications -> Your App -> Action -> View**.
