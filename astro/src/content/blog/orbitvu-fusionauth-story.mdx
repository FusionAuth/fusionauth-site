...
htmlTitle: "Orbitvu Streamlines Authentication with FusionAuth"
description: "Orbitvu improved authentication across applications by adopting FusionAuth, enabling seamless SSO, protocol flexibility, and simplified user management."
authors: Dan Moore
...
tags: community story, single sign-on
...
**Maciej:** Of course, the typical 360-degree presentation made with our solutions might be similar to this presentation of the miter saw. We have a number of products targeted to different industries and/or product sizes. For example, our Alphashot Micro is made for photography of smaller objects, e.g. jewelry or watches. For larger objects, such as human models, we have other solutions like our newest product [Fashion Studio](https://orbitvu.com/products/fashion-studio), which is great for packshots and videos.

{/* eslint-disable-line */}> [Choosing FusionAuth] opened a whole bunch of new possibilities in terms of architectural solutions and technologies we are able to use. 
...
> _Discover how FusionAuth can streamline your authentication processes, just like it did for Orbitvu. [Schedule a demo](/contact) today._
