...
image: /img/blogs/open-source-considerations/what-to-consider-before-choosing-an-open-source-auth-provider-header-image.png
categories: Education, Company
tags: market, vendor selection, auth, ciam
...
_This blog post is an excerpt from [Open Source vs Commercial Auth Providers](/articles/identity-basics/open-source-vs-commercial)._
...
To learn about pros and cons of open-source and commercial auth providers, read [Open Source vs Commercial Auth Providers](/articles/identity-basics/open-source-vs-commercial).
