...
Permify is a centralized authorization service based on [Google's Zanzibar](https://research.google/pubs/zanzibar-googles-consistent-global-authorization-system/) authorization model, a battle-tested approach used internally by some of the largest technology companies in the world.
