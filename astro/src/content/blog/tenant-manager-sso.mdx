...
Self-service SSO in FusionAuth 1.65 makes IdP configuration easy to test against a real identity provider before you deploy to production. If the configuration doesn't work, FusionAuth shows an error log that helps your customer debug their configuration without contacting your engineers.
