...
description: Enterprise SSO has always come with a tax — on your team's time, on your per-connection bill, or both. FusionAuth 1.65.0 cuts it.
authors: Andrew Hatfield
image: /img/blogs/tenant-manager-sso/tenant-manager-sso.png
categories: Product
tags: single sign-on, enterprise, tenant manager, saml, oidc, b2b
