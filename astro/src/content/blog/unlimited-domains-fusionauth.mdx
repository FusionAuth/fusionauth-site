...
description: A few weeks ago we announced that FusionAuth Cloud now supports unlimited custom domains. Here’s how we actually built it. 
authors: Mark Manes
...
FusionAuth supports [multiple tenants](/docs/v1/tech/core-concepts/tenants) and applications, so this shouldn't be a problem, right?
...
![FusionAuth Unlimited Domains Diagram](/public/img/blogs/unlimited-domains/unlimited-domains-diagram-fusionauth.png)
