...
Enter the correct credentials created when you set up FusionAuth and submit the form. You'll arrive back at your Next.js application home screen, [with your email address displayed and the <InlineUIElement>Log out</InlineUIElement> button.](/docs/lifecycle/authenticate-users/logout-session-management)
