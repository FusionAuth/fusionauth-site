...
- Our [Kickstart](/docs/get-started/download-and-install/development/kickstart) feature automates environment setup, making maintaining consistent development and CI environments simple.
