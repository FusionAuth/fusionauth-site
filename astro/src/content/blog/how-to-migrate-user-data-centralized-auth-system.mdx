...
* Build an HTTP JSON API endpoint in your existing application. This endpoint will receive the username and password, among other data, and return a JSON response. You should protect that API; you have a [variety of options to do so](/docs/lifecycle/migrate-users/connectors/generic-connector#security-2).
