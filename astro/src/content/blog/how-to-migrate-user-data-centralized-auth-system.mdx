...
If you don't have FusionAuth running, [get it going in 5 minutes](/docs/quickstarts/5-minute-setup-guide). Then get a license key and activate it. *Please note that Connectors are a paid edition feature. You can [learn more about paid editions and sign up for a free trial here](/pricing).* Finally, [activate your license](/docs/get-started/core-concepts/licensing). 
