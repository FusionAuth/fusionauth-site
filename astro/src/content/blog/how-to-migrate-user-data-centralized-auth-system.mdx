...
Now, set up the tenant to use this Connector. Navigate to <Breadcrumb>Tenants -> Default Tenant -> Connectors</Breadcrumb> tab. FusionAuth supports multiple tenants, but for this post, let's just keep everything in the "Default" tenant. Click the button to add a new policy.
