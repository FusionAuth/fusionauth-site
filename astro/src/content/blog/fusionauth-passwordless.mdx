...
image: /img/blogs/introducing-passwordless/fusionauth-1-5-passwordless.png
categories: Product, News
tags: passwordless, magic links, email, sms
excerpt_separator: "{/* more */}"
---
import { YouTube } from '@astro-community/astro-embed-youtube'

Logging in without a password? In what fantasy land can that be secure?!? The fact is it can be much more secure than traditional passwords, and is now supported in our newest release. FusionAuth `1.5` is now available for [direct download](/docs/get-started/download-and-install/docker),  [FastPath one-line install](/docs/get-started/download-and-install/fusionauth-app), [Homebrew](/docs/get-started/download-and-install/fusionauth-app) or [Docker](/docs/get-started/download-and-install/docker). It includes new features, a few changes, and minor fixes for issues discovered by QA testers and our growing community of users. Get the brief overview below, and visit our [release notes](/docs/release-notes#version-1-5-0) for the full details.
...
![Login with a magic link.](/img/blogs/introducing-passwordless/login-magic-link.png)
...
If you're still not getting it, read more about passwordless here. As passwords continue to be proven difficult to secure, more sites and applications will rely on passwordless authentication solutions in one form or another.
...
While we are pretty excited about passwordless login, the FusionAuth `1.5` release has many other updates and fixes that you should know about. Here are just a few to get you started, and visit our [release notes](/docs/release-notes#version-1-5-0) for the full details.
