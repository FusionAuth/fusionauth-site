...
Next, create a test user in FusionAuth. Navigate to <Breadcrumb>Users</Breadcrumb> then click <Breadcrumb>+</Breadcrumb> button. It is not necessary to specify an email address. Uncheck **Send email to setup password**. Make sure you set a **Username** and **Password**. Save the new user.
