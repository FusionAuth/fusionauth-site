...
Once you see the setup wizard in the browser, follow the [Setup Wizard](/docs/get-started/download-and-install/setup) tutorial that will guide you through completing the initial FusionAuth configuration necessary prior to making API calls and beginning your integration.
