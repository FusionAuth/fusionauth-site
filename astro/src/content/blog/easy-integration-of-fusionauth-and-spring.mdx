...
This post is old and no longer works. If you'd like to use Spring and FusionAuth, read [the Spring Boot FusionAuth quickstart](/docs/get-started/quickstarts/web/quickstart-springboot-web).
</Aside>
...
2. [Create an Application](/docs/get-started/core-concepts/applications)
   1. While you are creating an application, create two roles `user` and <InlineFieldValue>admin</InlineFieldValue> (you can create others if you like)
