...
5. Connect our library to your application using a Spring Security configuration.
    ...
    2. Spring handles the `/login` request by initiating an OAuth2 redirect to the [`authorize` endpoint](/docs/api/oauth#authorize) on the FusionAuth instance.
