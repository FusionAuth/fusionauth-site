...
2. [Create an Application](/docs/get-started/core-concepts/types/applications)
...
5. Connect our library to your application using a Spring Security configuration.
    ...
    2. Spring handles the `/login` request by initiating an OAuth2 redirect to the [`authorize` endpoint](/docs/apis/oauth/authorize) on the FusionAuth instance.
...
1. [Create](/docs/get-started/core-concepts/types/applications) and then copy your FusionAuth API key and your application Id into `application.properties`. Also update the base URL to be the location of your FusionAuth instance.
