...
[![Auth0 and FusionAuth Feature Comparison](/img/blogs/fusionauth-vs-auth0/download-full-auth0-comparison.png)](/resources/fusionauth-vs-auth0.pdf)
...
FusionAuth does offer advanced features and support for a price, but we have many users running their business self hosting the community edition.
...
<Button href="/resources/fusionauth-vs-auth0.pdf" label="Download the Auth0 and FusionAuth Feature Comparison" />

You can also view technical documentation about how you can migrate from Auth0 to FusionAuth.

<Button href="/docs/lifecycle/migrate-users/bulk/auth0" label="View the Auth0 Technical Migration Guide" />
