...
<a href='/resources/fusionauth-vs-auth0.pdf' class="button brochure orange text-larger">Download the Auth0 and FusionAuth Feature Comparison</a>

You can also view technical documentation about how you can migrate from Auth0 to FusionAuth.

<a href='/docs/v1/tech/migration-guide/auth0' class="button brochure orange text-larger">View the Auth0 Technical Migration Guide</a>
