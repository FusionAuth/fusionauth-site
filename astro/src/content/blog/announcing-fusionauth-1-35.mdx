...
This release contained features, enhancements, and bug fixes. Please see the [release notes](/docs/release-notes#version-1-35-0) for a full breakdown of the changes between `1.34` and `1.35`. 
...
The [release notes](/docs/release-notes#version-1-35-0) are a guide to the changes, fixes, and new features. Please read them carefully to see if any features you use have been modified or enhanced.
