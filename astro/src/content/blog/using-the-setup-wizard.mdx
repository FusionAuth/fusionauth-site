...
If you instead are being prompted by the FusionAuth Maintenance Mode, please complete that setup first and then return to this step. See the Maintenance Mode section in the [FusionAuth App Installation Guide](/docs/get-started/download-and-install/fusionauth-app).
...
For more details on how to use the FusionAuth Setup Wizard or any other functions, please read the complete [FusionAuth documentation here](/docs/get-started/download-and-install/setup-wizard "Jump to the FusionAuth Docs").
