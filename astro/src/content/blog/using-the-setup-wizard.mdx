...
For more details on how to use the FusionAuth Setup Wizard or any other functions, please read the complete [FusionAuth documentation here](/docs/get-started/download-and-install/setup "Jump to the FusionAuth Docs").
