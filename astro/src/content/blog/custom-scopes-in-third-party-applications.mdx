...
<Aside type="note">
Please note that the custom scope feature is only available in an Essentials or Enterprise plan. You can visit the [pricing page](https://fusionauth.io/pricing) to learn more.
</Aside>
