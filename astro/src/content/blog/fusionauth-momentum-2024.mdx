...
- FusionAuth is the most feature-rich free CIAM solution, adding passkey support to its [freely-licensed Community version.](/docs/get-started/download-and-install/docker)
- FusionAuth can now be purchased directly through the [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-65uhkzzoaqnwa). Whether you get it there or download it from DockerHub, FusionAuth fits natively into container-based environments, making it a perfect fit for microservice-driven organizations. A [licensed free version](/docs/get-started/download-and-install/docker) allows businesses to unlock additional features without incurring extra costs, wherever they run it.
...
To experience the power of FusionAuth and take your authentication experience to the next level, visit [FusionAuth.io](/), [download the Community version](/docs/get-started/download-and-install/docker) to get started for free, or contact the sales team for a [personalized demo](/contact).
