...
htmlTitle: "Auth0 and Okta Enterprise Pricing Explained: The Hidden IDP Tax"
description: This article breaks down enterprise connection fees in platforms like Auth0 and Okta, and how FusionAuth avoids the IDP tax.
authors: Andy Pai
image: /img/blogs/idp-tax/idp-tax.png
categories: Education
tags: idp, single sign-on
...
> _[Schedule a demo](/contact) to see how FusionAuth delivers enterprise-grade features like SSO and M2M connections, without hidden fees or per-IdP costs._
...
We carry that same philosophy across the entirety of our [pricing and packaging](/pricing). Someone using our [free Community version](/docs/get-started/download-and-install/docker) probably doesn't need advanced MFA or custom OAuth scopes. But it wouldn't surprise us if a Starter version user needed them, so they're included in the base price. Best of all? you can test out those features for free with a fully-custom proof of concept, guided by our Solutions Engineers.
