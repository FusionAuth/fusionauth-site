...
authors: Keanan Koppenhaver
image: /img/blogs/try-before-you-buy/how-to-get-the-most-out-of-a-free-auth-provider-trial-header-image.png
categories: Product, Company
tags: vendor selection, auth, open source, download
...
_This blog post is an excerpt from [The Value of Trying Your Auth Provider Before You Commit](/articles/identity-basics/try-before-you-buy)._
...
To learn about the value of trying an auth provider before you buy, read [The Value of Trying Your Auth Provider Before You Commit](/articles/identity-basics/try-before-you-buy).
