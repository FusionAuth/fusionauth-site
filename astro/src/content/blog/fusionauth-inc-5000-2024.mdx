...
Outside of the Inc. ranking, a key component that we track is growth based on company size. Companies at our same size on average grow roughly 30% per year according to [Eleken](https://www.eleken.co/blog-posts/average-saas-growth-rate-brief-guide-for-startups) FusionAuth grew over 65% last year and over 130% the year before that. And wait it gets even better. In 2021, we grew 314%! And we have no plans on slowing down either.

## Still Growing

We've been hiring like mad in every department since last year. The investment we received  from [Updata Partners](https://fusionauth.io/blog/fusionauth-funding) last year allowed us to hire the right people for the right roles...right now. 

Oh yeah and by the way, [we're still hiring](https://fusionauth.io/jobs), because we've been busier than ever over the past year. Here's a peek behind the curtain: 
...
One challenge that we've had to face is that our unique position brings complexity with it. We've listened to our users and we've decided to spend the next few release cycles simplifying FusionAuth in every way possible. That started with our [Simple Theme builder](https://fusionauth.io/blog/announcing-fusionauth-1-51) in version 1.51.0. Over the next few months, you'll see FusionAuth become even easier to use, no matter what your use case.

## Safety for Everyone

It should come as no surprise that we're ruthlessly devoted to user and app security. We want everyone to be as secure as possible, that's why we've always had our free Community Edition of FusionAuth. It's free forever, with no MAU caps, and it's powering millions of logins around the globe.
...
With version 1.52.0 of FusionAuth, we brought passkeys to our Community Edition. Yes, that means that you can give your users peace of mind and keep their data safe for FREE. And we've made it super easy to get started with our [five-minute guide](https://fusionauth.io/docs/quickstarts/5-minute-setup-guide). 
