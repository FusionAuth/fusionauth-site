...
description: While working on a consulting project building an e-commerce platform, Softozor chose FusionAuth to manage their authentication and authorization.
authors: Dan Moore
...
We love sharing community stories. You can check out Softozor's website if you'd like to learn more. 
