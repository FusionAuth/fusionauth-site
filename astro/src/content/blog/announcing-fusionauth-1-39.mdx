...
For instance, if you have a user with id `fff92906-68c4-4453-b126-46344bb7f7ca` who has a <InlineField>firstName</InlineField> field of "Richard", you can change their name to "Rick" using an API call like this:
