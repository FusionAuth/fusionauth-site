...
Once FusionAuth is installed on your platform, you can follow this [simple 5-minute guide](/docs/quickstarts/5-minute-setup-guide) to set it up and ensure it's running properly. That guide uses Node for the integration, but you can skip that part if you prefer to use Java.
