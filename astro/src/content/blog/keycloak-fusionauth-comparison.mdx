...
Learn more about [single- and multi-tenant solutions](/articles/identity-basics/multi-tenancy-vs-single-tenant-idaas-solutions) and [GDPR requirements](/articles/ciam/developers-guide-to-gdpr) in these whitepapers.

## How Keycloak and FusionAuth Are Different

[![Keycloak and FusionAuth Feature Comparison](/img/blogs/keycloak-vs-fusionauth/keycloak-fusionauth-comparison-sample.png)](/resources/fusionauth-vs-keycloak.pdf)
...
<Button href="/resources/fusionauth-vs-keycloak.pdf" label="Download the Keycloak and FusionAuth Feature Comparison" />

You can also view technical documentation about how you can migrate from Keycloak to FusionAuth.

<Button href="/docs/lifecycle/migrate-users/bulk/keycloak" label="View the Keycloak Technical Migration Guide" />

> _Let us show you why FusionAuth is the preferred CIAM solution. [Book a demo](/contact)._
