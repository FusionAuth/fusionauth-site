...
<a href='/resources/fusionauth-vs-keycloak.pdf' class="button brochure orange text-larger">Download the Keycloak and FusionAuth Feature Comparison</a>

You can also view technical documentation about how you can migrate from Keycloak to FusionAuth.

<a href='/docs/v1/tech/migration-guide/keycloak' class="button brochure orange text-larger">View the Keycloak Technical Migration Guide</a>
