...
htmlTitle: "Seegno Chooses FusionAuth for Multi-Tenant Authentication"
description: "Seegno uses FusionAuth and Kubernetes to manage over 5,000 tenants, replacing their custom auth system with multi-tenant authentication."
authors: Dan Moore
image: /img/blogs/seegno-fusionauth/seegno-manages-thousands-of-tenants-with-fusionauth-and-kubernetes-header-image.png
categories: Community
tags: community story, homegrown, kubernetes, javascript
...
{/* eslint-disable-line */}We would like to ask the FusionAuth team to continue improving the services' ability to handle a high number of tenants, both in performance and in the UI [_editor's note: follow along on [this issue](https://github.com/FusionAuth/fusionauth-issues/issues/374) for more details about these improvements_].
...
> _Managing thousands of tenants? [Schedule a demo](/contact) to see how FusionAuth can simplify your multi-tenant authentication strategy._
