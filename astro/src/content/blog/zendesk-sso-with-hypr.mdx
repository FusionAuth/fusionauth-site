...
authors: Dan Moore
image: /img/blogs/zendesk-sso-hypr-webinar/fusionauth-hypr-single-sign-on-sso-webinar.jpg
categories: Product
tags: zendesk, hypr, single sign on, sso, partner
...
If you were to continue this pattern with multiple applications, such as GSuite or a custom web application, users could sign into your entire suite of tools, both COTS and custom, with one username and password. [This architecture](/blog/auth-and-the-bottleneck-architecture) also allows for operational efficiencies since all users are managed in a single store.
