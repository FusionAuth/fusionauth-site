...
htmlTitle: "Okta Acquires Auth0: What It Means for Developers and CIAM"
description: "Explore what Okta’s acquisition of Auth0 means for identity management, developers, and the CIAM market, and how FusionAuth’s approach remains different."
authors: Dan Moore
image: /img/blogs/auth0-okta-acquisition/congratulations-auth0-on-the-acquisition-by-okta-header-image.png
categories: News
tags: ciam, auth0, market
...
![Okta explains to investors why they acquired Auth0..](/img/blogs/auth0-okta-acquisition/acquisition-reasons.png)
...
![CIAM and IAM markets in the view of Okta..](/img/blogs/auth0-okta-acquisition/tam-diagram.png)
...
We look forward to continuing to provide best in class auth systems for developers with [great documentation](/docs/), [thoughtful APIs](/docs/apis/), [excellent support](/pricing) and [quick and easy setup](/docs/quickstarts/5-minute-setup-guide).
