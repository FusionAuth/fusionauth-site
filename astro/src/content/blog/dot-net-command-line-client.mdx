...
You'll also want to double check to make sure your system meets the [memory, storage and CPU requirements](/docs/get-started/download-and-install/reference/system-requirements) for FusionAuth.
...
Right now poor newuser2@example.com can't do much. Next, we'll [create a web application](/blog/securing-asp-netcore-razor-pages-app-with-oauth) that they can log in to.
