...
tags: release notes, fusionauth, passkeys, product
...
So, what are you waiting for? [Download](/docs/get-started/download-and-install/docker) FusionAuth or upgrade to version 1.52.0 to provide your users with a superior login experience. Activating passkeys is simple—just toggle the switch in the FusionAuth UI. For detailed instructions, check out our [documentation on Authentication with WebAuthn and Passkeys](/docs/lifecycle/authenticate-users/passkeys/configure).
