...
BOULDER, Colo., July 22, 2026 — FusionAuth, the [deploy anywhere](/platform/product) Customer Identity and Access Management (CIAM) platform built for security, control, and scale, today announced the appointment of Jamey Miller to SVP of Engineering and Technology. He will be responsible for scaling engineering to support the company's accelerated growth and increasing enterprise adoption, maintaining product quality and platform reliability, and positioning engineering for AI.
