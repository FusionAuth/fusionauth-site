...
{/* eslint-disable-line */}> [FusionAuth] APIs are straightforward and do everything we need.
...
And custom interfaces for user management don't always seem to be a first-class citizen. Customizing the built-in UI is quite limited. _Ed. note: This [issue](https://github.com/FusionAuth/fusionauth-issues/issues/91) may be of interest._
...
> _Looking to streamline your authentication process like ClearSpend? [Schedule a demo](/contact) to see how FusionAuth can simplify your identity management._
