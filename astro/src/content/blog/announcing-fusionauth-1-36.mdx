...
These releases contained features, enhancements, and bug fixes. Please see the [release notes](/docs/release-notes/#version-1-36-1) for a full breakdown of the changes between 1.35 and 1.36. 
...
Read more about all the changes in the [release notes](/docs/release-notes/#version-1-36-1).

## Upgrade at will

The [release notes](/docs/release-notes/#version-1-36-1) are a guide to the changes, fixes, and new features. Please read them carefully to see if any features you use have been modified or enhanced.
