...
- Support both [on-premises](/docs/get-started/download-and-install/) and [cloud](/docs/cloud/) deployments
...
Betty Blocks continues to grow as a recognized player in the low-code space, having been featured in [Gartner Magic Quadrants](https://blog.bettyblocks.com/betty-blocks-named-a-visionary-in-2020-gartner-magic-quadrant-for-enterprise-low-code-application-platforms) and Forrester Wave reports. As they execute on their strategy of providing even greater flexibility to customers, FusionAuth remains a key part of their plans:
