...
description: Get key takeaways from Identiverse 2021. Learn what FusionAuth learned and what trends shaped the identity and access management conversation.
authors: Dan Moore
...
It was three days long; here's [the agenda](https://identiverse.com/idv2021/). I don't believe videos are available to the public, but if you attended, you can [view them until the end of July](https://x.com/Identiverse/status/1408466566346199046) using the same Identiverse application you may have used to view the agenda during the event or to ask questions of speakers.
