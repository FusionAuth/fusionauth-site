...
Wouldn't it be nice if you never had to click on a <Breadcrumb>forgot password</Breadcrumb> link again? Taking that dream a step further, what if you never had to come up with a password at all? [Passkeys](/guides/what-is-a-passkey) are the solution that makes these dreams possible. Ready to learn more? [Sign up now](https://go.fusionauth.io/value-of-passkeys) for our free webinar.
