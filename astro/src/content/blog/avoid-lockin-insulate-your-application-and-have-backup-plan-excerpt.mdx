...
_This blog post is an excerpt from [Avoiding Authentication System Lock-in](/articles/authentication/avoid-lockin)._
...
To learn about other ways to avoid lock-in, including the benefit of open standards and portability considerations, read [Avoiding Authentication System Lock-in](/articles/authentication/avoid-lockin).
