...
You might have seen late last year that [developers were finding their prices going up 300%](https://x.com/AmitTaylor/status/1732530584524615995) using another customer identity platform. Unlike them, we're simply making it easier to buy FusionAuth.
...
3. Select your projected monthly [active users](/docs/get-started/core-concepts/types/users#what-makes-a-user-active).
