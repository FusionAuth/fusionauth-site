...
<Aside type="tip" nodark="true">This blog post has been [superseded by a newer Flutter tutorial](/docs/quickstarts/quickstart-flutter-native).</Aside>
...
In order to set up FusionAuth, follow the [5 minute setup guide](/docs/quickstarts/5-minute-setup-guide). It is simple and quick. By default, the FusionAuth instance will run at the address `http://localhost:9011`. 
