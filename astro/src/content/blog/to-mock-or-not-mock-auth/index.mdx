...
tags: mock, security, server, hosted backend
icon: /img/icons/sso-works-why-care.svg
darkIcon: /img/icons/sso-works-why-care-dark.svg
url: https://raw.githubusercontent.com/fusionauth/fusionauth-example-mocking/refs/heads/main/
---
...
<RemoteCode url={frontmatter.url + "webhook.py"} lang="python"/>
...
In short, you're disabling the protections your system and your auditors depend on.
...
**Note:** A [contract test](https://www.browserstack.com/guide/contract-testing) checks that two systems agree on how they talk to each other, like making sure tokens have the expected claims, fields, and formats your app depends on.
