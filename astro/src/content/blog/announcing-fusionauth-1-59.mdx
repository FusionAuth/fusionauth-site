...
tags: release notes, identity management, phone authentication, SMS authentication, passwordless login, mobile-first
...
Ready to implement phone authentication? [Download FusionAuth 1.59.0](/docs/get-started/download-and-install/docker) and explore phone-based authentication flows.
