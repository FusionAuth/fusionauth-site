...
If you want to go through a step-by-step walk-through of generating the JWT with FusionAuth, you should take a look at our [Go Quickstart](/docs/get-started/quickstarts/api/quickstart-golang-api).
</Aside>
...
> _[Schedule a demo](/contact) to see how FusionAuth simplifies JWT-based security for Go microservices._
...
* [Set up FusionAuth in 5 minutes](/docs/get-started/start-here/step-1) and have it generate the JWTs when a user logs in.
* Learn how to [secure golang applications with OAuth](/blog/securing-a-golang-app-with-oauth).
