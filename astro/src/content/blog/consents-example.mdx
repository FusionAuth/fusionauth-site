...
Replace the UUID in each consent with the <InlineFieldValue>Id</InlineFieldValue> you recorded earlier. You can make the descriptions whatever you like. Click <InlineUIElement>Submit</InlineUIElement>, and then save the theme.
