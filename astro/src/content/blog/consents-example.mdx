...
We'll need to get their permission for each of these options. FusionAuth manages all this under the [Consents](/docs/v1/tech/apis/consents) concept. We can create custom consents for our app.
