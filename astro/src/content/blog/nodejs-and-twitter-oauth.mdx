...
Clicking the <Breadcrumb>Login with Twitter</Breadcrumb> button should redirect you to Twitter to complete the authentication.
...
Clicking on the <Breadcrumb>Members Only area</Breadcrumb> link should take you to `users/me`, showing a JSON object representing your profile on FusionAuth (with the username from Twitter).
