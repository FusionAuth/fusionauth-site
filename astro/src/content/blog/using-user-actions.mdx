...
To create a user account, navigate to <Breadcrumb>Users</Breadcrumb> and click the <InlineUIElement>Add</InlineUIElement> button. Then supply an email address. You can untoggle the <InlineUIElement>Send email to set up password</InlineUIElement> switch to supply a password.
