...
To verify the integrity of the message, create a sha 256 hash of the payload you receive. Extract the JWT from the header and process it. Verify the signature of the JWT; this step is important, otherwise someone could modify the JWT in the header, and tweak the hash to match the modified payload.
