...
In this release, the team has added new debugging capabilities. When you have an issue around the functionality, look for a <InlineField>Debug enabled</InlineField> field and check it. Save the configuration, then run through the integration workflow one more time. Check the event log, by navigating to <Breadcrumb>System -> Event Log</Breadcrumb>. The additional debugging information will be there.
...
If you have a FusionAuth Cloud deployment, proceed to the <Breadcrumb>Deployments</Breadcrumb> tab on your <a href="https://account.fusionauth.io/account/deployment/" target="_blank">account dashboard</a> and upgrade your servers. If you have questions about the upgrade, <a href="https://account.fusionauth.io/account/support/" target="_blank">please open a support ticket</a>.
