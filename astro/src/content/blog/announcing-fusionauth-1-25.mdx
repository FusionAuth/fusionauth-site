...
In this release, the team has added new debugging capabilities. When you have an issue around the functionality, look for a **Debug enabled** field and check it. Save the configuration, then run through the integration workflow one more time. Check the event log, by navigating to <Breadcrumb>System -> Event Log</Breadcrumb>. The additional debugging information will be there.
