...
This release contained a number of enhancements and bug fixes. Please see the [release notes](/docs/release-notes/#version-1-25-0) for the full breakdown of the changes between 1.24 and 1.25. 
