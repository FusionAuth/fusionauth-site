...
If you then want even deeper analyses on a regular basis, you need to dive into the world of business intelligence (BI): data extraction, denormalization, and dashboards.
...
In this guide you learned how to use basic FusionAuth login data to analyze user behavior. If you see any patterns you'd like to investigate further, edit the code to log user Ids in any group that interests you. Use the Ids to investigate which of your app features affect those users.
