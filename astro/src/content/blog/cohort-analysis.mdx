...
Replace `<your_db_password>`, `<your_db_host>`, and `<your_db_user>` with your database credentials (check your `.env` file or `docker-compose.yml`). Replace `<your_application_id>` with your FusionAuth application Id, which you can find in your `.env` file.
