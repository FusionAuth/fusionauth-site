...
To view your charts, visit [http://localhost:7777](http://localhost:7777). A static `charts.html` file is also written to the repo directory on every run, so you can open it directly in a browser without keeping the server running.
