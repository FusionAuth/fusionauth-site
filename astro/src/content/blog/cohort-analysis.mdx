...
Extraction can take several minutes for large user bases — login records are fetched one user at a time, so a FusionAuth instance with 20,000 users typically takes 10-15 minutes. Progress is printed every 100 users.
