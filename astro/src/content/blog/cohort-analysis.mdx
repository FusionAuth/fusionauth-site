...
Unfortunately more complex charts aren't possible directly in FusionAuth because they are overly time-consuming to calculate. If you want more informative charts, you need to export your data and calculate statistics manually. This guide will you show how to do that.
...
While application databases, like FusionAuth, store data in a denormalized structure to save space, data analysis needs data to be normalized for fast retrieval and computation.
