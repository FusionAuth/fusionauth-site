...
The charts below were created from a thousand random users with random registration and login dates, so you won't see realistic patterns, but they're enough to illustrate the concepts.
