...
FusionAuth, the product, is designed to be [downloaded and run locally](/docs/get-started/download-and-install/docker). While you can pay FusionAuth, the company, to run FusionAuth, the product, [for you in the cloud](/docs/cloud/cloud) as a SaaS offering, many users run FusionAuth on their own servers or laptops.
