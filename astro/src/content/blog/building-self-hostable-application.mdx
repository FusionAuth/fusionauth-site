...
Offering great customer support is more difficult with a self-hostable product. You are not only answering questions about how to use your product, some of which may be quite niche or twist your product in different ways. In fact developers often depend on undocumented but observable features; [see Hyrum's Law](https://www.hyrumslaw.com/). On top of that, you also support heterogeneous deployment environments.
...
Support is easy to offer; allow some users to pay for access to a slack channel, ticketing system or email address. However, support requires an investment in employees and doesn't scale linearly. For a self-hostable product, support can be more complex to offer, as discussed above.
...
Self-hosting is making a comeback for customers who value control, data locality and have the team to operate software. Hopefully this guide gave you some idea of what you'd to consider to build a robust piece of self-hostable software.
