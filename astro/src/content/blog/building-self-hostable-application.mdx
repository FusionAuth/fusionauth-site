...
<details>
    <summary>Summary - Building a Self-Hostable Product</summary>
...
FusionAuth, the product, is designed to be [downloaded and run locally](/docs/get-started/download-and-install/docker). While you can pay FusionAuth, the company, to run FusionAuth, the product, [for you in the cloud](/docs/get-started/run-in-the-cloud/cloud) as a SaaS offering, many users run FusionAuth on their own servers or laptops.
...
![A person choosing between building SaaS and self-hostable software.](/img/blogs/self-hostable-application/two-paths.png)
...
![A Winnie the Pooh meme emphasizing control.](/img/blogs/self-hostable-application/control.png)
...
![Little girl running with text ](/img/blogs/self-hostable-application/running-product.png)
...
![A person with a fork and the headline ](/img/blogs/self-hostable-application/hits-different.png)
...
![A meme with Jeff Goldblum stating ](/img/blogs/self-hostable-application/users-find-way.png)
...
![Jerry Maguire yelling ](/img/blogs/self-hostable-application/show-me-business-model.png)
