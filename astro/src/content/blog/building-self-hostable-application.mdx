...
This article will focus on developer tools that are sold and require integration in to an existing application, rather than standalone developer tools such as an IDE or products given away for free. 
...
<img src="/img/blogs/self-hostable-application/two-paths.jpg" alt="A person choosing between building SaaS and self-hostable software." width="1200"/>
...
<img src="/img/blogs/self-hostable-application/control.jpg" alt="A winnie the pooh meme emphasizing control." width="1200"/>
...
Finally, if a company wants to switch architectural components, self-hosting gives them options, because they have access to the data. Whereas SaaS product may or may not have full-featured export functionality.
...
Self-hostable software can also decrease your expenses. You sell the product, but they run it. The cost of operating it is bourne by your customer. That control doesn't come for free, after all.
...
<img src="/img/blogs/self-hostable-application/running-product.jpg" alt="Little girl running with text 'what does your product need to run?'." width="1200"/>
...
Which ones? Ask your potential customers. FusionAuth supports MySQL and PostgreSQL. If you are targetting enterprises, Oracle might be a better fit. If you are targetting embedded developers, sqlite might be a good choice.
...
<img src="/img/blogs/self-hostable-application/hits-different.jpg" alt="A person with a fork and the headline 'it just hits different' and the words deployment process and dependencies above the fork." width="1200"/>
...
Release complexity means you must document and build systems such that your users have a clear idea of the impact of production upgrades. This is an common software problem and there are several approaches, including separating the control and data planes and maintaining strict n-1 version backwards compatibility.
...
In addition to the nuts and bolts of release process and customer impact, you have to let your userbase know about it. After all, if they don't know, they won't upgrade.
...
<img src="/img/blogs/self-hostable-application/users-find-way.jpg" alt="A meme with Jeff Goldblum stating 'users will find a way'." width="1200"/>
...
When a self-hostable product has enough versions, think about creating a long term support (LTS) plan similar to what Linux distributions or programming language haves. An LTS lets developers using your tool upgrade to certain versions and remain on them for a long time. Critical self-hostable products share a lot of similarities with programming languages. Your users may be hesitant to invest to regularly upgrade your product. New features can encourage upgrading, but once your product meets their needs, they won't bother.

Since all your customers and users are not running the same version of your softare, backporting bug fixes becomes a thing. Doing this increases development complexity, but offers more stability. Backports can include security fixes as well as selected bugs.
...
The possible combinations of how your software can be installed or operated is nearly infinite. Try to limit the effort by documenting common integrations and complementary software components. For instance, FusionAuth works with any proxy, but have a repository with common configurations for NGINX, CloudFront, and more.
...
<img src="/img/blogs/self-hostable-application/show-me-business-model.jpg" alt="Jerry Maguire yelling 'show me the business model' into a telephone." width="1200"/>
...
Hopefully this guide gave you some idea of what you'd consider to build a robust piece of self-hostable software.
