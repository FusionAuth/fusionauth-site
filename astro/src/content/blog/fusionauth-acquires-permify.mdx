...
| ------------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Identity Core (AuthN)     | World-class, deployable CIAM.                        | Same world-class CIAM, now deeply connect to authorization                            | Cohesion: Your identity data is now immediately leveraged to drive authorization decisions.                                         |
