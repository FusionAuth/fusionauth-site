...
Look for a formal announcement of the fully integrated offering and **streamlined pricing model in early 2026.** Until then, we encourage you to [check out the power of Permify’s technology](/permify-docs/permify-overview/intro) and see why we believe this is the most powerful combination in the identity space today.
