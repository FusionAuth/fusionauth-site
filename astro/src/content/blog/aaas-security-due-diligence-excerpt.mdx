...
authors: Mihir Patel
image: /img/blogs/security-due-diligence/authentication-as-a-service-security-due-diligence-tips-header-image.png
...
_This blog post is an excerpt from [Performing Due Diligence on Authentication Vendors](/articles/identity-basics/due-diligence-authentication-vendors)._
...
To learn about those aspects and more, read [Performing Due Diligence on Authentication Vendors](/articles/identity-basics/due-diligence-authentication-vendors).
