...
image: /img/blogs/identity-pre-verification/stop-registration-spam-with-identity-pre-verification.png
...
* **Phone**: Navigate to <Breadcrumb>Settings -> Messengers</Breadcrumb> and add a Messenger (such as Twilio). Then, go to <Breadcrumb>Tenants -> Your Tenant -> Identities</Breadcrumb> and select your Messenger in the <InlineUIElement>Messaging settings</InlineUIElement> section.
...
2. In the <InlineUIElement>Identity verification settings</InlineUIElement> section for either **Email** or **Phone**:
...
* **Existing customers**: [Upgrade](/docs/operate/deploy/upgrade) to the latest version of FusionAuth to start using these features.
