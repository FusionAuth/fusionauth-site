...
First, ensure that the Identity field is mandatory. Navigate to <Breadcrumb>Customizations -> Form Fields</Breadcrumb> and verify that <InlineField>user.email</InlineField> or <InlineField>user.phoneNumber</InlineField> has <InlineField>Required</InlineField> set to <InlineFieldValue>true</InlineFieldValue>.
...
![An Advanced Registration Form with a Verification step.](/img/docs/lifecycle/manage-users/verification/identity-pre-verification-form-email-verification.png)
...
- Sets the <Breadcrumb>Identity verification settings</Breadcrumb> like:
  - <InlineField>Email Verify identity</InlineField> to <InlineFieldValue>true</InlineFieldValue>.
