...
* **Phone**: Navigate to <Breadcrumb>Settings -> Messengers</Breadcrumb> and add a Messenger (such as Twilio). Then, go to <Breadcrumb>Tenants -> Your Tenant -> Identities</Breadcrumb> and select your Messenger in the <Breadcrumb>Messaging settings</Breadcrumb> section.
...
2. In the <Breadcrumb>Identity verification settings</Breadcrumb> section for either **Email** or **Phone**:
...
- Sets the <Breadcrumb>Identity verification settings</Breadcrumb> like:
