...
authors: Dan Moore
image: /img/blogs/cimd-dcr/cimd-dcr-header.png
categories: Education
tags: mcp, client registration, oauth, cimd, dcr, mcp
...
[CIMD support](https://github.com/FusionAuth/fusionauth-issues/issues/3230) is coming soon to FusionAuth. Want to chat about how we see MCP being used in the wild or be notified when CIMD lands? [Reach out and chat](/contact).
