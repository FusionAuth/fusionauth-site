...
_This blog post is an excerpt from [How the OAuth Device Authorization grant Can Make Your Users’ Lives Easier](/articles/gaming-entertainment/oauth-device-grant-gaming)._
...
To learn more about the device grant, as well as to look at code for a game that authenticates using the grant, read [How the OAuth Device Authorization grant Can Make Your Users’ Lives Easier](/articles/gaming-entertainment/oauth-device-grant-gaming).
