...
Then click on the <Breadcrumb>+</Breadcrumb> button on the top right of the <InlineField>Applications" page and fill in the "Name</InlineField> field with a name of your choosing (here, it's "django_sso_app"):
