...
[MFA Lambda](/docs/lifecycle/authenticate-users/multi-factor-authentication#mfa-requirement-lambda): custom logic embedded in FusionAuth that determines whether or not to issue an MFA challenge during authentication

[Step-Up Authentication](/docs/lifecycle/authenticate-users/contextual-multi-factor#step-up-authentication): requests for MFA challenges embedded in your application logic
