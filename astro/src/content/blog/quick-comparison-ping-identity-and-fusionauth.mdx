...
<a href='/resources/fusionauth-vs-ping-identity.pdf' class="button brochure orange text-larger">Download the Ping Identity and FusionAuth Feature Comparison</a>
