...
5. Vercel requests that you install it into your GitHub account. Select <InlineUIElement>Install</InlineUIElement>. In the popover that appears select <InlineUIElement>Only select repositories</InlineUIElement> and choose the repository you forked in [Fork The Example Repository](#fork-the-example-repository).
6. Click <InlineUIElement>Install</InlineUIElement>.
7. Click <InlineUIElement>Import</InlineUIElement> for your forked repository.
