...
You've made changes to your web app, tested those changes, and merged the changes into your main GitHub branch. But that's usually just the start. Now you have to build and deploy to production.
...
3. Open the <InlineUIElement>Settings</InlineUIElement> tab for your repository.
