...
SLO relies on many of the systems and architecture needed to implement SSO. [Security Assertion Markup Language (SAML) 2.0](/docs/v1/tech/samlv2/) provides a full-fledged implementation of SLO with a dedicated logout profile that helps with SLO functionality.
