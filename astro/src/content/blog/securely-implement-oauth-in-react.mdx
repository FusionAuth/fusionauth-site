...
Select <Breadcrumb>Manage</Breadcrumb> and go to the <Breadcrumb>Registrations</Breadcrumb> tab. Click on <InlineUIElement>Add Registration</InlineUIElement>, pick your new application, and then <InlineUIElement>Save</InlineUIElement> to register yourself.
