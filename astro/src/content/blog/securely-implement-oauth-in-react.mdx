...
<Aside type="tip">This blog post has been [superseded by a newer React/OAuth tutorial](/blog/how-to-authenticate-your-react-app).</Aside>
...
(Check out the [Download FusionAuth page](/docs/get-started/download-and-install/docker) for other installation options.)
...
If you need a refresher on React basics, check out the [official docs](https://react.dev/learn).
