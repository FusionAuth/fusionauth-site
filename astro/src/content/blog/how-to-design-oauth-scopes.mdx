...
The exact structure of this parameter is undefined, other than a mandatory <InlineField>type</InlineField> field which specifies the type of the request. The RFC also outlines optional fields to handle common authorization needs, such as:
