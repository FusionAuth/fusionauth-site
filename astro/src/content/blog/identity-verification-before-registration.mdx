...
TODO
Key metrics to track: verification success rates, false positives, user drop-off
Continuous improvement based on verification data and user feedback
* make an API call out to a reporting service (Pipedream will do for a protoype) so that you know how many registrations are failing; this lets you tune your risk threshold
...
* add more business logic to the lambda, looking at other aspects of the data returned by the API call
