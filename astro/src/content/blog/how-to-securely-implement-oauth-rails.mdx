...
A [FusionAuth Application](/docs/get-started/core-concepts/types/applications) is simply something a user can log in to.
...
* Add and assign user [roles](/docs/get-started/core-concepts/types/roles) such that functionality in our Rails application can be shown or hidden accordingly.
* Customize the FusionAuth login page with a look and feel of our application using [themes](/docs/customize/look-and-feel/).
* Use [Identity Providers](/docs/get-started/core-concepts/identity-providers) to add "Login with Google" or "Login with Facebook" social login buttons.
