...
At FusionAuth, our [client libraries and SDKs](/docs/sdks/) and community projects like our [non-blocking NIO Java HTTP Server](https://github.com/FusionAuth/java-http) are all licensed under the Apache 2.0 open source license. And, though [it is not open source](/license-faq#why-isnt-fusionauth-open-source), [FusionAuth Community](/docs/get-started/download-and-install/docker) has been downloaded more than 10,000,000 times and is actively used by tens of thousands of developers to power the authentication and authorization for tens of millions of end users. 
...
[NextAuth.js](https://opencollective.com/nextauth) is a complete open source authentication solution for [Next.js](https://nextjs.org/) applications. This project has over 15,000 stars on GitHub. They are also changing their name to Auth.js and broadening their scope in their next version (v4).
