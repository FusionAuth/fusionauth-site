...
Click the <InlineUIElement>Add registration</InlineUIElement> button, select the `Kubernetes` application and the <InlineFieldValue>admin</InlineFieldValue> role, and save the registration.
