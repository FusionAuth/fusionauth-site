...
tags: social logins, facebook, google, twitter, oauth, single sign on
...
To get set up, simply go to <Breadcrumb>Settings -> Identity Providers</Breadcrumb> in your FusionAuth dashboard. Then tap <Breadcrumb>Add provider</Breadcrumb> to select which to enable and configure. It's that easy. Read [the documentation here](/docs/lifecycle/authenticate-users/identity-providers/).
