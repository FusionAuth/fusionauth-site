...
htmlTitle: "Custom SSO with FusionAuth | Intelligov Case Study"
description: "How Inteligov built custom SSO solutions using FusionAuth, integrating with Google Workspace and AD to simplify auth and create new revenue streams."
authors: Dan Moore
image: /img/blogs/fusionauth-inteligov/fusionauth-inteligov.png
categories: Community
tags: community story, i18n, single sign-on, azure ad, google, saas, rails, self-hosted
...
{/* eslint-disable-line */}> [FusionAuth] allowed us not only to provide custom SSO solutions to enterprise customers using Google Workspace and Microsoft Active Directory, but it also allowed us to charge for these integrations, opening up an unexpected revenue stream.
...
{/* eslint-disable-line */}> Cost, functionality and the presence of an active community were the main drivers [of choosing FusionAuth].
...
{/* eslint-disable-line */}> I can't precisely estimate how much time and money [FusionAuth] saved us, but it was a lot. We managed to provide authorization with magic links, Google, Microsoft and Slack out of the box.
...
{/* eslint-disable-line */}> [I've] already suggested [FusionAuth] to 2 or 3 software companies who struggle with i18n.
...
{/* eslint-disable-line */}**Dan:** Thanks for your feedback! _[Ed note. Track the [first request in this GitHub issue](https://github.com/FusionAuth/fusionauth-issues/issues/1510)]_
...
> _See FusionAuth's SSO in action. [Schedule a demo](/contact) to learn how we simplify multi-application login like Inteligov._
