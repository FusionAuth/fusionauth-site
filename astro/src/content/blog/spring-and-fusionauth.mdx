...
Once the user has logged in via the FusionAuth application, we can retrieve their FusionAuth profile using the [OIDC](/docs/v1/tech/oauth/) functionality provided by FusionAuth.
