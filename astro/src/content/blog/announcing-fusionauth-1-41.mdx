...
As of this release, you can now choose to enable <InlineUIElement>Create registration</InlineUIElement> for the FusionAuth admin application for any given Identity Provider.
