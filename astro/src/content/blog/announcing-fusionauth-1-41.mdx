...
As of this release, you can now choose to enable <Breadcrumb>Create registration</Breadcrumb> for the FusionAuth admin application for any given Identity Provider.
