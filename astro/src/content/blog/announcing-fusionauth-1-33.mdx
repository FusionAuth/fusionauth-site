...
To learn what platform your FusionAuth instance is currently running, navigate to <Breadcrumb>System</Breadcrumb> and then the "About" section in the administrative user interface.
