...
This release contained a number of features, enhancements, and bug fixes. Please see the [release notes](/docs/release-notes#version-1-33-0) for a full breakdown of the changes between 1.32 and 1.33. 
...
Look for the <Breadcrumb>Platform</Breadcrumb> label:

![The About screen displaying the CPU architecture platform.](/img/blogs/release-1-33/about-screen.png)

By the way, if your FusionAuth instance is running on the PowerPC or LinuxONE architectures, please post a screenshot of the "About" screen in our [forum](/community/forum/) or tag us on [Twitter](https://x.com/fusionauth). We'd love to send you a t-shirt!
...
The [release notes](/docs/release-notes#version-1-33-0) are a guide to the changes, fixes, and new features. Please read them carefully to see if any features you use have been modified.
