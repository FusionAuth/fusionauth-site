...
3. **Inability to test interconnections** - In a distributed system like Android apps with OAuth authentication, service interactions are dynamic and often undocumented, making mocks unreliable.
