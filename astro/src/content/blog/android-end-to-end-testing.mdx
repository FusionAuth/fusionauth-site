...
With the test cases and test data defined and additional prerequisites for our testing environment and strategy defined. We are able to write the FullEnd2EndTest Gradle Task which we further explain in more detail below.
