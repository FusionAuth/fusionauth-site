...
On the top section labeled <Breadcrumb>Base Information</Breadcrumb> you will see the field labeled <InlineField>Id</InlineField>. This value is used by the Email APIs during integration and cannot be changed. The remainder of the fields in this section may be modified. The <InlineField>Default Subject</InlineField> and the <InlineField>Default From Name</InlineField> fields are marked with a code symbol indicating they may utilize replacement variables.
...
Be sure to click <Breadcrumb>Submit</Breadcrumb> in the bottom left corner. Once submitted you will see the name of your localized template on the **Locale** heading on the <Breadcrumb>Localization</Breadcrumb> tab.
