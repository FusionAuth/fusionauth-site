...
image: /img/blogs/email-templates/email-templates.png
...
**NOTE:** Email features require that the SMTP setup has been completed. Review your FusionAuth dashboard. If you see a box titled _Email Settings_ you will need to complete that task first. View the [Using the FusionAuth Setup Wizard tutorial](/blog/using-the-setup-wizard) to see how to complete the SMTP configuration.

![Email Templates in FusionAuth Setup.](/img/blogs/email-templates/email-templates-setup-smtp.png)

## Default Email Templates in FusionAuth

Once your SMTP configuration is complete, navigate to <Breadcrumb>Settings -> Email Templates</Breadcrumb>. This will take you to the Email Template page. Here you will see the three default Email templates provided by FusionAuth.
...
![Email Templates in FusionAuth Edit Templates.](/img/blogs/email-templates/email-template-edit-email-verification.png)

### Base Information

On the top section labeled <InlineUIElement>Base Information</InlineUIElement> you will see the field labeled <InlineField>Id</InlineField>. This value is used by the Email APIs during integration and cannot be changed. The remainder of the fields in this section may be modified. The <InlineField>Default Subject</InlineField> and the <InlineField>Default From Name</InlineField> fields are marked with a code symbol indicating they may utilize replacement variables.
...
![Email Templates in FusionAuth Localization.](/img/blogs/email-templates/email-templates-add-localization.png  )
...
Be sure to click <InlineUIElement>Submit</InlineUIElement> in the bottom left corner. Once submitted you will see the name of your localized template on the **Locale** heading on the <Breadcrumb>Localization</Breadcrumb> tab.
