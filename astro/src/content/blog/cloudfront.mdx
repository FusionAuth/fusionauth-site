...
While you configure a [custom domain](/docs/cloud/operate/custom-domains) with a [FusionAuth Hosting package](/pricing), you can also configure one using AWS Cloudfront.
