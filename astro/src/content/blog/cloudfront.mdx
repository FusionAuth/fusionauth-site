...
While you configure a [custom domain](/docs/cloud/operate/configure-custom-domain) with a [FusionAuth Hosting package](/pricing), you can also configure one using AWS Cloudfront.
...
* Under `Alternate domain name (CNAME) - optional`, select <Breadcrumb>Add item</Breadcrumb>. Enter `auth.codegremlins.net`.
