...
description: 'Learn how to use AWS CloudFront to Setup a Custom Domain with FusionAuth.'
...
* Next, select <InlineUIElement>Edit</InlineUIElement> in the <InlineUIElement>Settings</InlineUIElement> section of the <Breadcrumb>General</Breadcrumb> tab.
<div style={{textAlign: "center"}}>
...
* Under `Alternate domain name (CNAME) - optional`, select <InlineUIElement>Add item</InlineUIElement>. Enter <InlineFieldValue>auth.codegremlins.net</InlineFieldValue>.
...
* Select <InlineUIElement>Domains</InlineUIElement>.
* Select <InlineUIElement>codegremlins.net</InlineUIElement>.
