...
Lambda HTTP Connect is currently available for FusionAuth Essentials and FusionAuth Enterprise customers. Learn more in [the FusionAuth documentation](/docs/extend/code/lambdas/#http-connect).
