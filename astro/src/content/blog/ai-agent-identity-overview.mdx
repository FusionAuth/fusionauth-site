...
Agents can be simple two step workflows ("Claude, please review this article against this knowledge base for veracity") or multi-step ("please book a trip to Hawaii, find a good hotel and make some dinner reservations at a BBQ restaurant").
