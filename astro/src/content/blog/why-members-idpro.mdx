...
description: Learn how FusionAuth's renewed IDPro membership benefits developers. Get information about  identity trends, community engagement, and educational resources that keep our CIAM solution ahead of the status quo.
authors: Dan Moore
...
In a perfect world, every developer would undrestand OIDC, OAuth, and the intricacies of digital identity. Well, that isn't the world that we live in, but FusionAuth is doing our part to help make it a reality. That's why we've renewed our membership to [IDPro](https://idpro.org/), the professional organization for identity experts. You can think of IDPro as being akin to the American Bar Association for lawyers (except with a bit less history and influence). 
