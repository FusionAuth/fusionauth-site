...
- **Data Control** - FusionAuth's API provides full data access and control allowing developers to add, edit, and delete any user data as required by regulations. ([Read here for more details on how FusionAuth is GDPR compliant](/blog/is-fusionauth-gdpr-compliant).)
...
This is a brief overview of our Family and Consent APIs. For more details, visit the [release notes and API documentation](/docs/release-notes#version-1-7-0).  
...
- Login Record view that contains search and pagination capability. In the UI see <Breadcrumb>System -> Login Records</Breadcrumb>.
...
- [FusionAuth Snags Product of the Year](/blog/iam-product-of-the-year)
- [FusionAuth Recognized with Rising Star and Great User Experience Award](/blog/fusionauth-recognized-industry-distinctions-comparecamp)
