...
A core principle of java-http is to minimize dependencies; in this case there are none. This removes the risk of supply chain attacks. The zero-dependency approach also means you won't need to worry about version conflicts or transitive dependency issues. This is a reflection of the FusionAuth team's general approach to software: fast, purpose-built tools with as few dependencies as humanly possible.
