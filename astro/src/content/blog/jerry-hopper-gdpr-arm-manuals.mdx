...
<CheckList>
  <CheckItem>Hosted in the EU</CheckItem>
  <CheckItem>Account export 'self service'</CheckItem>
  <CheckItem>Account removal 'self service'</CheckItem>
  <CheckItem>Password strength/2fa</CheckItem>
  <CheckItem>Auditing/logging</CheckItem>
  <CheckItem>Data encryption options</CheckItem>
  <CheckItem>Anonymization</CheckItem>
</CheckList>
