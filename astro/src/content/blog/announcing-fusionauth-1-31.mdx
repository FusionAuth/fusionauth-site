...
This release contained a number of features, enhancements, and bug fixes. Please see the [release notes](/docs/release-notes/#version-1-31-0) for a full breakdown of the changes between 1.30 and 1.31. 
...
The [release notes](/docs/release-notes/#version-1-31-0) are a guide of the changes, fixes, and new features. Please read them carefully to see if any features you use have been modified.
