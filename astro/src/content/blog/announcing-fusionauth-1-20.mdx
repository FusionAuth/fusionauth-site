...
If you'd like to upgrade your self-hosted FusionAuth instance, see our [upgrade guide](/docs/v1/tech/admin-guide/upgrade). If you have a FusionAuth Cloud deployment, open a <a href="https://account.fusionauth.io/account/support/" target="_blank">support request from your account dashboard</a> or <a href="/contact" target="_blank">use our contact form</a> and we'll get your servers upgraded! Or, if you'd like to download and use FusionAuth, [check out your options](/pricing).
