...
authors: Dan Moore
image: /img/blogs/release-1-20/product-update-fusionauth-1.20.png
categories: Release Updates, Product
tags: release notes, saml, docker
...
FusionAuth also supports the <InlineField>SessionIndex</InlineField> attribute, which is optional, but required by some software applications, notably Artifactory.
...
In version 1.18, FusionAuth added [custom registration forms](/feature/user-registration) for users with a paid plan.

In this release, we've added a few new forms. These customizations are also only available to customers with a paid plan. (Learn more about [purchasing a paid plan](/pricing).) 
...
![A customized registration editing form..](/img/blogs/release-1-20/custom-edit-registration-form.png)
...
If you'd like to upgrade your self-hosted FusionAuth instance, see our [upgrade guide](/docs/operate/deploy/upgrade). If you have a FusionAuth Cloud deployment, open a <a href="https://account.fusionauth.io/account/support/" target="_blank">support request from your account dashboard</a> or <a href="/contact" target="_blank">use our contact form</a> and we'll get your servers upgraded! Or, if you'd like to download and use FusionAuth, [check out your options](/pricing).
