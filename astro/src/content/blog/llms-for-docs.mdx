...
The good folks at [Kapa.ai](https://www.kapa.ai/), who provide documentation based LLM chatbots for many companies, including FusionAuth, wrote a great blog post about [how to structure your technical documentation for LLMs](https://www.kapa.ai/blog/optimizing-technical-documentation-for-llms). There is a lot of good advice in that post, but their top tip is "embrace page structure and hierarchy". 
