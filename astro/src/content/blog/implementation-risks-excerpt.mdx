...
_This blog post is an excerpt from [Common Authentication Implementation Risks and How to Mitigate Them](/articles/authentication/common-authentication-implementation-risks)._
...
To learn about other risks including performance concerns, regulatory compliance, opportunity cost and more, read [Common Authentication Implementation Risks and How to Mitigate Them](/articles/authentication/common-authentication-implementation-risks).
