...
docker run --init  -it --rm -v ".:/app" -w "/app" -p 5173:5173 node:24.0.1-alpine3.21 sh -c  "npm run dev";

*/}

Browse to the frontend at http://localhost:5173.

Log in with the test user `richard@example.com` with password `password`.
