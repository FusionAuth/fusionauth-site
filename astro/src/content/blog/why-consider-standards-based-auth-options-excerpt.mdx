...
_This blog post is an excerpt from [The Value of Standards-Compliant Authentication](/articles/oauth/value-standards-compliant-authentication)._
...
To learn about details of particular authentication and authorization standards, read [The Value of Standards-Compliant Authentication](/articles/oauth/value-standards-compliant-authentication).
