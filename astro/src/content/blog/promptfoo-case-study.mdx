...
tags: FusionAuth, enterprise authentication, single sign-on implementation, SAML integration, AI security
...
**Steve Klein, Principal Engineer, Promptfoo**
...
2. **Multiple Deployment Models**: Promptfoo needed to support both cloud and on-premise deployments, with 80-90% of their enterprise customers requiring on-premise installations, including [air-gapped](/docs/get-started/download-and-install/reference/air-gapping) environments.
...
Klein, having built single sign-on integrations for Fortune 500 companies before, understood the complexity ahead:
...
> "We don't have two different routes, two different code paths for on-prem and cloud. It's the exact same code path, which is amazing... to just be able to build that once and it works in whole different environments."
...
> "By using the lambdas and being able to... write whatever glue code I need... It gave me confidence because I knew we could just write the code and it would work."

### 4. Exceptional Debug Capabilities

FusionAuth's detailed logging and debugging tools accelerated implementation:

> "One of the things I think that is extremely helpful that you guys nailed is the debug logging where you can see the detailed stuff every step of the way... it tells you exactly what's wrong."
...
Using FusionAuth's Lambdas, Klein built a generic solution that could adapt to each customer's unique requirements:

> "I was able to write a simple and generic implementation because I knew I had the ability to use lambdas to write the glue code I needed."
...
Klein's final assessment captures the value FusionAuth delivered:

> "We could not be happier with the decision we made. You guys delivered everything... It is one of the best decisions we made. So very, very happy over here with everything."
