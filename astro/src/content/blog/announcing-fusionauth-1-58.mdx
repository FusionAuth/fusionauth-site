...
description: We're excited to release two new features that will help to transform how you handle user management at scale for your customers.
...
We're excited to release two new features that will help to transform how you handle user management at scale for your customers. Organization Admin and Universal Apps are now available in FusionAuth 1.58.0, giving you the power to delegate user management while simplifying multi-tenant deployments.
...
Organization Admin lets your customers manage their own users safely and securely. It lets you give your customers the keys to their own user management kingdom, but with carefully designed boundaries that keep everyone secure.

### What Your Customers Can Do

With Organization Admin v1, designated administrators in your customers’ organizations can:
...
Organization Admin and Universal Apps are designed to complement each other perfectly:

1. Deploy fast with Universal Apps to get new customers up and running quickly
2. Delegate management with Organization Admin so customers can handle their own users
...
Organization Admin is available to any user with an Enterprise license. Universal Apps are available for all FusionAuth users via a Community or paid license. Here's how to get started:

### Enable Organization Admin

1.

### Set Up Universal Apps

1.

### API Integration

Universal apps are fully supported through our APIs, so you can integrate them into your existing workflows and automation. Check out our [API documentation](about:blank) for detailed implementation guides.
