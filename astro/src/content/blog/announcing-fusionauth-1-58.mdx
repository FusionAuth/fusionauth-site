...
tags: release notes, tenant manager, universal apps, b2b2c, multi-tenant, user management, api-first, enterprise
...
Universal apps are fully supported through our APIs, so you can integrate them into your existing workflows and automation. Read more about Universal Apps and how to use them within the [FusionAuth docs](/docs/get-started/core-concepts/types/applications#universal-applications).
