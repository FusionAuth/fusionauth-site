...
This feature is useful if your application supports multiple languages and you want to [send your welcome email](/docs/customize/email-and-messages/email-templates-replacement-variables#set-up-password) in the language your user prefers. Previous to 1.47, you had to use advanced registration forms to get this functionality.
...
Learn more about [configuring SAML assertion encryption](/docs/get-started/core-concepts/types/applications#assertion-encryption).
