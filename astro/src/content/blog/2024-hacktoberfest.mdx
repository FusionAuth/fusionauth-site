...
The first step is to <a href="https://hacktoberfest.com" target="_blank" rel="noopener noreferrer"> register for Hacktoberfest</a>. Once you've registered, any PRs submitted to FusionAuth (or any other repo with the label #Hacktoberfest) will count towards your participation in the event!
