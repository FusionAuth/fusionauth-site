...
Make sure you have some way to identify anonymous users as such. In FusionAuth, you might use the <InlineField>user.data</InlineField> field. Below is a screenshot of an anonymous user in the admin UI.
