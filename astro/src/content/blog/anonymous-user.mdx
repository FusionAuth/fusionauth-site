...
When the hosted login pages don't meet your needs, you can use the [APIs](/docs/v1/tech/apis/) to build your workflows. You can do this for anonymous users. Here's a [guide to implement this custom registration flow](/docs/v1/tech/guides/anonymous-user). 
...
Here's an example of code that sets a JWT with a user Id, using the [FusionAuth JWT Vend API](/docs/v1/tech/apis/jwt#vend-a-jwt).
