...
> A quick not here we have a great article on [Avoiding Authentication System Lock-In](/articles/authentication/avoid-lockin).
...
{/* ![Registering the native app client]() */}
...
To initialize this, the app makes a request:
...
- Apps should verify the signature and claims
