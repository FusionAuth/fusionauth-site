...
> We ended up choosing FusionAuth over other alternatives (primarily [KeyCloak](/compare/fusionauth-vs-keycloak) because of the exceptional documentation, and it checked all of the boxes we were looking for. 
...
**Tyler:**  It would be very nice if there was a plan between [Community](/pricing) _[ed: $0 for unlimited MAU]_ and [Starter](/pricing) _[ed: starts at $125 for 10k MAU]_ that offered Entity Management and the Client Credentials grant features. It would do a lot to help small startups with tight budgets ensure they have the tooling available so their systems remain secure and maintainable.
