...
**Tyler:** When Numetry was being built, the EU-US Privacy Shield was struck down by European courts and there was a lot of uncertainty working with USA-based companies from Europe, especially so if you were a company that handled a protected class of data (like children's data).
...
Self-hosting is part of that strategy to reduce our sub-processor list, which also improved the sales pipeline. When your primary customer are municipalities and/or school boards, they will be much more comfortable if their data is being sent to as few 3rd-party services as possible.
