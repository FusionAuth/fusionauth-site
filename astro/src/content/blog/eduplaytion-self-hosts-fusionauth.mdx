...
We also use FusionAuth's [Entity Management features](/docs/get-started/core-concepts/types/entity-management) to allow secure communication between different services in our backend.
