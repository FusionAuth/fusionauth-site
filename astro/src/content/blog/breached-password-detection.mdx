...
Assuming you've [activated your paid plan with a license key](/docs/get-started/core-concepts/licensing), navigate to the Tenant details page, and then to the <Breadcrumb>Password</Breadcrumb> tab. Enable <InlineField>Breached password detection settings</InlineField> and then choose your options. If you need varied configuration for different applications, use the multi-tenant feature to create separate tenants and configure them individually.
