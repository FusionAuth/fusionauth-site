...
**Jason:** Sure. Our website lays out the details of the platform, but we are a business messaging and collaboration tool. We are currently in beta testing with a few organizations and are getting ready for a general product release in May.
...
We love sharing community stories. You can check out Unio's website if you'd like to learn more about Unio.
