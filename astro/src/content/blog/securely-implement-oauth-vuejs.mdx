...
This blog post walks through low-level details of OAuth in Vue.js. If you want to add login, logout, and registration buttons to your Vue.js application, using pre-built buttons or service, you should take a look at our [Vue.js SDK](/docs/v1/tech/client-libraries/vue-sdk). You can also work through a [tutorial using the SDK](/docs/quickstarts/quickstart-javascript-vue-web/).
</Aside>
