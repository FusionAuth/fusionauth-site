...
import Diagram from "../../diagrams/blog/update-php-application/authorization-code-grant.astro";
...
* A running instance of FusionAuth. If you don't have this, check out the [5 minute setup guide](/docs/quickstarts/5-minute-setup-guide).
...
<Diagram alt="The Authorization Code grant data flow." />
