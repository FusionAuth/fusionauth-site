...
Navigate to <Breadcrumb>Applications</Breadcrumb> in the administrative user interface and create a new one. Go to the OAuth tab and ensure that the <InlineField>Authorization Code</InlineField> grant is checked. Add a redirect URL of `http://localhost:8000/oauth-callback.php`. At the end, it should look like this:
