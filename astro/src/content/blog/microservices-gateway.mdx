...
{/* eslint-disable-line */}If we've got our setup working right, you should be able to click <InlineUIElement>Login</InlineUIElement>. Login to FusionAuth with the user you set up previously. You'll see a "Hello [your name]" message.
