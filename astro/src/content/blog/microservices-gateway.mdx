...
If we've got our setup working right, you should be able to click <Breadcrumb>Login</Breadcrumb>. Login to FusionAuth with the user you set up previously. You'll see a "Hello [your name]" message.
