...
If you want to play with either protocol to learn more, FusionAuth has you covered. You can use the Community plan for free. The platform provides authentication, authorization, and user management for any kind of application, and it easily integrates with most languages and frameworks. [Download FusionAuth](/docs/get-started/download-and-install/docker) to explore SAML and OIDC functionality. 
