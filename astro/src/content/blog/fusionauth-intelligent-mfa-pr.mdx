...
**Boulder**, Colorado — July 14, 2026 — [FusionAuth](/), the Customer Identity and Access Management platform built for security, control, and scale, today announced the release of FusionAuth 1.68, introducing [Intelligent MFA](/intelligent-mfa), a risk-based authentication engine that evaluates every login against 10 configurable signals and challenges users only when risk is detected.
