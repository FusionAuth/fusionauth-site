...
In FusionAuth, implement this segmentation model [using tenants](/docs/get-started/core-concepts/types/tenants).
...
In FusionAuth, implement this segmentation model [using applications](/docs/get-started/core-concepts/types/applications).
