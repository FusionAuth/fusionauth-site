...
Before we jump into the models, let's establish some terminology. These are drawn from the [NIST Digital Identity guideslines](https://csrc.nist.gov/pubs/sp/800/63/a/4/final).
