...
htmlTitle: "History of Passwords: How the First Password Was Hacked"
description: The first password hacked was in 1966 by graduate student Allan Scherr at MIT. Learn more about the history of passwords. 
authors: Dan Moore
...
Choosing a good password as well as enabling [multi-factor authentication](/articles/authentication/multi-factor-authentication) will ensure that your data remains secure.
...
The algorithm and factor are not typically in your control; it's the province of whoever owns the system to which you are logging in. There are additional concepts that I'm not going to dive into here, such as a salt and a pepper. You can read more about the [math of password hashing here](/articles/security/math-of-password-hashing-algorithms-entropy).
...
_[Schedule a demo](/contact) to see how FusionAuth handles password security and storage best practices by default._
