...
It's conference season! Last week [we were at THAT](/blog/see-you-at-that-conference), next week we'll be at KCDC (The Kansas City Developer Conference). This is a developer focused conference which happens in downtown Kansas City Aug 8-10. We're sponsoring KCDC this year.
...
* "How to Hack OAuth" from [@aaronpk](https://x.com/aaronpk/) 
...
* We'll be out and about as well. Send us a note via our [contact form](/contact) or tweet/DM [me](https://x.com/mooreds) or [our corporate account](https://x.com/fusionauth) if you'd like to say hey.
