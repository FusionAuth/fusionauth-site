...
htmlTitle: "Private Label Tenant Apps with FusionAuth Multi-Tenancy"
description: "FusionAuth's multi-tenant feature enables you to build white label tenant applications with isolated user data, custom branding, and flexible authentication options."
authors: Dan Moore
...
categories: Product
tags: tenants, api, themes, b2b2c, b2b2e
...
FusionAuth provides an easier option: tenants. [Tenants](/docs/get-started/core-concepts/types/tenants) are a first class construct in FusionAuth. When you set up a new instance, there is one tenant installed: "Default". And sometimes one is enough. 
