...
Of course, people can change. So an admin can unlock an account anytime, either using the FusionAuth admin console or with the [FusionAuth API](/docs/apis/users/reactivate).
