...
<blockquote class="text">
  <p>Isn't this skating to where the puck has already been?<br></br>
    — Scott Barden</p>
</blockquote>
...
Our SAML support in this release allows FusionAuth to act as both the SAML Identity Provider and the SAML Service Provider.
 - [Configure FusionAuth to act as the IdP](/docs/lifecycle/authenticate-users/saml)
 - [Configure FusionAuth Service Provider connecting to a third party SAML IdP](/docs/lifecycle/authenticate-users/identity-providers/overview-samlv2)
...
![Duplicate Email Template Example.](/img/blogs/update-saml/duplicate-email-template-view.png)

## Fixes & Updates

The FusionAuth 1.6 release has additional updates and fixes that you should know about. The details are in the [release notes](/docs/release-notes/archive#version-1-6-0) but here are a few.
...
- We fixed an issue with [Passwordless login](/blog/fusionauth-passwordless) if no email template is configured or if Passwordless login is disabled.
