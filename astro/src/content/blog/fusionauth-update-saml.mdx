...
The FusionAuth `1.6` release has additional updates and fixes that you should know about. The details are in the [release notes](/docs/release-notes#version-1-6-0) but here are a few.
