...
For a list of best practices mitigating the danger of client-side token storage, read the recommendations by the IETF in the [OAuth 2.0 draft](https://datatracker.ietf.org/doc/html/rfc9700/), or this [summary](https://maida.kim/oauth2-best-practices-for-developers) by a FusionAuth developer.
...
The [final post](/blog/auth-architecture-part3-BBOC) in this series discusses the third and least secure OAuth architecture: BBOC. You'll learn how it works and the rare cases when you might choose it.
...
- [Part 3 of authentication architecture series: BBOC](/blog/auth-architecture-part3-BBOC)
...
- [OAuth 2.0 draft](https://datatracker.ietf.org/doc/html/rfc9700)
