...
To follow along, you need Git, Node.js, npm, and Docker installed. While it's not explained here, you could use Deno (or Node in Docker if know how to change your network settings) instead of Node.
