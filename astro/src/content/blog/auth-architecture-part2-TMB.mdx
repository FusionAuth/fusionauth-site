...
DPoP is not yet supported by FusionAuth, but it has been [requested](https://github.com/FusionAuth/fusionauth-issues/issues/1679). You can learn more about exactly how DPoP works in the [Evolving Auth Standards: Security Best Practices for App Developers webinar](https://fusionauth.io/webinar/evolving-auth-standards-security-best-practices-for-app-developers).
...
- [Evolving Auth Standards: Security Best Practices for App Developers](https://fusionauth.io/webinar/evolving-auth-standards-security-best-practices-for-app-developers)
