...
Navigate to <Breadcrumb>Applications</Breadcrumb> and then edit your application. Go to the <Breadcrumb>Registration</Breadcrumb> tab and the <Breadcrumb>Form Settings</Breadcrumb> section. Change the "Form" value to the form added above:
