...
Navigate to <Breadcrumb>Applications</Breadcrumb> and then edit your application. Go to the <Breadcrumb>Registration</Breadcrumb> tab and the <InlineUIElement>Form Settings</InlineUIElement> section. Change the "Form" value to the form added above:
