...
<Aside type="tip">If you cloned our [GitHub repository](https://github.com/FusionAuth/fusionauth-example-laravel-single-sign-on), you can just copy the contents from [`database/migrations/2023_02_20_150439_add_fusionauth_fields_user_table.php`](https://github.com/FusionAuth/fusionauth-example-laravel-single-sign-on/blob/main/database/migrations/2023_02_20_150439_add_fusionauth_fields_user_table.php).</Aside>
...
<Aside type="tip">If you cloned our [GitHub repository](https://github.com/FusionAuth/fusionauth-example-laravel-single-sign-on), you can just copy the contents from [`routes/web.php`](https://github.com/FusionAuth/fusionauth-example-laravel-single-sign-on/blob/main/routes/web.php).</Aside>
...
Get your hands dirty by [downloading FusionAuth for free](/docs/get-started/download-and-install/docker) and set up SSO for your Laravel app today.
