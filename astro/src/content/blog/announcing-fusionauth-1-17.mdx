...
authors: Dan Moore
image: /img/blogs/news/fusionauth-release-1-17.png
categories: Release Updates, Product
tags: release notes, apple, lambda
...
FusionAuth has support for [Sign in with Apple](/docs/lifecycle/authenticate-users/identity-providers/social/apple) as an identity provider. You can now let your users authenticate with their Apple account.
