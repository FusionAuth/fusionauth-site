...
These changes are backward compatible for [every version of PostgreSQL](/docs/get-started/download-and-install/reference/system-requirements#database) that FusionAuth supports.
