...
## Creating a new user
To test your Gatsby-based login, you'll need to add a new user and register them for your application in FusionAuth. From the Users page in FusionAuth, click <Breadcrumb>+</Breadcrumb> to add a user. Enter an email address and password for your new user and click the save button.

![Creating a new user in FusionAuth.](/img/blogs/oauth-gatsby/create-user.png)

Next, click <Breadcrumb>Add registration</Breadcrumb> to link this user to the application you created in Step 1. Click the save button when you're finished.
...
- Successfully log out by clicking the <Breadcrumb>Logout</Breadcrumb> button on your profile page
