...
We're also looking for feedback on how you use this MCP server and what kind of functionality you want to see in future releases. Please post it on the [community forum](/community/forum).

## How It Works

Under the hood, we're using an [open-source library](https://github.com/harsha-iiiv/openapi-mcp-generator) to automatically generate the MCP server from our OpenAPI specification. The [MCP server itself is open source](https://github.com/FusionAuth/fusionauth-mcp-api/), released under the Apache2 license. This means a few things.
