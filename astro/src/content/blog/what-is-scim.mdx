...
Now, as of version 1.36, FusionAuth can consume SCIM requests and act as the provisioning server in a SCIM client/server environment. If you are interested, you can [learn more here](/docs/lifecycle/migrate-users/scim).
...
* [FusionAuth SCIM documentation](/docs/lifecycle/migrate-users/scim)
