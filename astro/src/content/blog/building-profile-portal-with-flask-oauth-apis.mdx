...
_Note that user profile editing functionality is now available in paid editions of FusionAuth. [Learn more](/docs/lifecycle/manage-users/account-management/)._
