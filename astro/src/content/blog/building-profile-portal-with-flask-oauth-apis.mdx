...
You could stop here if you wanted, I suppose. You're showing the user data that is retrieved from the [`userinfo` OIDC endpoint](/docs/api/oauth#userinfo), and you could display other data like the user's name. 
