...
Next, update your application settings. Navigate to the <Breadcrumb>Applications -> OAuth</Breadcrumb> tab. Add `http://localhost:5000/callback` to the **Authorized redirect URLs** field. Set the logout URL to be `http://localhost:5000`.
