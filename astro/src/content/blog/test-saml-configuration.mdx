...
You will need an instance of FusionAuth up and running. You can do so using [Docker](/docs/get-started/download-and-install/docker), using [Homebrew](/docs/get-started/download-and-install/homebrew), [a number of other methods](/download).
