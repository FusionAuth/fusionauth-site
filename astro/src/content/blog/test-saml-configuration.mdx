...
<InlineField>Enabled</InlineField> <InlineFieldValue>True</InlineFieldValue>
...
If you are having trouble, set the <InlineField>Debug Enabled</InlineField> toggle to <InlineFieldValue>true</InlineFieldValue> on the <Breadcrumb>SAML</Breadcrumb> tab. This outputs more information to help you troubleshoot your configuration. You can find the logged information at <Breadcrumb>Logs -> Event Log</Breadcrumb> in the FusionAuth Admin application.
