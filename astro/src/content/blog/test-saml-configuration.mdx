...
You will need an instance of FusionAuth up and running. You can do so using [Docker](/docs/get-started/download-and-install/docker) or using [Homebrew](/docs/get-started/download-and-install/homebrew), among many ways.
