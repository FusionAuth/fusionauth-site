...
Select <InlineUIElement>Users</InlineUIElement>. Choose a user you wish to test. Select <InlineUIElement>Manage</InlineUIElement>. <InlineUIElement>Add registration</InlineUIElement> for the IAMShowcase Example application for the user.
