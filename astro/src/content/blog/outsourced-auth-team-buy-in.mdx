...
* **Cost:** There are a few things to consider here, which are covered in the <InlineUIElement>Cost of in-house vs outsourced auth</InlineUIElement> section of my post ["Why outsource your auth system?"](/blog/why-outsource-auth)
