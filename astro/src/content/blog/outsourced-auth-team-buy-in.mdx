...
* **Cost:** There are a few things to consider here, which are covered in the <Breadcrumb>Cost of in-house vs outsourced auth</Breadcrumb> section of my post ["Why outsource your auth system?"](/blog/why-outsource-auth)
