...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-example-react-native-0-71/main/ios/RNfusionauth/AppDelegate.h" lang="objectivec" />

Here's the `AppDelegate.mm` file contents:

<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-example-react-native-0-71/main/ios/RNfusionauth/AppDelegate.mm" lang="objectivec" />

The changes in `AppDelegate.mm` allows authentication with [Magic Links](/docs/lifecycle/authenticate-users/magic-links-and-codes/).
