...
This post is old and no longer maintained. If you'd like to protect a Ruby on Rails API with JWTs and FusionAuth, see this [tutorial on using Ruby on Rails and FusionAuth together](/docs/v1/tech/tutorials/integrate-ruby-rails-api).
</Aside>
