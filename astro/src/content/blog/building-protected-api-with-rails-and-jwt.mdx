...
htmlTitle: "How to Secure a Rails API With JWT Authentication"
description: Learn how to secure a Rails REST API using JWTs. This guide shows how to add token-based auth with FusionAuth and a Rails authentication gem.
authors: Dan Moore
