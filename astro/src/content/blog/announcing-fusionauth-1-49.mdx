...
Speaking of frustration, FusionAuth has dealt with a lot of issues around [our magic links functionality](/docs/lifecycle/authenticate-users/one-time-passwords/). This seems pretty straightforward:
