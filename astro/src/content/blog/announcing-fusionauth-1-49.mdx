...
In this release, FusionAuth offers requires the user to submit a form after they click on the emailed linkunless they are in the same browser. While this increases friction, it also guarantees the one-time code won't be used up by any known link checker.
