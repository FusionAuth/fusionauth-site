...
_This blog post is an excerpt from [What to Do When Your Auth System Vendor Gets Acquired](/articles/identity-basics/what-to-do-when-auth-system-vendor-acquired)._
...
To learn about more about vendor acquisitions, such as short-term and long-term benefits and risks, read [What to Do When Your Auth System Vendor Gets Acquired](/articles/identity-basics/what-to-do-when-auth-system-vendor-acquired).
