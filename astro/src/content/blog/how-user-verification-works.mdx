...
If you're unfamiliar with FusionAuth types, like Tenants, Applications, Users, and Registrations, please review the [documentation](/docs/get-started/core-concepts/types/). The relationship diagram below summarizes the types.
...
**Verification template** choose `Registration Verification`. Enable self-service registration on this page too, so you can register on FusionAuth as a new user.
