...
Hopefully FusionAuth will add an `effectivelyVerified` calculated field to the user object in the future. But until that exists, there is a simple algorithm to check the user identities to see if a user is effectively verified:
