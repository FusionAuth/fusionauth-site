...
The email tab remains in both versions, but the verification settings and email templates have moved to the Identities tab on the right.

![New Identities tab](../../../public/img/blogs/how-user-verification-works/newIdentities.svg)

But the Identities tab isn't just for email (hence the new name). FA now also supports phone numbers as a unique identifier for users in addition to email addresses.
