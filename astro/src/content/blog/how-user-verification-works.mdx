...
The SMTP settings remain in the new version of the Email tab, but the verification settings and email templates have moved to the new Identities tab on the right.

![New Identities tab](../../../public/img/blogs/how-user-verification-works/newIdentities.svg)

However, the Identities tab isn't just for email anymore (hence the new name). FA now supports phone numbers as a unique identifier for users in addition to email addresses.
