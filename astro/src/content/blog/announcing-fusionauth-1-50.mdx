...
The [UserInfo endpoint](/docs/api/oauth#userinfo), as defined in the OIDC specification, takes an access token and returns information about the user. Per the specification:
