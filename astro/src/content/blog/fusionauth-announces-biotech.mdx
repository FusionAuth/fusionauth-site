...
Per a [recent Microsoft post](https://www.microsoft.com/security/blog/one-simple-action-you-can-take-to-prevent-99-9-percent-of-account-attacks/):
...
The FusionAuth R&D team, with decades of experience in security and software development, saw a clear market opportunity to augment [traditional MFA methods](/articles/authentication/multi-factor-authentication) such as time based one-time password (TOTP), facial recognition, or sending a code via SMS with a new, innovative MFA method.
