...
You now have more flexibility to create custom login flows but still use the Device grant. If you want to learn more about these new endpoints, please check out the [Device grant documentation](/docs/apis/oauth/device).
