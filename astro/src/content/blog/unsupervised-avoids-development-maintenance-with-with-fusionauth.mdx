...
htmlTitle: "Unsupervised Integrates Upstream Providers with FusionAuth"
description: "Unsupervised uses FusionAuth to integrate with clients' upstream identity providers, reducing development overhead and simplifying authentication workflows."
...
{/* eslint-disable-line */}> "Allowing [FusionAuth] to be a known base is very freeing mentally. We are much more confident that FusionAuth will implement the authentication system correctly compared to our homegrown, quasi-maintained version."
...
> _Streamline your authentication processes like Unsupervised. [Schedule a demo](/contact) to discover how FusionAuth can simplify your identity management and reduce engineering overhead._
