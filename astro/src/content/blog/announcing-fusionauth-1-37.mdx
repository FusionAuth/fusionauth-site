...
This will show all webhooks. Any with a value of <InlineFieldValue>false</InlineFieldValue> for the <InlineField>global</InlineField> field is an application specific webhook. For these webhooks, the application Ids will be displayed as well. These are the webhooks you'll need to modify.
