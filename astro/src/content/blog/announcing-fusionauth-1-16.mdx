...
authors: Pete Geoly
image: /img/blogs/news/blog-fusionauth-1-16.png
categories: Release Updates, Product
tags: release notes, docker, user search
...
You can now test your SMTP settings in the <Breadcrumb>Tenants -> Email</Breadcrumb> page of the administration user interface. This allows you to test settings used to send email by sending a message to an email address you specify.
