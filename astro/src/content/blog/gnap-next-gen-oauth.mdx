...
{/* eslint-disable-line */}* Redirect: "redirect[ing] to an arbitrary URL" using the browser.
{/* eslint-disable-line */}* App: "launch[ing] an application URL" on a mobile device.
