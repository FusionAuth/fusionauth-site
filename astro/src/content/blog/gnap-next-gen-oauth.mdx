...
In some cases, the `key` attribute has the value <InlineFieldValue>true</InlineFieldValue>; in this case the token is bound to the key of the client previously presented to the authorization server.
