...
This release contained a number of enhancements and bug fixes. Please see the [release notes](/docs/release-notes/#version-1-29-0) for a full breakdown of the changes between 1.28 and 1.29. 
...
In particular, turning on debugging when using a [SAML Identity Provider](/docs/lifecycle/authenticate-users/identity-providers/samlv2/) will now log `AuthN` details, including:
...
The [release notes](/docs/release-notes/#version-1-29-0) are a guide of the changes, fixes, and new features. Please read them carefully to see if any features you use have been modified.
