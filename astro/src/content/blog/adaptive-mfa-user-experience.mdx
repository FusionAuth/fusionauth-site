...
FusionAuth 1.68 introduces [Intelligent MFA](/feature/intelligent-mfa), a built-in risk-scoring engine that addresses both of these gaps. Here's how it works.
