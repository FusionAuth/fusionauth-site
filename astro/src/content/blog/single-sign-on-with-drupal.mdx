...
Back in Drupal, navigate to <Breadcrumb>Configuration</Breadcrumb>, then to "OpenID Connect".
...
Navigate to <Breadcrumb>Configuration</Breadcrumb>, then "People". Under "Who can register accounts", select "Visitors". This ensures new users can register accounts.
