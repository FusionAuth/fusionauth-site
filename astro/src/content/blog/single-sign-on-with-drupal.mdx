...
2. An account in a [FusionAuth](/) instance. FusionAuth is an identity provider with a robust set of [APIs](/docs/v1/tech/apis/), a massive collection of [client libraries](/docs/v1/tech/client-libraries/), and is capable of storing custom data. You can either sign up for FusionAuth cloud or run your own FusionAuth instance for free. If you wish to self-host FusionAuth, make sure it is publicly accessible through the internet.
