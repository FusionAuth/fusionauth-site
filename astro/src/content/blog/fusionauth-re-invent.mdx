...
You can migrate from [Auth0](/docs/lifecycle/migrate-users/auth0) to FusionAuth and we're of course happy to help. Migrating away from Cognito isn't as straightforward, but [there are ways](/docs/lifecycle/migrate-users/cognito).
