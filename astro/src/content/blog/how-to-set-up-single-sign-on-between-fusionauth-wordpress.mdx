...
authors: Aniket Bhattacharyea and Michael Roth
...
![Setting up FusionAuth.](/img/blogs/wordpress-sso-fusionauth/setup-wizard.png)
...
<Aside type="note" nodark="true">
All FusionAuth user facing pages can be themed to look like the other application pages. [Learn more here](/docs/v1/tech/themes/).
</Aside>
