...
Go back to the FusionAuth screen and copy the <InlineField>Client Id</InlineField> and <InlineField>Client Secret</InlineField> from the popup window (you might have to scroll down a bit).
...
* Put <InlineFieldValue>openid</InlineFieldValue> in the <InlineField>OpenID Scope</InlineField> field.
