...
<RemoteCode url="https://raw.githubusercontent.com/FusionAuth/fusionauth-quickstart-javascript-vue-web/main/complete-application/src/components/LogoHeader.vue" lang="markup" />
...
* [magic link authentication](/docs/lifecycle/authenticate-users/one-time-passwords/)
* password expiration
...
* [passkeys](/docs/lifecycle/authenticate-users/passkeys/configure) (with a paid license)
* and more
