...
If your application architecture, use case, or design team rules out redirects, you can use the [Login API](/docs/v1/tech/apis/login) to directly pass user credentials to FusionAuth. 

You'll miss out on the functionality and security benefits outlined above, however.

At the current time there's no SDK support for this approach, but FusionAuth users can and have built out their own user interface using the Login API.
