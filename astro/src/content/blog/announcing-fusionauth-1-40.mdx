...
In particular, Okta updates users via `PUT` or `PATCH`, setting <InlineField>active</InlineField> to <InlineFieldValue>false</InlineFieldValue> when they are deactivated.
