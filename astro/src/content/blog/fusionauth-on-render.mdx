...
- Username: <InlineFieldValue>admin</InlineFieldValue>
...
Feel free to explore more [FusionAuth quickstarts](/docs/get-started/quickstarts/) and make sure your environment is tailored to your needs.
