...
- Spikes in use, such as when ticket purchase sites crash as bookings for a concert open.
- Spikes in popularity, such as when a competitor changes their terms of service, and thousands of customers register on your site as the alternative.

In both cases if you aren't prepared to scale you could lose huge amounts of sales and reputation.
