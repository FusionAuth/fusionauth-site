...
multiple customers
version upgrade ease
lower costs - docker
easy to down scale



data isolation. mistakes. hacks. multiple databases is easy with sqlite.
...
customer load hogging. neighbour load hogging. load spikes. email spam triggers. worpdress viruses in shared web hosting. ease of scaling up and down

query logic in shared database
