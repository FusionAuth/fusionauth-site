...
categories: Tutorial
tags: linxu, fusionauth, download
...
The easiest way to get up and running on Linux will be to use the Linux [Fast Path](/docs/get-started/download-and-install/fusionauth-app "Fast Path") installation. This method will download the zip packages and unzip them in the current working directory and have you up and running quickly.
...
Start by heading to the [Download](/docs/get-started/download-and-install/docker) page. In this example we are installing onto Ubuntu Linux, so we will download the Debian packages.
