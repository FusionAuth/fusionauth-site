...
3. Click the <Breadcrumb>Simple Theme</Breadcrumb> button to open the theme editor.
...
1. Once you're satisfied with your custom theme, click the <Breadcrumb>Save</Breadcrumb> button to save your changes.
