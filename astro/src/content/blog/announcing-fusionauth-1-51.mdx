...
3. Click the <InlineUIElement>Simple Theme</InlineUIElement> button to open the theme editor.
...
1. Once you're satisfied with your custom theme, click the <InlineUIElement>Save</InlineUIElement> button to save your changes.
2. To activate the theme, navigate to the tenant you would like to use this theme on <Breadcrumb> Home / Tenants / Edit / General</Breadcrumb>. Then click on the select option <InlineField>Theme</InlineField> and select your newly created Simple Theme.
