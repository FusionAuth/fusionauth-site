...
2. To activate the theme, navigate to the tenant you would like to use this theme on <Breadcrumb> Home / Tenants / Edit / General</Breadcrumb>. Then click on the select option **Theme** and select your newly created Simple Theme.
