...
title: Announcing FusionAuth 1.63 - Proof Pangolin
...
In 1.62, FusionAuth added support for the [MFA Lambda](/docs/extend/code/lambdas/mfa-requirement), which runs custom logic to determine if a user should be challenged for an extra factor of authentication during a login event. 

This release adds the `AuthenticationType` to the list of parameters available to this Lambda, making it possible to further target your MFA challenges to increase security and minimize friction.
