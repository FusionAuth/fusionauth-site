...
1. Your **Tenant ID** -- You can find this easily by clicking the <Breadcrumb>Tenants</Breadcrumb> tab on the left sidebar and then copying the "Id" value for the "Default" tenant.
...
1. Go to <Breadcrumb>Users</Breadcrumb> and add a user. I used "getgif@example.com" and unchecked "Send email to setup password" to set the user's password.
1. Save the user.
