...
If things do not go according to plan, you can find more detail in the [Readme.md](https://github.com/FusionAuth/fusionauth-example-client-libraries/blob/main/README.md) file in the repository. You could also check out one of our quickstarts, such as [.NET Web](/docs/quickstarts/quickstart-dotnet-web) for more details on how to get the FusionAuth server up and running.
