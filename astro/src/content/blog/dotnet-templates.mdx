...
Enter <InlineFieldValue>FusionAuth</InlineFieldValue> in the search bar. Then, select <Breadcrumb>Download</Breadcrumb> when you find the templates. You will need to restart Visual Studio after the templates are downloaded and installed.
