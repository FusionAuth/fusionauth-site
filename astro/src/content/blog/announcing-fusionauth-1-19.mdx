...
If you are migrating to FusionAuth, typically you are using [the Import Users API](/docs/apis/users/import), perhaps with a [custom password encryptor](/docs/extend/code/password-hashes/custom-password-hashing). You usually want to minimize impact on your users due to migration of a production system.
