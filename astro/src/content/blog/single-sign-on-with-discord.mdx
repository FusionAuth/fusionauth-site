...
- Install a [different example application](/docs/sdks/examples/) and set up Discord login for that application. Then you can SSO between both of them. For more, read the [SSO guide](/docs/v1/tech/guides/single-sign-on).
