...
Our secondary goal with the SDK was the standardization of the usage with, for example, the introduction of the [Authorization Manager](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/Documentation/Reference/classes/AuthorizationManager.md).
...
With the simplified start in the [Authorization Configuration](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/Documentation/Reference/structs/AuthorizationConfiguration.md) and standardized usage in the [Authorization Manager](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/Documentation/Reference/classes/AuthorizationManager.md) we now took care of best practice defaults. as well as handling token storage, refresh, and retrieval in the [Token Manager](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/Documentation/Reference/classes/TokenManager.md).
...
In there, you will find as well how you can [contribute](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/CONTRIBUTING.md) further in the development of the FusionAuth Swift SDK for iOS.