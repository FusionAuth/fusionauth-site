...
<RemoteContent url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-swift-sdk/main/README.md"
...
Our secondary goal with the SDK was the standardization of the usage with, for example, the introduction of the [Authorization Manager](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/library/docs/library/io.fusionauth.mobilesdk/-authorization-manager/index.md).
...
With the simplified start in the [Authorization Configuration](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/library/docs/library/io.fusionauth.mobilesdk/-authorization-configuration/index.md) and standardized usage in the [Authorization Manager](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/library/docs/library/io.fusionauth.mobilesdk/-authorization-manager/index.md) we now took care of best practice defaults. as well as handling token storage, refresh, and retrieval in the [Token Manager](https://github.com/sonderformat-llc/fusionauth-swift-sdk/blob/main/library/docs/library/io.fusionauth.mobilesdk/-token-manager/index.md).
...
We created detailed documentation of the SDK and made it available in the [GitHub repository](https://github.com/sonderformat-llc/fusionauth-swift-sdk/) of the SDK.

<RemoteContent url="https://raw.githubusercontent.com/sonderformat-llc/fusionauth-swift-sdk/main/README.md"
    tags="forDocSiteDocumentation" />

In there, you will find as well how you can [contribute](https://github.com/sonderformat-llc/fusionauth-swift-sdk/?tab=readme-ov-file#contributing) further in the development of the FusionAuth Swift SDK for iOS.