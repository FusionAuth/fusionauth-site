...
In this tutorial, you will install [FusionAuth](https://fusionauth.io) on [Fly.io](https://fly.io) using the [flyctl](https://fly.io/docs/hands-on/install-flyctl/) CLI. You will run FusionAuth locally and on Fly.io while accessing a Postgres database hosted on Fly.io.
...
[Fly.io](https://fly.io) is a platform for deploying and running [containerized applications](/docs/v1/tech/installation-guide/docker). It offers a number of features that make it attractive to developers, including:
