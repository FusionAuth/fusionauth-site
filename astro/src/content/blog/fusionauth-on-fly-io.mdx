...
categories: Tutorial
image: /img/blogs/fusionauth-on-fly-io/fusionauth-template.png
...
On Mac, I would highly recommend using `brew` and staying up to date.
...
You will see a message `? Looks like you're accessing a paid feature. Dedicated IPv4 addresses now cost $2/mo. Are you ok with this? (y/N) y`, answer yes to create the new IP address.
