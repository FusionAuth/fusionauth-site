...
<a href='/resources/fusionauth-vs-cognito.pdf' class='button brochure orange text-larger'>Download the Cognito and FusionAuth Feature Comparison</a>

You can also view technical documentation about how you can migrate from Cognito to FusionAuth.

[View the Cognito Technical Migration Guide](/docs/v1/tech/migration-guide/cognito)
