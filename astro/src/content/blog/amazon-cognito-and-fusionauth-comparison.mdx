...
With FusionAuth, you control the database layer and can architect multi-region failover. Active-passive disaster recovery (DR) is supported, and if you're using FusionAuth Cloud, [DR can be included in your plan](/docs/cloud/disaster-recovery). You can deploy in any region, on any infrastructure.
