...
- Framework - [Remix](https://remix.run/), [Next.js](https://nextjs.org/), [SvelteKit](https://svelte.dev/), [Phoenix Framework](https://www.phoenixframework.org/), [Laravel](https://laravel.com/), [Flask](https://flask.palletsprojects.com/en/3.0.x/), [Angular](https://angular.io/)
- Database - [PlanetScale](https://planetscale.com/), [AlloyDB for PostgreSQL](https://cloud.google.com/alloydb), [AWS Aurora Serverless](https://aws.amazon.com/rds/aurora/serverless/), [CockroachDB Serverless](https://www.cockroachlabs.com/blog/announcing-cockroachdb-serverless/), [EdgeDB](https://www.geldata.com/), [Neon](https://neon.com/), [Supabase](https://supabase.com/), [Timescale](https://www.timescale.com/), [Upstash](https://upstash.com/), [Grafbase](https://grafbase.com/), [Turso](https://turso.tech/), Fauna, [Ably](https://ably.com), [Convex](https://www.convex.dev/), [Hasura](https://hasura.io/), [liveblocks](https://liveblocks.io/)
