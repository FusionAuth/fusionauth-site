...
authors: Bryan Giese
image: /img/blogs/login-authentication-workflows/types-logins-authentication-workflows.png
categories: features
...
![An XMLHttpRequest example.](/img/blogs/login-authentication-workflows/login-type-xmlhttprequest.png)
...
<a href='/articles/login-authentication-workflows' class="button brochure orange text-larger">View Login and Authentication Workflows</a>
