...
You can start super simple and just collect an email and password, and optionally ask for their name and phone number. This new form can also be customized using our theme feature. See our [Theme Tutorial](/docs/customize/look-and-feel/) for additional information. Get started by navigating to your FusionAuth application <Breadcrumb>Settings -> Applications</Breadcrumb> to <InlineUIElement>Edit</InlineUIElement> an application. Under <Breadcrumb>Options -> Registration</Breadcrumb> tab. Here you'll find the <InlineUIElement>Self-service Registration configuration</InlineUIElement>.
