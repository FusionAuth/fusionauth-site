...
image: /img/blogs/fusionauth-self-service-registration/fusionauth-self-service-registration-typescript.jpg
categories: Product, News
tags: typescript, registration
excerpt_separator: "{/* more */}"
---
import Breadcrumb from 'src/components/Breadcrumb.astro';
import { YouTube } from '@astro-community/astro-embed-youtube';

FusionAuth `1.4` was just released and is available for [direct download](/docs/get-started/download-and-install/docker) and through our [FastPath one-line install](/). It includes new features, a few changes, and some minor fixes for issues discovered by our excellent community and QA testers. Get the brief overview below, and visit our [release notes](/docs/release-notes#version-1-4-0) for the full details.
...
![Register User.](/img/blogs/fusionauth-self-service-registration/register-form.png)
...
You can start super simple and just collect an email and password, and optionally ask for their name and phone number. This new form can also be customized using our theme feature. See our [Theme Tutorial](/docs/customize/look-and-feel/) for additional information. Get started by navigating to your FusionAuth application <Breadcrumb>Settings -> Applications</Breadcrumb> to <Breadcrumb>Edit</Breadcrumb> an application. Under <Breadcrumb>Options -> Registration</Breadcrumb> tab. Here you'll find the <Breadcrumb>Self-service Registration configuration</Breadcrumb>.



### TypeScript Client Library
If you're integrating FusionAuth with a TypeScript application, [this library](/docs/sdks/typescript) will speed up your development time. All of our client libraries are open source and hosted on our [GitHub account](https://github.com/FusionAuth "Jump to GitHub"). You can fork and tweak them as well as look over the code to learn how the client libraries work. If we are missing a language, open a [GitHub Issue](https://github.com/FusionAuth/fusionauth-issues/issues "Jump to GitHub") as a Feature Request.
...
<YouTube id="IPB8Rig52PI" />

## Fixes & Updates

- The FusionAuth [System Requirements](/docs/get-started/download-and-install/reference/system-requirements) have been updated. Please review the updated requirements to ensure you meet the minimum supported versions of operating systems and databases.
