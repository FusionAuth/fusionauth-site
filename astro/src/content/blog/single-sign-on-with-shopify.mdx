...
Scroll down a bit, and in the <Breadcrumb>Attribute Mapping</Breadcrumb> section, enter “email” in the **Email** field. This tells the app that the **Email** field present in the FusionAuth response needs to be mapped to the **Email** field of the user.
