...
_This blog post is an excerpt from [Best Practices for Handling Spiky Registration Traffic for Game Launches](/articles/gaming-entertainment/best-practices-spiky-registration)._
...
To learn more about other best practices, including CAPTCHAs and monitoring, read [Best Practices for Handling Spiky Registration Traffic for Game Launches](/articles/gaming-entertainment/best-practices-spiky-registration).
