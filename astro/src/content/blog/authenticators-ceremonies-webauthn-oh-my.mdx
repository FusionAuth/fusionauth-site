...
You might be wondering why you should use passkeys instead of using a more robust password from a password generator. Or you may be considering adding 2FA for more security, which is an improvement but still prone to cyberattacks (for example, phishing) [compared to passkeys](https://www.slashid.dev/blog/webauthn-antiphishing/).
