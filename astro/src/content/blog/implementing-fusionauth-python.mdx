...
_For other [Fast Path install scripts](/docs/get-started/download-and-install/fusionauth-app) and methods of installation, check out our [installation guide](/docs/get-started/download-and-install)._
