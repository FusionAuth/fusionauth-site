...
I was selected to give two different sessions, [one on JWTs](https://longhornphp.com/sessions#what-php-developers-need-to-know-about-jwts) and a [workshop on protecting your APIs](https://longhornphp.com/sessions#protecting-your-apis). I'm especially excited about the hands-on workshop, where users will, using a [web based training platform](https://instruqt.com/), explore various options of protecting an API written in PHP. 
...
In particular, I'm looking forward to [Serializing Modern PHP](https://longhornphp.com/sessions#serializing-modern-php) and [Minimal vs. functional: “Clean” code as a practical – rather than aesthetic – virtue](https://longhornphp.com/sessions#minimal-vs-functional-clean-code-as-a-practical---rather-than-aesthetic---virtue), but there are of course a number of great sessions.
...
If you want to meet up with me at Longhorn PHP, I'll be around! Ping me on [LinkedIn](https://www.linkedin.com/in/mooreds/) or [Twitter/X](https://x.com/mooreds), or [fill out our contact form](/contact) and I'll see it. 
