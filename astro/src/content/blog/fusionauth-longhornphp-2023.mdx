...
I was selected to give two different sessions, one on JWTs and a workshop on protecting your APIs. I'm especially excited about the hands-on workshop, where users will, using a [web based training platform](https://instruqt.com/), explore various options of protecting an API written in PHP. 
