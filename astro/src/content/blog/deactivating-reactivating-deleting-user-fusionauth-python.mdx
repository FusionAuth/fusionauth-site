...
On the <Breadcrumb>Manage User</Breadcrumb> page in the FusionAuth UI, you'll see the <InlineField>User Id</InlineField> located directly under the user's email address. In this instance, it's <InlineFieldValue>4e0f2af0-33a2-4001-8631-0f8225e65f1c</InlineFieldValue>.
