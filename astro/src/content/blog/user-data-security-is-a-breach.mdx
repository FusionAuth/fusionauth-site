...
authors: Bryan Giese
image: /img/blogs/user-data-security-is-a-breach/user-data-security-is-a-breach.png
categories: Education, Security
tags: data security, data breaches
...
[Read FusionAuth's Guide to User Data Security](/articles/security/guide-to-user-data-security)
...
[Learn more about FusionAuth](/ "FusionAuth Home")
