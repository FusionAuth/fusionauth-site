...
<APIBlock>
  ...
  <APIField name="database.password" type="String">
    The password that FusionAuth will use to connect to the database. If you are using [Silent Mode](/docs/get-started/download-and-install/reference/silent-mode) or [Setup Wizard](/docs/get-started/download-and-install/setup), then this password might be used when the `database.user` is automatically created for you, depending on your database server and configuration options.
  ...
  <APIField name="database.username" type="String">
    The database user that FusionAuth will use to connect to the database. If you are using [Silent Mode](/docs/get-started/download-and-install/reference/silent-mode) or [Setup Wizard](/docs/get-started/download-and-install/setup), then this user might be automatically created for you, depending on your database server and configuration options. If this user is created as part of [Silent Mode](/docs/get-started/download-and-install/reference/silent-mode) or [Setup Wizard](/docs/get-started/download-and-install/setup), it will also be the owner of the database and schema for FusionAuth.
