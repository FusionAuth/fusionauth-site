...
Fill in the admin user account details, read and accept the License Agreement. When you are ready, click <InlineUIElement>Submit</InlineUIElement>.

<Aside nodark="true" type="tip">For details, see [Setup Wizard](/docs/get-started/download-and-install/setup-wizard).</Aside>
