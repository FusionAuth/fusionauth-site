...
Then click on the <Breadcrumb>+</Breadcrumb> button on the top right of the <Breadcrumb>Applications</Breadcrumb> page and fill in the <InlineField>Name</InlineField> field with a name of your choosing (here, it's **"your_application"**):
