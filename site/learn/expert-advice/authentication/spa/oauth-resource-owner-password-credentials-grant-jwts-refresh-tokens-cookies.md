...
{% plantuml source: _diagrams/learn/expert-advice/authentication/spa/oauth-resource-owners-grant-jwts-refresh-tokens-cookies.plantuml, alt: "Single page application OAuth 2 Resource Owners Grant with JWTs and refresh tokens in cookies diagram" %}
