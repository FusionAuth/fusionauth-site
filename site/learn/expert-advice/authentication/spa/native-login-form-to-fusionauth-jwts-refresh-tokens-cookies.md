...
{% plantuml source: _diagrams/learn/expert-advice/authentication/spa/native-login-form-to-fusionauth-jwts-refresh-tokens-cookies.plantuml, alt: "Single page application native login with JWTs and refresh tokens in cookies diagram" %}
