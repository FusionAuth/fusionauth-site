...
{% plantuml source: _diagrams/learn/expert-advice/authentication/spa/oauth-implicit-grant-sessions.plantuml, alt: "Single page application OAuth 2 Implicit Grant with backend session diagram" %}
