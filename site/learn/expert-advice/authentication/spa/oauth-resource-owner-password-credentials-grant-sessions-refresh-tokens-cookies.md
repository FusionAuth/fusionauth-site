...
{% plantuml source: _diagrams/learn/expert-advice/authentication/spa/oauth-resource-owners-grant-sessions-refresh-tokens-cookies.plantuml, alt: "Single page application OAuth 2 Resource Owners Grant with server-side sessions and refresh tokens in cookies diagram" %}
