...
{% plantuml source: _diagrams/learn/expert-advice/authentication/webapp/oauth-authorization-code-grant-sessions-refresh-tokens-cookies.plantuml, alt: "Web application OAuth 2 Authorization Code Grant with server-side sessions and refresh tokens in cookies diagram" %}
