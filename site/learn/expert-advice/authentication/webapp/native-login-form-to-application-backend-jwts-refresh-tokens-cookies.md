...
{% plantuml source: _diagrams/learn/expert-advice/authentication/webapp/native-login-form-to-application-backend-jwts-refresh-tokens-cookies.plantuml, alt: "Web application native login with JWTs and refresh tokens in cookies diagram" %}
