...
What's the use of an auth system that's not maintained or supported? Maybe you could manage other software that's not given much attention, but not an auth system. Authentication is critical to your customers' privacy and the entire working of your application. You don't want a security vulnerability in an auth system to shake your customer's confidence in your application.
