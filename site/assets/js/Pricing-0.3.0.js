...
class FusionAuthPriceCalculator {
  ...
  #hostingPriceDiv;
  #hostingSelectionDiv;
  #monthlyActiveUserSlider;
  #monthlyActiveUserSliderMin;
  #monthlyActiveUserSliderMax;
  #monthlyActiveUserValue;
  #plan;
  #planPrice;
  #planPriceDiv;
  #planSelectionDiv;
  ...
  #redraw() {
    ...
    if ((!this.#hosting || this.#hosting === 'self-hosting' || this.#hosting === 'basic-cloud') && (!this.#plan || this.#plan === 'Community' || this.#plan === 'Starter')) {
      ...
      this.#sumDiv.nextSibling.style.display = 'none';
      ...
      this.#sumDiv.nextSibling.style.display = 'inline';
