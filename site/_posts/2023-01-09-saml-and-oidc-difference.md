...
If you want to play with either protocol to learn more, FusionAuth has you covered. You can use the community edition for free. The platform provides authentication, authorization, and user management for any kind of application, and it easily integrates with most languages and frameworks. [Download FusionAuth](https://fusionauth.io/download) to explore SAML and OIDC functionality. 
