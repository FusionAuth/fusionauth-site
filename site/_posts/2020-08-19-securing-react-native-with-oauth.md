...
```xml
{% remote_include 'https://raw.githubusercontent.com/FusionAuth/fusionauth-example-react-native-0-71/main/ios/RNfusionauth/Info.plist' %}
```
...
```objective_c
{% remote_include 'https://raw.githubusercontent.com/FusionAuth/fusionauth-example-react-native-0-71/main/ios/RNfusionauth/AppDelegate.h' %}
```

Here's the `AppDelegate.mm` file contents:
```objective_c
{% remote_include 'https://raw.githubusercontent.com/FusionAuth/fusionauth-example-react-native-0-71/main/ios/RNfusionauth/AppDelegate.mm' %}
```

The changes in `AppDelegate.mm` allows authentication with [Magic Links](/docs/v1/tech/passwordless/magic-links).
...
```tsx
{% remote_include 'https://raw.githubusercontent.com/FusionAuth/fusionauth-example-react-native-0-71/main/App.tsx' %}
```
...
{% include _image.liquid src="/assets/img/blogs/react-native-oauth/react-native-ios-walkthrough.gif" alt="React Native Example App Walkthrough" class="img-fluid" figure=false %}
