...
"*Please Note:* The node client is deprecated.  This tutorial will still work, however! We are currently working on an updated tutorial with our TypeScript library. You can track the progress of that [here](https://github.com/FusionAuth/fusionauth-site/issues/1097))."
%}
