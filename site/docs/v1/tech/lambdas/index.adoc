...
Lambdas may not interrupt the login process or any other user flow. 
They are used to change data only.
If you are looking to interfere or modify the flow of a user's auth experience, use a transactional
 webhook.
