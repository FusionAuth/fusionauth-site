...
You can provider request header values in a number of different ways:
...
* `headers`: headers returned by the request.
* `status`: an HTTP status code. This will be an integer.
