...
** `members[x].data.$ref` - The URI to retrieve the SCIM User representation of the FusionAuth User `ex. https://login.piedpiper.com/api/scim/v2/Users/902c246b-6245-4190-8e05-00816be7344a`
