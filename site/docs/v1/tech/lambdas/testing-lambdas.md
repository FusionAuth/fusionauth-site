...
This command will run FusionAuth, and setup a sample application with an API Key and a User, configured in the kickstart.json file in the kickstart subdirectory.
...
Add this new function to `test.js`. It is the lambda function that would run on FusionAuth, similar to the "Hello World" function earlier.
