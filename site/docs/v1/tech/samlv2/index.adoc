...
image::samlv2/overview/samlv2-application-authentication.png[Application SAML v2 Authentication Configuration,width=1200]
...
[field]#Default verification key# [required]#Required#::
...
[field]#Signature canonicalization method# [optional]#Optional#::
...
[field]#Signature location# [optional]#Optional#::
...
image::samlv2/overview/samlv2-application-logout.png[Application SAML v2 Logout Configuration,width=1200]
...
When set to `All session participants`, each session participant that has [field]#Enable single logout# set to true will be sent a Logout Request. 
+
...
[field]#Enable single logout# [optional]#Optional#::
...
[field]#Logout URL# [required]#Required#::
The URL which you want to receive the LogoutRequest from FusionAuth.
+
If [field]#Enable single logout# is not enabled, this field is optional.
...
image::samlv2/overview/samlv2-application-encryption.png[Application SAML v2 Assertion Encryption Configuration,width=1200]
...
[field]#Encryption algorithm# [optional]#Optional#::
The symmetric key encryption algorithm used to encrypt the SAML assertion.

[field]#Key location# [optional]#Optional#::
...
[field]#Key transport encryption certificate# [optional]#Optional#::
...
include::docs/v1/tech/docs/shared/_saml-sp-limitations.adoc[]
