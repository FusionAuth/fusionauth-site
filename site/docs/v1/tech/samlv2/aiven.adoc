...
You need to generate a custom RSA certificate and upload it to your FusionAuth instance's [breadcrumb]#Key Master#. To do so you can use a script in our https://github.com/FusionAuth/fusionauth-example-scripts[example scripts GitHub repository].
