...
image::samlv2/aiven/create-api-key.png[Creating API Key.,width=1200,role=custom]
...
image::samlv2/aiven/grab-api-key.png[Grabbing API Key.,width=1200,role=custom]
