...
The Event object for a two factor add.  See the link:/docs/v1/tech/events-webhooks/events/user-two-factor-method-add[Webhooks & Events section] for field definitions.
...
[field]#event# [type]#[Event]#::
The Event object for a two factor remove.  See the link:/docs/v1/tech/events-webhooks/events/user-two-factor-method-remove[Webhooks & Events section] for field definitions.
