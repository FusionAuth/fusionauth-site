...
To enable and configure the SMTP server navigate to [breadcrumb]#Settings# icon:chevron-right[role=breadcrumb] [breadcrumb]#Tenants# icon:chevron-right[role=breadcrumb]
[breadcrumb]#Email#.
