...
Gmail is a commonly used SMTP service. Gmail is not recommended for production use, since it has a https://support.google.com/a/answer/166852?hl=en[number of limits]. However, it can be useful to test email functionality.
