...
This section is designed to review how to utilize email and email templates in FusionAuth. See link:../apis/emails[Email APIs]
...
have been completed during the link:../tutorials/setup-wizard[FusionAuth Setup Wizard]. If you have not yet completed this step see the topic
