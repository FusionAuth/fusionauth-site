...
[NOTE]
====
This information is provided for starting guidance only - FusionAuth connects seamlessly with many different email services. A deep exploration of email best practices and providers is outside the scope of this section.
====
