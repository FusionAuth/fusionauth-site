...
Below you examples of templates for reference. The available replacement values will be outlined below for each template.
...
[source,text]
----
include::docs/src/email/confirm-child.txt[]
----
...
[.api]
[field]#child#::
The child's User object.

[field]#user#::
The parent's User object.
...
[source,text]
----
include::docs/src/email/family-registration.txt[]
----
...
[.api]
[field]#parent#::
The parent's User object, if they have an account, otherwise null. 
...
[source,text]
----
include::docs/src/email/parent-registration.text[]
----
