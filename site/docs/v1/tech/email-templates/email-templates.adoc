...
// TODO Add link to additional documentation as we complete
The verification One Time Code (OTP) to be used with the Gated Email workflow. The user enters this code to open the 'gate' and allow the email verification to continue.
...
[field]#verificationOneTimeCode# [type]#[String]#::
// TODO Add link to additional documentation as we complete
The verification One Time Code (OTP) to be used with Gated Registration. The user enters this code to open the 'gate' and allow the application registration to continue.
