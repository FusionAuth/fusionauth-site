...
* to modify the problematic objects via the API to remove the mismatched fields 
* run a re-index operation. 

If you have a support contract, please https://account.fusionauth.io/account/support/[open a ticket] and we'll help you out. 

If not, please back up your FusionAuth database and test the fix thoroughly before applying it to production. 
