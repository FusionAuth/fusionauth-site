...
image::troubleshooting/system-logs-single-node.png[System Logs - Single Node,width=1200,role=shadowed]

.System logs UI w/ multiple FusionAuth nodes
image::troubleshooting/system-logs-multiple-nodes.png[System Logs - Multiple Nodes,width=1200,role=shadowed]
