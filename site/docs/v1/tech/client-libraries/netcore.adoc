...
To test projects created using the .NET templates, refer to the testing section in the https://github.com/FusionAuth/fusionauth-example-client-libraries/tree/main/dotnet/Kickstart/README.md[README.md] file.
