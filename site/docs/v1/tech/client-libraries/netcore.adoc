...
To create a new project from a template, first create or open a Solution. Then select [breadcrumb]#File > New Project#. In the "New Project" dialog, select [breadcrumb]#Custom# from the left-hand menu. Then select the FusionAuth template you want to use and  click [uielement]#Continue#. Fill in the required information, including the fully qualified URL to your FusionAuth server and your FusionAuth Application Client Id and click [uielement]#Continue#.
...
To create a new project from a template, first create or open a Solution. Then select [breadcrumb]#File > New Project#. In the "New Project" dialog, select "FusionAuth" from the project types dropdown. Then select the FusionAuth template you want to use. Fill in the required information, including the fully qualified URL to your FusionAuth server FusionAuth and your FusionAuth Application Client Id and click [uielement]#Continue#.
