...
A **client library** is a thin wrapper over our FusionAuth APIs. It needs to cover all FusionAuth APIs. A client library is like a set of legos, to be put together by a developer who wants to extend or manipulate FusionAuth to meet their needs.
...
An **SDK** is an opinionated set of higher level constructs. These focus on a subset of functionality. These are like an assembled lego set.
