...
At FusionAuthk, a **client library** is a thin wrapper over our FusionAuth APIs. It needs to cover all FusionAuth APIs. A client library is like a set of legos, to be put together by a developer who wants to extend or manipulate FusionAuth to meet their needs.
