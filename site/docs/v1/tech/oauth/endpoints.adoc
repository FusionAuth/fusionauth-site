...
[NOTE]
====
You must add an asymmetric key in order to have any public keys published. 

A FusionAuth installation has no public/private keypairs. You may add them using the admin UI by navigating to [breadcrumb]#Settings -> Key Master# and generating or importing them.
====
