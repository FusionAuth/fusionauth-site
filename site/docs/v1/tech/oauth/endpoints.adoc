...
|Determines how the result parameters are to be returned. Valid values are `form_post`, `fragment`, and `query`.

`query` can only be used with a `response_type` of `code`.
...
Accept: */*
Content-Length: 436
client_id=3c219e58-ed0e-4b18-ad48-f4f92793ae32&code=+WYT3XemV4f81ghHi4V+RyNwvATDaD4FIj0BpfFC4Wzg&scope=offline_access
----
...
.Request Parameters
|===
|[field]#user_code# [type]#[String]# [optional]#Required#
|The end-user verification code.
|===
