...
Returns public keys generated by FusionAuth, used to cryptographically verify JWTs using the JSON Web Key format. You may also use the link:../apis/jwt#retrieve-public-keys[JWT Public Key] API to retrieve these keys in PEM format.
