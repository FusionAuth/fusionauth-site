...
In support of https://tools.ietf.org/html/rfc6749[OAuth 2.0 IETF RFC 6749], https://tools.ietf.org/html/rfc8628[OAuth 2.0 IETF RFC 8628], and https://tools.ietf.org/html/rfc7662[OAuth 2.0 IETF RFC 7662], the following endpoints are provided.
