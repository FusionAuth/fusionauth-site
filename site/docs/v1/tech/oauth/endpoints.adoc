...
The optional state parameter, this is generally used as a Cross Site Request Forgery (CSRF) token.
...
Opaque value used to maintain state between the logout request and the callback.
