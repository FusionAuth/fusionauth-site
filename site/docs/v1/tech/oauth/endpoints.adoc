 ...
 ** <<Device Authorization Grant Request>>
...
The following response applies to the <<Authorization Code Grant Request>>, <<Refresh Token Grant Request>> and the <<Device Authorization Grant Request>> examples.
