...
This table can be used as a guideline for describing when the [field]#client_secret# is required.
...
[cols="35,35,15,15"]
|===
| Grant | clientAuthenticationPolicy | PKCE Used | Client Secret Required
