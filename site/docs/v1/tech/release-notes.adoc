...
{nbsp} + \
{nbsp} + \
*Note:* Release notes and documentation still in progress&hellip;]
...
** See the Login API response for additional details.
* The Verify Email API now takes the `verificationId` in the request body instead of a URL segment.
