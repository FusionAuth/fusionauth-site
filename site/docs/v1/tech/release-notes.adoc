...
* Emails API no longer requires a from email or a default from name, defaults may be taken from the tenant.  See the link:/docs/v1/tech/apis/emails[Emails API] documentation for reference.
