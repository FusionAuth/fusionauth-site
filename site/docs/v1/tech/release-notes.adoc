...
{nbsp} + \
{nbsp} + \
This migration should be adequate, but it is recommended that you audit your theme for any usage of `?html` and  ensure you test your theme after migration. In the FusionAuth UI if you navigate to  [breadcrumb]#Settings# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Themes# you can use the View action to render each template and ensure they render properly.]
