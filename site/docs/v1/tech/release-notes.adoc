...
=== Changed
* The Two-Factor API has changed which allows you to enable and disable Two-Factor methods
* The Import API has changed for enabling Two-Factor
* The User API has changed for enabling and disabling Two-Factor
* Email and SMS Two-Factor methods will now require a paid edition of FusionAuth
  * If you are only using Authenticator for Two-Factor, this will continue to function properly in the free version.
