...
=== Changed
- Updated base image for Docker from `alpine` to `ubuntu:focal`. This is a non-functional change, but please be aware of this change if your building Docker images using ours as a base.
+
...
=== New
- SAML POST Bindings support from a third party SP when FusionAuth is acting as the IdP
* Resolves https://github.com/FusionAuth/fusionauth-issues/issues/845[GitHub Issue #845]
- SAMP POST Bindings support to third party SAML IdP when FusionAuth is acting as the SP
* Resolves https://github.com/FusionAuth/fusionauth-issues/issues/845[GitHub Issue #845]
- SAML v2 SessionIndex
