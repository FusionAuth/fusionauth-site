...
* Correct the `Content-Type` HTTP response header returned from SCIM endpoints.
...
* Fix validation of the Oauth2 Logout endpoint when using the `post_logout_redirect` parameter.
