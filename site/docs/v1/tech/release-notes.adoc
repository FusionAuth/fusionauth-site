...
* A core macro in the `Helpers` theme was modified to accept a checkbox as input. This will cause a breakage if the this usage is copy/pasted without modifying `_helpers.ftl`.
