...
*** authorize page -> `<form action="/oauth2/authorize" method="POST" class="full">`
*** child registration not allowed page -> `<form *  action="/oauth2/child-registration-not-allowed" method="POST" class="full">`
*** passwordless page -> `<form action="/oauth2/passwordless" method="POST" class="full">`
*** register page -> `<form action="/oauth2/register" method="POST" class="full">`
*** two factor page -> `<form id="2fa-form" action="/oauth2/two-factor" method="POST" *  class="full">`
*** change password page -> `<form action="/password/change" method="POST" class="full">`
*** forgot password page -> `<form action="/password/forgot" method="POST" class="full">`
