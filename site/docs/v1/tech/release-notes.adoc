...
Is User Search and Reaper stuff being release in 1.12.0 or 1.13.0? APIs currently state "AVAILABLE SINCE 1.13.0"
////
...
=== New
* Actions added to [breadcrumb]#Users# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Manage#
** `Send password reset`
...
** Configurable with the [field]#tenant.userDeletePolicy.unverified.enabled# and [field]#tenant.userDeletePolicy.unverified.numberOfDaysToRetain# fields.
** Addresses https://github.com/FusionAuth/fusionauth-issues/issues/360[GitHub Issue #360]
* Delete application registrations of users who have not verified their registration after a specified duration
** Configurable with the [field]#application.registrationDeletePolicy.unverified.enabled# and [field]#application.registrationDeletePolicy.unverified.numberOfDaysToRetain# fields
** Addresses https://github.com/FusionAuth/fusionauth-issues/issues/360[GitHub Issue #360]
