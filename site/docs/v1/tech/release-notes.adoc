...
_Note: Release notes in Progress&hellip; feel free to refresh the page._

=== Fixed
* Support importing an x.509 certificate with a private key into KeyMaster in the admin UI.
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1805[GitHub Issue #1805]
...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1809[GitHub Issue #1809]
...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1909[GitHub Issue #1909]
...
* Login error when logging out and logging back in with SAML IdP-initiated
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1941[GitHub Issue #1941]
...
* 500 error when navigating to Manage Profile page after authenticating with SAML IdP-initiated
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1976[GitHub Issue #1976]
* Serbian Locale causing an exception when the User is actioned
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1978[GitHub Issue #1978]
* Kafka integration doesn't check for required topic when sending test event
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1985[GitHub Issue #1985]
* Forgot Password Workflow Bug
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1989[GitHub Issue #1989]
* Preview of HTML email on edit is different than list
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/2007[GitHub Issue #2007]
* Unexpected behavior using Step Up MFA Trust and Forgot Password Workflow
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/2010[GitHub Issue #2010]
* PostgreSQL 15 the default permissions of the public schema have been modified
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/2015[GitHub Issue #2015]
* Cannot Edit Custom Consent Form Field
...
*  Provide FusionAuthClient constructor that accepts IRESTClientBuilder
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/2082[GitHub Issue #2082]

=== Enhancements
* Apple IdP using a mobile/desktop app
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/778[GitHub Issue #778]
* Apple identity provider needs support to both web and mobile
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1248[GitHub Issue #1248]
* Change order of logs shown in the admin UI
...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1735[GitHub Issue #1735]
* Getting only 404 error code if provided loginId or currentPassword wrong
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1897[GitHub Issue #1897]
* Supported SP and IDP SAML Login
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1900[GitHub Issue #1900]
* Review the System Log Download action to see if it will pick up "rolled" logs that hav been gzipped
...
* Add `sourceApplicationId` to the Application API to create an app from an existing to copy settings
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1957[GitHub Issue #1957]
* Add default add/remove MFA email templates
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1993[GitHub Issue #1993]
...
* add more details to the edit registration form in the admin UI so you know which user you are editing
...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/437[GitHub Issue #437]
* add configuration support for TLS to FusionAuth when you don't want to use a reverse proxy
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1996[GitHub Issue #1996]
* support for `salted-pbkdf2-hmac-sha512-512` password algorithm
