...
////
- Google, Facebook, etc redirect Base64 encoding issues.
https://github.com/FusionAuth/fusionauth-issues/issues/553

- Other Base64 encoding issue
https://github.com/FusionAuth/fusionauth-issues/issues/548

- Make Forgot Password and Change Password more defensive on expired links, to take advantage you'll need to update your email templates, post examle changes and update email template doc to show default templates and what state is available.
   We could just copy paste the example templates we ship for reference.
https://github.com/FusionAuth/fusionauth-issues/issues/468
////
