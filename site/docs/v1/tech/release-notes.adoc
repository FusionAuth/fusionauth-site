...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/1649[GitHub Issue #1649]
...
=== New
* Additional Multi-Factor policy option to require a user to enable multi-factor during login if not yet configured. See `Tenants > Edit > MFA > Policies > On login > Required.`
