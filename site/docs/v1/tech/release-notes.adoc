...
=== Known Issues
* If you use a non default theme for the FusionAuth default tenant, you will see an error when trying to log in to the admin UI. You can workaround this by appending `?&bypassTheme=true` to your login URL. Tracking this in https://github.com/FusionAuth/fusionauth-issues/issues/1175[GitHub Issue #1175].
