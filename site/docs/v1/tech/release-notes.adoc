...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/2535[GitHub Issue #2535]
...
** Resolved in version `1.48.1` via https://github.com/FusionAuth/fusionauth-issues/issues/2535[GitHub Issue #2535]
...
* The minimum required version of Elasticsearch is version `7.6.1`. If you are using a version older than this, please plan to upgrade it to version `7.6.1` or later when upgrading FusionAuth. If you are using Elasticsearch `>= 7.6.1` or using OpenSearch v2, this will not affect you.
...
:warning_message: pass:normal[Please be sure to read the notes in the **Changed** section before upgrading.]
...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/2250[GitHub Issue #2250], thanks to https://github.com/MarekUniq[@MarekUniq] for his report, persistence and https://github.com/FusionAuth/java-http/pull/9[contribution] to https://github.com/FusionAuth/java-http[java-http]!
...
** Navigate to [breadcrumb]#Entity Management -> Entity Types -> Edit -> JWT#.
...
=== New
* Add a policy to require a user to provide their current password when changing a password on the self-service account pages. See [breadcrumb]#Applications -> Edit -> Registration -> Form settings -> Require current password#.
...
** See link:/docs/v1/tech/reference/password-hashes#phpass-md5[phpass MD5] and link:/docs/v1/tech/reference/password-hashes#phpass-md5[phpass SHA-512] for additional details.
...
:migration_message: pass:normal[{nbsp} + \
*Additional details* \
{nbsp} + \
...
** See link:/docs/v1/tech/reference/password-hashes#salted-pbkdf2-hmac-sha-512[Salted PBKDF2 HMAC SHA-512] for additional details.
