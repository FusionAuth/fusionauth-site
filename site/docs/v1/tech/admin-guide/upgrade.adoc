...
3. Redeploy FusionAuth but use the previous version you used instead of the new one. How you do this will depend on your deployment method. 
...
FusionAuth is available in a ZIP package for macOS, Linux, and Windows. If you are using the ZIP package, please use this guide to update an existing instance of FusionAuth. Find the ZIP packages at the FusionAuth https://fusionauth.io/download[Downloads] page.
