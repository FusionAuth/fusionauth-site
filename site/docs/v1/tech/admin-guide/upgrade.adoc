...
You'll need to verify if the new version has any new configuration options with defaults that affect your installation. This can be ascertained by reviewing the release notes.

There are a number of options for managing the configuration of your FusionAuth instance over time and promoting changes from one environment to another. This includes changes from from one version to another.
