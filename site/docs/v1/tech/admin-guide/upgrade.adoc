...
. FusionAuth can perform database migrations automatically and silently, interactively, or you can run any needed scripts yourself. With any method, you should perform a manual backup of your database before upgrading.
...
This is a good option for single instance development or QA systems, or for systems that can tolerate downtime.
