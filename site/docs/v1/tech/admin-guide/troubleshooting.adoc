...
FusionAuth lets you develop locally with a full featured auth system. To do so, link:/docs/v1/tech/installation-guide/[install FusionAuth using one of the options, such as homebrew or a .deb file].
