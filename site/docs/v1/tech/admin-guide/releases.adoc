...
Another use case is testing a migration from a released version to the EAP version to gain an understanding of release duration or functionality. To do so:
