...
Some use cases where an EAP instance may be helpful include testing a new install with existing configuration with the EAP version, using the following steps:
