...
It's really important to perform a proof of concept integration when you are considering a solution that is going to be a critical part of your application.

There are two paths for supporting such proof of concepts.

The first is self-directed. In this case, you don't interact with the sales team at all. You can use our link:/docs/v1/tech/[documentation] to get started, our community support options such as the link:/community/forum/[forums] for questions, and review our https://github.com/fusionauth/fusionauth-issues/issues[GitHub issues] for known issues. You're in total control.

The second is to engage with our technical sales team. In this scenario, there's support and engagement from a sales representative and a sales engineer who help answer your specific questions, and may escalate issues internally. They can set you up with the resources and answers you need to determine if FusionAuth is a fit for you. They'll also follow up with you to make sure you are making the progress you need.
