...
FusionAuth contains no custom tracing spans, but it can be set up as an OpenTelemetry exporter. This provides useful data about types of requests, database queries, and more.
