...
FusionAuth contains no custom spans, but it can be set up as an exporter. This can provider useful data about the types of requests, database queries, and more.
...
Set this environment variable and make sure it is available however you start FusionAuth (in a starup script, `.bashrc`, etc):
