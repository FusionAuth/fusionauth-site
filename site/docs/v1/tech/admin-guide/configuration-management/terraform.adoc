...
| create | always create and be able to manage all resources through Terraform | bigger initial effort
|===
...
You can't destroy the Default Tenant. In FusionAuth this can't be deleted. Attempting to do so will break your Terraform state. See <<Terraform Remove>> for more details.
====
...
* https://registry.terraform.io/providers/gpsinsight/fusionauth/latest/docs/resources/key[Terraform Key Resource]
...
* https://registry.terraform.io/providers/gpsinsight/fusionauth/latest/docs/resources/email[Terraform Email Resource]
...
After that you can go ahead with `terraform apply`.
