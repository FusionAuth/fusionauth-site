...
cd auth.example.com
----
For all the variables you are going to use, create a `variables.tf file with the following content to declare all https://developer.hashicorp.com/terraform/language/values/variables[Input Variables] used throughout the example.
