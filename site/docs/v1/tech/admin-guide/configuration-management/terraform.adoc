...
In this example you create an Application called forum with a custom Access Token Key in a newly created forum Tenant with related roles (admin and user):
...
* https://registry.terraform.io/providers/gpsinsight/fusionauth/latest/docs/resources/key[Terraform Key]
