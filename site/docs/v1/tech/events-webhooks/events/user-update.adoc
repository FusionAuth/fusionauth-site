...
This event is currently generated each time a user logs in via a federated IdP, such as Google, or OIDC -- even if the user data in the IdP has not changed.
