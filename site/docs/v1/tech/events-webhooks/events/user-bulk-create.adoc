...
This event is generated when multiple users are created via the link:/docs/v1/tech/apis/users#import-users[User Import API]. The JSON includes each of the Users that were created.
