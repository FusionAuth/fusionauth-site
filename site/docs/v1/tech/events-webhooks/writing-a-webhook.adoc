...
Here's an example of a Webhook written in Node using Express. In this example, if the event is a `user.delete` event, this code deletes all of the user's Todos. The example code is https://github.com/FusionAuth/fusionauth-example-javascript-webhooks/blob/main/simple/app.js[available on Github].
...
----
//...
include::https://raw.githubusercontent.com/FusionAuth/fusionauth-example-javascript-webhooks/main/simple/app.js[tags=simplewebhook]
//...
----
