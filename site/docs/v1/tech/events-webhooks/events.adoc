...
* <<Two-factor Method Add>> - when a user has added a two-factor method
* <<Two-factor Method Remove>> - when a user has removed a two-factor method
...
:type: pass:normal[audit.log.create]
include::docs/v1/tech/events-webhooks/_event-body-base.adoc[]
