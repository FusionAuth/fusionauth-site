...
description: User Registration Delete Complete event details
---
...
This event is generated when a user registration delete transaction has completed.
...
.Example Event JSON
----
include::docs/src/json/events/user-registration-delete-complete.json[]
----