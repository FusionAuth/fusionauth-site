...
include::../_tenant-or-application-scoped-event.adoc[]
...
include::_transactional-event.adoc[]
...
.Example Event JSON
----
include::../../../../src/json/events/jwt-refresh-token-revoke-user.json[]
----
...
.Example Event JSON
----
include::../../../../src/json/events/jwt-refresh-token-revoke-all-user.json[]
----
...
.Example Event JSON
----
include::../../../../src/json/events/jwt-refresh-token-revoke-application.json[]
----