...
description: User Registration Create Complete event details
---
...
This event is generated when a user registration has been completed.
...
.Example Event JSON
----
include::docs/src/json/events/user-registration-create-complete.json[]
----