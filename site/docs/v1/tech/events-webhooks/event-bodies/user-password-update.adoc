...
The user that has been updated. See the link:/docs/v1/tech/apis/users/[Users API] for property definitions and example JSON.

[source,json]
.Example Event JSON
----
include::../../../../src/json/events/user-password-update.json[]
----