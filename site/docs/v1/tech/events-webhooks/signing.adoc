...
Next, you configure your webhook to sign the event with this key. From [breadcrumb]#Settings -> Webhooks#, click on the Edit button for your webhook (or create a new webhook). Select the [breadcrumb]#Signature# tab panel. Once you enable webhook signatures, a select dropdown allows you to choose the generated key.
