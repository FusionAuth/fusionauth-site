...
* The following hidden fields were added and you will need to update your `[#macro oauthHiddenFields]` in the theme "Helpers" of existing Themes in order to use the Device Grant or `response_mode` in the Authorization grant:
...
** Resolves https://github.com/FusionAuth/fusionauth-issues/issues/332[GitHub Issue #322], thanks to https://github.com/davidmw[@davidmw] for the feedback!
