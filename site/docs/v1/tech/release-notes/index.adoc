...
* Support for the OAuth2 Implicit Grant. See the link:../oauth/[OAuth 2.0 & OpenID Connect Overview] and link:../oauth/endpoints[OAuth 2.0 Endpoints] for additional information.
...
* Full theme support for login. See the link:../themes/[Login Theme] tutorial for additional information and examples.
