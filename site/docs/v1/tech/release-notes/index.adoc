...
** This is a partial fix to work around not supporting the `claims` parameter ont he Authorize request. See https://github.com/FusionAuth/fusionauth-issues/issues/308[GitHub Issue #308] for additional information.
