...
.Guice Module
----
include::https://raw.githubusercontent.com/FusionAuth/fusionauth-example-password-encryptor/master/src/main/java/com/mycompany/fusionauth/plugins/guice/MyExampleFusionAuthPluginModule.java[]
----
