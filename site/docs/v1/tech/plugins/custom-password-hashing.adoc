...
.Guice Module
----
include::https://github.com/FusionAuth/fusionauth-example-password-encryptor/blob/master/src/main/java/com/mycompany/fusionauth/plugins/guice/MyExampleFusionAuthPBKDF2PluginModule.java[]
----
...
.Unit Test
----
include::https://github.com/FusionAuth/fusionauth-example-password-encryptor/blob/master/src/test/java/com/mycompany/fusionauth/plugins/ExamplePBDKF2HMACSHA1PasswordEncryptorTest.java[]
----
