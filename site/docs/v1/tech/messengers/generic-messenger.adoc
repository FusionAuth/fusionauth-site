...
Currently the only supported transport for a messenger is SMS. If you need to connect to an SMS provider other than Twilio, you can use the Generic messenger configuration.
