...
Simply click `Add Kafka Messenger`
...
You also have the ability to test your Kafka messenger configuration. By hitting `Send test message` FusionAuth will fire a test message to your Kafka topic just created to ensure everything is set up correctly.
