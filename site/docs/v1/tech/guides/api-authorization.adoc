...
Another option is to use link:/docs/v1/tech/apis/authentication#managing-api-keys[FusionAuth API keys].
...
* As of version 1.26, you can manage API keys using the link:/docs/v1/tech/apis/api-keys[API Key API], including creating and revoking the keys.
