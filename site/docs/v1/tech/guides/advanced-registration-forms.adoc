...
Emails are localized based on the user preferred language attributes.

Using advanced registration forms, you can set this attribute on registration. When that is done, FusionAuth will localize any initial emails, such as a password setup or email verification email.
