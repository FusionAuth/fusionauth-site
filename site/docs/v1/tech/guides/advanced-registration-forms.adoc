...
If your form is an admin user form, you'll modify the tenant settings. If, on the other hand, it is a admin registration form, you'll modify the application settings. In both cases, you can use either the UI or the API to update the tenant or application.

Here's how you'd change the form used to edit users. Navigate to [breadcrumb]#Tenants -> Form Settings#. Then chose your custom form  as the [field]#Admin user form#.

pic TBD

To change the admin registration form, navigate to [breadcrumb]#Tenants -> Form Settings#. Then chose your custom form  as the [field]#Admin user form#.
...
create form
add fields
associate with tenant or applciation
