...
image::guides/advanced-registration-forms/minimum-price-form-field.png[Adding the minimum price field.,width=1200]
...
image::guides/advanced-registration-forms/geographic-area-form-field.png[Adding the geographic area field.,width=1200]
...
image::guides/advanced-registration-forms/new-form.png[The blank form, ready to be assembled.,width=1200]
...
image::guides/advanced-registration-forms/first-step-no-placeholder.png[The first page of the custom registration flow.,width=1200]
...
image::guides/advanced-registration-forms/new-user-data-display.png[The user data tab of the newly registered user.,width=1200]
...
image::guides/advanced-registration-forms/update-theme-for-tenant.png[Select your new theme for the default tenant.,width=1200]
...
image::guides/advanced-registration-forms/first-step-with-placeholder.png[The first page of the registration form with the correct messages added.,width=1200]
...
image::guides/advanced-registration-forms/first-step-with-placeholder-and-labels.png[The first registration step with labels.,width=1200]
...
image::guides/advanced-registration-forms/flask-app-screen-shot.png[The user profile portal.,width=1200]
