...
If you need to perform more complex validation of the registration form, including making `fetch` calls to an external
api, you may do so by adding a
link:/docs/v1/tech/lambdas/self-service-registration[Self Service Registration Validation lambda].
