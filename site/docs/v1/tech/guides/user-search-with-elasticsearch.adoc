...
The exact list of indexed fields is not documented, but if you are running FusionAuth self-hosted, you can find the list by https://www.elastic.co/guide/en/elasticsearch/reference/6.3/indices-get-mapping.html[retrieving the Elasticsearch mapping].
