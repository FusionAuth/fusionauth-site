...
* Configure the OAuth redirect URL as you would with an application where users authenticate with a password (https://fusionauth.io/docs/v1/tech/oauth/[more on OAuth config here]).
...
update email templates with those from a fresh install
