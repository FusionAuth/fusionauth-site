...
The `state` parameter is optional. If present, it is provided to your application upon successful authentication. This allows anonymous users to interact with your application, then log in and have data from their anonymous session available. 
