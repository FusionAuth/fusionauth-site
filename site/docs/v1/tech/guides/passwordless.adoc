...
+
image::guides/passwordless/login-page-with-magic-link.png[The passwordless login magic link.,width=1200]
. Enter the user's email
+
image::guides/passwordless/passwordless-email-request-form.png[The passwordless email request form.,width=1200]
