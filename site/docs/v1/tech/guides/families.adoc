...
In this scenario, a child creates an account but doesn't have full access until a parent has approved the account.

Both parent and child must have accounts.

. The child creates an account including a 
