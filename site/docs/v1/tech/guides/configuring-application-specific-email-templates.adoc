...
Navigate to [breadcrumb]#Customizations -> Emails Templates# and click the blue edit icon for the [uielemen t]#Forgot Password# email template and copy the [field]#HTML Template# and [field]#Text Template# sections into a text file for easier editing.
