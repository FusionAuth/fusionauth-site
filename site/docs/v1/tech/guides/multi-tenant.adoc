...
image::guides/multi-tenant/slack-hostname-based-selection.png[The hostname approach used by Slack.,width=1200,role=bottom-cropped]

Here's an example of the user self-identification approach:

image::guides/multi-tenant/aws-user-code-based-selection.png[The user self-identification approach used by AWS.,width=1200,role=bottom-cropped]
