...
Invoke https://developer.mozilla.org/en-US/docs/Web/API/CredentialsContainer/create[navigator.credentials.create()] on the WebAuthn JavaScript API, passing the transformed FusionAuth API response as a parameter.
