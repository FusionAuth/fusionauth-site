...
If you are having issues with importing users, review the link:/docs/v1/tech/troubleshooting/#troubleshooting-user-import[relevant troubleshooting section].
