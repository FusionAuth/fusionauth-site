...
Migrating users with social logins such as Apple or Facebook requires that you have the existing social provider user identifier. What Id looks like depends on the particular social provider as well as the original system's storage format.
