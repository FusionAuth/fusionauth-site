...
Another option is to not import these users using the Import API at all. Instead, note that these users don't have a password and import them one by one using the link:/docs/v1/tech/apis/users/[User API], which can send emails. 
