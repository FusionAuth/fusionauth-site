...
Please see the link:/docs/v1/tech/email-templates/templates-replacement-variables#breached-password[email template documentation] for more information, including available variables.
