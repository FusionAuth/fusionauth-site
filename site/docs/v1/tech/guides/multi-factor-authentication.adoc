...
image::guides/multi-factor-authentication/single-mfa-method.png[The user experience with one MFA method enabled.,width=1200]
...
image::guides/multi-factor-authentication/multiple-mfa-methods.png[The user experience with more than one MFA method enabled.,width=1200]
