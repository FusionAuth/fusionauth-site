...
To check whether MFA is enabled, put a value in the JWT using a link:/docs/v1/tech/lambdas/jwt-populate[JWT Populate Lambda].
...
When your application receives the JWT, check this claim.
