...
image::guides/basic-registration-forms/registration-verification-settings.png[Registration Verification Settings,width=1200]
...
image::guides/basic-registration-forms/after-verification.png[New user listing,width=1200, role=bottom-cropped]
