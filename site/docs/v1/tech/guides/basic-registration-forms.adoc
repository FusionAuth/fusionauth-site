...
Often you will need to require users to verify their email address. Basic registration support this feature by sending them an email with a verification link. To configure this, see the link:/docs/v1/tech/guides/user-verification[this verification guide]
