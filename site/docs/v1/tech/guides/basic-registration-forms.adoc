...
Basic self-servide registration is a quick and simple way to get started. However, if your application requires custom data to be captured at registration, or other advanced capabilities, you can use advanced registration forms.
