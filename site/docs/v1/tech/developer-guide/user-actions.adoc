...
image::docs/tutorials/user-actions/user-actions-add-application.png[Add FusionAuth Application,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-create-user.png[Create User,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-create-api-key.png[Create API Key,width=1200px]
 
Record the value of your API Key.

image::docs/tutorials/user-actions/user-actions-api-key-created.png[API Key Created,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-email-templates.png[Email Templates,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-user-action-created.png[User Action Created,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-add-webhook.png[Add Webhook",width=1200px]
 
Scroll down and make sure that the [uielement]#user.action# event is enabled.
 
image::docs/tutorials/user-actions/user-actions-webhook-switch.png[Webhook event switch,width=1200px]
 
Then, select the [breadcrumb]#Tenants# tab and select your tenant. Alternatively, you can select [uielement]#All tenants#.
 
image::docs/tutorials/user-actions/user-actions-webhook-tenant.png[Enable tenant on webhook page,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-tenants-webhooks.png[Webhook enabled on tenants page,width=1200px]
 
Scroll down and make sure the [uielement]#user.action# event is enabled here too.
 
image::docs/tutorials/user-actions/user-actions-tenants-switch.png[Tenant event switch,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-email.png[Email confirmation,width=1200px]
...
image::docs/tutorials/user-actions/user-actions-webhook-site.png[Webhook confirmation,width=1200px]
