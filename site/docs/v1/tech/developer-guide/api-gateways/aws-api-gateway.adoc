...
Click `Create function` to create a new Lambda function. Name the function `privateFunction`, and leave all the other options as the defaults. Click `Create Function` at the bottom of the page.
