...
There's a lot more you can do with Amazon API Gateway 

You can configure scopes for a route, and check against them before allowing a user through. 
