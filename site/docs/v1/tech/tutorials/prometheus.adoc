...
If you prefer to allow unauthenticated access to this endpoint from local scrapers, you may set `fusionauth-app.local-metrics.enabled=true` as link:/docs/v1/tech/reference/configuration#[documented here].
