...
If you prefer to allow unauthenticated access to this endpoint from local scrapers, you may set `fusionauth-app.local-metrics.enabled=true`. See the  link:/docs/v1/tech/reference/configuration[configuration reference] for more info.
