=== Issue: the Links Emailed to Users Don't Function As Expected.

==== Background

Users cannot verify their application registration or verify their email -- the link or code does not work (expired or other error)
