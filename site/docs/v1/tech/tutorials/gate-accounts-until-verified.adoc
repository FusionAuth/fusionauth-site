...
* Update the [field]#Verification strategy#. This can be either `Clickable link` or `Form field`. The former sends an email with a link to verify the user's address. The latter emails a code; the user will provide this code to FusionAuth. For this tutorial, use `Clickable link`.
...
After you have registered but before you have verified the email by clicking the link, you'll be gated. 

In your browser where you registered, you'll see a page similar to below:
