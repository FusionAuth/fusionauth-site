...
[NOTE]
====
You can create a user with an unverified email address in other ways than self service registration, such as by using the API. But self service registration is the simplest way to create a user who does not have a verified email.
====
...
Visit the registration URL you copied above. You'll be prompted to register. Fill out the form with a valid email address. You'll receive an email prompting you to verify your email address. Below is the email in the mailcatcher interface:
...
After that, you'll be gated because you haven't verified your email address. In your browser where you registered, you'll be shown a page similar to this below:
...
Close your browser or open a different browser and visit the login URL you copied above. Enter the email and password for the user you just registered. You'll be sent to the same gated email verification page.
...
If you view the user in the administrative user interface, you'll see a `?` next to their email address. This indicates that their email has not yet been verified.
...
* Discover how to link:/docs/v1/tech/themes/[modify the theme] to make the email verification gating pages look more like your application.
