...
Be sure to supply a first and last name for your user in order for OIDC to work properly. 
...
Navigate back to the parent directory and execute `flask run` to run your app.
