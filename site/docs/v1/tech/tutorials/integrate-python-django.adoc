...
[source,xml,title="Your FusionAuth configuration requirements.txt"]
----
...
TBD pull over djanog from https://fusionauth.io/blog/2023/01/24/single-sign-on-django-fusionauth
