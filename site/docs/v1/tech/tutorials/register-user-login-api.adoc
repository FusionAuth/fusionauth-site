...
In order to register a User, you must have first created an Application.  A tutorial for creating an application is provided in the link:../core-concepts/applications[Application overview]. Once the Application has been created, you are ready to call the API to register a User.
