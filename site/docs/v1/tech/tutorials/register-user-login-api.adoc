...
Once you have created a User and registered them for an Application, you can authenticate them by calling the link:/docs/v1/tech/apis/login[Login API]. That will return a JWT and other User information as documented.
