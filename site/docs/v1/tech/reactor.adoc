...
* Create any `Entity` unique to your business. Maybe it's `laser-jet-01` type, or a `west-regional-division`.
...
- link:/docs/v1/tech/entity-management/[Entity Management Overview]
