...
[%hardbreaks]
_Enter Entities._ Entities allow you to model everything right from FusionAuth! They enable machine-to-machine communication via the Client Credentials OAuth2 grant.
