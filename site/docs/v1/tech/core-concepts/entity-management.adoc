...
[%hardbreaks]
_Enter Entities._ Entities allow you to model everything right from FusionAuth! They enable machine-to-machine communication via a accepted standard (specifically, the client credentials grant, in this case)
