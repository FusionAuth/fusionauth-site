...
It is not currently possible to utilize an OAuth2 grant to retrieve user permissions to an entity.  A workaround is listed in the following link:https://github.com/FusionAuth/fusionauth-issues/issues/1295/[active issue].