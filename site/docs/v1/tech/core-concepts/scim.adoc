...
- You will need an Entity defined for each SCIM client and SCIM Server. link:/docs/v1/tech/core-concepts/entity-management#scim-integration[Default entity types] are provided for you. You only need to create the entities from those default types.
