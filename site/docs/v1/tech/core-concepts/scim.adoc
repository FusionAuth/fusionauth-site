...
.Suggested mapping between SCIM User schema and FusionAuth User
[cols="1,1"]
|===
...
|`externalId`
|`User.data.<Client Id>.externalId`
...
|`User.data.<Client Id>.honorificPrefix`

|`name.honorifixSuffix`
|`User.data.<Client Id>.honorificSuffix`
