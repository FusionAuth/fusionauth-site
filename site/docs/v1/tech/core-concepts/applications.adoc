...
* Required when client authentication is not provided - Requires the use of the `code_verifier` parameter unless a valid `client_secret` parameter is used.
