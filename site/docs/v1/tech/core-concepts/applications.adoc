...
Enable to required the SAML v2 Service Provider to sign the SAML v2 authentication request. When enabled, if a signature is omitted, the request will be rejected.
