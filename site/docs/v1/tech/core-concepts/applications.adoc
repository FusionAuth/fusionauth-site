...
If set, a user will have to provide their current password when changing their password on the self-service
account form. Note that a User self-service form must be selected for this setting to have any effect.
