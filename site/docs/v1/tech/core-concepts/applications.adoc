...
The lambda that will be used to perform additional validation on registration form steps.
See link:/docs/v1/tech/lambdas/self-service-registration[Self Service Registration Validation lambda]
