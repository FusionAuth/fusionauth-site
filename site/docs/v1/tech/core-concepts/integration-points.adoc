...
The proper JWT storage choice should be based on your threat modelling. You can configure your JWTs to be short lived, which minimizes the amount of time a stolen JWT can be used.
