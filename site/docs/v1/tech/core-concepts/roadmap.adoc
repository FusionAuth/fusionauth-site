...
We will clearly mark these features as requiring a paid license in the documentation. You can learn more about link:/docs/v1/tech/core-concepts/editions-features[these features here].
