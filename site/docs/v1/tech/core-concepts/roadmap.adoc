...
Releases will be documented in the link:/docs/v1/tech/release-notes/[release notes]. Additionally, there will be link:/community/forum/category/5/release[an announcement post] made in the forum.
