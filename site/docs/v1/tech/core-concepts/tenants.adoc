...
image::tenant-configuration-mfa-authenticator-settings.png[Tenant Configuration - MFA authenticator settings,width=1200,bottom-cropped top-cropped]
+
include::docs/v1/tech/shared/_premium-edition-blurb.adoc[]
...
image::tenant-configuration-mfa-email-settings.png[Tenant Configuration - MFA email settings,width=1200,bottom-cropped top-cropped]
...
image::tenant-configuration-mfa-sms-settings.png[Tenant Configuration - MFA SMS settings,width=1200,bottom-cropped top-cropped]
