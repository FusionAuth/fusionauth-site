...
image::core-concepts/tenant-configuration-list.png[List of Tenants,width=1200,role=shadowed]
...
image::create-tenant.png[Create a Tenant,width=1200,role=bottom-cropped]
