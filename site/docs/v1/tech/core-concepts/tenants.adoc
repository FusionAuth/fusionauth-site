...
image::tenant-configuration-mfa-authenticator-settings.png[Tenant Configuration - MFA authenticator settings,width=1200,role=shadowed top-cropped]

===== Authenticator settings

[.api]
[field]#Enabled# [optional]#Optional#::
When enabled, users may use an authenticator application to complete a two-factor authentication request.

image::tenant-configuration-mfa-email-settings.png[Tenant Configuration - MFA email settings,width=1200,role=shadowed top-cropped]

===== Email settings

[.api]
[field]#Enabled# [optional]#Optional#::
When enabled, users may use an email address to complete a two-factor authentication request.

[field]#Template# [required]#Required#::
The email template to use when a two-factor authentication request is sent to the User's email address.
+
Required when the [field]#Enabled# toggle is enabled.

image::tenant-configuration-mfa-sms-settings.png[Tenant Configuration - MFA SMS settings,width=1200,role=shadowed top-cropped]

===== SMS settings

[.api]
[field]#Enabled# [optional]#Optional#::
When enabled, users may use a mobile phone number to complete a two-factor authentication request.

[field]#Messenger# [required]#Required#::
The Messenger used to deliver the template.

[field]#Template# [required]#Required#::
The SMS template to use when a two-factor authentication request is sent to the User's mobile phone number.
+
Required when the [field]#Enabled# toggle is enabled.
