...
If you set the user's preferred language, FusionAuth's administrative user interface will localized. There are no translations of the FusionAuth administration user interface, however. 
