...
The current actions tab allows you to view the current User Actions.
...
The action that is currently active.
...
The history tab allows you to view expired User Actions for a user. Comments are also displayed here.
...
[field]#Actioning user# [required]#Required#::
The user who executed this action.

[field]#Actioning user id# [required]#Required#::
The Id of the user who executed this action.
