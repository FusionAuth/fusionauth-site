...
image::core-concepts/user-search-extended-a.png[User Search with over 10000 results,width=1200,role=bottom-cropped]
...
image::core-concepts/user-search-extended-b.png[User Search with over 10000 results,width=1200,role=bottom-cropped]

You may continue to page forward using [uielement]#Next# until you reach the last of the search results.

image::core-concepts/user-search-extended-c.png[User Search with over 10000 results,width=1200,role=bottom-cropped]
