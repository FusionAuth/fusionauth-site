...
There are two primary types sessions shown in this table:
...
[NOTE.note]
====
Sessions are not ended, nor are associated refresh tokens revoked by the link:/docs/v1/tech/oauth/endpoints/#logout[front channel logout].
====
