...
[source,javascript,title=The Complete OAuth Code Exchange Function]
----
//...
include::https://raw.githubusercontent.com/FusionAuth/fusionauth-example-5-minute-guide/master/routes/index.js[tags=fullOAuthCodeExchange]
//...
----
...
There are other options for storing this user object, but for this tutorial, this will work fine. If you want to learn more, such as other patterns for storing the token, please check out link:/learn/expert-advice/authentication/login-authentication-workflows[these articles about login workflows].
