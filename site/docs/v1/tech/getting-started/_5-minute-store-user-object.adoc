...
Once you have the User object, it is stored in a server side session so that it can be used in other parts of the application. This includes a view where it is used to greet the user. (There are other options for storing this user object, but for this tutorial, this will work fine.)
