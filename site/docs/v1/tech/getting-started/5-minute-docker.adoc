...
You've chosen to install FusionAuth via Docker.

This is the best option if you have Docker set up or you plan to run FusionAuth in a Docker compatible environment such as Kubernetes and want to learn more about how FusionAuth runs in Docker.
...
Here are the steps that we need to take to set up FusionAuth to provide login, logout and registration for your application:
