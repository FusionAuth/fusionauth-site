...
The Id of an existing link:/docs/v1/tech/apis/keys[Key]. The X.509 certificate is used for client certificate authentication in requests to the Messenger.
