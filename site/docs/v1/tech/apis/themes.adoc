...
This API is used to create a new Theme from an existing Theme.
...
The Id of an existing Theme to make a copy of.
+
If present, the [field]#defaultMessages#, [field]#localizedMessages#, [field]#templates#, and [field]#stylesheet# from the source Theme will be copied to the new Theme. All other fields not listed here may be provided on this request, such as [field]#theme.name#.  The [field]#theme.name# is required.
