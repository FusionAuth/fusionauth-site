...
|242
|The user was authenticated successfully. Either the user has two factor authentication enabled or two factor authentication is required. The response will contain the `twoFactorId` to be used
