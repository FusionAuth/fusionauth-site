...
|212
|The user's email address has not yet been verified. The response will contain the User object that was authenticated. If the `emailConfiguration.verificationStrategy` has been set to `FormField`, the response will contain the [field]#emailVerificationId# that was generated for the user.

|213
|The user's registration has not yet been verified. The response will contain the User object that was authenticated. If the `emailConfiguration.verificationStrategy` has been set to `FormField`, the response will contain the [field]#registrationVerificationId# that was generated for the user.
