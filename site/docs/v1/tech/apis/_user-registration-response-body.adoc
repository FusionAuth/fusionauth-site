...
The refresh token can be used to obtain a new access token once the provided one has expired.
endif::[]
...
+
See the link:/docs/v1/tech/apis/identity-providers/links/[Link APIs] for how to retrieve Identity Provider tokens.
[deprecated]#Removed in version 1.28.0#
