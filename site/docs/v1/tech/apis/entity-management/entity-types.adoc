...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Create a Permission with a randomly generated Id
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/entity/type/`\{entityTypeId\}`/permission#
--
...
.URI
--
[method]#POST# [uri]#/api/entity/type/`\{entityTypeId\}`/permission/`\{permissionId\}`#
--
...
.URI
--
[method]#PUT# [uri]#/api/entity/type/``\{entityTypeId\}``/permission/``\{permissionId\}``#
--

:api_endpoint: pass:normal[/api/entity/type/``\{entityTypeId\}``/permission/``\{permissionId\}``]
include::docs/v1/tech/apis/_patch-support.adoc[]
...
.URI
--
[method]#DELETE# [uri]#/api/entity/type/``\{entityTypeId\}``/permission/``\{permissionId\}``#
--
...
.URI
--
[method]#DELETE# [uri]#/api/entity/type/``\{entityTypeId\}``/permission``?name={name\}``#
--
