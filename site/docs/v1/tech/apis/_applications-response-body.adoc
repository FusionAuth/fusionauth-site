...
[field]#applications``[x]``.active# [type]#[Boolean]# [deprecated]#Deprecated#::
Whether or not the Application is active.
+
...
[field]#application``[x]``.insertInstant# [type]#[Long]# [since]#Available since 1.18.0#::
The link:/docs/v1/tech/reference/data-types/#instants[instant] that the Application was added to the FusionAuth database.

[field]#applications``[x]``.jwtConfiguration.accessTokenKeyId# [type]#[UUID]# [since]#Available since 1.6.0#::
...
[field]#application``[x]``.lastUpdateInstant# [type]#[Long]# [since]#Available since 1.18.0#::
...
[field]#applications``[x]``.oauthConfiguration.debug# [type]#[Boolean]# [since]#Available since 1.25.0#::
...
[field]#application``[x]``.registrationConfiguration.formId# [type]#[UUID]# [since]#Available since 1.18.0#::
...
[field]#application``[x]``.registrationConfiguration.type# [type]#[String]# [since]#Available since 1.18.0#::
...
[field]#applications``[x]``.samlv2Configuration.audience# [type]#[String]# [since]#Available since 1.6.0#::
...
[field]#applications``[x]``.samlv2Configuration.authorizedRedirectURLs# [type]#[Array<String>]# [since]#Available since 1.20.0#::
...
[field]#applications``[x]``.samlv2Configuration.callbackURL# [type]#[String]# [since]#Available since 1.6.0# [deprecated]#Deprecated#::
...
[field]#applications``[x]``.samlv2Configuration.debug# [type]#[Boolean]# [since]#Available since 1.6.0#::
Whether or not FusionAuth will log SAML debug messages to the event log. This is useful for debugging purposes.

[field]#applications``[x]``.samlv2Configuration.defaultVerificationKeyId# [type]#[UUID]#  [since]#Available since 1.20.0#::
...
[field]#applications``[x]``.samlv2Configuration.enabled# [type]#[Boolean]# [since]#Available since 1.6.0#::
Whether or not the SAML IdP for this Application is enabled or not.

[field]#applications``[x]``.samlv2Configuration.issuer# [type]#[String]# [since]#Available since 1.6.0#::
...
[field]#applications``[x]``.samlv2Configuration.keyId# [type]#[UUID]# [since]#Available since 1.6.0#::
The unique Id of the Key used to sign the SAML response.

[field]#applications``[x]``.samlv2Configuration.logoutURL# [type]#[String]# [since]#Available since 1.6.0#::
The URL that the browser is taken to after the user logs out of the SAML service provider.

[field]#applications``[x]``.samlv2Configuration.requireSignedRequests# [type]#[Boolean]#  [since]#Available since 1.20.0#::
When this value is `true` all requests missing a signature will be rejected.

[field]#applications``[x]``.samlv2Configuration.xmlSignatureC14nMethod# [type]#[String]# [since]#Available since 1.6.0#::
...
[field]#applications``[x]``.samlv2Configuration.xmlSignatureLocation# [type]#[String]# [since]#Available since 1.21.0#::
...
[field]#applications``[x]```.state# [type]#[String]# [since]#Available since 1.22.0#::
