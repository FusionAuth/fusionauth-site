...
[field]#application.registrationConfiguration.type# [type]#[String]# [optional]#Optional# [since]#Available since 1.18.0#::
The type of registration flow.
+
Supported values include:
+
* `basic`
* `advanced` - When using this type `formId` must be included.
