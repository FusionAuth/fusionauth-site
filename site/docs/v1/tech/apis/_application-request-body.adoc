...
+
ifdef::source_application_id_create_request[]
If present, the only two definable fields are [field]#id# and [field]#name#. All other fields are copied from the source Application.
endif::[]
ifdef::source_application_id_update_request[]
