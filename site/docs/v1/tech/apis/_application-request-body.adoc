...
+
If [field]#{base_field_name}.jwtConfiguration.refreshTokenExpirationPolicy# is set to `SlidingWindowWithMaximumLifetime`, value must be greater than or equal to the Refresh Token duration.
