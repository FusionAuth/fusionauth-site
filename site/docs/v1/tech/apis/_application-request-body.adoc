...
[field]#application.externalIdentifierConfiguration.twoFactorTrustIdTimeToLiveInSeconds# [type]#[Integer]# [optional]#Optional#  [since]#Available since 1.37.0#::
...
+
When this value is not defined, the value defined by [field]#tenant.externalIdentifierConfiguration.twoFactorTrustIdTimeToLiveInSeconds# is utilized. When this value is defined it will override the tenant configured value.
+
This configuration is only utilized when [field]#application.multiFactorConfiguration.loginPolicy# is enabled.

[field]#application.formConfiguration.selfServiceFormConfiguration.requireCurrentPasswordOnPasswordChange# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `false`# [since]#Available since 1.45.0#::
...
[field]#{base_field_name}.jwtConfiguration.refreshTokenExpirationPolicy# [type]#[String]# [optional]#Optional# [default]#defaults to `Fixed`# [since]#Available since 1.17.0#::
...
[field]#{base_field_name}.jwtConfiguration.refreshTokenSlidingWindowConfiguration.maximumTimeToLiveInMinutes# [type]#[Integer]# [optional]#Optional# [default]#defaults to `43,200`# [since]#Available since 1.46.0#::
...
[field]#application.lambdaConfiguration.selfServiceRegistrationValidationId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.43.0#::
...
[field]#application.multiFactorConfiguration.loginPolicy# [type]#[String]# [optional]#Optional# [since]#Available since 1.37.0#::
...
+
When configured, this value overrides the value configured by the [field]#tenant.multiFactorConfiguration.loginPolicy#.
+
...
[field]#application.multiFactorConfiguration.trustPolicy# [type]#[String]# [optional]#Optional# [default]#Defaults to `Any`# [since]#Available since 1.37.0#::
When [field]#application.multiFactorConfiguration.loginPolicy# is set to `Enabled`, this trust policy is utilized when determining if a user must complete a two-factor challenge during login.
+
For example, a normal two-factor login flow will result in a trust Id being returned if you set [field]#trustComputer# equal to `true` when completing a Two Factor Login. The returned Trust identifier can be used on subsequent Login requests to keep from being required to complete a Two-Factor login. This configuration determines if that trust value can be utilized for another application.
+
Supported values include:
+
...
+
:validation_policy_field_name: application.oauthConfiguration.authorizedURLValidationPolicy
:validation_policy_wildcard: pass:quotes[`AllowWildcards`]
include::../shared/_oauth-wildcard-usage.adoc[]
...
[field]#application.oauthConfiguration.authorizedURLValidationPolicy# [type]#String# [optional]#Optional# [default]#Defaults to `ExactMatch`# [since]#Available since 1.43.0#::
Controls the validation policy for [field]#application.oauthConfiguration.authorizedOriginURLs# and [field]#application.oauthConfiguration.authorizedRedirectURLs#.
+
The possible values are:
+
...
[field]#application.samlv2Configuration.assertionEncryptionConfiguration.digestAlgorithm# [type]#[String]# [optional]#Optional# [default]#Defaults to `SHA256`# [since]#Available since 1.47.0#::
...
[field]#application.samlv2Configuration.assertionEncryptionConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `false`# [since]#Available since 1.47.0#::
Determines if SAML assertion encryption is enabled for this Application.

[field]#application.samlv2Configuration.assertionEncryptionConfiguration.encryptionAlgorithm# [type]#[String]# [optional]#Optional# [default]#Defaults to `AES256GCM`# [since]#Available since 1.47.0#::
...
[field]#application.samlv2Configuration.assertionEncryptionConfiguration.keyLocation# [type]#[String]# [optional]#Optional# [default]#Defaults to `Child`# [since]#Available since 1.47.0#::
...
[field]#application.samlv2Configuration.assertionEncryptionConfiguration.keyTransportAlgorithm# [type]#[String]# [optional]#Optional# [default]#Defaults to `RSA_OAEP`# [since]#Available since 1.47.0#::
 ...
 * `RSA_OAEP` - RSA encryption with Optimal Asymmetric Encryption Padding using the mask generation function and hash specified by [field]#application.samlv2Configuration.assertionEncryptionConfiguration.maskGenerationFunction#
...
[field]#application.samlv2Configuration.assertionEncryptionConfiguration.keyTransportEncryptionKeyId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.47.0#::
...
+
This parameter is required when [field]#application.samlv2Configuration.assertionEncryptionConfiguration.enabled# is set to `true`.

[field]#application.samlv2Configuration.assertionEncryptionConfiguration.maskGenerationFunction# [type]#[String]# [optional]#Optional# [default]#Defaults to `MGF1_SHA1`# [since]#Available since 1.47.0#::
...
+
This value is only used when the [field]#application.samlv2Configuration.assertionEncryptionConfiguration.keyTransportAlgorithm# is set to `RSA_OAEP`. `RSAv15` does not require a message digest function, and `RSA_OAEP_MGF1P` will always use `MGF1_SHA1` regardless of this value.
...
[field]#application.samlv2Configuration.initiatedLogin.enabled# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `false`# [since]#Available since 1.41.0#::
Determines if SAML v2 IdP initiated login is enabled for this application. See [field]#application.samlv2Configuration.authorizedRedirectURLs# for information on which destination URLs are allowed.

[field]#application.samlv2Configuration.initiatedLogin.nameIdFormat# [type]#[String]# [optional]#Optional# [default]#Defaults to `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent`# [since]#Available since 1.41.0#::
...
[field]#application.samlv2Configuration.loginHintConfiguration.enabled# [type]#[Boolean]# [since]#Available since 1.47.0#::
When enabled, FusionAuth will accept a username or email address as a login hint on a custom HTTP request parameter.

[field]#application.samlv2Configuration.loginHintConfiguration.parameterName# [type]#[String]# [optional]#Optional# [default]#Defaults to `login_hint`# [since]#Available since 1.47.0#::
...
[field]#application.webAuthnConfiguration.bootstrapWorkflow.enabled# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `false`# [since]#Available since 1.41.0#::
Whether the WebAuthn bootstrap workflow is enabled for this application. This overrides the tenant configuration. Has no effect if [field]#application.webAuthnConfiguration.enabled# is `false`.
+
...
[field]#application.webAuthnConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `false`# [since]#Available since 1.41.0#::
...
[field]#application.webAuthnConfiguration.reauthenticationWorkflow.enabled# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `false`# [since]#Available since 1.41.0#::
Whether the WebAuthn reauthentication workflow is enabled for this application. This overrides the tenant configuration. Has no effect if [field]#application.webAuthnConfiguration.enabled# is `false`.
+
:advanced_feature: WebAuthn
include::../shared/_advanced-edition-blurb-api.adoc[]
+
