...
[field]#application.oauthConfiguration.requireClientAuthentication# [type]#[Boolean]# [optional]#Optional# [default]#Defaults to `true`# [since]#Available since 1.3.0# [deprecated]#Deprecated#::
