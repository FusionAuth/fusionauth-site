...
Determines if the `preferredLanguages` field will be included on the registration form. The default control will display all available link:/docs/v1/tech/reference/data-types#locales[locales].
