...
[field]#application.emailConfiguration.emailVerificationEmailTemplateId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.19.0#::
...
[field]#application.emailConfiguration.forgotPasswordEmailTemplateId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.19.0#::
...
[field]#application.emailConfiguration.passwordlessEmailTemplateId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.19.0#::
...
[field]#application.emailConfiguration.setPasswordEmailTemplateId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.19.0#::
