...
[field]#application.samlv2Configuration.loginHintParameter# [type]#[String]# [optional]#Optional# [since]#Available since 1.47.0#::
The name of the login hint paramter provided by the service provider on an AuthnRequest. If this parameter is present, its value will be used to pre-populate the username field on the FusionAuth login form.
