...
[field]#application.samlv2Configuration.logout.keyId# [type]#[UUID]# [optional]#Optional# [default]#Defaults to the key defined by `application.samlv2Configuration.keyId`# [since]#Available since 1.25.0#::
...
Whether or not the Single Logout for this SAML IdP is enabled.

[field]#application.samlv2Configuration.logout.singleLogout.keyId# [type]#[UUID]# [optional]#Optional# [default]#Defaults to the key defined by `application.samlv2Configuration.keyId`# [since]#Available since 1.25.0#::
The unique Id of the Key used to sign the SAML Single Logout response. 

[field]#application.samlv2Configuration.logout.singleLogout.url# [type]#[UUID]# [optional]#Optional# [default]#Defaults to the key defined by `application.samlv2Configuration.keyId`# [since]#Available since 1.25.0#::
...
+
include::_xmlSignatureC14nMethod-values.adoc[]
