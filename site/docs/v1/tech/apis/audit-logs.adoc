...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Create an Audit Log
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve an Audit Log by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Searches the Audit Logs using the given search criteria
[.endpoint]
.URI
--
...
The string to search in the Audit Log message for. This can contain wildcards using the asterisk character (`*`). If no wildcards are present, this parameter value will be interpreted as `pass:[*value*]`.

[field]#newValue# [type]#[String]# [optional]#Optional# [since]#Available since 1.30.0#::
The string to search for in the Audit Log field for [field]#newValue#. Note, that not all audit log entries will contain this field, it is primarily used for Audit Logs for updates to existing objects.

[field]#numberOfResults# [type]#[Integer]# [optional]#Optional# [default]#defaults to `25`#::
The number of results to return from the search.

[field]#oldValue# [type]#[String]# [optional]#Optional# [since]#Available since 1.30.0#::
The string to search for in the Audit Log field for [field]#oldValue#. Note, that not all audit log entries will contain this field, it is primarily used for Audit Logs for updates to existing objects.
...
+
 * `insertInstant` - the link:/docs/v1/tech/reference/data-types#instants[instant] when the Audit Log was created
...
[field]#reason# [type]#[String]# [optional]#Optional# [since]#Available since 1.30.0#::
The string to search for in the Audit Log field for [field]#reason#. Note, that not all audit log entries will contain this field.
...
The string to search in the Audit Log user for. This can contain wildcards using the asterisk character (`*`). If no wildcards are present, this parameter value will be interpreted as `pass:[*value*]`.
...
[field]#search.newValue# [type]#[String]# [optional]#Optional# [since]#Available since 1.30.0#::
The string to search for in the Audit Log field for [field]#newValue#. Note, that not all audit log entries will contain this field, it is primarily used for Audit Logs for updates to existing objects.

[field]#search.numberOfResults# [type]#[Integer]# [optional]#Optional# [default]#defaults to `25`#::
The number of results to return from the search.

[field]#search.oldValue# [type]#[String]# [optional]#Optional# [since]#Available since 1.30.0#::
The string to search for in the Audit Log field for [field]#oldValue#. Note, that not all audit log entries will contain this field, it is primarily used for Audit Logs for updates to existing objects.
...
[field]#search.reason# [type]#[String]# [optional]#Optional# [since]#Available since 1.30.0#::
The string to search for in the Audit Log field for [field]#reason#. Note, that not all audit log entries will contain this field.
...
The total number of Audit Logs matching the search criteria. Use this value along with the [field]#numberOfResults# and [field]#startRow# in the Search request to perform pagination.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Export the Audit Logs matching the criteria
[.endpoint]
.URI
--
