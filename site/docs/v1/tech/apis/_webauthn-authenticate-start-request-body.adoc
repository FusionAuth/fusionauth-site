...
The WebAuthn workflow for the current authentication ceremony. The value changes the options returned by this API for the WebAuthn client API call based on the tenant configuration. The possible values are:
+
