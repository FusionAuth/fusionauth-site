...
The WebAuthn workflow for the current authentication ceremony. The value changes the options returned by this API for the https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API[WebAuthn client API] call based on the tenant configuration. The possible values are:
+
