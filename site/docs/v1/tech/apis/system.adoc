...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve the System Configuration
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Update the System Configuration
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Export the System Logs
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Return the system status without an API key
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:lock[type=fas]] Return the system status with an API key
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/status#
