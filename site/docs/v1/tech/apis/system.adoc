...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#basic-authentication[icon:shield[type=fas]] Retrieve FusionAuth application metrics to use with Prometheus.
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/prometheus/metrics#
...
=== Authentication
As of version 1.27.0 this endpoint can be authenticated with an API key or `basic auth`. Please refer to the link:/docs/v1/tech/apis/authentication#basic-authentication-with-api-key[Authentication] document for more details about how to use `basic auth`.
