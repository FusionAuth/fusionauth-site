...
[NOTE]
====
FusionAuth also supports a system status check using Prometheus.  See Prometheus documentation here.
====
...
=== Response
The JSON response from the Status API is complex and subject to change excepting the `version` key.
