...
[field]#tenant.externalIdentifierConfiguration.emailVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [required]#Required# [since]#Available since 1.27.0#::
+
:generator_type: emailVerificationIdGenerator
...
[field]#tenant.externalIdentifierConfiguration.emailVerificationOneTimeCodeGenerator.type# [type]#[String]# [required]#Required# [since]#Available since 1.27.0#::
+
:generator_display_name: email verification one time code
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [required]#Required# [since]#Available since 1.27.0#::
+
:generator_type: registrationVerificationIdGenerator
...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.type# [type]#[String]# [required]#Required# [since]#Available since 1.27.0#::
+
:generator_display_name: registration verification one time code
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
...
[field]#tenant.externalIdentifierConfiguration.twoFactorOneTimeCodeIdGenerator.length# [type]#[Integer]# [required]#Required# [since]#Available since 1.8.0#::
+
...
[field]#tenant.externalIdentifierConfiguration.twoFactorOneTimeCodeIdGenerator.type# [type]#[String]# [required]#Required# [since]#Available since 1.8.0#::
+
...
The maximum number of digits to use when building a unique suffix for a username. A number will be randomly selected and will be 1 or more digits up to this configured value in length. For example, if this value is `5`, the suffix will be a number between `00001` and `99999`, inclusive and left padded with zeros. The value of this field must be greater than or equal to `3` and less than or equal to `10`.
