...
[field]#tenant.captchaConfiguration.captchaMethod# [type]#[String]# [required]#Required# [since]#Available since 1.30.0#::
The type of captcha method to use. The possible values are:
+
* `GoogleRecaptchaV2` - use Google Recaptcha v2
* `GoogleRecaptchaV3` - use Google Recaptcha v3
* `HCaptcha` - use HCaptcha
* `HCaptchaEnterprise` - use HCaptcha Enterprise
...
[field]#tenant.captchaConfiguration.secretKey# [type]#[String]# [required]#Required# [since]#Available since 1.30.0#::
The secret key for this captcha method.

[field]#tenant.captchaConfiguration.siteKey# [type]#[String]# [required]#Required# [since]#Available since 1.30.0#::
...
The threshold which separates passing from failing the Google v3 or HCaptcha Enterprise score. If not using either of those methods then this value is ignored. The value must be between `0.0` and `1.0`.
