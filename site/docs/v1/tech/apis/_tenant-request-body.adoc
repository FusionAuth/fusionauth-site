...
When renewing a Refresh Token in a Sliding Window, the maximum lifetime of a Refresh Token. When this value is reached, the Refresh Token is expired, regardless if a sliding window configuration is used. Value must be greater than 0.
+
