...
+
:premium_feature: captcha
include::../shared/_premium-edition-blurb-api.adoc[]
// You must keep the empty line above the `+` and you cannot undefine :premium_feature!: here it breaks the formatting.
...
[field]#tenant.emailConfiguration.defaultFromEmail# [type]#[String]# [optional]#Optional# [default]#defaults to `change-me@fusionauth.io`# [since]#Available since 1.16.0#::
...
[field]#tenant.emailConfiguration.unverified.allowEmailChangeWhenGated# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.27.0#::
...
[field]#tenant.emailConfiguration.unverified.behavior# [type]#[String]# [optional]#Optional# [default]#defaults to `Allow`# [since]#Available since 1.27.0#::
...
[field]#tenant.emailConfiguration.verificationStrategy# [type]#[String]# [optional]#Optional# [since]#Available since 1.27.0#::
...
* `FormField` - send the user a short code intended to be manually entered into a form field. This is only available when [field]#tenant.emailConfiguration.unverified.behavior# has the `Gated` value.
