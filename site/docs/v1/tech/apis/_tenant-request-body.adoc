...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationIdGenerator.length# [type]#[Integer]# [required]#Required# [default]#6# [since]#Available since 1.8.0#::
+
...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [required]#Required# [default]#6# [since]#Available since 1.27.0#::
+
:generator_type: registrationVerificationIdGenerator
