...
:premium_feature: WebAuthn
include::../shared/_premium-edition-blurb-api.adoc[]
// You must keep the empty line above the `+` and you cannot undefine :premium_feature!: here it breaks the formatting because of the list.
...
[field]#tenant.webAuthnConfiguration.relyingPartyId# [type]#[String]# [optional]#Optional# [default]#defaults to `null`# [since]#Available since 1.41.0#::
...
+
The default value is `null`, which behaves the same as using your fully qualified domain name.
+
:premium_feature: WebAuthn
include::../shared/_premium-edition-blurb-api.adoc[]
+
...
[field]#tenant.webAuthnConfiguration.relyingPartyName# [type]#[String]# [optional]#Optional# [default]#defaults to `null`# [since]#Available since 1.41.0#::
...
+
The default value is `null`. If no value is configured, the [field]#tenant.issuer# value will be used.
+
:premium_feature: WebAuthn
include::../shared/_premium-edition-blurb-api.adoc[]
+
