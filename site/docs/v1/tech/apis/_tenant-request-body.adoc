...
[field]#tenant.eventConfiguration.events``[type]``.transactionType# [type]#[String]# [optional]#Optional# [default]#defaults to `None`# [since]#Available since 1.8.0#::
...
[field]#tenant.externalIdentifierConfiguration.trustTokenTimeToLiveInSeconds# [type]#[Integer]# [optional]#Optional# [default]#defaults to `180`# [since]#Available since 1.33.0#::
...
[field]#tenant.externalIdentifierConfiguration.webAuthnAuthenticationChallengeTimeToLiveInSeconds# [type]#[Integer]# [optional]#Optional# [default]#defaults to `180`# [since]#Available since 1.41.0#::
...
include::../shared/_advanced-edition-blurb-api.adoc[]
+
:advanced_feature!:

[field]#tenant.externalIdentifierConfiguration.webAuthnRegistrationChallengeTimeToLiveInSeconds# [type]#[Integer]# [optional]#Optional# [default]#defaults to `180`# [since]#Available since 1.41.0#::
...
[field]#tenant.failedAuthenticationConfiguration.actionCancelPolicy.onPasswordReset# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.42.0#::
...
[field]#tenant.failedAuthenticationConfiguration.emailUser# [type]#[String]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.42.0#::
Indicates you would like to email the user when the user's account is locked due to this action being taken. This requires the User Action specified by the [field]#tenant.failedAuthenticationConfiguration.userActionId# to also be configured for email. If the User Action is not configured to be able to email the user, this configuration will be ignored. See [field]#userEmailingEnabled# on the User Action.
+
...
[field]#tenant.jwtConfiguration.refreshTokenExpirationPolicy# [type]#[String]# [optional]#Optional# [default]#defaults to `Fixed`#::
...
* `SlidingWindowWithMaximumLifetime` - the expiration is calculated in the same manner as `SlidingWindow`, however, the token will eventually expire once the maximum lifetime is reached.
...
[field]#tenant.jwtConfiguration.refreshTokenRevocationPolicy.onMultiFactorEnable# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.42.0#::
...
[field]#tenant.jwtConfiguration.refreshTokenSlidingWindowConfiguration.maximumTimeToLiveInMinutes# [type]#[Integer]# [optional]#Optional# [default]#defaults to `43,200`# [since]#Available since 1.46.0#::
The absolute maximum lifetime of a Refresh Token, when renewing a Refresh Token in a Sliding Window. When this value is reached, the Refresh Token is expired, regardless if a sliding window configuration is used. Value must be greater than 0.
+
Required if [field]#tenant.jwtConfiguration.refreshTokenExpirationPolicy# is set to `SlidingWindowWithMaximumLifetime`.
...
[field]#tenant.lambdaConfiguration.scimEnterpriseUserRequestConverterId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
The Id of a SCIM User Request Lambda that will be used to convert the SCIM Enterprise User request to a FusionAuth User.
+
:enterprise_feature: SCIM
include::../shared/_enterprise-edition-blurb-api.adoc[]
+
:enterprise_feature!:
Required when [field]#tenant.scimServerConfiguration.enabled# is `true`.

[field]#tenant.lambdaConfiguration.scimEnterpriseUserResponseConverterId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.lambdaConfiguration.scimGroupRequestConverterId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.lambdaConfiguration.scimGroupResponseConverterId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.lambdaConfiguration.scimUserRequestConverterId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.lambdaConfiguration.scimUserResponseConverterId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.multiFactorConfiguration.loginPolicy# [type]#[String]# [optional]#Optional# [default]#Defaults to `Enabled`# [since]#Available since 1.37.0#::
...
+
This value may be overridden by the value configured by the [field]#application.multiFactorConfiguration.loginPolicy#.
+
...
[field]#tenant.scimServerConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.scimServerConfiguration.schemas# [type]#[Map]# [optional]#Optional# [default]#defaults to **[see description]**# [since]#Available since 1.36.0#::
...
[field]#tenant.scimServerConfiguration.serverEntityTypeId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.36.0#::
...
[field]#tenant.webAuthnConfiguration.bootstrapWorkflow.authenticatorAttachmentPreference# [type]#[String]# [optional]#Optional# [default]#defaults to `crossPlatform`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.bootstrapWorkflow.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.bootstrapWorkflow.userVerificationRequirement# [type]#[String]# [optional]#Optional# [default]#defaults to `required`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.debug# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.reauthenticationWorkflow.authenticatorAttachmentPreference# [type]#[String]# [optional]#Optional# [default]#defaults to `crossPlatform`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.reauthenticationWorkflow.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.reauthenticationWorkflow.userVerificationRequirement# [type]#[String]# [optional]#Optional# [default]#defaults to `required`# [since]#Available since 1.41.0#::
...
[field]#tenant.webAuthnConfiguration.relyingPartyId# [type]#[String]# [optional]#Optional# [default]#defaults to **[see description]**# [since]#Available since 1.41.0#::
...
+
When this parameter is omitted, FusionAuth will use `null` for the Relying Party Id in passkey creation and request options. A `null` value in the https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API[WebAuthn JavaScript API] will use the browser origin.
+
:advanced_feature: WebAuthn
include::../shared/_advanced-edition-blurb-api.adoc[]
+
...
[field]#tenant.webAuthnConfiguration.relyingPartyName# [type]#[String]# [optional]#Optional# [default]#defaults to **[see description]**# [since]#Available since 1.41.0#::
...
+
When this parameter is omitted, FusionAuth will use the [field]#tenant.issuer# value.
+
:advanced_feature: WebAuthn
include::../shared/_advanced-edition-blurb-api.adoc[]
+
