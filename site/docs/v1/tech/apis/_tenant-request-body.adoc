...
The threshold for failing the Google v3 or HCaptcha Enterprise score. If not using either of those methods then this value is ignored. The value must be between `0.0` and `1.0`.
