...
[field]#tenant.jwtConfiguration.refreshTokenRevocationPolicy.onPasswordChanged# [type]#[String]# [optional]#Optional# [default]#default is `true`# [since]#Available since 1.17.0#::
