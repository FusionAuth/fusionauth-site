...
[field]#tenant.connectorPolicies``[x]``.connectorId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.18.0#::
The identifier of the connectorId to which this policy refers.

[field]#tenant.connectorPolicies``[x]``.domains# [type]#[String]# [optional]#Optional# [default]#defaults to `*`# [since]#Available since 1.18.0#::
