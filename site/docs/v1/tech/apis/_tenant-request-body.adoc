...
[field]#tenant.jwtConfiguration.refreshTokenExpirationPolicy# [type]#[String]# [since]#Available since 1.17.0#::
...
[field]#tenant.jwtConfiguration.refreshTokenRevocationPolicy.onLoginPrevented# [type]#[Boolean]# [since]#Available since 1.17.0#::
...
[field]#tenant.jwtConfiguration.refreshTokenRevocationPolicy.onPasswordChanged# [type]#[String]# [since]#Available since 1.17.0#::
...
[field]#tenant.jwtConfiguration.refreshTokenUsagePolicy# [type]#[String]# [since]#Available since 1.17.0#::
