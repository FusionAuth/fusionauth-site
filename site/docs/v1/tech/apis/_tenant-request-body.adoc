...
When enabled, users may utilize an authenticator application to complete a two-factor authentication request. This is often referred to as TOTP (Time Based One Time Password), or a Google Authenticator.
