...
[field]#tenant.externalIdentifierConfiguration.emailVerificationOneTimeCodeGenerator.type# [type]#[String]# [optional]#Optional# [default]#randomAlphaNumeric# [since]#Available since 1.27.0#::
+
:generator_display_name: email verification one time code
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.type# [type]#[String]# [optional]#Optional# [default]#randomAlphaNumeric# [since]#Available since 1.27.0#::
+
:generator_display_name: registration verification one time code
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
