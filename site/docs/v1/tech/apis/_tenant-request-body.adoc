...
|[field]#tenant.passwordValidationRules.breachDetection.matchMode# [type]#[String]# [optional]#Optional# [default]#defaults to `"High"`# [since]#Available Since 1.15.0#
...
|[field]#tenant.passwordValidationRules.breachDetection.onLogin# [type]#[String]# [optional]#Optional# [default]#defaults to `"Off"`# [since]#Available Since 1.15.0#
...
* `NotifyUser` Notify the end user via email. `tenant.passwordValidationRules.breachDetection.notifyUserEmailTemplateId` must also be set.
