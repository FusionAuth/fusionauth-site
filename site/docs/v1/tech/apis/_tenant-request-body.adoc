...
+
When this parameter is omitted, FusionAuth will use `null` for the Relying Party Id in passkey creation and request options. A `null` value in the https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API[WebAuthn client API] will use the browser origin.
+
:advanced_feature: WebAuthn
include::../shared/_advanced-edition-blurb-api.adoc[]
+
