...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationIdGenerator.type# [type]#[String]# [optional]#Optional# [default]#randomAlphaNumeric# [since]#Available since 1.8.0#::
+
:generator_display_name: registration verification Id
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
...
[field]#tenant.externalIdentifierConfiguration.twoFactorOneTimeCodeIdGenerator.length# [type]#[Integer]# [optional]#Optional# [default]#6# [since]#Available since 1.8.0#::
+
...
[field]#tenant.externalIdentifierConfiguration.twoFactorOneTimeCodeIdGenerator.type# [type]#[String]# [optional]#Optional# [default]#randomDigits# [since]#Available since 1.8.0#::
+
