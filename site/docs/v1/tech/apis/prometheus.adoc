...
Please refer to the link:/docs/v1/tech/apis/authentication#[Authentication] document for more details about `basic auth` authentication method using API keys.
