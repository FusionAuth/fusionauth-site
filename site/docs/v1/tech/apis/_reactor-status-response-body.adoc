...
The status for link:/docs/v1/tech/guides/webauthn[WebAuthn] features.
+
include::_reactor-status-values.adoc[]

[field]#status.webAuthnPlatformAuthenticators# [type]#[String]# [since]#Available since 1.41.0#::
The status for link:/docs/v1/tech/guides/webauthn[WebAuthn] platform authenticators.
+
include::_reactor-status-values.adoc[]

[field]#status.webAuthnRoamingAuthenticators# [type]#[String]# [since]#Available since 1.41.0#::
The status for link:/docs/v1/tech/guides/webauthn[WebAuthn] roaming, or cross-platform, authenticators.
+
include::_reactor-status-values.adoc[]
