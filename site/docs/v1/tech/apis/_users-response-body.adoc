...
The last link:/docs/v1/tech/reference/data-types/#instants[instant] when user was Updated. Note: webhooks may be a more effective way to track user changes.
