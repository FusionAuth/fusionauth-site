...
The last link:/docs/v1/tech/reference/data-types/#instants[instant] when user was updated. Note: webhooks may be another effective way to track user changes.
