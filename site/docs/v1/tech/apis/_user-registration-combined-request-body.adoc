...
[field]#user.twoFactor.methods``[x]``.authenticator.algorithm# [type]#[TOTPAlgorithm]# [optional]#Optional#::
...
[field]#user.twoFactor.methods``[x]``.id# [type]#[UUID]# [optional]#Optional#::
The unique Id of the method.

[field]#user.twoFactor.methods``[x]``.lastUsed# [type]#[Boolean]# [optional]#Optional#::
