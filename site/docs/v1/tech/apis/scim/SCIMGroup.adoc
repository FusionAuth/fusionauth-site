...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Delete a Group through a SCIM request
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Retrieves a Group through a SCIM request
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Updates a Group from a SCIM request
[.endpoint]
.URI
--
...
This API is used to list FusionAuth Groups in SCIM schema format through a SCIM request.

=== Request

[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Lists Groups through a SCIM request
[.endpoint]
.URI
--
