...
All error responses from From FusionAuth SCIM API endpoints will be returned in SCIM compliant link:https://datatracker.ietf.org/doc/html/rfc7644#section-3.12[schema].
