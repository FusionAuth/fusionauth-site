...
=== Request
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Retrieve All Resource Types
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Retrieve All Schemas
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Retrieve a Schema by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#client-credentials[icon:cogs[type=fas]] Retrieve Service Provider Configuration
[.endpoint]
.URI
--
