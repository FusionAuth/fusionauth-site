...
This is taken from the SCIM RFC describing a SCIM Schemas schema. For the full specification, see link:https://datatracker.ietf.org/doc/html/rfc7643#section-7[RFC 7643 section #7].
