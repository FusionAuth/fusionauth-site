...
|Original
|`application/json`
|Varies, sometimes a merge, other times an append. Test before using. Safest option is `GET` then `PUT`.
|1.12.0
|N/A
|Yes
...
[source,shell,title=Updating an object's array with the original PATCH behavior]
----
API_KEY=...
GROUP_ID=...
APPLICATION_ID=...
