...
|512
|A lambda invocation failed during this API request. An event log will have been created with details of the exception. See [breadcrumb]#System# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Event Log#.
|===
