...
layout: doc
title: API Key APIs
description: APIs for logging in, logging out, and refreshing tokens using OAuth 2 code flow with PKCE.
---
...
* link:/docs/v1/tech/apis/hosted-backend[Hosted Backend] - These APIs allow you initiate OAuth 2 code flow logins with FusionAuth-hosted backend endpoints.
