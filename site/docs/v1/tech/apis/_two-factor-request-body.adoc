...
+
You may optionally use value provided in the `secret` field returned by the link:/docs/v1/tech/apis/two-factor#generate-a-secret[Two Factor Secret] API instead of generating this value yourself. This value is a random byte array that is Base-64 encoded.
