...
The total number of Groups matching the search criteria. Use this value along with the [field]#numberOfResults# and [field]#startRow# in the Search request to perform pagination.

[source,json]
.Example Response JSON
----
include::../../../src/json/groups/search-response.json[]
----
endif::include_total[]

ifndef::include_total[]

[field]#groups``[x]``.tenantId# [type]#[UUID]#::
