...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] link:authentication#no-authentication-required[icon:lock[type=fas]] Authenticate a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Complete a Two Factor Login
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Update the login instant for a given User and Application
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[type=fas]] Update the login instant for a given User and Application using a JWT
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Remove the `access_token` and `refresh_token` cookies if they exist on the client.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Searches for Login Records given search criteria
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Export the Login Records matching the criteria
[.endpoint]
.URI
--
