...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Update the Consent with the given Id
[.endpoint]
.URI
--
...
[.endpoint]
--
[method]#PATCH# [uri]#/api/consent/`\{consentId\}`#
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Delete a Consent by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Grant consent to a User with a randomly generated Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Grant consent to a User with the provided unique Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Update a User Consent with given Id
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/consent/`\{userConsentId\}`#
...
[.endpoint]
--
[method]#PATCH# [uri]#/api/user/consent/`\{userConsentId\}`#
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Revoke a User Consent with given Id
[.endpoint]
.URI
--
