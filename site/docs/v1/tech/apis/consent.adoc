...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Create a new Consent with a randomly generated Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Create a new Consent with the provided unique Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve all of the Consents
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a Consent by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Update the Consent with the given Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Delete a Consent by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Grant consent to a User with a randomly generated Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Grant consent to a User with the provided unique Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve all of a User's Consents
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User Consent by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Update a User Consent with given Id
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/consent/`\{userConsentId\}`#
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Revoke a User Consent with given Id
[.endpoint]
.URI
--
