...
[WARNING.deprecated]
====
This documentation is for version 1.25, when major changes were introduced to this API. 

You can view the link:../two-factor[current two factor documentation] if needed.

The usage of this API in this manner is deprecated.
====
