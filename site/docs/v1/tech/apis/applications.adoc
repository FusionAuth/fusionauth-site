...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Create an Application from an existing Application with a generated Id
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/application#
