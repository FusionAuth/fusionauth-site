...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Applications by name, state and Tenant Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Applications by name
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/application/search``?name=\{name\}``#
--

[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Applications by tenant
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/application/search``?tenantId=\{tenantId\}``#
--
