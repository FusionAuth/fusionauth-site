...
[field]#{base_field_name}.signatureConfiguration.enabled# [type]#[Boolean]# [default]#defaults to `false`#::
Whether or not webhook events are signed.

[field]#{base_field_name}.signatureConfiguration.signingKeyId# [type]#[UUID]# [optional]#Optional#::
