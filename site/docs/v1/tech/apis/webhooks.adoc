...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Create a Webhook without providing an Id. An Id will be automatically generated.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Create a Webhook with the given Id.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve all of the Webhooks
[.endpoint]
.URI
--
