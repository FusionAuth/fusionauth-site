...
[field]#tenants``[x]``.emailConfiguration.defaultFromEmail# [type]#[String]# [since]#Available Since 1.16.0#::
...
[field]#tenants``[x]``.emailConfiguration.defaultFromName# [type]#[String]# [since]#Available Since 1.16.0#::
