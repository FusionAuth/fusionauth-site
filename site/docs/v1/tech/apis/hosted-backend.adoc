...
To work around this, develop locally, stand up a barebones backend with a more liberal cookie policy (https://github.com/FusionAuth/fusionauth-example-react-sdk/tree/main/server[here's an example]), or set up a link:/docs/v1/tech/installation-guide/cloud#updating-with-existing-custom-domains[custom domain name].
====
