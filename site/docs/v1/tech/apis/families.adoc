...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Retrieve pending users by parent email address
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Request parental approval
[.endpoint]
.URI
--
