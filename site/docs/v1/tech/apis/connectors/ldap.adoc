...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Create a LDAP Connector with a randomly generated Id.
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Create a LDAP Connector with the provided unique Id.
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve the LDAP Connector by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Update the LDAP Connector by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Delete the LDAP Connector by Id
[.endpoint]
.URI
--
