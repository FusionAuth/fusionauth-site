...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Create a Generic Connector with a randomly generated Id.
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Create a Generic Connector with the provided unique Id.
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Retrieve the Generic Connector by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Update the Generic Connector by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Delete the Generic Connector by Id
[.endpoint]
.URI
--
