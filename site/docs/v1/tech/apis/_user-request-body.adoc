...
If `true`, FusionAuth will send the User an email asking them to set their password. The Email Template used is the [field]#Set Password Email Template# configured in the Tenant settings.
+
