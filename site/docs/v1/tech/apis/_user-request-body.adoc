...
An object that can hold any information about a User that should be persisted. Please review the link:/docs/v1/tech/reference/limitations#data-field-limitations[limits on data field types].
