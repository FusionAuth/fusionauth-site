...
[field]#tenant.emailConfiguration.defaultFromEmail# [type]#[String]# [since]#Available Since 1.16.0#::
...
[field]#tenant.emailConfiguration.defaultFromName# [type]#[String]# [since]#Available Since 1.16.0#::
