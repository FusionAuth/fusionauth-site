...
+
In version 1.8.0 and beyond, email configuration is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, event configuration is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, external identifier configuration is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, failed authentication configuration is managed per `link:./tenants[Tenant]`.
...
+
In version 1.8.0 and beyond, http session max inactive interval is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, issuer is managed per `link:./tenants[Tenant]`.

[field]#systemConfiguration.jwtConfiguration.accessTokenKeyId# [type]#[UUID]# [required]#Required# [since]#Available since 1.6.0# [deprecated]#Deprecated#::
The Id of the signing key used to sign the access token.
+
[.deprecated]
Removed in version 1.8.0
+
In version 1.8.0 and beyond, JWT configuration is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, logoutURL is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, password age settings are managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, password encryption configuration is managed per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, password validation rules are configured per `link:./tenants[Tenant]`.
...
Removed in version 1.8.0
+
In version 1.8.0 and beyond, theme configuration is managed per `link:./tenants[Tenant]` and themes are configured using the `link:./themes[Theme]` API or via the UI.
