...
An object that can hold any information about the User for this registration that should be persisted. Please review the link:/docs/v1/tech/reference/limitations#data-field-limitations[limits on data field types] as you plan for and build your custom data schema.
...
The username of the User for this Application. This username cannot be used to login. It is for display purposes only.
