...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Lambdas by name
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/lambda/search``?name=\{name\}``#
--

[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Lambdas by function body contents
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/lambda/search``?body=\{body\}``#
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Lambdas using the given search and sort criteria
[.endpoint]
.URI
--
