...
[field]#{base_field_name}.samlv2Configuration.loginHintConfiguration.parameterName# [type]#[String]# [optional]#Optional# [default]#Defaults to `login_hint`# [since]#Available since 1.47.0#::
