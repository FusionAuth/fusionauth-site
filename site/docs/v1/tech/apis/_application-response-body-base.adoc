...
[field]#{base_field_name}.emailConfiguration.emailVerificationEmailTemplateId# [type]#[UUID]# [since]#Available since 1.19.0#::
...
[field]#{base_field_name}.emailConfiguration.forgotPasswordEmailTemplateId# [type]#[UUID]# [since]#Available since 1.19.0#::
...
[field]#{base_field_name}.emailConfiguration.passwordlessEmailTemplateId# [type]#[UUID]# [since]#Available since 1.19.0#::
The Id of the Passwordless Email Template. When configured, this value will take precedence over the same configuration from the Tenant when an application context is known.

[field]#{base_field_name}.emailConfiguration.setPasswordEmailTemplateId# [type]#[UUID]# [since]#Available since 1.19.0#::
...
[field]#application.formConfiguration.selfServiceFormId# [type]#[UUID]# [since]#Available since 1.26.0#::
...
[field]#application.oauthConfiguration.clientAuthenticationPolicy# [type]#[String]# [since]#Available since 1.28.0#::
...
[field]#application.oauthConfiguration.proofKeyForCodeExchangePolicy# [type]#[String]# [since]#Available since 1.28.0#::
...
[field]#application.oauthConfiguration.requireRegistration# [type]#[Boolean]# [since]#Available since 1.28.0#::
...
[field]#application.themeId# [type]#[UUID]# [since]#Available since 1.27.0#::
