...
[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.digestAlgorithm# [type]#[String]# [since]#Available since 1.47.0#::
...
[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.enabled# [type]#[Boolean]# [since]#Available since 1.47.0#::
Whether or SAML assertion encryption is enabled for this Application.

[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.encryptionAlgorithm# [type]#[String]# [since]#Available since 1.47.0#::
...
[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.keyLocation# [type]#[String]# [since]#Available since 1.47.0#::
...
[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.keyTransportAlgorithm# [type]#[String]# [since]#Available since 1.47.0#::
...
[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.keyTransportEncryptionKeyId# [type]#[UUID]# [since]#Available since 1.47.0#::
The unique Id of the Key used to encrypt the symmetric key for transport in the SAML response.

[field]#{base_field_name}.samlv2Configuration.assertionEncryptionConfiguration.maskGenerationFunction# [type]#[String]# [since]#Available since 1.47.0#::
...
[field]#{base_field_name}.samlv2Configuration.loginHintConfiguration.enabled# [type]#[Boolean]# [since]#Available since 1.47.0#::
Determines if support for a login hint sent by a SAML service provider is enabled for this application.

[field]#{base_field_name}.samlv2Configuration.loginHintConfiguration.parameterName# [type]#[String]# [since]#Available since 1.47.0#::
...
[field]#{base_field_name}.samlv2Configuration.logout.xmlSignatureC14nMethod# [type]#[String]# [default]#Defaults to `exclusive_with_comments`# [since]#Available since 1.25.0#::
