...
[field]#{base_field_name}.application.oauthConfiguration.clientAuthenticationPolicy# [type]#[String]# [since]#Available since 1.28.0#::
...
[field]#total# [type]#[Integer]# [since]#Available since 1.44.0#::
