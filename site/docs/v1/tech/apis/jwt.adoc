...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[type=fas]] Issue an Access Token
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Reconcile a JWT
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Retrieve all Public Keys
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Retrieve a single Public Key for a specific Application by Application Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Retrieve a single Public Key by Key Identifier
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Request a new Access Token by presenting a valid Refresh Token.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Retrieve Refresh Tokens issued to a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[type=fas]] Retrieve Refresh Tokens issued to a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Revoke all Refresh Tokens for an entire Application
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Revoke all Refresh Tokens issued to a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[type=fas]] Revoke a single Refresh Token
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[type=fas]] Validate Access Token.
[.endpoint]
.URI
--
