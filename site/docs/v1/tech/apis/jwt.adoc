...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=fas]] Issue an Access Token
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Reconcile a JWT
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Retrieve all Public Keys
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Retrieve a single Public Key for a specific Application by Application Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Retrieve a single Public Key by Key Identifier
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Request a new Access Token by presenting a valid Refresh Token.
[.endpoint]
.URI
--
...
[.api]
[field]#refreshToken# [type]#[String]#::
The refresh token. This will be the same as the [field]#refreshToken# provided.
...
[.api]
[field]#access_token# [type]#[String]#::
The encoded access token. This cookie is written in the response as an `HTTPOnly`, `SameSite=Lax` session cookie.

[field]#refresh_token# [type]#[String]#::
The encoded refresh token. This cookie is written in the response as an `HTTPOnly`, `SameSite=Lax` session cookie.


== Retrieve Refresh Tokens

[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve Refresh Tokens issued to a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=fas]] Retrieve Refresh Tokens issued to a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Revoke all Refresh Tokens for an entire Application
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Revoke all Refresh Tokens issued to a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Revoke a single Refresh Token
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Validate Access Token.
[.endpoint]
.URI
--
