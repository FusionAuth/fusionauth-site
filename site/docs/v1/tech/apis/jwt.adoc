...
.URI
--
[method]#DELETE# [uri]#/api/jwt/refresh``?tokenId=\{tokenId\}``#
--
...
[.api]
[field]#tokenId# [type]#[UUID]# [optional]#Optional#::
...
[.api]
[field]#token# [type]#[String]# [optional]#Optional# [deprecated]#Deprecated#::
...
+
[deprecated]#Using this field is deprecated as of version 1.30.0 and may be removed in the future. Use the `tokenId` parameter instead.#
