...
[field]#{base_field_name}.connectorPolicies# [type]#[Array]# [optional]#Optional# [since]#Available since 1.18.0#::
A list of connector policies. Users will be authenticated against Connectors in order.

[field]#{base_field_name}.connectorPolicies``[x]``.connectorId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.18.0#::
The identifier of the connectorId to which this policy refers.

[field]#{base_field_name}.connectorPolicies``[x]``.domains# [type]#[String]# [optional]#Optional# [default]#defaults to `*`# [since]#Available since 1.18.0#::
The list of email domains to which this connector should apply. `*` means all users will be checked against this connector.

[field]#{base_field_name}.connectorPolicies``[x]``.migrate# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.18.0#::
