...
The threshold which separates passing from failing the Google v3 or HCaptcha Enterprise score. If not using either of those methods then this value is ignored.
