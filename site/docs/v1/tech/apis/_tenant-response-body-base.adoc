...
[field]#{base_field_name}.captchaConfiguration.captchaMethod# [type]#[String]# [required]#Required# [since]#Available since 1.30.0#::
The type of captcha method to use.

[field]#{base_field_name}.captchaConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.30.0#::
Whether captcha configuration is enabled.

[field]#{base_field_name}.captchaConfiguration.secretKey# [type]#[String]# [required]#Required# [since]#Available since 1.30.0#::
The secret key for this captcha method.

[field]#{base_field_name}.captchaConfiguration.siteKey# [type]#[String]# [required]#Required# [since]#Available since 1.30.0#::
The site key for this captcha method.

[field]#{base_field_name}.captchaConfiguration.threshold# [type]#[Float]# [optional]#Optional# [default]#defaults to `0.5`# [since]#Available since 1.30.0#::
