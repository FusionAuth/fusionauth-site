...
[field]#{base_field_name}.connectorPolicies``[x]``.connectorId# [type]#[UUID]# [required]#Required# [since]#Available since 1.18.0#::
The identifier of the Connector to which this policy refers.

[field]#{base_field_name}.connectorPolicies``[x]``.domains# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to `["*"]`# [since]#Available since 1.18.0#::
