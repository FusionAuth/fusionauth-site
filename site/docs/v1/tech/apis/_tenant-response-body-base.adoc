...
The Relying Party Id the tenant will use in WebAuthn ceremonies. Passkeys can only be used to authenticate on sites with the same Relying Party Id they were registered.
+
