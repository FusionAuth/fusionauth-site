...
The type of security protocol FusionAuth will use when connecting to the SMTP server. The following are valid values:
+
...
[field]#{base_field_name}.jwtConfiguration.refreshTokenRevocationPolicy.onPasswordChanged# [type]#[String]# [since]#Available since 1.17.0#::
