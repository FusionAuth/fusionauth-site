...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [since]#Available since 1.27.0#::
+
:generator_type: registrationVerificationIdGenerator
...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.type# [type]#[String]# [since]#Available since 1.27.0#::
+
:generator_display_name: registration verification one time code
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
...
[field]#tenant.usernameConfiguration.unique.strategy# [type]#[String]# [since]#Available since 1.29.0#::
