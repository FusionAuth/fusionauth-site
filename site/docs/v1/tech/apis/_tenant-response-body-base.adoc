...
[field]#tenant.externalIdentifierConfiguration.emailVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [since]#Available since 1.27.0#::
+
:generator_type: emailVerificationIdGenerator
...
[field]#tenant.externalIdentifierConfiguration.emailVerificationOneTimeCodeGenerator.type# [type]#[String]# [since]#Available since 1.27.0#::
+
:generator_display_name: email verification one time code
include::_tenant-generator-type-config-rules.adoc[]
:generator_display_name!:
