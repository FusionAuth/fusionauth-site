...
+
The default value is `null`, which instructs the https://developer.mozilla.org/en-US/docs/Web/API/Web_Authentication_API[WebAuthn client API] to use the browser origin.
