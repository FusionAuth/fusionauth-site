...
[field]#{base_field_name}.externalIdentifierConfiguration.emailVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [default]#6# [since]#Available since 1.27.0#::
+
:generator_type: emailVerificationIdGenerator
...
[field]#tenant.externalIdentifierConfiguration.registrationVerificationOneTimeCodeGenerator.length# [type]#[Integer]# [default]#6# [since]#Available since 1.27.0#::
+
:generator_type: registrationVerificationIdGenerator
...
[field]#{base_field_name}.externalIdentifierConfiguration.twoFactorOneTimeCodeIdGenerator.length# [type]#[Integer]# [default]#6# [since]#Available since 1.8.0#::
+
