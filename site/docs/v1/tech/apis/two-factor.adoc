...
|242
|The user has two factor authentication enabled. Since version `1.42.0`, this status code is returned when two factor authentication is required.  The user will be required to complete a two-factor challenge during the next login attempt.
