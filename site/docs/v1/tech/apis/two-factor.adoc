...
|242
|Either the user has two factor authentication enabled or two factor authentication is required, and will be required to complete a two-factor challenge during the next login attempt.
