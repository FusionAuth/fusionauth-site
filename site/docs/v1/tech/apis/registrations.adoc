...
The short code used to verify the User's registration is valid by ensuring they have access to the provided email address. This field is required when the registration [field]#verification strategy# on the Application is set to `Form field`.
