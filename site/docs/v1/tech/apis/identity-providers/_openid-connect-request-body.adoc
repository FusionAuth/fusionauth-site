...
|[field]#identityProvider.oauth2.clientAuthenticationMethod.client_secret_post# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available Since 1.15.3#
|Whether to use `client_secret_post` as the client authentication method.  When `false`, `client_secret_basic` will be used as the client authentication method.
