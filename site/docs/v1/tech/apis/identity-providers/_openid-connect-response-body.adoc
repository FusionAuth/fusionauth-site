...
|[field]#identityProvider.domains# [type]#[List<String>]#
...
|[field]#identityProvider.oauth2.clientAuthenticationMethod.client_secret_post# [type]#[Boolean]# [since]#Available Since 1.15.3#
|Determines if `client_secret_post` will be used as the client authentication method.  When `false`, `client_secret_basic` will be used as the client authentication method.
