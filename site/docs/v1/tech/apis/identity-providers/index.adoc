...
link:../authentication#api-key-authentication[icon:lock[type=fas]] Retrieve all of the Identity Providers
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#no-authentication-required[icon:unlock[type=fas]] Lookup an Identity Provider by domain/email
[.endpoint]
.URI
--
