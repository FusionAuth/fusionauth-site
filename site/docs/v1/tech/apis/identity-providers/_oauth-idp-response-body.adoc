...
[field]#identityProvider.applicationConfiguration``[applicationId]``.enableOneTap# [type]#[String]# [since]#Available since 1.44.0#::
...
ifeval::["{idp_type}" == "Google"]
[field]#identityProvider.enableOneTap# [type]#[Boolean]# [since]#Available since 1.44.0#::
