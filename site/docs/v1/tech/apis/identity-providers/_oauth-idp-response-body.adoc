...
Google Identity Services HTML login API configuration in a properties file formatted String. Properties will be added to the HTML element with the `g_id_onload` element Id as data attributes.

[field]#identityProvider.properties.button# [type]#[String]# [since]#Available since 1.44.0#::
Google Identity Services HTML API button configuration in a properties file formatted String. Properties will be added to the HTML element with the `g_id_signin` class as data attributes.
