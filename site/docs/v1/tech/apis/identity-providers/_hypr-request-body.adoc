...
|[field]#identityProvider.applicationConfiguration``[applicationId]``.licensingEnabled# [type]#[Boolean]# [optional]#Optional#
|This is an optional Application specific override for the top level client id.

|[field]#identityProvider.applicationConfiguration``[applicationId]``.licensingEnabledOverride# [type]#[Boolean]# [optional]#Optional#
|This is an optional Application specific override for the top level client secret.

|[field]#identityProvider.applicationConfiguration``[applicationId]``.licensingURL# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `true`#
