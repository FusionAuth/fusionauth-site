...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Create an OpenID Connect Identity Provider using a generated id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Create an OpenID Connect Identity Provider with the provided unique id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=fas]] Delete an OpenId Connect Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Complete OpenID Connect Login
[.endpoint]
.URI
--
