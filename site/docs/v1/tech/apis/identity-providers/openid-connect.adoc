...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Create an OpenID Connect Identity Provider using a randomly generated Id
[.endpoint]
.URI
--
