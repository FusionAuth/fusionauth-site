...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Retrieve the Facebook Identity Provider by type
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Retrieve the Facebook Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Update the Facebook Identity Provider by type
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Update the Facebook Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Delete the Facebook Identity Provider by type
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Delete the Facebook Identity Provider by Id
[.endpoint]
.URI
--
