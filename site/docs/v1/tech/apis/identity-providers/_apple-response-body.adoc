...
[field]#identityProvider.applicationConfiguration``[applicationId]``.bundleId# [type]#[String]# [since]#Available since 1.43.0#::
...
[field]#identityProvider.bundleId# [type]#[String]# [since]#Available since 1.43.0#::
