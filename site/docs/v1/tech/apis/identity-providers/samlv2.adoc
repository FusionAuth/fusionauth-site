...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Create a SAML v2 Identity Provider using a generated id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Create a SAML v2 Identity Provider with the provided unique id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Delete a SAML v2 Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Complete SAML v2 Login
[.endpoint]
.URI
--
