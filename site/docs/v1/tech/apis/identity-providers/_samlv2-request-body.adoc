...
The name of the email claim in the SAML response that FusionAuth uses to uniquely identity the user.
...
When this parameter is omitted a default format of `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent` will be used.
endif::[]
