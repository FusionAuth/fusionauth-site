...
+
[since]#Since 1.44.0#
The [field]#identityProvider.applicationConfiguration``[applicationId]``.buttonText# value will not be used when [field]#identityProvider.loginMethod# is set to `UsePopup` or `UseVendorJavaScript` because of changes to the Google JavaScript API.
endif::[]
...
+
[since]#Since 1.44.0#
The [field]#identityProvider.applicationConfiguration``[applicationId]``.scope# value will not be used when [field]#identityProvider.loginMethod# is set to `UsePopup` or `UseVendorJavaScript` because of changes to the Google JavaScript API. The `email`, `profile`, and `openid` scopes will always be requested.
endif::[]
...
+
[since]#Since 1.44.0#
The [field]#identityProvider.buttonText# value will not be used when [field]#identityProvider.loginMethod# is set to `UsePopup` or `UseVendorJavaScript` because of changes to the Google JavaScript API.
endif::[]
...
+
[since]#Since 1.44.0#
The [field]#identityProvider.scope# value will not be used when [field]#identityProvider.loginMethod# is set to `UsePopup` or `UseVendorJavaScript` because of changes to the Google JavaScript API. The `email`, `profile`, and `openid` scopes will always be requested.
endif::[]
