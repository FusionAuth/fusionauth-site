...
While this API is still functional, its usage is discouraged. When available please use the link:/docs/v1/tech/apis/identity-providers/links#link-a-user[Link a User endpoint] which takes a slightly different request body.
====
...
While this API is still functional, its usage is discouraged. When available please use the link:/docs/v1/tech/apis/identity-providers/links#complete-a-pending-link[Complete a Pending Link] which takes a slightly different request body.
====
...
.Example Request JSON
----
include::docs/src/json/identity-providers/links/request-complete-a-pending-link-deprecated.json[]
----
