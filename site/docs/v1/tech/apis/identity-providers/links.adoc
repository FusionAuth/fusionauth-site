...
[WARNING]
====
Deprecated Since 1.43.0.

While this API is still functional, its usage is discouraged. For Versions of FusionAuth that are >= 1.43.0, please use the link:/docs/v1/tech/apis/identity-providers/links#link-a-user[Link a User endpoint].
====
[.endpoint]
.URI
--
...
While this API is still functional, its usage is discouraged. For Versions of FusionAuth that are >= 1.43.0, please use the link:/docs/v1/tech/apis/identity-providers/links#complete-a-pending-link[Complete a Pending Link].
====
[.endpoint]
.URI
--
