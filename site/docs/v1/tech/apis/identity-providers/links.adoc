...
[WARNING.deprecated]
====
While this endpoint is still functional, it's usage is discouraged in favor of the Link a User endpoint that takes a top level `identityProviderLink` object since 1.43.0.
====
