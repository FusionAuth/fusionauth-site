...
[NOTE.since]
====
This API endpoint has been available since 1.43.0.
====
[.api-authentication]
...
A human-readable value identifying the user in the remote identity provider.
+
...
The Id of the existing Identity Provider.
