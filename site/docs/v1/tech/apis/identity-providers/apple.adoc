...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Create the Apple Identity Provider
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Retrieve the Apple Identity Provider by type
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Retrieve the Apple Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Update the Apple Identity Provider by type
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Update the Apple Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Delete the Apple Identity Provider by type
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[type=fas]] Delete the Apple Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#no-authentication-required[icon:unlock[type=fas]] Complete Apple Login
[.endpoint]
.URI
--
