...
----
ifeval::["{loginProvider}" == "Apple"]
include::../../../../src/json/identity-providers/login/apple-request.json[]
endif::[]
ifeval::["{loginProvider}" == "Facebook"]
...
ifeval::["{loginProvider}" == "LinkedIn"]
include::../../../../src/json/identity-providers/login/linkedin-request.json[]
endif::[]
ifeval::["{loginProvider}" == "Twitter"]
...
ifdef::idp_lowercase[]
include::../../../../src/json/identity-providers/login/{idp_lowercase}-request.json[]
endif::[]
----
:default!:
