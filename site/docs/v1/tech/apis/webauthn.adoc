...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Start a WebAuthn Registration Ceremony and Retreive Passkey Creation Options
[.endpoint]
.URI
--
