...
* <<Start a WebAuthn Passkey Assertion>>
...
This API is used to start a WebAuthn registration ceremony by providing some details about the current user and the new passkey. The response contains the creation options that will be passed to the authenticator on the client device, including a one-time challenge unique to the current registration ceremony.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:unlock[type=fas]] Complete a WebAuthn Registration Ceremony and Return Passkey Details
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:unlock[type=fas]] Complete a WebAuthn Authentication Ceremony
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:unlock[type=fas]] Assert a WebAuthn Authentication Ceremony
[.endpoint]
.URI
--
