...
* link:#create_tenant_generate_id[Create a Tenant with a randomly generated Id]
* link:#create_tenant_with_id[Create a Tenant with the provided unique Id]
* link:#copy_tenant_generate_id[Create a Tenant from an existing Tenant with a randomly generated Id]
* link:#copy_tenant_with_id[Create a Tenant from an existing Tenant with the provided unique Id]

=== Request

[.api-authentication, id="create_tenant_generate_id" ]
...
[.api-authentication, id="create_tenant_with_id" ]
...
[.api-authentication, id="copy_tenant_generate_id" ]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Create a Tenant from an existing Tenant with a randomly generated Id
...
[.api-authentication, id="copy_tenant_with_id"]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Create a Tenant from an existing Tenant with the provided unique Id
...
include::docs/v1/tech/apis/_tenant-copy-request-body.adoc[]
