...
* <<Create a Tenant>>
* <<Create a New Tenant From an Existing Tenant>>
* <<Retrieve a Tenant>>
* <<Search for Tenants>>
* <<Update a Tenant>>
* <<Delete a Tenant>>
...
This API is used to create a new Tenant from an existing Tenant.
...
[.api]
[field]#sourceTenantId# [type]#[UUID]# [required]#Required# [since]#Available since 1.14.0#::
The Id of an existing Tenant to make a copy of. A unique [field]#tenant.name# is required. All other values will be copied from the source Tenant to the new Tenant.
