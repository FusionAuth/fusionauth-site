...
[field]#key.issuer# [type]#[String]# [optional]#Optional#::
The issuer of the RSA or EC certificate. If omitted,this value will default to the issuer defined on the tenant. For HMAC keys, this field does not apply and will be ignored if specified.
