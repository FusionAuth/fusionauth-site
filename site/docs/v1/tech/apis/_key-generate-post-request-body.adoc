...
[field]#key.issuer# [type]#[String]# [optional]#Optional# [default]#defaults to `tenant.issuer` for default tenant#::
The issuer of the RSA or EC certificate. If omitted, this value will default to the value of [field]#tenant.issuer# on the default tenant. For HMAC keys, this field does not apply and will be ignored if specified.
