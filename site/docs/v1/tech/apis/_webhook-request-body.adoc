...
[field]#webhook.signatureConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available since 1.48.0#::
Whether or not webhook events are signed.

[field]#webhook.signatureConfiguration.signingKeyId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.48.0#::
The Id of the key used to sign webhook events. Required when [field]#webhook.signatureConfiguration# is set to `true`.

[field]#webhook.sslCertificate# [type]#[String]# [optional]#Optional# [deprecated]#Deprecated#::
...
In version 1.48.0 and beyond, the webhook SSL certificate can be managed via [field]#webhook.sslCertificateKeyId#. This field is not allowed on a request when [field]#webhook.sslCertificateKeyId# is provided.
