...
[field]#users``[x]``.twoFactor.methods``[x]``.authenticator.algorithm# [type]#[TOTPAlgorithm]# [optional]#Optional#::
...
[field]#users``[x]``.twoFactor.methods``[x]``.id# [type]#[UUID]# [optional]#Optional#::
The unique Id of the method.

[field]#users``[x]``.twoFactor.methods``[x]``.lastUsed# [type]#[Boolean]# [optional]#Optional#::
