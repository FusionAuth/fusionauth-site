...
+
This field must not be a string in a Crypt/Shadow password format such as `$5a$foobarbaz$728348sehalkoiew90u32970`. 
+
This field should contain only the password hash; using the above example, `728348sehalkoiew90u32970` is the correct value.
