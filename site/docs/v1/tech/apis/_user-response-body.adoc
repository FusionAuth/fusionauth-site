...
[field]#user.twoFactor.methods``[x]``.authenticator.algorithm# [type]#[TOTPAlgorithm]#::
...
[field]#user.twoFactor.methods``[x]``.id# [type]#[UUID]#::
...
[field]#user.twoFactor.recoveryCodes# [type]#[Array<String>]#::
