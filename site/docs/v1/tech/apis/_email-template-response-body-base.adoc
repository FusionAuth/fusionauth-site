...
The total number of Email Templates matching the search criteria. Use this value along with the [field]#numberOfResults# and [field]#startRow# in the Search request to perform pagination.

[source,json]
.Example Response JSON for Email Template Search
----
include::../../../src/json/email-templates/search-response.json[]
----
endif::include_total[]
