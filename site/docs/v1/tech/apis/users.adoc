...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User by login Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User by email
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User by username
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User by Change Password Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve a User by Email Verification Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#jwt-authentication[icon:id-badge[type=fas]] Retrieve a User using a JWT
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Update the User with the given Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Deactivate a User (Soft Delete)
[.endpoint]
.URI
--
...
--
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Permanently Delete a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Deactivate Users by User Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Deactivate Users by Search Query String
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Permanently Delete Users by User Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Permanently Delete Users by Search Query String
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Bulk delete using the request body. This allows for larger requests than are possible using request parameters.
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Reactivate the User
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Import Multiple Users
[.endpoint]
.URI
--
...
include::docs/v1/tech/apis/_import-users-request-body.adoc[]
...
You can also learn more about hashes in the link:/docs/v1/tech/reference/password-hashes[password hashing reference], and you can link:/docs/v1/tech/plugins/custom-password-hashing[implement your own custom hash] as well.
...
----
include::https://raw.githubusercontent.com/FusionAuth/fusionauth-example-scripts/master/import-helpers/convert-md5-hexadecimal-to-base64.rb[]
----

=== Bcrypt

When importing a bcrypt hash, you may have a value such as `$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy`. This single string represents the bcrypt version, factor, salt and hash.
...
For the above bcrypt hash, `10` is the factor and should be placed in the [field]#factor# field.  `N9qo8uLOickgx2ZMRZoMye` is the salt and should be placed in the [field]#salt# field.  `IjZAgcfl7p92ldGxad68LJZdL17lhWy` is the hash value and should be placed in the [field]#password# field.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Import Refresh Tokens
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/refresh-token/import#
--

include::docs/v1/tech/apis/_x-fusionauth-tenant-id-header-create-operation.adoc[]

include::docs/v1/tech/apis/_users-refresh-tokens-request-body.adoc[]
...
Calling this API with either the `GET` or `POST` HTTP method will will provide the same search results given the same query parameters.
...
Which search query parameters are available and how they behave depends on the search engine type. Read more about link:/docs/v1/tech/core-concepts/users#user-search[the different types of search engines].

=== Database Search Engine

This is a good choice for link:/docs/v1/tech/core-concepts/users#database-search-engine[smaller installs, embedded scenarios, or other places where the additional capability of Elasticsearch is not required].
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Users by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Users by a query string
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Users by a query string and sort the response
[.endpoint]
.URI
--
...
:parameter_prefix:
include::docs/v1/tech/apis/_user-search-request-parameters.adoc[]
:query_string_request!:
:database_search_engine_type!:
:parameter_prefix!:
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Users using a JSON request body. This allows for larger requests than are possible using request parameters.
[.endpoint]
.URI
--
...
include::docs/v1/tech/apis/_user-search-request-body-database-examples.adoc[]

=== Elasticsearch Search Engine

The Elasticsearch engine has link:/docs/v1/tech/core-concepts/users#elasticsearch-search-engine[advanced querying capabilities and better performance]. You can also review the link:/docs/v1/tech/guides/user-search-with-elasticsearch[Elasticsearch search guide] for more examples.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Search for Users by a raw JSON query
[.endpoint]
.URI
--
...
include::docs/v1/tech/apis/_user-search-request-body-elasticsearch-examples.adoc[]
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Retrieve recent logins
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#no-authentication-required[icon:unlock[type=fas]] Verifies the User's email address using the `verificationId`.

[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/verify-email#
--
...
The short code used to verify the User's account is valid by ensuring they have access to the provided email address. This field is required when the email [field]#verification strategy# on the Tenant is set to `Form field`.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Administratively verify the User's email address.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#no-authentication-required[icon:unlock[type=fas]] Resend the verification email
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Resend the verification email using an API key
[.endpoint]
.URI
--
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#no-authentication-required[icon:unlock[type=fas]] Start the forgot password workflow without an API Key.
[.endpoint]
.URI
--
...
[.api]
[field]#applicationId# [type]#[UUID]# [optional]#Optional# [since]#Available since 1.21.0#::
The Id of the application. If valid, the email template configured in the Application settings will be used, if present. If not present, the email template configured in the Tenant settings will be used. In either case, the corresponding Application object will be available to the template.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Start the forgot password workflow using an API key
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/forgot-password#
...
|403
|The forgot password functionality has been disabled. This is caused by an administrator setting the Forgot Password Email Template to the option _Feature Disabled. No template selected._ in the Tenant Email configuration. See [breadcrumb]#Tenants -> Email -> Template settings# in the FusionAuth admin UI.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#no-authentication-required[icon:unlock-alt[role=green, title="No authentication required"]] Changes a User's password using the change password Id.
...
[.api]
[field]#changePasswordId# [type]#[String]# [required]#Required# [deprecated]#Deprecated#::
...
&nbsp;
+
[deprecated]#Deprecated in version 1.33.0#
This value can still be provided on the URL segment as shown in the above example, but it is recommended you send this value in the request body instead using the [field]#changePasswordId# field. If the value is provided in the URL segment and in the request body, the value provided in the request body will be preferred.
+
This field is not required if using the change password endpoint in conjunction with API authentication while providing a [field]#loginId#.
...
[.api]
[field]#changePasswordId# [type]#[String]# [required]#Required# [since]#Available since 1.33.0#::
The `changePasswordId` that is used to identity the user after the Start Forgot Password workflow has been initiated.
+
If this `changePasswordId` was sent via an email to the User by FusionAuth during User create in order to set up a new password, or as part of a Forgot Password request, then successful use of this identifier to change the User's password will implicitly complete Email Verification if not already verified and the Tenant configuration has enabled implicit email verification.
+
If the [field]#changePasswordId# is provided in the URL segment and in the request body, the value provided in the request body will be preferred.
+
This field is not required if using the change password endpoint in conjunction with API authentication while providing a [field]#loginId#.
...
The email or username of the user to change passwords. This is used in conjunction with API Authentication to change a user's password without a [field]#changePasswordId#.
...
[field]#trustToken# [type]#[String]# [optional]#Optional# [since]#Available since 1.33.0#::
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:lock[type=fas]] Changes a User's password using an email address or username.
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#jwt-authentication[icon:id-badge[type=fas]] Changes a User's password using a JWT
...
.Example Response JSON
----
include::docs/src/json/errors/requires-trust-token-response.json[]
----
