...
[WARNING.deprecated]
====
Using [field]#verificaitonId# in the URL segment is deprecated as of version 1.27.0 and may be removed in the future. This API now takes this field in the request body.
====
