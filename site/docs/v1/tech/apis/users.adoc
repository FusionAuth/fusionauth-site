...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Deactivate Users by Raw JSON Search Query
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Permanently Delete Users by Raw JSON Search Query
[.endpoint]
.URI
--
...
[NOTE]
====
This API has some limitations when FusionAuth is configured to use the database as the user search engine. These limits apply only to the request and are documented below.
====

=== Request

There are two kinds of user search query parameters. Those specific to a search engine type (database or Elasticsearch) and those common across search engine types.
...
+
Using this parameter will not hit the Elasticsearch index (if applicable), instead it will cause users to be retrieved by Id only.
...
include::docs/v1/tech/apis/_user-search-request-body-common.adoc[]
...
==== Database Search Engine Request Query String Parameters

:parameter_prefix: 
include::docs/v1/tech/apis/_user-search-request-parameters-database.adoc[]
:parameter_prefix!:
...
==== Database Search Engine Request Body Parameters

:parameter_prefix: search.
include::docs/v1/tech/apis/_user-search-request-parameters-database.adoc[]
:parameter_prefix!:

==== Database Search Engine Request Body Examples
...
The Elasticsearch engine has advanced querying capabilities.
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Search for Users by a raw JSON query
[.endpoint]
.URI
--
...
==== Elasticsearch Search Engine Request Query String Parameters

:parameter_prefix: 
include::docs/v1/tech/apis/_user-search-request-parameters-elasticsearch.adoc[]
:parameter_prefix!:
...
==== Elasticsearch Search Engine Request Body Parameters

:parameter_prefix: search.
include::docs/v1/tech/apis/_user-search-request-parameters-elasticsearch.adoc[]
:parameter_prefix!:

==== Elasticsearch Search Engine Request Body Examples
