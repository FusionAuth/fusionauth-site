...
What search query parameters are available depends on the search engine type (database or Elasticsearch). link:../core-concepts/users#user-search[Read more about the different types of search engines].
