...
MD5 is commonly stored in hexadecimal format, such as `25d55ad283aa400af464c76d713c07ad`. FusionAuth requires imported passwords to be stored in base64. You must convert any hexadecimal values to base64 before importing, or the import will not work.
