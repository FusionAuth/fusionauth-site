...
[field]#limit# [type]#[Integer]# [optional]#Optional# [default]#defaults to `10000`# [since]#Available since 1.48.0#::
The maximum number of users to delete in one call.
+
Because user UUIDs are returned in the response and the operation can take time you may use this parameter to process the deletes in batches.
