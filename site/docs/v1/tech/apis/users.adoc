...
|The raw JSON Elasticsearch query that is used to search for Users. This parameter is required when the [field]#queryString# or [field]#userId# parameters are not provided.
...
|The Elasticsearch query string that is used to search for Users to be deleted. This parameter is required when the [field]#query# or [field]#userId# parameters are not provided.

|[field]#userId# [type]#[UUID]# [optional]#Optional#
|The Id of the User to delete. Repeat this parameter for each user to be deleted. This parameter is required when the [field]#query# or [field]#queryString# parameters are not provided.
|===
