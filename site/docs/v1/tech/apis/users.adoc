...
The one exception to this is with the password field. If you do not specify a password using the `PUT` method, the user's current password
will be preserved and will not be deleted. A user's password will only be overwritten if you provide a new password.
