...
[field]#application.active# [type]#[Boolean]# [deprecated]#Deprecated#::
...
[field]#application.oauthConfiguration.debug# [type]#[Boolean]# [since]#Available since 1.25.0#::
...
[field]#application.samlv2Configuration.xmlSignatureLocation# [type]#[String]# [since]#Available since 1.21.0#::
...
[field]#application.state# [type]#[String]# [since]#Available since 1.22.0#::
