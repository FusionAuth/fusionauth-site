...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green]] Send the provided code via email
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green]] Generate a code and send a login link via email
