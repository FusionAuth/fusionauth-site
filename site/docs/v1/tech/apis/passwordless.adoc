...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Generate a passwordless login code
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock[role=green,type=fas]] Send the provided code via email
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock[role=green,type=fas]] Generate a code and send a login link via email
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock[role=green,type=fas]] Login using the code sent via email
[.endpoint]
.URI
--
