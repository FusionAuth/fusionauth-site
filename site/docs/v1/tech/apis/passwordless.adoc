...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:unlock[type=fas]] Send the provided code via email
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:unlock[type=fas]] Generate a code and send a login link via email
...
[.api-authentication]
link:/docs/v1/tech/apis/authentication#api-key-authentication[icon:unlock[type=fas]] Login using the code sent via email
[.endpoint]
.URI
--
