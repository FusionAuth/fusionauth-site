...
This API allows you to generate a passwordless code that can be used to complete login. This API should be used if you want to collect the code and send it to the user using a third party system.
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Generate a passwordless login code
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green]] Send a login link via email using [field]#code#
[.endpoint]
.URI
--
...
[NOTE]
====
This is the preferred method of calling this API as of version 1.11.0
====
[cols="3a,7a"]
[.api]
.Request Body
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green]] Send a login link via email using [field]#applicationId# and [field]#loginId#
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/passwordless/send#
