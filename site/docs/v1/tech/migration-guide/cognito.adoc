...
The user should be transparently migrated over to FusionAuth. Let's verify the import succeeded by viewing the user in the administrative user interface.
