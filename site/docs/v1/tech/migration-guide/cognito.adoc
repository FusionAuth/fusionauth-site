...
If on the other hand, you are okay with resetting user passwords, a <<Bulk Migration>> might work for you. Review that section for more details on the required steps. You may also perform a bulk migration after a slow migration has run for a few months. At that time, your active users will have been transparently migrated and the other users may be okay with resetting their passwords.
