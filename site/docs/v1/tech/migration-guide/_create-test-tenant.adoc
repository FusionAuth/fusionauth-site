...
Give it a descriptive name like `{migration_source_name} import test` and save it. You shouldn't need to modify any of the other configuration options to test importing users, but feel free to change any that you want to.
