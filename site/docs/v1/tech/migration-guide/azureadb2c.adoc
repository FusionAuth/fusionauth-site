...
Azure Functions can be coded within the Azure portal directly, or coded on your local machine and deployed as a package using https://docs.microsoft.com/en-us/azure/azure-functions/functions-develop-vs-code?tabs=csharp[Visual Studio Code, with Azure Extensions]. As the function has dependent modules, you will need to follow these instructions. Clone the https://github.com/ritza-co/fusion-ropc-azure-function[function project], and follow the instructions in the link to deploy to your Azure Function.
...
We've created a node console tool to authenticate with the Graph API and export the users. You can clone or fork it from https://github.com/ritza-co/fusion-azure-add-bulk-export[here], and configure the `.env` file with your Azure AD B2C tenant and app ID and secret.
