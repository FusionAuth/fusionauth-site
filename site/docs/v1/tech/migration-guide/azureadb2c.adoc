...
:migration_source_name: ADB2C
:migration_source_dir: adb2c
...
Visit the Azure AD B2C App Registrations tab. Then https://docs.microsoft.com/en-us/azure/active-directory-b2c/add-ropc-policy?tabs=app-reg-ga&pivots=b2c-user-flow#register-an-application[follow these instructions] to set up a new ROPC App Registration. 

At the end, you'll end up with an app client configuration looking similar to this:

image::migration-guide/{migration_source_dir}/ropc-app-registration-configuration.png[Configuring an ROPC App Registration for migration.,width=1200]
...
image::migration-guide/{migration_source_dir}/ropc-app-client-id.png[Finding the app client id.,width=1200]
...
==== Configuring the Azure Functioin
