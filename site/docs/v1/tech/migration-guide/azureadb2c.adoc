...
After deploying the Function, set the following Function environment variables, also known as https://docs.microsoft.com/en-us/azure/azure-functions/functions-how-to-use-azure-function-app-settings?tabs=portal[Application Settings], to those that you recorded when setting up the ROPC app:
