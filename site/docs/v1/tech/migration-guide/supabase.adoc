...
image::img/create-tenant.png

==== Create a Test Application

Below is a screenshot for creating your Tenant:

image::img/create-application.png
...
image::img/user-migration-result-using-ruby-script.png
...
image::img/facebook-user-imported.png

image::img/google-user-imported.png
