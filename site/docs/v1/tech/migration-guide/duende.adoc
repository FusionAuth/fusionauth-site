...
This document will help you migrate off of Duende Indentity Server. If
you are looking to compare FusionAuth and Duende Authentication, link:/blog/2018/10/02/firebase-and-fusionauth-ciam-comparison[this document may help].
