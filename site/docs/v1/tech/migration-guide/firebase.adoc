...
If you have external dependencies on an Id stored in Firebase, you will have to relink using the new FusionAuth UUID.
...
[source,shell,title="Adding the scrypt parameters to the plugin"]
----
include::https://raw.githubusercontent.com/FusionAuth/fusionauth-contrib/master/Password%20Hashing%20Plugins/src/main/java/com/mycompany/fusionauth/plugins/ExampleFirebaseScryptPasswordEncryptor.java[tags=scryptParameters]
----
