...
Alternatively, if the user has not been migrated, the customer service representative can look up the user and then reset theier password in the legacy system.
