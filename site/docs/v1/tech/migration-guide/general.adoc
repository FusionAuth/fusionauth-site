...
The message displayed in the user interface when someone enters the "forgot password" flow can modified by changing the `forgot-password-email-sent` property in the `messages.properties` file in link:/docs/v1/tech/themes/localization#messages[your theme].
