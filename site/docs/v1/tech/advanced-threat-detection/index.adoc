...
[NOTE.note]
====
Turning this feature on requires a support ticket, as this feature is being rolled out on an account by account basis.

Submit a https://account.fusionauth.io/account/support[support ticket through your account portal] and request this feature be turned on.

This feature also requires increased RAM, as documented in the link:/docs/v1/tech/installation-guide/system-requirements#compute-ram[System Requirements].
====
