...
Emails can be sent to the user on certain security events.
...
Such emails can be localized like any other email template.

Here are the security events for which you can send such emails:
