...
There is a sample link:/docs/v1/tech/email-templates/templates-replacement-variables#threat-detected["Threat Detected" email template] which documents variables available.
Such emails can be localized similar like any other email template.
