...
In order to complete this process, we'll be using the FusionAuth typescript client library along with Express and Pug templates. Here's how our `package.json` file looks:
