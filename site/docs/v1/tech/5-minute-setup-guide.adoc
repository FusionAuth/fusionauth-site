...
- where should we do the cookie stuff?
add red rectangles to stuff
remove 'Node.js' and just call it node
review colon vs no colon for before showing a file excerpt. (no colon is what we want.
title of code samples, titlecased?
we vs you (want you)
sort menu nav alpha
