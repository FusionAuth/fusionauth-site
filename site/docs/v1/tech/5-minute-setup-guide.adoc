...
If you are on Windows, you'll need to use the `startup.bat` (prior to version 1.37) or `startup.ps1` (version 1.40 and later) file instead. Versions 1.37 through 1.39 do not support native Windows installation.
