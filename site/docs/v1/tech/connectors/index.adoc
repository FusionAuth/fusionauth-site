...
Find Connectors in the administrative user interface by navigating to [breadcrumb]#Settings -> Connectors# or use the link:/docs/v1/tech/apis/connectors/[Connectors] APIs.
...
{% include docs/_connector-diagram.liquid %}
{% endmermaid %}
++++
