...
Enabled Connectors are in the critical path the login experience and therefore should have low latency.
BHere are some things to do to increase performance of your Generic Connector.
...
You can load test your Connector using FusionAuth's load testing framework or any other HTTP based load testing framework.
