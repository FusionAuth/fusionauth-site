...
[.api]
[field]#connectTimeout# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `5000`#::
The HTTP connect timeout in milliseconds used when connecting to the API.

[field]#readTimeout# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `5000`#::
...
* `FUSIONAUTH_FORM[adminUser]_ID` - The Id of the default admin user editing form.
