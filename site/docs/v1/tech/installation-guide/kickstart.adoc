...
If you have a paid support contract you will be provided with a Support Id. If you would like to set this value during kickstart you will set the value in a top level field called `supportId`.

In this example I have a support Id of `eb7244dc-5d8e-40cd-a005-70b116fbda31.`
```json
{
