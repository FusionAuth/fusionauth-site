...
If you are running FusionAuth in an environment with no network access, you must download the MySQL driver jar file and place it in `fusionauth-app/web/WEB-INF/lib`.
