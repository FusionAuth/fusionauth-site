...
FusionAuth ships configured to use the database as the default search engine type, you will need to update the configuration to leverage ElasticSearch as the search engine.  See the link:../reference/configuration[Configuration] documentation for reference in configuring the search engine.
