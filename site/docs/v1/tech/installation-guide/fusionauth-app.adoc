...
[NOTE]
====
* Prior to version 1.37 `FusionAuthApp.exe` is located at `\fusionauth\fusionauth-app\apache-tomcat\bin`
* Versions 1.37 through 1.39 do not support native Windows install.
====
