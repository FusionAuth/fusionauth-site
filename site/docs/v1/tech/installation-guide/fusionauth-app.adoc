...
:137_link: /docs/v1/tech/installation-guide/fusionauth-app-pre-1-37
[NOTE.note]
====
include::docs/v1/tech/shared/_post-1-37-note.adoc[]
====
...
.macOS (ZIP package)
----
<FUSIONAUTH_HOME>/fusionauth-app/bin/startup.sh
----

[source]
.Windows (ZIP package)
----
\fusionauth\fusionauth-app\bin\startup.ps1
----
