...
Under **Applications**, click on the `Copy endpoint` link next to **Elasticsearch** to copy the URL to your clipboard. You will need to save this URL for use when link:/docs/v1/tech/installation-guide/[deploying FusionAuth] to your AKS cluster.
