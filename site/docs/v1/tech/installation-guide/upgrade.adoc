...
To upgrade to the latest version of FusionAuth using Docker go link:docker[here].

If you want to continue in manual mode, download the latest version of FusionAuth and then continue. See https://fusionauth.io/download[Downloads].
====
...
[NOTE]
====
In production runtime mode, you will need to upgrade the database manually using the information below.

In development runtime mode, you will not need to upgrade the database manually using the information below. FusionAuth ships with a system called Maintenance
...
For more on runtime modes, see the link:./fusionauth-app#runtime-modes[FusionAuth Installation Guide] for reference.
====
