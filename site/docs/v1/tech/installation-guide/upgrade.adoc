...
[NOTE]
====
If you want FusionAuth to upgrade the database automatically, use the link:../guides/silent-mode[Silent Mode] process, which will perform an automated upgrade.
...
For more information on the various configuration options, see the link:../reference/configuration[Configuration Reference].
====
