...
. Login to the administrative UI. If there were migrations required, they'll be applied automatically to your database.

This should pull the given image.

If you have previously been on `fusionauth/fusionauth-app:latest` you may need to remove the old image first:
