...
See the link:/docs/v1/tech/reference/configuration/[configation reference] or the link:/docs/v1/tech/guides/silent-mode/[silent mode guide] for more information. To apply the database migrations out of band see the link:/docs/v1/tech/admin-guide/upgrade/#database[database upgrade] documentation.
...
The following is an example `docker-compose.yml` file configuring FusionAuth to scan for plugins a plugin` at startup. 
