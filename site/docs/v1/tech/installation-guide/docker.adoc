...
For example, in development environments it can be helpful to run https://mailcatcher.me/[MailCatcher] for SMTP.
...
https://raw.githubusercontent.com/FusionAuth/fusionauth-containers/master/docker/fusionauth/fusionauth-app-mysql/Dockerfile[fusionauth-containers/docker/fusionauth/fusionauth-app-mysql/Dockerfile]