...
To update your billing, navigate to the [breadcrumb]#Billing# tab.
	...
	site/assets/img/docs/installation-guides/cloud/billing-overview.png
	site/assets/img/docs/installation-guides/cloud/billing-update-card.png
	site/assets/img/docs/installation-guides/cloud/billing-update-detail.png
	site/assets/img/docs/installation-guides/cloud/billing-view-invoices.png
