...
If your IP addresses meet these conditions, https://account.fusionauth.io/account/support/[log a support ticket]. The turnaround time for an allow list change is two to three business days.
