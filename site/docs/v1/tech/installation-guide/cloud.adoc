...
If you encounter a CAPTCHA during manual testing, ensure you have local browser caching enabled. Often, using browser developer tools disables caching, which can lead to CAPTCHA presentation. Consult the documentation for your browser to learn more.
