...
|+++<i class="fas fa-check-square"></i>+++
| Created a new deployment under account.fusionauth.io

|+++<i class="fas fa-check-square"></i>+++
| The deployment in FusionAuth Cloud and my local instance are the same version of FusionAuth.
...
Make sure that the self-hosted FusionAuth instance is the same version as your Cloud deployment used. There's an https://github.com/FusionAuth/fusionauth-issues/issues/1390[open issue regarding this], but the best current way to find out is to open a support ticket.
