...
* If you are using the Elasticsearch search engine, you may modify the Elasticsearch settings or view the Elasticsearch index directly. Among other things, this means that you can't use use some of the link:/docs/v1/tech/admin-guide/troubleshooting[troubleshooting steps] available to users who are self-hosting FusionAuth.
