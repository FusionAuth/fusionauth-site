...
* If you want to run Advanced Threat Detection, you'll need a cloud deployment with sufficient memory. Currently that means it must be a Large or X-Large size.
