...
Non-production rollbacks will be completed within two business days, and will be handled during normal FusionAuth business hours (9am-5pm Mountain time). Non-production rollbacks will not be treated as a production outage.
