...
* [breadcrumb]#Logout# - logs you out of the account application.

image::installation-guides/cloud/home-tab.png[The dashboard of the FusionAuth Cloud account application.,width=1200]
...
Before you can create a FusionAuth deployment, you register for a free account and provide payment information.
Register by going to https://account.fusionauth.io/[the account portal].

If you already have an account, you can log in and skip this section.
...
image::installation-guides/cloud/registration-first-screen.png[Registering for an account.,width=1200]

On the next screen, you'll be prompted for email, password and other required information.

image::installation-guides/cloud/registration-second-screen.png[Registering for an account.,width=1200]
...
image::installation-guides/cloud/home-tab.png[The home tab.,width=1200]
...
If you need to have the receipt, you can update that in the [breadcrumb]#Billing# tab.

The following section focuses on the [breadcrumb]#Deployments# tab.
Learn more about the link:#other-portal-areas[other portal areas here].
...
image::installation-guides/cloud/deployments-tab-invoiced.png[On the Deployments tab with invoicing set up after trying to launch.,width=1200,roles=bottom-cropped]
...
Choose the version you want to run; the default is the latest release.

image::installation-guides/cloud/provisioning-add-details.png[Add details for provisioning.,width=1200]

Pick the type of this deployment: Basic, Business or High-Availability (HA).
Each has different features and data durability guarantees.

image::installation-guides/cloud/provisioning-select-type.png[Selecting your desired type on the provisioning screen.,width=1200]
...
When you have your deployment configured as you would like, click "Add to Cart".
...
Finally, scroll to the bottom and click [field]#Purchase# to begin the deployment creation process.
...
If you do not have a payment method on file, add one in the [breadcrumb]#Billing# tab. Learn more about the link:#billing[[breadcrumb]#Billing# tab].
...
To add another deployment, click "Add deployment".
...
They are upgraded one at a time and can continue to recieve traffic during the upgrade. 
...
* Select a time that work for your users, your team, and your applications.
...
If you are interested in migrating from an auth system other than FusionAuth, you're looking for our link:/docs/v1/tech/migration-guide/[Migration Guide].
...
image::installation-guides/cloud/custom-url-action.png[Navigating to the custom URLs domain entry screen.,width=1200]
...
Add the domain names to the text field.
For example, `auth.piedpiper.com`.
Then click [field]#Submit#.

image::installation-guides/cloud/custom-url-add-domains.png[Adding custom URLs.,width=1200]
...
image::installation-guides/cloud/custom-url-verification-instructions.png[Pending verification instructions screen.,width=1200]
...
The account portal is where you can manage your deployments and licenses, as well as other data FusionAuth has about you and your company.

=== Home

The [breadcrumb]#Home# tab is a dashboard where you can view information about your FusionAuth account.

image::installation-guides/cloud/home-tab.png[Home tab.,width=1200]
...
image::installation-guides/cloud/plan-tab.png[The plan tab.,width=1200]
...
To update your billing, navigate to the [breadcrumb]#Billing# tab.

You can view and modify aspects of your billing.

There's an overview of your billing status.

image::installation-guides/cloud/billing-overview.png[The overview section of the billing tab.,width=1200]

You can update your payment methods with a different credit card.

image::installation-guides/cloud/billing-update-card.png[The payment method update section of the billing tab.,width=1200]

You can update current payment settings, including the name and tax identifier on the invoice, the email address that invoices are sent to.

image::installation-guides/cloud/billing-update-detail.png[The payment method details section of the billing tab.,width=1200]

You can view past invoices.

image::installation-guides/cloud/billing-view-invoices.png[The invoices section of the billing tab.,width=1200]

=== Users

You can add, modify and remove users from your FusionAuth account.

View the list of users in your account.

image::installation-guides/cloud/users-list.png[List the users with access to your account.,width=1200]

Add users to your account. You can have unlimited users in your FusionAuth account portal.

image::installation-guides/cloud/users-list-add.png[The add button to add users to your account.,width=1200]

Modify a user in your account. You can change their name, email address and roles.

image::installation-guides/cloud/users-edit.png[Edit a user.,width=1200]

Users can have zero or more roles, which control access to functionality within the portal.
...
Support tickets can be opened by any user with an account.
...
image::installation-guides/cloud/company-edit.png[Edit your company.,width=1200]
...
image::installation-guides/cloud/company-danger-zone.png[The company danger zone.,width=1200]
...
To update your account, navigate to the [breadcrumb]#Account# tab.

You can edit your user details, including your name, password, and email address.

image::installation-guides/cloud/account-edit-user.png[Edit your account details.,width=1200]

You can also set up MFA for your account.

image::installation-guides/cloud/account-two-factor.png[Set up MFA for your account.,width=1200]
...
* Each set of components is run in separate geographic availability zones, geographically separated. This prevents disasters from affecting all compononents.
