...
* With HA deployments, requests to public metric endpoints such as `/api/status` are round-robined to individual servers and not aggregated across the deployment.
