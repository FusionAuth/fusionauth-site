...
If you are looking to modify other attributes of your deployment, such as the region it is running in, the node size, or the service tier, review the <<Modifying Deployments>> section.
====
