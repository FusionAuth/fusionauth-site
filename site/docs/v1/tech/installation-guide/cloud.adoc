...
If you need to download user data regularly, consider using the link:/docs/v1/tech/apis/[API] or a link:/docs/v1/tech/events-webhooks/[webhook] to track ongoing account creation.

If these solutions do not meet your needs and you have an Enterprise support plan, open a https://account.fusionauth.io/account/support/[support ticket] to discuss options.
