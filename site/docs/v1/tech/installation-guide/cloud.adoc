...
image::installation-guides/cloud/home-tab.png[The dashboard of the FusionAuth Cloud account application.,width=1200,role=bottom-cropped]

include::docs/v1/tech/installation-guide/_cloud-user-note.adoc[]

You can read more about the other portal areas in the <<Other Portal Areas>> section.
...
image::installation-guides/cloud/login-screen.png[Log in to your account,width=1200,role=bottom-cropped,top-cropped]
...
image::installation-guides/cloud/registration-first-screen.png[Registering for an account.,width=1200,role=bottom-cropped,top-cropped]
...
image::installation-guides/cloud/home-tab.png[The home tab.,width=1200,role=bottom-cropped]
...
If you need to have the receipt, you can update details in link:#billing[the [breadcrumb]#Billing# tab].
...
Learn more about the link:#billing[[breadcrumb]#Billing# tab].
...
image::installation-guides/cloud/billing-overview.png[The overview section of the billing tab.,width=1200,role=bottom-cropped.]
...
image::installation-guides/cloud/billing-update-card.png[The payment method update section of the billing tab.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/billing-update-detail.png[The payment method details section of the billing tab.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/billing-view-invoices.png[The invoices section of the billing tab.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/users-list.png[List the users with access to your account.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/users-list-add.png[The add button to add users to your account.,width=1200,role=bottom-cropped]

As well as adding a new user, you can also modify an existing user.
You can change their name, email address and roles.

image::installation-guides/cloud/users-edit.png[Edit a user.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/company-edit.png[Edit your company.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/company-danger-zone.png[The company danger zone.,width=1200,role=bottom-cropped]
...
image::installation-guides/cloud/account-edit-user.png[Edit your account details.,width=1200,role=bottom-cropped]

You can also set up MFA for your account.
Currently only TOTP MFA is allowed for the account portal

image::installation-guides/cloud/account-two-factor.png[Set up MFA for your account.,width=1200,role=bottom-cropped]
