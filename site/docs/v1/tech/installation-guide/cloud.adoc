...
1. Add the vanity URL CNAMEs first
...
A support request is required because data exports contain sensitive fields, like password hashes. The FusionAuth team will work with you to find a safe dat1Ga transfer mechanism.
...
If you need your data exported regularly for any other reason, this is only available to organizations 1-on Enterprise plans.
