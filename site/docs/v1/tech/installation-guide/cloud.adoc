...
image::installation-guides/cloud/too-many-requests-blocked.png[Too Many Requests,width=1200,role=bottom-cropped]

Prior to this message you may receive the following CAPTCHA challenges
...
To prevent either scenario please limit the number of requests you are making over a given time period or open a support ticket to whitelist your static production IP addresses as needed.
