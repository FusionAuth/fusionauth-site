...
If you encounter a CAPTCHA during manual testing, ensure you have local browser caching enabled. Consult the documentation for your browser to learn more.
