...
If you would like to have your FusionAuth deployment in a different country, please open a https://account.fusionauth.io/account/support/[support ticket with details]. You can also self-host FusionAuth if you need data residency in a country not on the above list.
