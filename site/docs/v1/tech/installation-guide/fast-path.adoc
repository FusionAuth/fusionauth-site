...
[NOTE]
====
Prior to version 1.37.0 use `startup.bat` to start Elasticsearch and FusionAuth. Versions 1.37.0 through 1.39.0 do not support native Windows installation.
====
