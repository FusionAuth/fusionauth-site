...
FusionAuth provides the ability to theme the OAuth v2 login pages plus all of the support pages for login. Any user of the FusionAuth admin application with either the `admin` or `theme_manager` roles may view, edit, update, and delete Themes.

Here is a list of all of the pages that can be themed using this feature:
