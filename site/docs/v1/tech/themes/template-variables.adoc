...
+
If you need to customize the look and feel for different tenants but desire to use the same theme to lower maintainance, store values in [field]#tenant.data#.
