...
+
If you need to customize the look and feel for different tenants but you want to use the same theme to lower maintainability costs, store values in [field]#tenant.data#.
