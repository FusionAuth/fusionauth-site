...
FusionAuth themes allow you to customize the OAuth2 / OpenID Connect login pages and other user workflows such as forgot password. In FusionAuth you may create one to many themes and assign a theme per application so that you can customize the user experience for different users.
...
[field]#OAuth two-factor methods# [required]#Required#::
...
The verification id that was included on as a URL parameter.
...
Whether or not to display a link to allow the user to select a different method or resend the code.
...
[field]#user# [type]#[User]#::
The current user performing multi-factor authentication.
