...
See the corresponding link:/docs/v1/tech/apis/themes/[Theme APIs] if you'd prefer to programatically configure FusionAuth themes.
...
Continue reading below to see an example video, how to create a theme, how to preview a theme, example code and some troubleshooting help.
