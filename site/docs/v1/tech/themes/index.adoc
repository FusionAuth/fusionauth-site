...
// TODO : Josh : clarify this below 👇
// How does this vary from the currentUser Object described in the common variables section?
[field]#user# [type]#[User]#::
The User object corresponding to the authenticated user.
...
[field]#devicePendingIdPLink# [type]#[PendingIdPLink]#::
The PendingIdpLink that is generated when using the device OAuth flow.
...
[field]#metaData# [type]#[RefreshToken]#::
// TODO : expand and confirm type 👆
...
[field]#passwordlessEnabled# [type]#[Boolean]#::
// TODO : expand
A boolean that controls whether or not to to utlize a passwordless flow.

[field]#pendingIdpLink# [type]#[PendingIdpLink]#::
...
[field]#rememberDevice# [type]#[String]#::
// TODO : expand
...
[field]#registrationEnabled# [type]#[boolean]#::
...
[field]#incidentId# [type]#[String]#::
A string that defines the Id of each security incident generated by our advanced threat detection suite.
