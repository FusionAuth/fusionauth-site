...
The multi-factor methods that are available to be configured.
...
The recovery codes when a user configured multi-factor authentication for the first time.
