...
|Email verification complete [required]#Required#
...
|Email verification re-send [required]#Required#
...
|OAuth authorize [required]#Required#
...
|OAuth child registration not allowed [required]#Required#
...
|OAuth child registration not allowed complete [required]#Required#
...
|OAuth complete registration [required]#Required#
...
|OAuth device [required]#Required# [since]#Since 1.11.0#
...
|OAuth device complete [required]#Required# [since]#Since 1.12.0#
...
|OAuth logout [required]#Required#
...
|OAuth passwordless [required]#Required#
...
|OAuth register [required]#Required#
...
|OAuth two-factor [required]#Required#
...
|OAuth wait [required]#Required# [since]#Since 1.12.0#
...
|OAuth Change password form [required]#Required#
...
|OAuth password password complete [required]#Required#
...
|Forgot password [required]#Required#
...
|Forgot password sent [required]#Required#
...
|Verify registration complete [required]#Required#
...
|Verify registration send [required]#Required#
...
|Verify registration [required]#Required#
