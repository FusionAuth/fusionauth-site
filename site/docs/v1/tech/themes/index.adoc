...
See the corresponding link:/docs/v1/tech/apis/themes/[Themes APIs] if you'd prefer to programatically configure FusionAuth themes.
...
You apply a theme by applying it to either a Tenant or an Application.
