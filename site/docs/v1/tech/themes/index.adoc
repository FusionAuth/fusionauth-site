...
[field]#Verify registration re-send# [required]#Required#::
...
This page is rendered when a user is required to verify their email address prior to being allowed to proceed with registration. This occurs when [field]#Unverified behavior# is set to `Gated` in email verification settings on the Application.
+
...
When `true`, a form input is displayed to allow a user to enter the verification code. This occurs when [field]#Verification strategy# is set to `Clickable link` under email verification settings on the Tenant.
...
[.api]
[field]#collectVerificationCode# [type]#[Boolean]#::
When `true`, a form input is displayed to allow a user to enter the verification code. This occurs when [field]#Verification strategy# is set to `Clickable link` under email verification settings on the Application.
