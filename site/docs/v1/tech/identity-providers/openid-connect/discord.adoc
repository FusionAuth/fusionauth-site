...
You will need to enable the [field]#Authenticate with client_secret_post# field, as Discord expects the `client_secret` in the request body of the authentication request.
