...
Additionally, you will need to update the [field]#Unique Id Claim# field to `id` (from the standard claim of `sub`) under options.

image::identity-providers/discord-change-unique-claim.png[FusionAuth Discord Change Claim,,role=top-cropped]
