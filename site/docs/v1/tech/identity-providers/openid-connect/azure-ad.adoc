...
You will need to specify `email` as a [field]#Email claim# for your application.
...
image::identity-providers/bottom-of-fusionauth-azure-ad-oidc-config.png[FusionAuth Azure AD IdP Configuration,width=1200]
