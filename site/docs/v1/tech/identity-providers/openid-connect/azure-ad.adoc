...
Once logged in, navigate to [breadcrumb]#Azure Active Directory# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#App Registrations# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#New Registration# to create a new Azure Active Directory Application.
...
Navigate to [breadcrumb]#Azure Active Directory# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#App Registrations# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#{Your Application}# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Certificates & secrets# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#New client secret# to create a new Azure Active Directory Application Client Secret.
...
To create an Azure AD Identity Provider return to FusionAuth and navigate to [breadcrumb]#Settings# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Identity Providers# and click `Add provider` and select `OpenID Connect` from the dialog.
