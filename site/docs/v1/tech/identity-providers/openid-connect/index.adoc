...
|Authenticate with client_secret_post [optional]#Optional# [since]#Available Since 1.15.3#
|Enable to use `client_secret_post` as the client authentication method. When `false`, `client_secret_basic` will be used as the client authentication method.
