...
* link:/docs/v1/tech/identity-providers/openid-connect/cognito[Configure OpenID Connect with Amazon Cognito]
...
* link:/docs/v1/tech/identity-providers/openid-connect/okta[Configure OpenID Connect with Okta]
