...
image::identity-providers/github-openid-connect-login.png[Login with GitHub,width=1200,role=shadowed]
...
image::identity-providers/github-openid-connect-register-application.png[Register a new GitHub OAuth Application,width=1200,role=shadowed]
...
image::identity-providers/github-openid-connect-client-id-secret.png[GitHub Client ID and Secret,width=1200,role=shadowed]
...
image::identity-providers/github-openid-connect-configuration.png[FusionAuth GitHub IdP Configuration,width=1200,role=shadowed]
