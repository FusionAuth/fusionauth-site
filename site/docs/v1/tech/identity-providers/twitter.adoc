...
Twitter allows you to create an application as part of the developer account setup. If you do not yet have a Twitter app you will need to create one in this step. Application creation is restricted according to the level of access you have in your Twitter project. You will need to apply for elevated access to be able to create more than one app in your Twitter project. You can learn more about access levels and permissions https://developer.twitter.com/en/docs/projects/overview[here].  If you already have a Twitter app that you plan to use for FusionAuth please review this section anyway to ensure your configuration is correct to support the Twitter login.

Visit this link https://developer.twitter.com/en/portal/projects-and-apps[https://developer.twitter.com/en/portal/projects-and-apps] to view a list of your Twitter apps.

image::identity-providers/twitter-developer-dashboard.png[Twitter Create App,width=1200]

In the following sections we go through the configurations that you will need to set to allow Twitter to connect with FusionAuth.
...
Your will need to use [breadcrumb]#OAuth 1.0a# as the authentication method. Under [breadcrumb]#User authentication settings# click the [breadcrumb]#Edit# button to modify the app settings.

image::identity-providers/twitter-create-app.png[Create Twitter App,width=1200,role=shadowed]

==== Add the Callback URL +++<span style"height: 50%; width: 50%;"><span class="fa-stack fa-2x" style="color: #F4821F;"><i class="fa fa-circle fa-stack-1x"></i><span class="fa-stack-1x calendar-text" style="color: white; font-family: sans-serif; font-size: medium">1</span></span>+++ & +++<span class="fa-stack fa-2x" style="color: #F4821F;"><i class="fa fa-circle fa-stack-1x"></i><span class="fa-stack-1x calendar-text" style="color: white; font-family: sans-serif; font-size: medium">2</span></span>+++

Enable [breadcrumb]#OAuth 1.0a# and register the "Callback URI / Redirection URL"

In this example we are registering `\https://login.piedpiper.com/oauth1/callback` as the callback URI. The redirect URL *must* be set to an absolute URL in the twitter console for your application. If your hostname is login.piedpiper.com, the redirect URL would be `https://login.piedpiper.com/oauth1/callback/`.



==== Request Email +++<span class="fa-stack fa-2x" style="color: #F4821F;"><i class="fa fa-circle fa-stack-1x"></i><span class="fa-stack-1x calendar-text" style="color: white; font-family: sans-serif; font-size: medium">3</span></span>+++
