...
image::twitter-permissions.png[Twitter App Permissions,width=1200,role=shadowed bottom-cropped]
...
image::twitter-keys-tokens.png[Twitter Keys and tokens,width=1200,role=shadowed bottom-cropped]
