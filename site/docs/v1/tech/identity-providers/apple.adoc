...
The last step will be to create an Apple Identity Provider in FusionAuth. To create an Identity Provider navigate to [breadcrumb]#Settings -> Identity Providers# and click [breadcrumb]#Add Apple# from the top right selection button.
