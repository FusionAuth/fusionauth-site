...
Configure one or both of the [field]#Services Id# and [field]#Bundle Id# fields as needed. If you are only supporting a native app, use [field]#Bundle Id# and leave [field]#Services Id# blank. If only a webapp, use [field]#Services Id# and leave [field]#Bundle Id# blank. If your application is both a native and a web application, configire If only supporting a native app, configure both the [field]#Bundle Id# and [field]#Services Id# fields. 
