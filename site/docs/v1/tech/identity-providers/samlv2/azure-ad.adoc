...
Previously, you created and used a "dummy" X.509 certificate. At this point, you can change this to the real value. In the Azure AD SAML application overview, under step three, find a [field]#Certificate (Base64)#. You'll download and then upload this to FusionAuth.
