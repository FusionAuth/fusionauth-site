...
[field]#Issuer# [required]#Required# [since]#Available since 1.43.0#::
The EntityId (unique identifier) of the SAML v2 identity provider. Only available if IdP initiated login is enabled. This value should be provided to you.
