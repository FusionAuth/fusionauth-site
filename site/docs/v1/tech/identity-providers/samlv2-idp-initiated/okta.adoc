...
image::identity-providers/idp-initiated/view-saml-setup-instructions.png[View SAML Setup Instructions,width=1200]
...
Finally, click on the [breadcrumb]#Assignments# tab and assign the user to the application. First, select the user.
