...
An Identity Provider in FusionAuth is a configuration that represents an external identity provider. The link:../../apis/identity-providers/[Identity Providers]
