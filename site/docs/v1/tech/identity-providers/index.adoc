...
Find the FusionAuth Identity Providers in the UI by navigating to [breadcrumb]#Settings# icon:chevron-right[role=breadcrumb] [breadcrumb]#Identity Providers# or use the link:../apis/identity-providers/[Identity Providers] APIs.
