...
* link:/docs/v1/tech/identity-providers/epic-games/[Epic Games]
...
* link:/docs/v1/tech/identity-providers/xbox/[Xbox]
...
image::identity-providers/identity-provider-application-config.png[Identity Providers,width=1200,role=shadowed, bottom-cropped]
...
[NOTE]
====
Regardless of whether you enable "Create registration" or not, a user will be created within FusionAuth when a person signs in with the identity provider, per the linking strategy (see below). This setting controls whether a user is authorized for this application.
====
...
include::/docs/v1/tech/identity-providers/_linking-strategies.adoc[]