...
You can also run your query directly against Elasticsearch. This will get you the UUIDs of the users only. If you need additional user data, you'd have to query FusionAuth with the UUIDs.
