...
In order to send this value to FusionAuth, you would need to convert this date time to the number of milliseconds since epoch and then send the value `1436028300000` as an input parameter. link:/learn/expert-advice/dev-tools/date-time[Convert instants to human readable dates or vice versa.]
...
link:/learn/expert-advice/dev-tools/uuid-generator[Generate a UUID.]
