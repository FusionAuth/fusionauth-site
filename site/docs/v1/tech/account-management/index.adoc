...
FusionAuth self-service account management allows your users to manage their accounts, including the ability to add Multi-factor Authentication (MFA).  This documentation section covers adding MFA, customizing the account management user page, and troubleshooting guidance.
