...
FusionAuth self-service account management allows users to manage their accounts, including the ability to add Multi-factor Authentication (MFA). This documentation section covers:
    ...
    * link:/docs/v1/tech/account-management/authenticator-two-factor[Add Two Factor Method - Authenticator]
...
=== A Note About Images in this Documentation
...
==== Defaults Shown in Screenshots

Additionally, all screenshots shown are reflective of the default themes and forms shipped with FusionAuth. In a production environment, themed pages and forms will likely differ according to your brand and product requirements.
