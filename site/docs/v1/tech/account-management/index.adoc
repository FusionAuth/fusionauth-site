...
To view the account and self service pages, navigate to [breadcrumb]#Applications# and click on the icon:search[role=ui-button green,type=fas] icon to view the application details. 
...
In a real world application you'd have this link be part of the navigation for your application.

image::account-management/applications-home.png[Home Screen, width=1200]

=== Account Home

Before accessing your account you will be asked to log in. Make sure the user you log in with is registered for this application.
...
Please note that once an authenticator is enabled, users will be offered recovery codes similar to what is shown below. 

Please save these in a secure location, as they can be used to recover you account, should one of your second factors fail to be available. For example, if your email or sms service is "down" and users still want to use your application, or if a user loses their phone, a recovery code can allow access.
