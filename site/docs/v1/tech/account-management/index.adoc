...
Additionally, all screenshots show the default theme and forms shipped with FusionAuth. In a production environment, themed pages and forms will likely differ according to your brand and product requirements.
