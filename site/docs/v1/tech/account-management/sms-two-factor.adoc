...
image::account-management/sms-configure-cropped.png[Add SMS Authenicator, width=1200]
...
Upon next login, the user will be prompted for a code sent by SMS code in addition to your password.
