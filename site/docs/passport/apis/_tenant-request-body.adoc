...
.Request Body
|===
|[field]#tenant.data.attributes# [type]#[Object]# [optional]#Optional#
...
|[field]#tenant.forgotEmailTemplateId# [type]#[UUID]# [optional]#Optional#
...
|[field]#tenant.setPasswordEmailTemplateId# [type]#[UUID]# [optional]#Optional#
...
|[field]#tenant.verificationEmailTemplateId# [type]#[UUID]# [optional]#Optional#
...
|[field]#tenant.verifyEmail# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`#
|Whether or not user's email addresses are verified when the register with your application.

|[field]#tenant.verifyEmailWhenChanged# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`#
