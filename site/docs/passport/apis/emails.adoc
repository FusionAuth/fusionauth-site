...
include::docs/passport/apis/_email-template-request-body.adoc[]
...
include::docs/passport/apis/_email-template-response-body.adoc[]
...
include::docs/passport/apis/_email-templates-response-body.adoc[]
...
----
include::docs/passport/src/json/email-templates/preview-request.json[]
----
...
include::docs/passport/apis/_preview-response-body.adoc[]
...
.Example Request JSON
----
include::docs/passport/src/json/email-templates/send-request.json[]
----
...
include::docs/passport/apis/_send-response-body.adoc[]
