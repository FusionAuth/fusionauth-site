...
|[field]#integration.kafka.defaultTopic# [type]#[String]# [optional]#Optional# [since]#Available Since 1.15.0#
|The name of the Kafka topic to send messages. Required when the Kafka integration is enabled.

|[field]#integration.kafka.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `false`# [since]#Available Since 1.15.0#
|True if the Kafka integration is enabled.

|[field]#integration.kafka.producer# [type]#[Map<String, String>]# [optional]#Optional# [since]#Available Since 1.15.0#
