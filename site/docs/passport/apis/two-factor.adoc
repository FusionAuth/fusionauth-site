...
include::docs/passport/apis/_two_factor-request-body.adoc[]
...
----
include::docs/passport/src/json/two-factor/send/request_userId.json[]
----
...
----
include::docs/passport/src/json/two-factor/secret/response.json[]
----