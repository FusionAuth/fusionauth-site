...
----
When building your application, utilize the version that corresponds to the version of FusionAuth your running. View all available versions on https://search.maven.org/#search%7Cgav%7C1%7Cg%3A%22com.inversoft.passport%22%20AND%20a%3A%22passport-java-client%22[https://search.maven.org]
