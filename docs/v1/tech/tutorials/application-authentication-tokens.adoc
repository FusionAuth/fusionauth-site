...
will be used to authenticate them. These tokens are long sequences of characters and function similarly to API Keys. If you let FusionAuth
...
To enable Authentication Tokens, open the FusionAuth web interface and navigate to [breadcrumb]#Settings# icon:chevron-right[role=breadcrumb]
...
image::authentication-token.png[Authentication Tokens,width=1200]
