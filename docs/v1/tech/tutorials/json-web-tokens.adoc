...
[breadcrumb]#System#  in the FusionAuth
...
image::global-jwt-configuration.png[Global JWT Configuration,width=1200]
...
image::application-jwt-configuration.png[Application JWT Configuration,width=1200]
