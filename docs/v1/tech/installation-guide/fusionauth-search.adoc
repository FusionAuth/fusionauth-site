...
Log into your https://www.inversoft.com/account[Inversoft account] and click Download. Find the FusionAuth Search package for your target platform.
...
C:\fusionauth\fusionauth-search\elasticsearch\bin> PassportSearchEngine.exe /install
----
