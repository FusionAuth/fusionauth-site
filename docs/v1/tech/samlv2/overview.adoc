...
////
TODO Update screenshot? The domain text area has shrunk a bit, that is probably ok. But the new panel has a note about the "view" dialog and integration details.
////
== Overview
...
The complete documentation for this lambda can be found on the link:../lambdas/samlv2-populate[SAML v2 populate lambda documentation page].
