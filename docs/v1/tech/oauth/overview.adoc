...
description: An overview of how FusionAuth provides an OAuth 2.0 compliant SSO login system
---

== Overview

FusionAuth supports the following two grant types as defined by the OAuth 2.0 framework in https://tools.ietf.org/html/rfc6749[RFC 6749].

* link:overview#example-authorization-code-grant[Example Authorization Code Grant]
* link:overview#example-resource-owner-password-credentials-grant[Example Resource Owner Password Credentials Grant]
