...
* The Login Report may now be optionally filtered to a particular User in the UI, and the link:../apis/reports#s#generate-login-report[Login Report] API will now take `loginId` or `userId`.
