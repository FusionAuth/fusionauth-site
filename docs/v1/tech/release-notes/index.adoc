...
:info_message: The FusionAuth link:../installation-guide/system-requirements[System Requirements] have been updated. Please review to ensure you have met the requirements for minimum supported versions of operating system and database.
