...
|The link:../reference/data-types#instants[instant] when the User consent was granted.

|[field]#userConsent.lastUpdateInstant# [type]#[Long]#
|The link:../reference/data-types#instants[instant] when the User consent was last updated.
