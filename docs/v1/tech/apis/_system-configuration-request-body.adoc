...
|[field]#systemConfiguration.auditLogConfiguration.delete.numberOfDaysToRetain# [type]#[Integer]# [optional]#Optional#
...
|[field]#systemConfiguration.eventLogConfiguration.numberToRetain# [type]#[Integer]# [optional]#Optional# [default]#defaults to `10000`#
...
|[field]#systemConfiguration.loginRecordConfiguration.delete.numberOfDaysToRetain# [type]#[Integer]# [optional]#Optional#
|The number of days to retain the login records. Required when `systemConfiguration.loginRecordConfiguration.delete.enabled` is set to true.
