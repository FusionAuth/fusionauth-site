...
|[field]#systemConfiguration.corsConfiguration.allowedHeaders# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to **[see description]**# [since]#Available Since 1.8.0#
...
When this parameter is omitted the following default value will be used.
...
|[field]#systemConfiguration.corsConfiguration.allowedMethods# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to **[see description]**# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.corsConfiguration.exposedHeaders# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to **[see description]**# [since]#Available Since 1.8.0#
