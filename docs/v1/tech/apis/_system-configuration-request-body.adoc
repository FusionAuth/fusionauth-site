...
|[field]#systemConfiguration.corsConfiguration.allowCredentials# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `true`# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.corsConfiguration.allowedHeaders# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to `["Accept", "Access-Control-Request-Headers", "Access-Control-Request-Method", "Authorization", "Content-Type", "Last-Modified", "Origin", "X-FusionAuth-TenantId", "X-Requested-With"]`# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.corsConfiguration.allowedMethods# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to `["GET", "POST", "PUT", "DELETE", "HEAD", "OPTIONS"]`# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.corsConfiguration.allowedOrigins# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to `["*"]`# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.corsConfiguration.enabled# [type]#[Boolean]# [optional]#Optional# [default]#defaults to `true`# [since]#Available Since 1.8.0#
|Whether the FusionAuth CORS filter will process requests made to FusionAuth.

|[field]#systemConfiguration.corsConfiguration.exposedHeaders# [type]#[Array<String>]# [optional]#Optional# [default]#defaults to `["Access-Control-Allow-Origin", "Access-Control-Allow-Credentials"]`# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.corsConfiguration.preflightMaxAgeInSeconds# [type]#[Integer]# [optional]#Optional# [default]#defaults to `1800`# [since]#Available Since 1.8.0#
...
|[field]#systemConfiguration.issuer# [type]#[String]# [required]#Required# [since]#Available Since 1.6.0#
...
|[field]#systemConfiguration.jwtConfiguration.accessTokenId# [type]#[UUID]# [required]#Required# [since]#Available Since 1.6.0#
...
|[field]#systemConfiguration.jwtConfiguration.idTokenKeyId# [type]#[UUID]# [required]#Required# [since]#Available Since 1.6.0#
