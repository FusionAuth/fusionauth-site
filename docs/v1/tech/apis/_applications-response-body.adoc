...
|[field]#applications``[x]``.jwtConfiguration.algorithm# [type]#[String]#
|
...
|[field]#applications``[x]``.jwtConfiguration.privateKey# [type]#[String]#
...
|[field]#applications``[x]``.jwtConfiguration.publicKey# [type]#[String]#
...
|[field]#applications``[x]``.jwtConfiguration.secret# [type]#[String]#
