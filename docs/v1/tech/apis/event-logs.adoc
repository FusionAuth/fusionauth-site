...
|The link:../reference/data-types#instants[instant] when the Event Log was created.
...
* `insert_instant` - the link:../reference/data-types#instant[instant] when the Event Log was created
