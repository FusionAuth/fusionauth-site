...
.Request Body
|===
|[field]#auditLog.data.attributes# [type]#[Object]# [optional]#Optional#
|An object that can hold additional details of an audit log.

|[field]#auditLog.data.newValue# [type]#[String]# [optional]#Optional#
|Intended to be utilized during a change to record the new value.

|[field]#auditLog.data.oldValue# [type]#[String]# [optional]#Optional#
|Intended to be utilized during a change to record the old value prior to the change.

|[field]#auditLog.data.reason# [type]#[String]# [optional]#Optional#
