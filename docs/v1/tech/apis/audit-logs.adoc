...
When calling the API using a `GET` request you will send the search criteria on the URL using request parameters.
...
|[field]#numberOfResults# [type]#[Integer]# [optional]#Optional#
...
|[field]#startRow# [type]#[Integer]# [optional]#Optional#
