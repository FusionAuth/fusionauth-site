...
|[field]#systemConfiguration.emailConfiguration.forgotPasswordEmailTemplateId# [type]#[UUID]#
...
|[field]#systemConfiguration.emailConfiguration.setPasswordEmailTemplateId# [type]#[UUID]#
...
|[field]#systemConfiguration.emailConfiguration.verificationEmailTemplateId# [type]#[UUID]#
...
|[field]#systemConfiguration.emailConfiguration.verifyEmail# [type]#[Boolean]#
|Whether or not user's email addresses are verified when the register with your application.

|[field]#systemConfiguration.emailConfiguration.verifyEmailWhenChanged# [type]#[Boolean]#
