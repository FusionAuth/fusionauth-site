const referenceData = {
  redirects: {
    ...
    '/docs/v1/tech/apis/two-factor': '/docs/apis/messengers/two-factor',
    ...
    '/docs/v1/tech/identity-providers/openid-connect/': '/docs/lifecycle/authenticate-users/identity-providers/',
    '/docs/v1/tech/identity-providers/samlv2/': '/docs/lifecycle/authenticate-users/identity-providers/',
    ...
    '/docs/v1/tech/core-concepts/scim': '/docs/lifecycle/migrate-users/scim/scim',
    ...
    'example-scripts': '/docs/v1/tech/docs/operate/deploy/example-scripts',
    ...
    '/docs/v1/tech/release-notes': '/docs/release-notes/release-notes',
    ...
    '/docs/v1/tech/archive/apis/system': '/docs/archive/apis/system-1-29',
    '/docs/v1/tech/client-libraries/': '/docs/sdks/',
    '/docs/v1/tech/events-webhooks/events/': '/docs/extend/events-and-webhooks/events/',
    '/docs/v1/tech/getting-started/': '/docs/getting-started/index',
    ...
    '/docs/v1/tech/installation-guide/kubernetes/': '/docs/get-started/download-and-install/kubernetes/index',
    '/docs/v1/tech/installation-guide/migration': '/archive/passport-to-fusionauth',
    '/docs/v1/tech/migration-guide/': '/docs/lifecycle/migrate-users/index',
  ...
  indexPaths: {
    ...
    '/docs/lifecycle/authenticate-users/saml/': true,
  ...
  s3Paths: ['/direct-download', '/license'],
...
const handler = (event, context, callback) => {
  ...
  } else if (!uri.endsWith('/') && referenceData.indexPaths[uri + '/'] === true) {
...
function removeSlash(uri) {
  return referenceData.indexPaths[uri] !== true &&
         (!uri.startsWith('/blog') || (uri.match('^/blog/[\\w\\d-]*/$') && !uri.match('^/blog/latest/$'))) &&
         referenceData.redirectsByPrefix.find(e => uri.startsWith(e[0])) === undefined;
}

function calculateRedirect(uri) {
  var result = referenceData.redirects.hasOwnProperty(uri) ? referenceData.redirects[uri] : null;

  if (result === null) {
    var prefix_replacement = referenceData.redirectsByPrefix.find(e => uri.startsWith(e[0]));
  ...
  if (result === null) {
    referenceData.redirectsByRegex.forEach(function (regexValueArray) {
...
function calculateURI(uri) {
  var i;
  for (i = 0; i < referenceData.s3Prefixes.length; i++) {
    if (uri.startsWith(referenceData.s3Prefixes[i])) {
      return uri.endsWith('/') ? uri + 'index.html' : appendHTML(uri);
    }
  }

  for (i = 0; i < referenceData.s3Paths.length; i++) {
    if (uri === referenceData.s3Paths[i]) {
