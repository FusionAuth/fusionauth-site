...
const redirects = {
  ...
  '/docs/v1/tech/admin-guide/account-portal': '/docs/get-started/run-in-the-cloud/account-portal',
  '/docs/v1/tech/installation-guide/cloud': '/docs/get-started/run-in-the-cloud/cloud',
  '/docs/v1/tech/installation-guide/common-configuration': '/docs/get-started/run-in-the-cloud/common-configuration',
  '/docs/v1/tech/installation-guide/marketplaces': '/docs/get-started/run-in-the-cloud/marketplaces',
  '/docs/v1/tech/tutorials/setup-wizard': '/docs/get-started/run-in-the-cloud/setup-wizard',
...
var s3Prefixes = ['/blog/', '/docs/', '/legal/', '/articles/', '/dev-tools/'];
...
function handler(event) {
  ...
  if (!uri.endsWith('/') && indexPaths[uri + '/'] === true) {
    return redir(uri + '/');
  }
